...
try {
	...
	var __IntegralASConfig = {
		...
		sp_cdnScripts: {xsca: "static.adsafeprotected.com/xsca.17.4.85.js", sca: "static.adsafeprotected.com/sca.17.4.114.js", main: "static.adsafeprotected.com/main.19.8.102.js"},
		protocol: 'https',
		jsref: "",
		asid: "136fb810-c1ed-11ea-b54c-028169c47751",
...
__IntegralASConfig.initialize=function(m,w,M){function Va(){var h,a,b;m.perf.markStart(na);l.startSystem();z=l.getAggregator();z.provide({omidAdSessionContext:{}});z.provide({omidAdSessionVerificationParameters:{}});h=Wa();a=oa();b=(new Xa).createInstance(h,a);z.provide({mErrors:h,mJsonp:a,mComm:b});h=__IASOmidVerificationClient;z.provide({omidVerificationClient:h});z.once("callContinueMain",function(){var a,b;m.perf.markStart(pa);b=Y.instantiateModules();a=Y.preImpression(b.mDataTransfer,b.mViewability,
b.mAdTalk,b.iOutput,b.mErrors,b.mAncestorOrigins,b.mBrowser,b.mPageUrls,b.mFeatures,s,b.renderDetector);Y.sendImpression(b.mErrors,b.mFeatures,b.mIds,b.mMode,b.iOutput,b.mBrowser,b.mViewability,a,b.mVideo);Y.postImpression(b.mBrowser,b.mIds,b.mViewability,b.mFeatures,b.mComm,b.mDataTransfer,b.mErrors,b.iOutput,b.loopDelay,b.mAdTalk,b.viewabilityMeasurement,b.mAncestorOrigins,s);m.perf.markEnd(pa)});z.on("tryToCallContinueMain",function(a){m.isResolved?z.trigger("callContinueMain"):z.trigger("requestBootstrapper",
a)});z.once("requestBootstrapper",function(a){var b=m.forcedBootstrapperHost||"http://jsconfig.adsafeprotected.com";"string"===typeof a&&(a=JSON.parse(a));var e=a&&a.config,k=a&&a.sca,u=a&&a.xsca;e&&z.trigger("jsonp",b+"/jsconfig"+e+(m.adSessionId?"&adSessionId="+m.adSessionId:""),function(a){Object.assign(m,"string"===typeof a?JSON.parse(a):a);m.isResolved=!0;m.sp_cdnScripts={sca:k,xsca:u};z.trigger("callContinueMain")},!1,"cbName")});h=[{environment:new da(h),adSessionReadyStrategy:new Ya(h)},{environment:new Za,
adSessionReadyStrategy:new $a}];(new ab(h)).resolve().adSessionReadyStrategy.start();m.perf.markEnd(na)}var z,Y=function(){function h(a){var b=new bb(a,s),c=new cb,d=new db(a,s),p=eb(a,s),q=(new fb(m,s,a)).resolve(),h=[b],E=[];p.applies()&&h.push(p);d.applies()&&h.push(d);c.applies(a,s)&&h.push(c);f(q).each(function(a,b){h.push(new gb(b,s));E.push(b.id)});0<E.length&&(z.trigger("addOutputItem",{output:E.join(".")},"scm",{type:g.IMPRESSION_EVENT}),z.trigger("addOutputItem",{output:E},"metricIdList",
{type:g.DT_CODES.UNLOAD,asION:!0}));return h}function a(a,b,c,d){var p=h(a);z.provide("viewabilityDefinitions",p);return f(p).map(function(q,p){var h,f,l;h=new qa(p,b);var m=(new hb(c,a,p.rts)).getCallbacks(),x=new ra(d.createPingJobs(p.type,p.timeInViewThresholds,m,p.metricId));p.sendOtherwiseInViewSignal&&(l=new qa(p,b,p.sendOtherwiseInViewSignal),f=new ra(d.createPingJobs(p.type,p.timeInViewThresholds,m,p.metricId,p.sendOtherwiseInViewSignal)));p.rtsCallbacks=m;p.thresholdType===g.GROUPM_MOBILE_PASS_THRU_TIME_IN_VIEW_THRESHOLD_TYPE?
h=new ib(h,p,x,s.isVideo()):(h=new sa(h,new Z(p.minUnit),x),p.sendOtherwiseInViewSignal&&(f=new sa(l,new Z(p.minUnit),f,p.sendOtherwiseInViewSignal),f.start()));h.start();return h})}function b(a,b){var c=(new ea).accepts(),c=!s.isAvid()&&!c&&!s.isInMobiMraidVideo();return s.isVideo()&&c?jb(m.videoId,a,b):{}}function c(a,b,c,d,p,q,h,E,B,A){try{m.perf.markStart(ta),m.tpiLookupURL&&kb(h,E).init(m.tpiLookupURL),s.isDomless()||A.isStarted()&&A.sendOriginList(),l.runAll(),r.execAtEndOfThread(function(){var q;
try{m.perf.markStart(ua);q={output:(new Date).getTime()-p};a.addItem(q,"sinceFw",{type:g.DT_CODES.ADTALK});f.isDef(b.loopStarted())&&a.addItem({output:b.loopStarted()},"readyFired",{type:g.DT_CODES.ADTALK});m.perf.markEnd(ua);var h,v;m.isSplitMode&&(v=m.protocol+"://"+m.sp_cdnScripts.main,m.perf.markResource(lb,v));m.impUrl&&m.perf.markResource(mb,m.impUrl);h=m.perf.getData();z.trigger("addThrottledProp",g.DT_SLOT.IM,"prf",f(h).toION());c.isApplicable(s)&&c.sendAdTalkCall()}catch(E){d.add(g.ERROR_CODES.ADTALK_DELAY)}}),
m.perf.markEnd(ta)}catch(K){d.add(g.ERROR_CODES.EVENT_LOOP_ONE)}}function d(a,b,d,n,p,q,h,f,g){var l;"true"!==m.minimizeCalls&&(l=(new Date).getTime(),r.execAtEndOfThread(function(){c(a,b,d,n,l,p,q,h,f,g)}))}return{instantiateModules:function(){var c,d,u,n,p,q,h,f,g={};m.perf.markStart(va);z=l.getAggregator();g.mFeatures=z.provide("features",nb());z.provide("mobileApp",function(){return c=c||new ob(g.mFeatures)});z.provide("avidJsClient",function(){return d=d||new pb(r.getWindow())});z.provide("context",
s);g.mBrowser=z.provide("browser",(new qb).createInstance());g.mErrors=z.request("mErrors");g.mIds=z.provide("ids",rb());g.iOutput=new sb(z);z.request("mJsonp");g.mComm=z.request("mComm");g.viewabilityMeasurement=(new tb(new ub(g.mIds),g.mFeatures,g.mBrowser)).create();if((n=z.request("omidAdSessionContext"))&&n.queuedOutputItems)for(q=0;q<n.queuedOutputItems.length;q++)z.trigger("addOutputItem",{output:n.queuedOutputItems[q].value},n.queuedOutputItems[q].code,{type:"impression"});g.mFeatures.on("swapids")&&
(m.oid=m.asid,m.asid=g.mIds.unq);g.mAdTalk=(new vb).createInstance(g.mFeatures);u=wb();n=xb(z);p=z.provide("mPage",(new yb).createInstance());g.mAncestorOrigins=zb();g.mPageUrls=z.provide("pageUrls",(new Ab).createInstance(g.mAncestorOrigins,r));q=z.provide("mScreenEvents",Bb());z.provide("ieXDomainViewability",Cb(g.mBrowser));h=Db(g.mBrowser);f=b(g.mFeatures,q);g.mVideo=z.provide("video",f);Eb(Fb.build());h=(new Gb).createInstance(g.mErrors,h,g.mFeatures);p=(new Hb).createInstance(h,g.mErrors,p,
s);f=z.provide("jobFactory",Ib());g.mDataTransfer=Jb(h,g.mErrors,g.mFeatures,g.mIds,g.iOutput,g.mBrowser,q,u);u=Kb(g.mErrors,g.mFeatures,z,n);g.mMode=Lb(u,g.mFeatures,g.viewabilityMeasurement.isImmediate());g.mViewability=z.provide("viewability",Mb(new G,g.viewabilityMeasurement,g.mBrowser,g.mDataTransfer,g.mFeatures,z,g.iOutput,p,q,g.mVideo));a(g.mFeatures,g.mViewability,n,f);g.loopDelay=wa();g.renderDetector=Nb();g.mDataTransfer.setViewabilityMod(g.mViewability);m.perf.markEnd(va);return g},preImpression:function(a,
b,c,d,p,q,h,f,B,l,K){var x,D,r,C,I;m.perf.markStart(xa);m.b11="1"===m.adHeight&&"1"===m.adWidth?"true":"false";m.cnod=m.contextNode?"true":"false";try{c.isApplicable(l)&&(c.start(),d.addItem(c.getFrameMap(),"fm"),B.on("fm2")&&d.addItem(c.getFrameMapIncludingPeerCase(),"fm2"),B.on("idMap")&&(x=c.getIdMap())&&d.addItem(x,"idMap"))}catch(s){p.add(g.ERROR_CODES.ADTALK_GENERAL)}try{q.isApplicable(h,B,l)&&q.start(),I=f.detectTopURL(),B.on("exch")&&(D=(new Ob).createInstance(p,d),D.parse(I)),r=Pb(),r.isApplicable(B)&&
r.start(B),l.usesGroupMCustomMetric()&&Qb(),C=Rb(),C.isApplicable(B)&&(C.start(),z.trigger("sendCookie")),K.start()}catch(t){p.add(g.ERROR_CODES.IMPRESSION_LEADUP)}m.perf.markEnd(xa);return I},sendImpression:function(a,b,c,d,p,q,h,g,l){try{Sb(a,b,c,d,p,q,h).send(g),f.isFunction(l.triggerInitializationEvents)&&l.triggerInitializationEvents()}catch(A){__IntegralASDiagnosticCall("impsend",A,m)}},postImpression:function(a,b,c,n,p,q,h,f,B,A,K,x,D){try{m.perf.markStart(ya);var r=Tb();r.start();r.addFieldTypes([g.DT_SLOT.IM,
g.DT_SLOT.FF,g.DT_SLOT.ENVIRONMENT,g.DT_SLOT.FF_EXP]);var C=Ub(a,b,c);C.isApplicable(n)&&C.start();var s;n.bootstrapOn("getTpl")&&n.on("usetpl")&&(s=Vb(p,q,h,b,f),s.init());d(f,B,A,h,n,p,q,b,x);K&&K.start&&K.start();D.isDomless()||Wb().start(["sca","xsca","rsrch"],n);Xb();l.runTier(g.TIERS.VIEWABILITY);var F=Yb();F.isApplicable(n)&&(F.start(),T.recordBlockingTime(),m.perf.mark(Zb),T.setupOnLoadTracking(),T.setupBrowserDelayTracking());m.perf.markEnd(ya)}catch(t){h.add(g.ERROR_CODES.POST_IMPRESSION)}}}}(),
...
c:!1},u=function(a,b){var c;try{c=a.document}catch(d){c=m.contextNode.ownerDocument}return V(c,b,e)},n=function(a){var b=[],e=(a=a&&a.getElementsByTagName&&a.getElementsByTagName("*"))&&a.length,k,u;if(a)for(var p=0;p<e;p++)u=(k=a[p])&&k.nodeName&&k.nodeName.toUpperCase(),!k.children||0!==k.children.length||f(d).contains(u)||f(c).contains(u)||f(b).contains(u)||b.push(u);return d.concat(b)},p=function(c){var d;h=h||m.contextNode.parentNode;if(c)if(t.isNodeXDomainIframe(c))d=c;else if(k(c))d=c;else{h=
c;d=p;var f;if((m.useFIF&&s.friendlyIframe||s.isSpecifiedAd())&&3>b)a:{var B=c,A,K,x,D,R=t.getNodeName(B);c=r.getTop()&&r.getTop().document;try{x=n(B);if(c&&B===c.body){f=null;break a}t.isWindow(B)?(A=u(B,x),A||(D="["+g.AD_IDENTIFIER+"-"+m.asid+"]",K=t.crossQuerySelector(D),a=K.parentNode,A=V(a,x,e))):("IFRAME"===R?B=B.contentWindow.document:a=B,x=n(B),A=V(B,x,e));void 0===A&&a&&a.parentNode&&(a=A=a.parentNode,b+=1)}catch(C){l.getAggregator().trigger("renderdiag",C)}f=A}else{f=c;A=t.getNodeName(f);
try{R=n(f),t.isWindow(f)?B=u(f,R):("IFRAME"===A&&(f=f.contentWindow.document,R=n(f)),B=V(f,R,e))}catch(I){l.getAggregator().trigger("renderdiag",I)}f=B}d=d(f)}else d=null;return d};return{find:p,getClosestContainerName:function(){return t.getNodeName(h)}}},Nb=function(){var h,a,b=!1,c={status:g.RENDER.STATUS.OTHER,details:g.RENDER.DETAILS.OTHER},d={status:g.RENDER.STATUS.DETECTED,details:g.RENDER.DETAILS.ENVIRONMENT},e=l.getAggregator().request("omidAdSessionContext"),k=function(){b=!0},u=function(a){a&&
(a.status=g.RENDER.STATUS.DETECTED);l.getAggregator().trigger("adRendered")},n=function(){var a=!1;s.isOmid()&&e&&e.useOMID13Logic&&(a=!0);return a},p=function(a){var b={},c=r.getDoc(),d=function(e){var k=e&&e.type;if("readystatechange"===k&&"complete"===e.target.readyState||"load"===k)u(b),h.saveNode(a),"readystatechange"===k?h.save(g.RENDER.DIAGNOSTIC.DOCUMENT_READY):"load"===k&&h.save(g.RENDER.DIAGNOSTIC.LOAD_FIRED),E(b),y.removeEvent(a,"load",d),y.removeEvent(c,"readystatechange",d)};"complete"===
...
m);n()?K()||(a=Aa(K,500),a.start(),h.save(g.RENDER.DETAILS.ENVIRONMENT),h.save(g.RENDER.DIAGNOSTIC.OMID_UNRENDERED),E(c)):s.isAvid()||s.isOmid()||s.isVideo()?(l.getAggregator().trigger("eligiblerender"),h.save(d.details),u(),E(d)):(E(c),B())}}},ac=function(){var h=[],a=[],b=function(a){var b;if(t.isWindow(a))b="WINDOW";else if(t.isNodeXDomainIframe(a))b="XIFRAME";else try{b=t.getNodeName(a)}catch(k){c("nen")}return b},c=function(a){h.push(a)};return{build:function(){var b=[];f(a).each(function(a,
c){b.push(c)});f(h).each(function(a,c){b.push(c)});a=[];h=[];return b.join(".")},getAdNodeName:b,save:c,saveNode:function(d){try{var e=d&&b(d),k=d&&t.getRect(d),u=d&&"IMG"===e,n=d&&t.hasBackgroundImage(d),p=d&&d.innerText&&0<d.innerText.length,q=d&&d.children&&0===d.children.length&&p,h=k&&k.width>=g.RENDER.WIDTH_THRESHOLD&&k.height>=g.RENDER.HEIGHT_THRESHOLD?g.RENDER.DIAGNOSTIC.QUALIFIED_SIZE:g.RENDER.DIAGNOSTIC.UNQUALIFIED_SIZE,f=(n||u)&&(0===d.naturalWidth||0===d.naturalHeight);a.push(e);a.push(h);
...
h();r.clearInterval(b);b=null};return{start:d,stop:e,updateFrequency:function(a,b){c=a;e();d(b)}}},Z=function(h){var a,b,c=0,d=s.getTagTime(),e=0,k=!1;return{getTotalTime:function(){return e},stop:function(){c=0;d=s.getTagTime();k=!1},mark:function(){a=k?s.getTagTime()-d:0;c+=a;c>=h&&(b=c-a<h,e+=b?c:a);d=s.getTagTime();k=!0}}},S=function(h,a){var b=h||m.adsafeSrc||m.requrl;b&&0===b.indexOf("http")||(b=0===b.indexOf("//")?m.protocol+":"+b:m.protocol+"://"+b);var b=/((http|https):\/\/(([^\/\.]*)\.([^\/]*)))(?:\/(.[^?]*)\??(.+)?)*/.exec(b),
...
'"></iframe>'],img:['<img src="','"/>']}[a];d=d[0]+b+d[1];s.isOmid()?(e=new lc,e.isApplicable(b)?e.deployBlockingScriptIntoIframe(b):c(a,b,d)):"true"===m.forceAppend?c(a,b,d):M.write(d)},c=function(a,b,c){var d=!c&&y.getXHR2();d?(d.open("POST",a),d.onreadystatechange=function(){4===d.readyState&&200===d.status&&b&&b()},d.send()):(c=t.createImage(),b&&(c.onload=b),c.src=a)},d=function(a,b,c,d){var e=M.createElement("script");c=c||m.contextNode.parentNode;e.type="text/javascript";e.src=a;b&&(e.onload=
...
(b=new XDomainRequest);return b},whenReady:function(h,a){if(s.isDomless())r.setTimeout(function(){h()},50);else{var b=a||(s.xDomainIframe?M:r.getTop().document),c=function(a){var c=r.setInterval(function(){b.body&&(r.clearInterval(c),a())},50)},d=this;(function(a){var k=function(){a(!0)};f.isFunction(M.addEventListener)?"complete"==b.readyState||"loaded"==b.readyState||"interactive"==b.readyState?r.execAtEndOfThread(k):d.addEvent(b,"DOMContentLoaded",k,!1):c(a)})(h)}},isSandboxed:function(h){var a,
...
d=b&&b[h];f.isDef(d)&&0!==d&&f(c).contains(h)&&(a=a+"."+d);d=b[h];b[h]=f.isDef(d)?d+1:1;return a}();return{callType:h,enumerator:a}};ba.callTypeCounter={};var Jb=function(h,a,b,c,d,e,k,u){var n=0,p=0,q=!1,v=function(a,e,u,h,v,E){u=u||!b.on("postDts");var s=a===g.DT_CODES.DIAGNOSTIC||a===g.DT_CODES.ADTALK||a===g.DT_CODES.SCA||a===g.DT_CODES.XSCA||a===g.DT_CODES.EXTERNAL||a===g.DT_CODES.LARGE_BILLABLE;if(c.impressionIsIdentifiable()&&(s||"n"!==k.getCurrentLoc()))try{var t=m.dtBaseURL,L=new S(t,!0),
w=r.now();l.getAggregator().trigger("preSendDt",a);t||(L.path("dt"),b.on("usedtdomain")&&L.sub("dt"));B(L,a,e);v&&v.field&&L.setParam(v.field,v.value);h||A(L,a);l.getAggregator().trigger("send",L,function(){p+=1;n=r.now()-w;f.isFunction(E)&&E()},u);a===g.DT_CODES.UNLOAD&&(q=!0);d.cleanup()}catch(y){__IntegralASDiagnosticCall("dt-"+a,y),l.getAggregator().trigger("error",g.ERROR_CODES.PHONE_HOME)}};h=function(){q||v(g.DT_CODES.UNLOAD,-1,!0)};var E=function(a,c){var d={bapi:"a",bapiClient:"b",jload:"c",
jss:"d",jsi:"e"},e=m.mode,d=d[a]||d[e];b.on(c||e+"Diag")&&d&&v(g.DT_CODES.DIAGNOSTIC,-5,!0,!0,{field:"bkp",value:d})},B=function(a,b,e){var k=new ba(b);e=f.isDef(e)?e:k.enumerator;a.setParam("asId",m.asid);e={c:c.getCacheBustId(),pingTime:e,time:s.getTagTime(),type:b};d.filterOutput(function(a){var c=a.minDt&&(!a.type||a.type===b);c&&a.oneTime&&(a.flagForRemoval=!0);return c},e);a.setParam("tv",e)},A=function(c,h){var f,q={};d.filterOutput(function(a){return a.standalone&&!a.minDt&&a.type===h},function(a,
b){c.setParam(a,b.replace("%3A",":"))});k.fastForward();if(h===g.DT_CODES.CUSTOM||h===g.DT_CODES.UNLOAD||h===g.DT_CODES.VIDEO_EVENTS||h===g.DT_CODES.FULLY_INVIEW||h===g.DT_CODES.PING||h===g.DT_CODES.VIEWABILITY_READY||h===g.DT_CODES.ADTALK)q.clog=u,s.isVideo()&&(f=s.isOmid()&&!s.isOmidForWeb()?"omidVideoEventsString":"videoEventsString",(f=l.getAggregator().request(f))&&!f.isEmpty()&&(q.ve=f));h===g.DT_CODES.UNLOAD&&(q.ndt=p);-1!==m.mode.indexOf("jsvid")&&(q.vv=l.getAggregator().request("videoVersion"));
q.NULL1=b.output();q.NULL2=k.stringify(10);q.em=s.embedded;q.fr=s.friendly;q.e=a.toString();q.tt=m.mode;q.dtt=n;d.filterOutput(function(a){var b=!a.standalone&&!a.minDt&&(!a.type||a.type===h);b&&a.oneTime&&(a.flagForRemoval=!0);return b},q);c.setParam("tv",q);c.setParam("br",e.getBrowserType())};l.getAggregator().on({sendDt:function(a,b,c){v(a,f.resolve(b),void 0,void 0,void 0,c)},sendMinDt:function(a,b){v(a,b,void 0,!0)},sendDiag:E,updateDtCount:function(){p++},unload:h});return{send:v,unload:h,
diagnostic:E,setViewabilityMod:function(a){}}},H=function(h){var a={},b=!1,c=function(){var a=1===h.nodeType?t.nodeIsHidden(h):0===h.width||0===h.height;return b?!1:a},d=function(){var b={};f(a).each(function(a,c){b[a]=r.round(c)});return b},e=function(a){return f.isNumeric(a)||f.isUndef(a)},k=function(){return r.round(a.width)*r.round(a.height)};(function(){var b;h!==w.parent&&(1!==h.nodeType?a=h:f.isDef(h.getBoundingClientRect)&&(b=t.getRect(h),f(a).mixin({x:f.useIfDef(b.x)||b.scrX,y:f.useIfDef(b.y)||
...
width:r.round(b.width),height:r.round(b.height)}}catch(c){l.getAggregator().trigger("error",g.ERROR_CODES.GET_WIN_DIMENSIONS),h={}}return h},windowSize:function(){var h={},a,b;if(s.isDomless())return{width:0,height:0};if(s.friendly)if(a=top.document,b=a.documentElement,a=a.body,f.isDef(top.innerWidth))h.width=top.innerWidth,h.height=top.innerHeight;else if(f.isDef(b.clientWidth))h.width=b.clientWidth,h.height=b.clientHeight;else if(f.isDef(a.clientWidth))h.width=a.clientWidth,h.height=a.clientHeight;
...
f.isDef(screen.availLeft)&&(h={scrX:w.screen.availLeft,scrY:w.screen.availTop,width:w.screen.availWidth,height:w.screen.availHeight});return h},getOurIFrameInTop:function(){for(var h,a=r.getTop(),b=r.getWindow();b!=a;)h=b,b=h.parent;return h},getOurNodeInTop:function(){var h;s.friendly&&(h=s.embedded?(h=t.getOurIFrameInTop())&&h.frameElement:m.contextNode);return h},getAncestorNodes:function(h){var a=[],b=h.ownerDocument&&h.ownerDocument.documentElement;if(b)for(;h.parentNode!==b;)a.push(h),h=h.parentNode;
return a},getTagsNamed:function(h,a){var b,c=a||r.getDoc();try{b=c.getElementsByTagName(h)}catch(d){b=null}return b},containsScriptTagWithSrc:function(h){return!!f(t.getTagsNamed("script")).findFirst(function(a,b){var c=b.src;return f.isFunction(h)?h(c):c===h})},contains:function(h,a){var b=!1;try{b=f.isDef(h)&&f.isFunction(h.contains)&&h.contains(a)}catch(c){}return b},querySelector:function(h,a){var b;try{b=h.querySelector(a)}catch(c){b=null}return b},nodeIsInWindow:function(h,a){return h.ownerDocument&&
(h.ownerDocument.defaultView||h.ownerDocument.parentWindow)===a},setAttributeOf:function(h,a,b){h&&f.isFunction(h.setAttribute)&&h.setAttribute(a,b)},removeAttributeOf:function(h,a){h&&f.isFunction(h.removeAttribute)&&h.removeAttribute(a)},crossQuerySelector:function(h,a){var b,c,d=[m.contextNode.parentNode,r.getDoc()];s.friendly&&d.push(r.getTop().document);if(a&&s.embedded)try{d.push(r.getWindow().frameElement.ownerDocument)}catch(e){}f(d).each(function(a,d){try{c=t.querySelector(d,h)}catch(e){}!b&&
c&&(b=c)});return b},getNodeName:function(h){return h&&h.nodeName},isWindow:function(h){var a=!1;try{a=h&&"object"===typeof h&&"setInterval"in h}catch(b){a=!0}return!!a},getChildWindowsOf:function(h){var a=[];(h=t.getTagsNamed("iframe",h))&&(a=f(h).map(function(a,c){return c.contentWindow}));return a},getFrameId:function(){var h=r.getWindow().frameElement;return h&&h.id},isViewportVisible:function(h,a){var b=h.innerWidth,c=h.innerHeight,d=b>a.width&&c>a.height;return b*c>a.width*a.height&&d},getTagName:function(h){return h.tagName.toLowerCase()},
...
d=a.adDimensions?a.adDimensions.getRounded():{width:0,height:0};c=p(a);var e={sl:v(a.viewState)};u=s.getTagTime();m(e);e.t=u;c=f({toString:function(){f(b).each(function(a,b){b.fastForward()});return"{"+f(e).toParams()+this.details+this.breakdowns+"}"},details:c,breakdowns:{piv:[],as:[],toString:function(){var a,b=function(a,b){return b.duration+"~"+b.state};a=""+("piv:["+f(this.piv).stringify(b)+"]");a+=",as:["+f(this.as).stringify(b)+"]";return",bkn:{"+a+"}"}}}).mixin(e);f(c).mixin(a);c.width=d.width;
c.height=d.height;f.isUndef(c.percentInView)&&(c.percentInView=g.PIV_NA);f.isUndef(c.reason)&&(c.reason="");return k=c};(function(){q("piv",function(a){var b,c=a.percentInView,d=[1,25,30,50,75];100===c||0===c?b=c:(f(d).each(function(a,e){f.isUndef(b)&&c<e&&(b=d[a-1])}),f.isUndef(b)&&(b=d[d.length-1]));return b});q("as",function(a){var b=g.NA;a=a.adDimensions?a.adDimensions.getRounded():{width:b,height:b};return a.width+"."+a.height})})();return{fastForward:function(){u=s.getTagTime();E()},registerLocation:function(d){var k,
...
r.getWindow(),c=a.split(".");for(a=0;a<c.length&&(b=b[c[a]],!f.isUndef(b));a++);return b},contains:function(a,b){return f.isStr(a)?-1!==a.indexOf(b):!1},trim:function(a){return f.isFunction(a.trim)?a.trim():a.replace(" ","")}},tc=function(){var a=function(){var a=function(a){return a&&a.width&&30<a.width&&a.height&&30<a.height},b=function(b){b=t.getDimensionFromAttributes(b);return a(b)};return{hasValidDimensions:function(c){var d;(d=b(c))||(c=t.getDimensionFromStyle(c),d=a(c));return d},hasValidDimentionAttributes:b}}(),
...
l.getAggregator().trigger("stopAdTalk"));return c},isCandidateForMyIdMap:k}},Ec=function(a){var b=new ga,c=function(a){var b=a,c="IFRAME"===t.getNodeName(a),d=t.isWindow(a);c?b=a.contentWindow.document:d&&(b=a.document);return b},d=function(a,b){return t.querySelector(c(a),b)},e=function(c,e){var g,p,q;try{p=d(c,e),p||(g=b.getFrames(!0,a),f(g).findFirst(function(a,b){return q=d(b,e)}))}catch(v){}return p||q||null};return{queryFor:function(b){var c=null;b&&(c=e(a,b));return c}}},Bc=function(a){var b=
...
n,m,s,x;try{k=a.request("frameCollection");n=a.request("adTalkMessageCollection");m=d.messageContent.self;n.add(d);var D=k.getMe();D.unifiedId>m.unifiedId&&(D.unifiedId=m.unifiedId);var t;t=r.now()-d.sentTime;d.transferDuration=t;n=s=k.getFrame(m.id);f.isUndef(n)||f.isUndef(n.selfDescription)?(s=s||k.addFrame(c.source,m.id.split("-"),d),s.addInformationFromSrc(d,m),e()):s.addInformationFromSrc(d,m);(x=b&&a.request("idMapModule").isCandidateForMyIdMap(d))&&u()}catch(C){l.getAggregator().trigger("error",
...
f.isDef(m._onMeasurable)}}},Lc=function(){return{start:function(a){dc(l.getAggregator(),["adImpression","measurable"]).onAll(function(){a()})},isApplicable:function(a,b){var c=9<=b.getIOSVersion();return(!b.browserIs(g.BROWSERS.WEBKIT)||c)&&s.isVideo()}}},Kc=function(){return{start:function(a){l.getAggregator().once("adImpression",function(){a()})},isApplicable:function(a){return a.isImmediatelyMeasurable()&&s.isVideo()}}},Mc=function(a,b,c){var d=["rjss","jss","jload"],e=function(){var b=!1,c=a.getAvidAdSessionContext();
...
v()):(b=!0,E())}},A=function(a){k.mediaType=a.data.mediaType;k.queuedOutputItems.push({code:"omtp",value:k.mediaType});"video"===a.data.mediaType&&(k.isVideo=!0);a.data.viewport&&a.data.adView&&(k.impressionViewabilityMeasurement={data:{viewport:a.data.viewport,adView:a.data.adView}},k.geometryArrived||(k.geometryArrived=g.checkForViewAttachmentBasedOnAdSessionType(k,a.data.adView)));a.data.hasOwnProperty("impressionType")&&!k.hasOwnProperty("impressionType")&&(k.impressionType=a.data.impressionType);
k.isNativeVideo=k.isNative&&"video"===a.data.mediaType;k.isDisplay="display"===a.data.mediaType;c=!0;E()},t=function(a){"loaded"===a.type&&(d=!0,a.data.hasOwnProperty("creativeType")&&(k.creativeType=a.data.creativeType),a.data.hasOwnProperty("impressionType")&&(k.impressionType=a.data.impressionType));E()},x=function(a){a&&"start"===a.type&&(k.videoStartArrived=!0)};return{start:function(){q.registerSessionObserver(B,"IAS");q.addEventListener("impression",A);try{q.addEventListener("media",t)}catch(a){}try{q.addEventListener("video",
...
return{calculateGeometricMeasurement:function(e,q){if(f.isDef(e)&&f.isDef(q)){var v=e.viewport,l=e.computedAdContainer,m=l.obstructions,s=m&&0<m.length,t=e.originalAdContainer,x=q.adGeometry,D=q.adFound,R=e.detectionMethod,C=0,v={x:0,y:0,width:v.width,height:v.height},I=u(t,x),F=e.outOfViewReason,w=0,L=0,y=s||!1,w=1>=x.width*x.height;c&&w&&(D=!1,F=F||"",D||-1!==F.indexOf(g.OUT_OF_VIEW_REASONS.GEOM)||(F=g.OUT_OF_VIEW_REASONS.GEOM+(""!==F?"."+F:"")));if(D&&0<e.percentageInView){w=d(v,l,I);s?(C=n(l,
I),C=k(v,l,C),C=u(l,C),C=a.calculateObstructedArea(C,m)):C=0;L=C;C=Math.round((w-L)/(I.width*I.height)*100);s&&0===L&&(y=!1);for(var x=(new H(I)).getRoundedGeometry(),D=y,z,s=0,L=b.getConfig(x).numberOfSlices,P=r.floor(x.height/L)||1,m=[],w=D?a.getObstructionStatusBySlice(L):[],W,s=0;s<L;s++)z=x.y+P*s,s==L-1&&(P=x.y+x.height-z),z={x:x.x,y:z,width:x.width,height:P},W=d(v,l,z),z=1==W/(z.width*z.height),m.push(z);if(D)for(l=r.min(w.length,L),s=0;s<l;s++)m[s]=m[s]&&!w[s];l=m}else l=b.getConfig(x).defaultSliceArray;
return{windowDimensions:v,containerDimensions:t,adDimensions:I,percentageInView:C,viewState:50<=C?g.IN_VIEW:g.OUT_OF_VIEW,outOfViewReason:50<=C?"":F||g.OUT_OF_VIEW_REASONS.GEOM,detectionMethod:R,isObstructed:y,sliceStatus:l}}}}},$c=function(){return{accepts:function(){return s.isAvidNative()}}},bd=function(a,b){var c=function(a){var c=a.eventData.originalAdContainer;a=!!c;c=(new H({x:0,y:0,width:a?c.width:0,height:a?c.height:0})).getRoundedGeometry();b.trigger("avidNativeGeometryChanged",{adGeometry:c,
...
l.matrix[k][m]&&(l.matrix[k][m]=1,l.obscuredPixelCount+=1);k=l}l=k.obscuredPixelCount;q=k;if(f.isUndef(q.matrix)||0===q.matrix.length)c=[];else{g=0;p=!1;k=q.matrix[0].length;n=q.matrix.length;p=a.getConfig({height:k}).numberOfSlices;for(var m=r.floor(k/p)||1,s=[],t=0;t<k;t++){p=!1;for(var K=0;K<n;K++)if(1===q.matrix[K][t]){p=!0;break}g++;p&&(t+=m-g,g=m);if(g==m||t===k-1)s.push(p),g=0}c=s}}else c=b;return l},getObstructionStatusBySlice:function(){return c}}},Yc=function(a,b){var c=l.getAggregator().request("omidAdSessionContext"),
...
u=!1,n,p,q,m,r,s=function(){if(!(f.isUndef(p)||f.isUndef(q)||f.isUndef(m))){r=!0;var a=e.calculateGeometricMeasurement(p,q),b=k&&u,c=k&&50<=a.percentageInView,l={windowDimensions:a.windowDimensions,containerDimensions:a.containerDimensions,adDimensions:a.adDimensions,percentageInView:a.percentageInView,detectionMethod:a.detectionMethod,isMeasurable:!0,isObstructed:a.isObstructed,sliceStatus:a.sliceStatus,isVideoPlaying:k,isVideoPlayingInFullscreen:b,isSoundOn:!0};b&&(l.percentageInView=100);b||c?
l.viewState=g.IN_VIEW:(l.viewState=g.OUT_OF_VIEW,l.outOfViewReason=a.outOfViewReason||g.OUT_OF_VIEW_REASONS.VIDEO);n=l;d.trigger("videoGeometryMeasurementChanged",n)}},t=function(a){p=a;s()},K=function(a){q=a;s()},x=function(a){m=a;a=a.eventType;"AdEnteredFullscreen"===a?u=!0:"AdExitedFullscreen"===a?u=!1:-1!=="AdStarted|AdVideoStart|AdPlaying".indexOf(a)?k=!0:-1!=="AdSkipped|AdUserClose|AdPaused|AdVideoComplete|AdStopped|AdError".indexOf(a)&&(k=!1);s()};return{start:function(){l.getAggregator().trigger("addOutputItem",
{output:g.MEDIA_TYPE.VIDEO_CODE},g.MEDIA_TYPE_CODE,{type:g.IMPRESSION_EVENT});a.addAdContainerGeometryMeasurementChangedListener(t);a.start();b.addAdGeometryMeasurementChangedListener(K);b.start();c.addVideoPlaybackEventListener(x);c.start()},getStrategyName:function(){return g.MEASUREMENT_STRATEGY.VIDEO},addMeasurementChangedListener:function(a){d.on("videoGeometryMeasurementChanged",a)},isMeasurable:function(){return r}}},La=function(a,b,c){var d,e=function(){var b=a.find(),e,n,p=!1;f.isDef(b)?
...
var d=c?"percentInViewIgnoringRender":"percentInView",e,n,q,m=b.adDimensions.area();q=1===b.tabHidden;var s=r.max(b.fullPercentInView||0,b[d]),d=f(a.thresholds).findFirst(function(a,b){e=b.lb||0;n=b.ub||k;if(m>=e&&m<=n)return!0});q=!q&&s>=d.piv;b.method==g.DETECTION_METHODS.AD_PLACEHOLDER&&0===a.tiv&&(q=!1);l&&(q=q&&b.isVideoPlaying,p&&(q=q&&b.isSoundOn));return q};c=new Q(a);d=a.qiv;(function(){e={};var a;f.isDef(m.rts)&&f.isDef(m.rts[n])&&(a=c&&f.isFunction(c.getTimeThresholds)&&c.getTimeThresholds()[0],
...
b,c,d){var e=d?"isInViewIgnoringRender":"isInView",f=function(d){a[e](d)?(b.mark(),c.doEligibleJobs(b.getTotalTime())):b.stop()};return{start:function(){a.addMeasurementChangedListener(f)}}},ib=function(a,b,c,d){var e,k,g,n,p,q,m=function(a,b){return!b&&a},r=function(a,b,c,d){return d?!0:!b&&(a||d)&&c},s=function(a){var l=0,m=1===a.tabHidden,v=a.isVideoPlaying,s=a.isSoundOn,x=a.isVideoPlayingInFullscreen;f(a.sliceStatus).each(function(a,b){g(b,m,v,x)?e[a].mark():e[a].stop();n[a]=e[a].getTotalTime()});
t("slcVt",n);d&&(f(a.sliceStatus).each(function(a,b){r(b,m,v,x)&&s?k[a].mark():k[a].stop();p[a]=k[a].getTotalTime()}),t("slcVtVol",p));q=d&&b&&b.shouldIncludeSound?p:n;a=f(q).findFirst(function(a,b){l=Math.max(l,b);return 0>=b});f.isUndef(a)&&c.doEligibleJobs(l)},t=function(a,b){var c={};c[a]=b;l.getAggregator().trigger("addOutputItem",{output:c},{minDt:!1})},K=function(a){!e&&a.sliceStatus&&(e=[],k=[],n=[],p=[],f(a.sliceStatus).each(function(a){e.push(new Z(1));n.push(0);d&&(k.push(new Z(1)),p.push(0))}))},
x=function(a){f.isUndef(a.sliceStatus)||(e||K(a),s(a))};return{start:function(){g=d?r:m;a.addMeasurementChangedListener(x)}}},qa=function(a,b,c){return{isInView:a.isInView,isInViewIgnoringRender:a.isInViewIgnoringRender,addMeasurementChangedListener:function(a){b.addMeasurementChangedListener(a,c)}}},Mb=function(a,b,c,d,e,f,l,n,p,q){var m=!1,t=s.isVideo(),B=f.request("mobileApp"),A=aa().applies(c,e),K=c.browserIs(g.BROWSERS.GECKO)||c.browserIs(g.BROWSERS.IE)&&e.on("rattie")||A,x=s.xDomainIframe&&
...
b,d){c=d.usesZeroPivCustomMetric();var e=aa();return b.on("viewabilityOptimization")&&e.applies(a,b,d)&&d.isDeviceTypeGroupMobile()},start:function(a){b=a;b.start(!0);l.getAggregator().on("IOPivChange",e)}}},td=function(a,b,c,d,e,k){var u,n,p,q,v,E,B,A,K,x=t.getElementsWindow(b);t.getElementsDocument(b);l.getAggregator().provide("iframeCalculatorHelper",md(x));var D=nd(b,d),R=g.AD_IDENTIFIER+"-"+m.asid,C=!1,I=H({}),F=s.isDeviceTypeGroupMobile(),z=s.usesGroupMCustomMetricMobilePassThru(),L,$=function(){if(!u)if(u=
D.calcDims(b,d,p),c===g.DETECTION_METHODS.VIDEO&&s.embedded){var a=u,e=(new H(b)).getRounded();try{a.set("width",e.width),a.set("height",e.height)}catch(f){l.getAggregator().trigger("error",g.ERROR_CODES.VIDEO_IN_IFRAME_DIMS_CALC)}}else c===g.DETECTION_METHODS.AD_PLACEHOLDER&&u.treatAsPlaceholder();return u},G=function(){var b,d=s.xDomainIframe&&C;b=F&&C&&p.isReady();b=d||b;d=D.getClippedDims&&(c===g.DETECTION_METHODS.VIDEO&&s.embedded||s.isCeltra());b?n=p.getPiv():f.isUndef(n)&&(b=!F&&(s.friendly||
f.isDef(w.mozInnerScreenX))&&e.on("offscreen"),A=$(),B=new H(t.calcWinDims()),E=new H(b?t.calcMonDims():{}),K=d?D.getClippedDims():I,n=a.calcPercentInView(A,B,E,K));return n},P=function(){return a.calcInitialViewState(G())},W=function(){return b===w?!1:$().isHidden()},J=function(a,b){return s.isVideo()?r.getDoc().body:a.document&&a.document.body?a.document.body:b.contentDocument&&b.contentDocument.body?b.contentDocument.body:b};(function(){var c=r.getWindow(),e=r.getDoc(),f=b===c,k=e.body,g=l.getAggregator(),
n=new aa,m=g.request("browser"),u=g.request("features"),x=g.request("context"),t=!s.xDomainIframe,g=J(b,d),e=f&&k?e.body:b;L=s.friendlyIframe?c.frameElement:e;y.addEvent(e,"click",function(){l.getAggregator().trigger("adComponentClicked")});y.addEvent(e,"mouseover",function(){l.getAggregator().trigger("adComponentMousedOver")});n.applies(m,u,x)?(p=Hc(b,t),p.start(),C=!0,z&&(c=new od($().getRounded()),n=new pd,g=new qd(g,n),q=new rd(c.getSlices(),g))):z&&(v=new sd(a))})();return{mark:function(){t.setAttributeOf(L,
R,"")},cleanup:function(){t.removeAttributeOf(L,R)},isNode:function(a){return b===a},isHidden:W,isObstructed:function(){return!1},getDims:$,getPercentInView:G,getLocationState:P,getOnPageViewability:function(){return W()?g.OUT_OF_VIEW:P()},getDetectionMethod:function(){return c},getContainerDims:function(){return D.allowsOptimization?u:H(d)},refresh:function(){K=A=B=E=n=u=void 0;if(k){var a,c;if(!s.isDomless()&&(c=b.parentNode)){for(;b!==w&&c&&c!==M&&!a;)a=c===d,c=c.parentNode;a||(d=b.parentNode)}}},
getAdNode:function(){return b},getSliceStatus:function(){var a;q&&q.isReadyToMeasure()?a=q.getSliceStatus():s.friendly&&v&&f.isDef(A)&&(a=v.getSliceStatus(A,B,E,K));return a}}},ud=function(a,b){var c=[],d,e=f([]),k=b.on("rvCombo"),m=function(){return c[0]&&c[0].getDetectionMethod()===g.DETECTION_METHODS.AD_PLACEHOLDER},n=function(k,n,p,q){var r=m()||0===c.length;k=td(a,k,n,p,b,q);m()&&(q=c.shift(),e=f(c),q.cleanup(),d=void 0);c.push(k);e=f(c);r&&k.mark();r&&n!==g.DETECTION_METHODS.AD_PLACEHOLDER&&
...
b=p();b=b.hasMeasurement?r.round(b.totalInView/b.totalArea*100):g.PIV_NA;if(isNaN(b)||q(a))b=0;return b},t=function(c){var d=b.bootstrapOn("mobOrTab"),d=p().totalArea>=g.MRC_LARGE_AD_SIZE&&b.on("largeAd")&&!d&&!s.isVideo();return a.calcInitialViewState(v(c),d)},B=function(a){var b=-1;e.each(function(c,d){d.isNode(a)&&(b=c)});return b},A=function(a){return function(){return c[0]&&c[0][a]()}};l.getAggregator().on("adComponentAdded",function(a){f(a).each(function(a,b){-1===B(b)&&n(b,g.DETECTION_METHODS.MUTATION)})});
l.getAggregator().on("adComponentRemoved",function(a){f(a).each(function(a,b){var d=B(b);-1<d&&c.splice(d,1)})});return{getDims:A("getDims"),isObstructed:A("isObstructed"),getDetectionMethod:A("getDetectionMethod"),getContainerDims:A("getContainerDims"),getViewState:t,getViewStateIgnoringRender:function(){return t(!0)},getPercentInView:v,getPercentInViewIgnoringRender:function(){return v(!0)},isHidden:A("isHidden"),isUsingPlaceholder:m,hasAd:function(){return!!c.length},refresh:function(){d=void 0;
e.each(function(a,b){b.refresh()})},addAdComponent:n,getOutOfViewReasons:function(a){var b,e=[],f=c[0],k=g.OUT_OF_VIEW_REASONS;f&&(b=d||t(),q(a)?e.push(k.RENDER):b!==g.OUT_OF_VIEW&&b!==g.PARTIAL_VIEW_MINUS||e.push(k.GEOM),f.isHidden()&&e.push(k.HIDDEN),f.isObstructed()&&e.push(k.OBSTRUCTION));return e},getComponentCount:function(){return c.length},getComponents:function(){return c},getSliceStatus:A("getSliceStatus")}},vd=function(a){var b=!1;if(!f.isUndef(w.MutationObserver)){var c=new w.MutationObserver(function(a){r.execAtEndOfThread(function(){b&&
...
d(c);return c},getAdContainer:function(){return a},allowForAdContainerChange:!0}},V=function(a,b,c){var d;a=t.findChildWithLargestContent(a||m.contextNode.parentNode,b,c);1<t.getNodeArea(a)&&!a[g.IAS_DETECTOR]&&(d=a);return d},Bd=function(){return{detectionMethod:g.DETECTION_METHODS.IFRAME,find:function(){return w},isApplicable:function(){return s.embedded},getAdContainer:function(){return m.contextNode.parentNode},allowForAdContainerChange:!0}},Ed=function(){var a,b=r.getDoc().scripts,c=function(){a||
...
t.findChildWithLargestContent(r.getDoc().body);return a&&a.hasValidSizeForMobileApp&&!a[g.IAS_DETECTOR]?a:void 0},getAdContainer:function(){return m.contextNode.parentNode},allowForAdContainerChange:!0}},xd=function(){var a;return{detectionMethod:g.DETECTION_METHODS.SPECIFIED_AD,isApplicable:function(){return s.isSpecifiedAd()},find:function(){var b=t.crossQuerySelector(m._cl_adpath);b&&(a=t.getParent(b),1>t.getNodeArea(b)&&(a=b,b=t.findElementsWithSize(b)));return b},getAdContainer:function(){return a},
allowForAdContainerChange:!0}},wd=function(){var a;return{detectionMethod:g.DETECTION_METHODS.SPECIFIED_AD_COMPOUND,isApplicable:function(){return s.isCompoundAd()},find:function(){var b=[],c;/\[(.*)\]/.exec(m._cl_adpath)[1].split(",").forEach(function(d){if(c=t.crossQuerySelector(d))a=t.getParent(c),1>t.getNodeArea(c)&&(a=c,c=t.findElementsWithSize(c));b.push(c)});return b},getAdContainer:function(){return a},allowForAdContainerChange:!0}},Cd=function(){return{usePlaceholder:!0,detectionMethod:g.DETECTION_METHODS.AD_HUNT,
isApplicable:function(){return!0},find:V,getAdContainer:function(){return m.contextNode.parentNode},allowForAdContainerChange:!0}},yd=function(){return{detectionMethod:g.DETECTION_METHODS.VIDEO,find:l.getAggregator().request("video").findAdNode,isApplicable:s.isVideo,getAdContainer:function(){return m.contextNode.parentNode},allowForAdContainerChange:!0}},nd=function(a,b){var c,d;c=[Hd(),Id(),Jd()];d=f(c).findFirst(function(c,d){return d.isApplicable(a,b)});c=Kd();c.isApplicable(b)&&(c.setBaseStrategy(d),
d=c);return d},Jd=function(){return{calcDims:function(a,b){var c,d,e=new H(a);t.isClippable(a,b)&&(c=t.getClippedDimensions(a,b),d=e.getRounded(),e.set("height",c.height<d.height?c.height:d.height||1),e.set("width",c.width<d.width?c.width:d.width||1));return e},allowsOptimization:!1,isApplicable:function(a){var b=(s.isSpecifiedAd()||s.isBustedIframe())&&t.nodeIsInWindow(a,r.getTop());a=!t.elementIsEmbedded(a);return b||a}}},Id=function(){var a=l.getAggregator().request("iframeCalculatorHelper");return{calcDims:a.calcDims,
getClippedDims:a.getClippedDims,allowsOptimization:!0,isApplicable:function(a){return!(s.isSpecifiedAd()||s.isBustedIframe())&&t.elementIsEmbedded(a)}}},Hd=function(){var a=l.getAggregator().request("iframeCalculatorHelper");return{calcDims:function(b){var c=a.calcDims();b=(new H(b)).getRounded();c.set("height",b.height);c.set("width",b.width);return c},getClippedDims:a.getClippedDims,allowsOptimization:!1,isApplicable:function(a,c){var d=(s.isSpecifiedAd()||s.isBustedIframe())&&s.embedded&&!t.nodeIsInWindow(c,
r.getTop()),e=s.isCeltra()&&t.elementIsEmbedded(a);return d||e}}},Kd=function(){var a;return{calcDims:function(b,c,d){d=f.isDef(d)?d.getAdNodeDimensions():void 0;a&&f.isUndef(d)&&(d=a.calcDims(b,c));return d},isApplicable:function(a){a=aa();var c=l.getAggregator(),d=c.request("browser"),e=c.request("features"),c=c.request("context");return c.isDeviceTypeGroupMobile()&&a.applies(d,e,c)},allowsOptimization:!1,setBaseStrategy:function(b){a=b}}},md=function(a){var b,c,d,e=l.getAggregator().request("features"),
k=l.getAggregator().request("browser");a=a||r.getWindow();var m=function(b,c){b=b||a;c=c||{top:0,left:0,width:r.getMaxNumber(),height:r.getMaxNumber()};for(var d,e=b.parent.frames,f=!1,k=0,n=e.length;k<n;k++)if(e[k]==b){d=e[k];f=!0;break}if(f){d=t.getRect(d.frameElement);c.left+=d.left;c.top+=d.top;try{c.width=r.min(c.width,d.width),c.height=r.min(c.height,d.height)}catch(s){l.getAggregator().trigger("error",g.ERROR_CODES.GET_AD_DIMENSIONS)}b!==r.getTop()&&m(b.parent,c)}return c},n=function(){var n,
q={};try{var v,E,B,A,w,x,D=r.getMaxNumber(),y=r.getMaxNumber();s.friendly?(v=m(),B=v.left,A=v.top,D=v.width,y=v.height,E=t.browserWindowPosition(),w=E.scrX+B,x=E.scrY+A):e.on("rattie")&&k.browserIs(g.BROWSERS.IE)?(d=d||l.getAggregator().request("ieXDomainViewability"),c=d.determineFramePosition(),w=c.scrX,x=c.scrY):f.isDef(a.mozInnerScreenX)&&(w=r.round(a.mozInnerScreenX),x=r.round(a.mozInnerScreenY));var q={scrX:w,scrY:x,iFrameClippingWidth:D,iFrameClippingHeight:y},C,I,F=b||t.getIeDimObj(a);b=F;
f.isDef(a.innerWidth)?(C=a.innerWidth,I=a.innerHeight):F&&f.isDef(F.clientWidth)?(C=F.clientWidth,I=F.clientHeight,0===C&&0<F.offsetWidth&&(C=F.offsetWidth),0===I&&0<F.offsetHeight&&(I=F.offsetHeight)):a.frameElement&&f.isDef(a.frameElement.clientWidth)&&(C=a.frameElement.clientWidth,I=a.frameElement.clientHeight);n=C;q.height=I;q.width=n}catch(z){l.getAggregator().trigger("error",g.ERROR_CODES.GET_AD_DIMENSIONS)}return q};return{calcDims:function(){return new H(n())},getClippedDims:function(){var a=
n();return new H({scrX:a.scrX,scrY:a.scrY,width:a.iFrameClippingWidth,height:a.iFrameClippingHeight})}}},Gb=function(){return{createInstance:function(a,b,c){return s.isDomless()?new Ld:new Md(a,b,c)}}},Md=function(a,b,c){var d,e=m&&m.contextNode&&m.contextNode.parentNode?m.contextNode.parentNode:null,k=ud(b,c),l=function(){var a,b,e;d=d||Dd(s,c);a=d.find();!a&&d.usePlaceholder?n():a&&(a=f(a).isArray()?a:[a],b=d.getAdContainer(),e=d.allowForAdContainerChange,f(a).each(function(a,c){k.addAdComponent(c,
f.resolve(d.detectionMethod),b,e)}))},n=function(){var a;k.hasAd()||(a=t.getPlaceholderSpan(),e.insertBefore(a,m.contextNode.nextSibling),k.addAdComponent(a,g.DETECTION_METHODS.AD_PLACEHOLDER,t.getParent(a)))};vd(a);return{find:function(){k.isUsingPlaceholder()||!k.hasAd()?l():k.refresh();return k},getDetectionMethod:function(){}}},Ld=function(){var a=function(){return null};return{find:a,getDetectionMethod:a}},pb=function(a){var b,c=[],d=a||w,e=function(){return"stub"===g().mode};a=function(){e()&&
...
r.now();d=a-e;e=a;c++;10<=c&&b&&r.clearInterval(b)},50);return{isLikelyToProduceFalsePositive:function(c){var e;c=c.getRounded().height;var f=t.calcMonDims().height,l=k.getUserAgent(),l=l&&null!==l.match(/(FBAN)/)?1:0,m=k.getUserAgent(),m=m&&null!==m.match(/(iPad)/)?1:0,s=g()?1:0,A=k.getUserAgent(),A=A&&null!==A.match(/(Version\/9\.0)|(CriOS\/55)/)?1:0;e=r.pow(Math.E,0.0033*c-9.26E-4*f-0.340351*l-0.874412*m+0.646972*s+0.28118*A+2.987259*(1E3<d?1:0)-2.463292);e/=1+e;a={mbah:c,mbsh:f,mbfb:l,mbip:m,
mbhs:s,mbbr:A,mblr:d,mbp:e};b&&r.clearInterval(b);return 0.15<e},getDebugState:function(){return a}}},Wc=function(a,b,c){var d,e,k,u,n,p=[],q=m.contextNode.parentNode,v=0,t=0,B=!1,A=!1,w=new Sd,x=function(){var a=p.length-1,b=-1;-1<a&&(b=p[a].piv);return b},D=function(){l.getAggregator().trigger("delayedViewabilityReadyCallOnly")},z=function(a){y.whenReady(function(){e=new Td(a,r.getDoc().body)})},C=function(){e.removePixels()},I=function(){var a=w.getDebugState(),b=x();f.isUndef(a)&&(a={});a.mbm=
f.fromBoolToNum(A);a.mbrd=f.fromBoolToNum(B);a.mbtg=f.isDef(q.tagName)?q.tagName:"na";a.mbaf=f.isDef(k)?k:"na";a.mbad=f.isDef(d)?d.getRounded().width+"_"+d.getRounded().height:"na";a.piv=f.isDef(b)?b:-1;b={minDt:!1,type:"dm"};try{l.getAggregator().trigger("addOutputItem",{output:a},b),l.getAggregator().trigger("addOutputItem",{output:-101},"pingTime",b),l.getAggregator().trigger("sendDt",b.type)}catch(c){}};return{getScreenLocationInfo:function(b,c){var q;q=f.isDef(d);if(c||!b.adDimensions)return b;
q||(k=b.method,d=b.adDimensions,z(d));if(f.isUndef(e)||!e.isReadyToMeasure())q=!1;f.isUndef(u)&&q&&(u=w.isLikelyToProduceFalsePositive(d));if(A=!u&&q){var m;q=e.getPercentInView();var C=x(),P=1===b.tabHidden;t=r.now()-v;m=0<v?900>t:!0;v=r.now();0===b.adDimensions.area()&&(q=0);m||(q=0);var y=q;p.push({tm:s.getTagTime(),piv:y});3<p.length&&p.shift();0===q&&0<C&&(m&&(m=p.length-1,y=!0,2<=p.length&&-1<m&&(y=0===p[m].piv&&0===p[m-1].piv),m=!y),m&&(q=C));a?(f.isUndef(n)&&(n=l.getAggregator().request("video")),
...
[];f(k).each(function(b,c){a=c.isInView();q.mbs.push(a);d.push({isInView:a,percentInView:c.percentInView})});b=w(d,!1);c=w(d,!0);return r.max(b,c)};(function(){d=l?B(e):t(e);var a=d.get();f(a).each(function(a,d){var e=new Ud(b,d.x,d.y,d.width,d.height,d.percentInView,c);k.push(e)})})();return{getPercentInView:function(){var a=m(),b=y();q.mbrd=a?1:0;b!=q.mbp&&q.mbivs.push([s.getTagTime(),b]);q.mbp=b;return a?b:-1},removePixels:function(){void 0!==c&&c.stop();f(k).each(function(a,b){try{b.remove()}catch(c){}})},
...
{AdPaused:"pauseAd",AdVolumeChange:"volumeChanged",AdPlaying:"resumeAd"};return{translate:function(b){var c=b.charAt(0).toLowerCase()+b.slice(1);b in a&&(c=a[b]);return c}}},Sa=function(){return{getVolumeFromContext:function(a){var b,c=-1;f.isDef(a)&&(f.isDef(a.volume)?c=a.volume:f.isDef(a.adVolume)&&(c=a.adVolume));-1!==c&&(b=c);return b}}},jb=function(a,b,c){var d="IASid"+a,e="getIasVidBridgeVersion"+a,k,u,n,p=[],q=g.OUT_OF_VIEW,v=!1,t=!1,w=!1,A=!0,z=new Yd,x=Zd(),D=new Wd,H=new Sa,C=new Ga,I=function(b){var d;
v=!0;var e={};try{e=JSON.parse(unescape(b&&b.data?b.data:b))}catch(f){e={}}e.id==a&&(d=z.registerEvent(e,c.getCurrentLoc()),d.indicatesPlaying()?(t=!0,q=w?g.IN_VIEW:!1):d.indicatesNotPlaying()?(t=!1,q=g.OUT_OF_VIEW):d.indicatesFullscreen()?(w=!0,q=t?g.IN_VIEW:g.OUT_OF_VIEW):d.indicatesNormalSize()&&(w=!1,q=t?!1:g.OUT_OF_VIEW),b=parseFloat(d.getVolume(H)),0<b?A=!0:0===b&&(A=!1));p.push(d);n&&M();return d},F=function(b){var c,g,k=oa().wrapToGlobal(I),n=function(a){f.isStr(a)&&(l.getAggregator().provide("vc",
...
b){var d=r.getDoc().querySelectorAll(b);return k=c(d)}),!k&&b.on("novidnodeerr")&&__IntegralASDiagnosticCall("novidnode",{},m));return k},L=function(){var a=G();a&&!v&&F(a);return a},J=function(a){a=H.getVolumeFromContext(a);A=f.isDef(a)?0<a:!1},M=function(){C.init();f(p).each(function(a,b){b&&(f.isUndef(b.sl)&&b.updateScreenLoc(c.getCurrentLoc()),b.trigger(),b.indicatesCompletion()&&l.getAggregator().trigger("adSessionComplete"),b.indicatesQuartile()&&("adVideoComplete"!==b.tp&&l.getAggregator().trigger("sendDt",
g.DT_CODES.VIDEO_EVENTS),l.getAggregator().trigger("videoQuartileEvent",b)))});p=[];n=!0};(function(){y.addEvent(r.getWindow(),"message",function(a){I(a)});l.getAggregator().on({volumeChanged:J});l.getAggregator().provide({videoEventsString:z,videoVersion:function(){var a,b=L();try{a=b.getVersion()}catch(c){a=-1,l.getAggregator().trigger("error",g.ERROR_CODES.NO_VIDEO_AD_INTERFACE)}return a},videoTranslator:function(){return u=u||new $d},adNode:L});L();D.listenForResult();x.isApplicable(s)&&x.start(c)})();
return{findAdNode:L,getViewStateOverride:function(){return q},isHandshakeComplete:function(){return v},triggerInitializationEvents:M,setVideoSpecificScreenEventFields:function(a){var b=a.viewState===g.NA;a.isVideoPlaying=!0;a.isSoundOn=A;a.isVideoPlayingInFullscreen=!1;if(q){if(q===g.OUT_OF_VIEW){var c=a.reason?a.reason.split("."):[];c[c.length]=g.OUT_OF_VIEW_REASONS.VIDEO;a.reason=c.join(".")}a.viewState=b?a.viewState:q;a.isVideoPlaying=q===g.IN_VIEW}w&&t&&(a.percentInView=100,a.isVideoPlayingInFullscreen=
...
[],function(){l.getAggregator().trigger("addThrottledProp",g.DT_SLOT.IM,"sf",f.stringifyTriState(s.isSafeFrame()))},{tier:g.TIERS.ENVIRONMENT,applies:function(a,b,c){return a.on("sfdetect")}});var Rb=function(){var a=m.asid,b=m.cookieBaseURL,c=m.protocol,d=function(a){f(a).each(function(a,b){l.getAggregator().trigger("notify",b)})},e=function(){var e;e=new S(c+"://"+b,!0);e.setParam("asid",a);e=e.toString();l.getAggregator().trigger("jsonp",e,d,!0);l.getAggregator().trigger("updateDtCount")};return{start:function(){l.getAggregator().on("sendCookie",
e)},isApplicable:function(a){return a.on("cookie")&&a.bootstrapOn("sendCookie")&&a.bootstrapperHas(["protocol","cookieBaseURL","asid"])}}},Sb=function(a,b,c,d,e,f,r){var n=function(a,b){return isNaN(a)||0>a||""===a?b:a};return{send:function(p){try{var q,t=d.baseUrl,w,y,A=f.getDocumentMode();"number"===typeof A?(y=2E3,8===A?y=4E3:8<A&&(y=8E3)):y=n(m.sp_imp_maxLength,2E3);w=y;if(s.integratedBlockingApplies(t)){y=t;var z=l.getAggregator().request("mobileApp"),x=z&&z.isMobileAppEnvironment&&z.isMobileAppEnvironment(),
D=m.contextNode.getAttribute("data-ias-container"),H=m.contextNode.getAttribute("data-ias-callback"),z=y+"adContainerId="+D+"&cbFunctionName="+H,z=x?z.replace("monitoring","blocking"):z.replace("skeleton.js",m.integration+".js"),C=m.protocol+":"+m.staticServer+m.integration+"a.js",I=m.protocol+":"+m.staticServer+m.integration+".js",t=z+"&true_pb="+encodeURIComponent(m.passback)+(x?"&redirectUrl="+encodeURIComponent(I):"")+(x?"&passback=":"&adsafe_pb=")+encodeURIComponent(C)+"&"}var x=t=t.replace(g.UNIQUE_ID_TOKEN,
m.asid),F=t.length,G,L,J=n(m.sp_imp_jsInfo_minLength,0),C="";try{G=w-F-J,0<G&&(L=ce(p,G,14,b.on("partialUrls")),C+=L.join("&"))}catch(M){a.add(g.ERROR_CODES.IMPRESSION_URLS)}t=x+C;p=t+="&"===t.slice(-1)?"":"&";var N,F="";try{N=w-t.length,F+=de(N,"adsafe_jsinfo=",a,b,c,e,f,r)}catch(O){a.add(g.ERROR_CODES.JSINFO),F+="adsafe_jsinfo=e:"+a.toString()}t=p+F;d.macroUrl&&(t+="&"===t.slice(-1)?"":"&",t+=d.macroUrl);q=t;d.sendImpression(q);m.impUrl=q;l.getAggregator().trigger("impressionsent")}catch(Q){__IntegralASDiagnosticCall("impsend",
Q,m)}}}},de=function(a,b,c,d,e,k,t,n){return function(c){var d=c.primary.join(","),g=b,k=0,l=function(a){if(a)return","+a};g.length+d.length+5<=a&&(g+=l(d),e.impressionIsIdentifiable(!0),f(c.secondary).each(function(b,c){g.length+c.length+5<=a?g+=l(c):k+=1}));return g+=",ov:"+k}(function(){var a,b;b=a={viewState:g.NA};s.isDomless()?b=n.checkScreenLoc(!0)||a:d.on("impFailSafe")?r.getDoc().body&&(b=(b=n.checkScreenLoc(!0))?b:a):f.isDef(r.getDoc().body)&&(b=n.checkScreenLoc(!0));n.isImmediatelyMeasurable()||
n.requiresDelayedViewabilityEvent();a=b;var v=a.viewState;b=e.getAvidIds();v=["id:"+m.asid,"c:"+e.getCacheBustId(),"sl:"+v,"em:"+s.embedded,"fr:"+s.friendly];d.on("avidPropertiesInImpression")&&f.isDef(b)&&(v.push("abi:"+b.bundleIdentifier),v.push("apn:"+b.partner),v.push("apv:"+b.partnerVersion));a=ee(a,c,d,e,k,t,n);l.getAggregator().trigger("eligiblerender");return{primary:v,secondary:a}}())},ee=function(a,b,c,d,e,k,u){var n=[],p=l.getAggregator().request("mPage");n.push("mn:"+m.mn);n.push("pt:"+
...
m.perf.mark("si");c.on("swapids")?n.push("oid:"+m.oid):n.push("uid:"+d.unq);n.push("v:19.8.102");n.push("sp:"+(m.isSplitMode?1:0));n.push("fwm:"+("true"===m.fwMonitoring?1:0));c.on("resolution")&&(n.push("wr:"+f(t.windowSize()).toArray().join(".")),n.push("sr:"+f(t.screenSize()).toArray().join(".")));b=function(){var a;a=String(m.scriptUrl).toLowerCase();var b=a.indexOf("ias_xpc");-1<b?(a=a.substring(b+7+1),b=a.indexOf("&"),a=-1<b?a.substring(0,b):a):a="NotFound";return a||""}();"NotFound"!==b&&n.push("x_xpc:"+
...
m.head||m.documentElement,e)).getWindow()[d]=c.getMethod(b)}catch(n){l.getAggregator().trigger("error",g.ERROR_CODES.FEATURE_SCRIPT)}}}},ge=function(){var a=function(a,c,d){a===m.asid&&(d.unshift(c),l.getAggregator().trigger.apply(null,d))};return{getMethod:function(b){return function(c){var d={asid:m.asid,constant:g,features:b,context:s,dtBaseURL:m.dtBaseURL,spg:Ua};"function"===typeof c&&c(a,d)}},getMethodName:function(a){return"register_"+a}}},Wb=function(){return{start:function(a,b){f(a).each(function(a,
