...
try {
	...
	var __IntegralASConfig = {
		...
		sp_cdnScripts: {xsca: "static.adsafeprotected.com/xsca.17.4.85.js", sca: "static.adsafeprotected.com/sca.17.5.12.js", main: "static.adsafeprotected.com/main.19.8.305.js"},
		protocol: 'https',
		jsref: "",
		asid: "4adea5ea-c57a-11ec-b9b4-62b4721105af",
		...
		accountForSadImps: '',
		fwMonitoring: '',
		mn: "jsserver-primary-7b4544cb89-6vprh",
		mobOrTab: false,
		app: true,
		mobAppWebview: false,
...
q.data.adView.onScreenGeometry=q.data.adView.containerGeometry=q.data.adView.onScreenContainerGeometry=q.data.adView.geometry;z&&0!==f&&0!==e||(q.data.adView.geometry.width=q.data.adView.geometry.height=0,q.data.adView.percentageInView=0);n.getAggregator().trigger("internallyGeneratedGeometryEvent",q)}v&&"loaded"!==a.type&&(t.cachedVideoEventsReceived=!0,"start"===a.type&&(t.cachedStartEventIndex=t.cachedEvents.length),t.cachedEvents.push(a));g.isDef(u)&&b.trigger("videoPlaybackEvent",{eventType:u,
eventData:null});F&&n.getAggregator().trigger("sendDt",l.DT_CODES.VIDEO_EVENTS)}catch(Ka){__IntegralASDiagnosticCall("omidvideo",Ka,y.bootstrapper)}};return{start:function(){n.getAggregator().on("impressionsent",B);n.getAggregator().provide({omidVideoEventsString:F});v=!0;"audio"===t.creativeType?x.addEventListener("media",M):x.addEventListener("video",M);v=!1;t.cachedVideoEventsChecked=!0;t.cachedVideoEventsReceived&&t.processCachedEvents();q.init()},addVideoPlaybackEventListener:function(a){b.on("videoPlaybackEvent",
...
0;var f={x:0,y:0,width:0,height:0};e=100===c?[!0]:[!1];d={windowDimensions:f,adDimensions:f,containerDimensions:f,shouldDelegateToDomBasedViewability:!1,isMeasurable:!0,isObstructed:!1,isHidden:!1,percentageInView:c,detectionMethod:l.DETECTION_METHODS.MRAID,sliceStatus:e};b.trigger("mraidScreenLocationChanged",d)}catch(D){}},e=function(){var b=a.mraid;return g(b).isObj()&&g.isFunction(b.isViewable)},f=function(){var b=a.mraid;d();b.addEventListener("viewableChange",d)},p=function(){var b=a.mraid;
e()&&(c=!0,"loading"===b.getState()?b.addEventListener("ready",function(){f()}):f())},m=function(){c||p()};return{start:function(){var b=!0;if(g.isDef(a.mraid)||u.containsScriptTagWithSrc("mraid.js"))b=!1;n.getAggregator().trigger("addOutputItem",{output:g.stringifyTriState(b)},"mi",{type:"impression"});b?n.getAggregator().trigger("exec","mraid.js",m):p()},addScreenLocationChangedListener:function(a){b.on("mraidScreenLocationChanged",a)}}},jc=function(a,b,c){var d={},e=function(c){var d=g.noop;b.bootstrapOn("useViewabilityNotification")&&
(d=function(){a.skipAsFraudulent()||n.getAggregator().trigger("notify",c)});return d};(function(){c&&g(c).map(function(a,b){d[a]=e(b)})})();return{getCallbacks:function(){return d}}},zb=function(){var a=new T({tiv:[1E4]}),b=g([l.IN_VIEW,l.PARTIAL_VIEW_PLUS]);return{timeInViewThresholds:a,type:l.DT_CODES.FULLY_INVIEW,rts:{},isInView:function(a){var c=r.max(a.fullPercentInView||0,a.percentInView);return b.contains(a.viewState)&&100===c},applies:function(a,b){return a.on("abcAudit")&&925955==k.anId&&
...
e[d]=k._onInViewMRC;return{timeInViewThresholds:c,type:l.DT_CODES.PING,rts:e,isInView:m,isInViewIgnoringRender:function(a){return m(a,!0)},applies:!0,minUnit:1E3,shouldIncludeSound:!1,sendOtherwiseInViewSignal:!0}},Bb=function(a,b){var c;c=a.on("everySecond");var d=b.isVideo(),e=b.usesIASFullyInViewCustomMetric(),f=[1E3,2E3,3E3,4E3,5E3,6E3,7E3,8E3,9E3,1E4,11E3,12E3,13E3,14E3,15E3],g=[1E3,5E3,15E3],m=[2E3,5E3,15E3],q=function(a){var b=r.max(a.fullPercentInView||0,a.percentInView);return-1!==(l.IN_VIEW+
"|"+l.PARTIAL_VIEW_PLUS).indexOf(a.viewState)&&100===b};c=c?new T({tiv:f}):d?new T({tiv:m}):new T({tiv:g});n.getAggregator().provide("isFullyInViewProvider",{isFullyInView:q});return{timeInViewThresholds:c,type:l.DT_CODES.FULLY_INVIEW,isInView:q,applies:function(){return e},minUnit:1E3,shouldIncludeSound:!1}},Ab=function(a,b){return{timeInViewThresholds:new T({tiv:[0]}),type:l.DT_CODES.FULLY_INVIEW,rts:{0:k._onInViewFull},isInView:function(a){var b=r.max(a.fullPercentInView||0,a.percentInView);return-1!==
(l.IN_VIEW+"|"+l.PARTIAL_VIEW_PLUS).indexOf(a.viewState)&&100===b},applies:function(){return b.usesGroupMCustomMetric()},minUnit:1E3,shouldIncludeSound:!1}},Db=function(a,b){var c,d,e,f=r.getMaxNumber(),p=b.isVideo(),m=a.id;d=a.sound&&"on"===a.sound;var q=!(a.soundExcl&&"groupm_native"===a.soundExcl&&k.groupm_native_publisher)&&d,n=function(b,c){if(!b.adDimensions)return!1;var d=c?"percentInViewIgnoringRender":"percentInView",e,m,k,n=b.adDimensions.area();k=1===b.tabHidden;var t=r.max(b.fullPercentInView||
0,b[d]),d=g(a.thresholds).findFirst(function(a,b){e=b.lb||0;m=b.ub||f;if(n>=e&&n<=m)return!0});k=!k&&t>=d.piv;b.method==l.DETECTION_METHODS.AD_PLACEHOLDER&&0===a.tiv&&(k=!1);p&&(k=k&&b.isVideoPlaying,q&&(k=k&&b.isSoundOn));return k};c=new T(a);d=a.qiv;(function(){e={};var a;g.isDef(k.rts)&&g.isDef(k.rts[m])&&(a=c&&g.isFunction(c.getTimeThresholds)&&c.getTimeThresholds()[0],a=g.isDef(a)?g.isFunction(a.getTimeInViewForRts)&&a.getTimeInViewForRts():l.RTS_KEY_FOR_VQ,e[a]=k.rts[m])})();return{timeInViewThresholds:c,
qivThreshold:d,type:l.DT_CODES.CUSTOM,rts:e,isInView:n,isInViewIgnoringRender:function(a){return n(a,!0)},metricId:m,minUnit:a.minunit?1E3*a.minunit:1E3,thresholdType:a.thresholdType,shouldIncludeSound:q,sendOtherwiseInViewSignal:!0}},Cb=function(a,b,c){var d=b.isVideo()?"video":"display",e=b.isMobileApp()?"app":"web",f=b.isDeviceTypeGroupMobile()?"mobile":"desktop",p=g(a.customViewability).isArray()&&0<a.customViewability.length,m=c.on("customMetric"),l=c.on("groupmCM"),k=function(a,b){var c,m,p,
k,q;c=g(b.mediaTypes).contains(d);m=g(b.distributionChannels).contains(e);p=g.isDef(b.deviceGroups)?g(b.deviceGroups).contains(f):!0;k=K.contains(b.id,"fiv");q=K.contains(b.id,"groupmCM");k=!k;q&&(k=l);return k&&c&&m&&p};return{resolve:function(){var b=[],c;m&&p&&(c=g(a.customViewability).filter(k),g(c).each(function(a,c){b.push(c)}));return b}}},T=function(a){var b=[];if(g(a.tiv).isArray())g(a.tiv).each(function(a,c){b.push(new na(c))});else if("string"===typeof a.tiv){a=a.tiv.split("|");var c=new Td;
b.push(new Ud(c,parseInt(a[1].replace("%"))));b.push(new na(1E3*parseInt(a[0])))}else g.isDef(a.tiv)&&b.push(new na(1E3*a.tiv));return{getTimeThresholds:function(){return b}}},Td=function(){var a=n.getAggregator().request("omidAdSessionContext").adDuration||-1,b=function(b){0<a||(b=g.isDef(b.ad_duration)?b.ad_duration:b.adRemainingTime,void 0!==b&&0<b&&(a=Math.ceil(b)))};n.getAggregator().on({omidAdDuration:b,adVideoStart:b,adDurationChange:b});return{getAdDuration:function(){return a},isVideoDurationResolved:function(){return 0<
...
a=a&&u,d=!d&&!e&&!a;return t.isMobileAppEnvironment()?b.isMeasurable():d},requiresDelayedViewabilityEvent:function(){t.isMobileAppEnvironment()&&b.hasMeasurementStrategy()&&b.requiresDelayedViewabilityEvent()},addMeasurementChangedListener:function(b){a.on("measurementChanged",b)}}},yc={name:"viewabilityLoopLifecycle",dependencies:["viewability","features","context","browser"],creator:function(a,b,c,d){var e,f=Vd(c),p=[new Wd,new Xd(f)],m=function(){return g(p).findFirst(function(a,e){return e.applies(d,
b,c)?e:void 0})},q=function(a){"sessionFinish"===a.type&&(n.getAggregator().trigger("addOutputItem",{output:v.getTagTime()},"osef"),n.getAggregator().trigger("adSessionComplete"))},t=function(a){A.addEvent(y,a,function(){n.getAggregator().trigger("adSessionComplete")},!1)},w=function(){var a=new ba(l.DT_CODES.VIDEO_EVENTS);n.getAggregator().trigger("sendDt",a.callType,a.enumerator,function(){var a={id:k.videoId,msg:"unloadComplete",messageType:"misc"};r.getWindow().postMessage(JSON.stringify(a),"*")})};
n.getAggregator().once("startViewabilityLoop",function(){var b,c=n.getAggregator().request("mobileApp").isMobileAppEnvironment();n.getAggregator().request("ids").impressionIsIdentifiable()&&(e=Sc(a.checkScreenLoc,f.getPollingFrequency()),(b=m())?b.start(e):e.start(!0),v.isOmid()?n.getAggregator().request("omidVerificationClient").registerSessionObserver(q,"IAS"):c?t("MOBILE_APP_TEST_EVENT_AD_SESSION_COMPLETE"):t("beforeunload"))});n.getAggregator().once("adSessionComplete",function(){!c.isVideo()||
...
return{applies:function(a,b,d){c=d.usesZeroPivCustomMetric();var e=aa();return b.on("viewabilityOptimization")&&e.applies(a,b,d)&&d.isDeviceTypeGroupMobile()},start:function(a){b=a;b.start(!0);n.getAggregator().on("IOPivChange",e);n.getAggregator().on("nodesAdded",f)}}},ee=function(a,b,c,d,e,f){var p,m,q,t,w,x,D,z,F,B=u.getElementsWindow(b);u.getElementsDocument(b);n.getAggregator().provide("iframeCalculatorHelper",Yd(B));var M=Zd(b,d),I=l.AD_IDENTIFIER+"-"+k.asid,L=!1,P=E({}),C=v.isDeviceTypeGroupMobile(),
G=v.usesGroupMCustomMetricMobilePassThru(),K,H=function(){if(!p)if(p=M.calcDims(b,d,q),k.autotagSizeSet&&1<k.adWidth&&1<k.adHeight&&(p.set("width",k.adWidth),p.set("height",k.adHeight)),c===l.DETECTION_METHODS.VIDEO&&v.embedded){var a=p,e=(new E(b)).getRounded();try{a.set("width",e.width),a.set("height",e.height)}catch(Ka){n.getAggregator().trigger("error",l.ERROR_CODES.VIDEO_IN_IFRAME_DIMS_CALC)}}else c===l.DETECTION_METHODS.AD_PLACEHOLDER&&p.treatAsPlaceholder();return p},N=function(){var b,d=v.xDomainIframe&&
L;b=C&&L&&q.isReady();b=d||b;d=M.getClippedDims&&(c===l.DETECTION_METHODS.VIDEO&&v.embedded||v.isCeltra());b?m=q.getPiv():g.isUndef(m)&&(b=!C&&(v.friendly||g.isDef(y.mozInnerScreenX))&&e.on("offscreen"),z=H(),D=new E(u.calcWinDims()),x=new E(b?u.calcMonDims():{}),F=d?M.getClippedDims():P,m=a.calcPercentInView(z,D,x,F));return m},Q=function(){return a.calcInitialViewState(N())},S=function(){return b===y?!1:H().isHidden()};(function(){var d=r.getWindow(),e=r.getDoc(),f=b===d,g=e.body,m=n.getAggregator(),
p=new aa,k=m.request("browser"),x=m.request("features"),m=m.request("context"),u=!v.xDomainIframe,e=f&&g?e.body:b;K=v.friendlyIframe?d.frameElement:e;A.addEvent(e,"click",function(){n.getAggregator().trigger("adComponentClicked")});A.addEvent(e,"mouseover",function(){n.getAggregator().trigger("adComponentMousedOver")});p.applies(k,x,m)?(q=sd(b,u),q.start(),L=!0,G&&c!==l.DETECTION_METHODS.AD_PLACEHOLDER&&(d=new $d(H().getRounded()),p=new ae,p=new be(q.getObservedNode(),p),t=new ce(d.getSlices(),p))):
G&&(w=new de(a))})();return{mark:function(){u.setAttributeOf(K,I,"")},cleanup:function(){u.removeAttributeOf(K,I)},isNode:function(a){return b===a},isHidden:S,isObstructed:function(){return!1},getDims:H,getPercentInView:N,getLocationState:Q,getOnPageViewability:function(){return S()?l.OUT_OF_VIEW:Q()},getDetectionMethod:function(){return c},getContainerDims:function(){return M.allowsOptimization?p:E(d)},refresh:function(){F=z=D=x=m=p=void 0;if(f){var a,c;if(!v.isDomless()&&(c=b.parentNode)){for(;b!==
y&&c&&c!==J&&!a;)a=c===d,c=c.parentNode;a||(d=b.parentNode)}}},getAdNode:function(){return b},getSliceStatus:function(){var a;t&&t.isReadyToMeasure()?a=t.getSliceStatus():v.friendly&&w&&g.isDef(z)&&(a=w.getSliceStatus(z,D,x,F));return a}}},fe=function(a,b){var c=[],d,e=g([]),f=function(){return c[0]&&c[0].getDetectionMethod()===l.DETECTION_METHODS.AD_PLACEHOLDER},p=function(m,p,k,q){var t=f()||0===c.length;m=ee(a,m,p,k,b,q);f()&&(k=c.shift(),e=g(c),k.cleanup(),d=void 0);c.push(m);e=g(c);t&&m.mark();
t&&p!==l.DETECTION_METHODS.AD_PLACEHOLDER&&n.getAggregator().trigger("primaryadfound",m)},m=function(){if(d)return d;var a,b=!1,c=0,f=0;e.each(function(d,e){var g;g=e.getDims();g.hasValidDims()&&(a=e.getPercentInView(),b=a!==l.NA,g=g.area(),c+=g,f+=a/100*g)});return d={totalArea:c,totalInView:f,hasMeasurement:b}},k=function(a){var b=n.getAggregator().request("adRenderStatus");return!a&&!b},t=function(a){var b;b=m();b=b.hasMeasurement?r.round(b.totalInView/b.totalArea*100):l.PIV_NA;if(isNaN(b)||k(a))b=
0;return b},w=function(c){var d=b.bootstrapOn("mobOrTab"),d=m().totalArea>=l.MRC_LARGE_AD_SIZE&&b.on("largeAd")&&!d&&!v.isVideo();return a.calcInitialViewState(t(c),d)},x=function(a){var b=-1;e.each(function(c,d){d.isNode(a)&&(b=c)});return b},u=function(a){return function(){return c[0]&&c[0][a]()}};n.getAggregator().on("adComponentAdded",function(a){g(a).each(function(a,b){-1===x(b)&&p(b,l.DETECTION_METHODS.MUTATION)})});n.getAggregator().on("adComponentRemoved",function(a){g(a).each(function(a,
b){var d=x(b);-1<d&&c.splice(d,1)})});return{getDims:u("getDims"),isObstructed:u("isObstructed"),getDetectionMethod:u("getDetectionMethod"),getContainerDims:u("getContainerDims"),getViewState:w,getViewStateIgnoringRender:function(){return w(!0)},getPercentInView:t,getPercentInViewIgnoringRender:function(){return t(!0)},isHidden:u("isHidden"),isUsingPlaceholder:f,hasAd:function(){return!!c.length},refresh:function(){d=void 0;e.each(function(a,b){b.refresh()})},addAdComponent:p,clearCollection:function(){e.each(function(a,
b){b.cleanup()});c=[];e=g([]);d=void 0},getOutOfViewReasons:function(a){var b,e=[],f=c[0],g=l.OUT_OF_VIEW_REASONS;f&&(b=d||w(),k(a)?e.push(g.RENDER):b!==l.OUT_OF_VIEW&&b!==l.PARTIAL_VIEW_MINUS||e.push(g.GEOM),f.isHidden()&&e.push(g.HIDDEN),f.isObstructed()&&e.push(g.OBSTRUCTION));return e},getComponentCount:function(){return c.length},getComponents:function(){return c},getSliceStatus:u("getSliceStatus")}},ge=function(a){var b=!1;if(!g.isUndef(y.MutationObserver)){var c=new y.MutationObserver(function(a){r.execAtEndOfThread(function(){b&&
g(a).each(function(a,b){b.addedNodes.length&&n.getAggregator().trigger("adComponentAdded",b.addedNodes);b.removedNodes.length&&n.getAggregator().trigger("adComponentRemoved",b.removedNodes)})})}),d=function(){b=!0;r.setTimeout(function(){b=!1},40)};n.getAggregator().on("adComponentClicked",d);n.getAggregator().on("adComponentMousedOver",d);A.whenReady(function(){try{c.observe(J.body,{attributes:!0,childList:!0,characterData:!0})}catch(e){a.add(l.ERROR_CODES.AC_WATCHER)}},r.getDoc())}},ne=function(a,
b){var c=[he(),ie()],d=[Va(),ma(),je(),oa(),ke(),le(),me()],c=c.concat(d);return g(c).findFirst(function(c,d){return d.isApplicable(a,b)})},oa=function(){var a,b,c,d=function(a){a?a&&c&&(r.execAtEndOfThread(function(){n.getAggregator().trigger("delayedViewabilityReadyCallOnly")}),c=!1):c=!0};return{detectionMethod:function(){return b&&b.detectionMethod},isApplicable:function(a){return a.isBustedIframe()},find:function(){b=b||ja();var c=u.crossQuerySelector(ja().getCssSelector(),!0);a=c?c.parentNode:
a;d(c);return c},getAdContainer:function(){return a},allowForAdContainerChange:!0}},oe=function(a,b){var c,d=u.findChildWithLargestContent(a||k.contextNode.parentNode,b);1<u.getNodeArea(d)&&!d[l.IAS_DETECTOR]&&(c=d);return c},Va=function(){var a=n.getAggregator().request("omidAdSessionContext");return{usePlaceholder:!0,detectionMethod:l.DETECTION_METHODS.OMID,isApplicable:function(){return v.isOmidForWeb()&&!v.isOmidNative()},find:function(){a.element||a.queuedOutputItems.push({code:"oea",value:!0});
return a.element},getAdContainer:function(){return a.element&&a.element.parentNode},allowForAdContainerChange:!0}},le=function(){return{detectionMethod:l.DETECTION_METHODS.IFRAME,find:function(){return y},isApplicable:function(){return v.embedded},getAdContainer:function(){return k.contextNode.parentNode},allowForAdContainerChange:!0}},pe=function(){var a,b=r.getDoc().scripts,c=function(){a||(a=g(b).findFirst(function(a,b){return K.contains(b.src,"servedby.flashtalking")}));return a},d=function(){var b,
d=a||c(),g=/;(\d+);/;d&&d.src&&(b=d.src.match(g)[1]);return b};return{detectionMethod:l.DETECTION_METHODS.BUSTED_IFRAME_FLASHTALKING,isApplicable:function(a,b){return b.on("bustediframe")&&a.embedded&&void 0!==c()},getCssSelector:function(){var a,b=d();try{a=g(["#ftdiv"+b,"#ftframe"+b]).findFirst(function(a,b){return u.crossQuerySelector(b,!0)})}catch(p){}return a}}},qe=function(){return{isApplicable:function(a,b){var c;try{c=u.getFrameId()}catch(d){}return b.on("yieldmo")&&c&&K.contains(c,"_tpi")&&
u.crossQuerySelector("[data-href*='ads.yieldmo.com']",!0)},getCssSelector:function(){return"[id='"+u.getFrameId().replace("_tpi","")+"']"},detectionMethod:l.DETECTION_METHODS.BUSTED_IFRAME_YIELDMO}},bb=function(){var a,b,c=r.getDoc(),d=function(){var b;a||(a=(b=(b=u.querySelector(c,"div[id*='ebDiv']"))&&b.id)&&b.split("ebDiv")[1]);return a},e=function(){var a=u.crossQuerySelector("iframe[id*='ebAd'][id$='"+d()+"']",!0);return a&&a.id},f=function(){var a;b||(a=e()?e():(a=u.crossQuerySelector("iframe[id*='ebBannerIFrame_'][id$='"+
d()+"']",!0))&&a.id,b=a&&"#"+a);return b};return{detectionMethod:l.DETECTION_METHODS.BUSTED_IFRAME_SIZMEK,isApplicable:function(a,b){var c=r.getWindow(),e=a.friendlyIframe&&r.getWindow().frameElement,e=e&&E(e).isOneByOne(),m=function(){var a=["bs.serving-sys.com/BurstingPipe/adServer","secure-ds.serving-sys.com/BurstingCachedScripts"],b=r.getDoc().scripts;return g(b).findFirst(function(b,c){return g(a).findFirst(function(a,b){return K.contains(c.src,b)})})}(),c=c.EBG&&c.EBG.ads&&!g(c.EBG.ads).isEmpty();
return b.on("sizmek")&&m&&c&&e&&d()&&f()},getCssSelector:f}},ja=function(){var a,b=n.getAggregator().request("features");a||(a=[bb(),qe(),pe()]);return g(a).findFirst(function(a,d){return d.isApplicable(v,b)})},ke=function(){var a,b=function(){r.execAtEndOfThread(function(){n.getAggregator().trigger("delayedViewabilityReadyCallOnly")})};return{usePlaceholder:!1,detectionMethod:l.DETECTION_METHODS.VENDOR_CELTRA,isApplicable:function(a,b){return b.on("celtra")&&a.isCeltra()},find:function(){var c,d=
...
allowsOptimization:!0,isApplicable:function(a){return!(v.isSpecifiedAd()||v.isBustedIframe())&&u.elementIsEmbedded(a)}}},re=function(){var a=n.getAggregator().request("iframeCalculatorHelper");return{calcDims:function(b){var c=a.calcDims();b=(new E(b)).getRounded();c.set("height",b.height);c.set("width",b.width);return c},getClippedDims:a.getClippedDims,allowsOptimization:!1,isApplicable:function(a,c){var b=(v.isSpecifiedAd()||v.isBustedIframe())&&v.embedded&&!u.nodeIsInWindow(c,r.getTop()),e=v.isCeltra()&&
...
I=r.getMaxNumber();v.friendly?(w=p(),D=w.left,z=w.top,A=w.width,I=w.height,x=u.browserWindowPosition(),y=x.scrX+D,B=x.scrY+z):e.on("rattie")&&f.browserIs(l.BROWSERS.IE)?(B=y=0,d=d||n.getAggregator().request("ieXDomainViewability"),c=d.determineFramePosition(),y=c.scrX,B=c.scrY):g.isDef(a.mozInnerScreenX)&&(y=r.round(a.mozInnerScreenX),B=r.round(a.mozInnerScreenY));var k={scrX:y,scrY:B,iFrameClippingWidth:A,iFrameClippingHeight:I},L,E,C=b||u.getIeDimObj(a);b=C;g.isDef(a.innerWidth)?(L=a.innerWidth,
E=a.innerHeight):C&&g.isDef(C.clientWidth)?(L=C.clientWidth,E=C.clientHeight,0===L&&0<C.offsetWidth&&(L=C.offsetWidth),0===E&&0<C.offsetHeight&&(E=C.offsetHeight)):a.frameElement&&g.isDef(a.frameElement.clientWidth)&&(L=a.frameElement.clientWidth,E=a.frameElement.clientHeight);m=L;k.height=E;k.width=m}catch(U){n.getAggregator().trigger("error",l.ERROR_CODES.GET_AD_DIMENSIONS)}return k};return{calcDims:function(){return new E(m())},getClippedDims:function(){var a=m();return new E({scrX:a.scrX,scrY:a.scrY,
...
x=function(a,b){var e=!1;g(a).each(function(a,b){switch(b.type){case "childList":g(b.addedNodes).each(function(a,b){b.nodeName&&"script"===b.nodeName.toLowerCase()&&(e=!0)});break;case "attributes":1>=b.target.height*b.target.width&&(e=!0)}});var f;e&&(f=bb(),f.isApplicable(v,c)&&(b.disconnect(),d=oa(),m.clearCollection(),n.getAggregator().trigger("nodesAdded")),setTimeout(function(){f.isApplicable(v,c)&&(b.disconnect(),d=oa(),m.clearCollection(),n.getAggregator().trigger("nodesAdded"))},0))},D=function(a){var b,
c;if(!e&&f.hasMutationObserver()&&u.isWindow(a))try{e=r.getMutationObserver(x),b=a&&a.frameElement,c=a&&a.document&&a.document.body,e.observe(b,{attributes:!0,attributeFilter:["height","width"]}),e.observe(c,{childList:!0,subtree:!0})}catch(M){}};ge(a);return{find:function(){m.isUsingPlaceholder()||!m.hasAd()?q():m.refresh();return m},getDetectionMethod:function(){}}},ve=function(){var a=function(){return null};return{find:a,getDetectionMethod:a}},Ib=function(a){var b,c=[],d=a||y,e=function(){return"stub"===
...
f&&"app"===f.environment,f=f&&"web"===f.environment;try{var m;if(!(m=g||v.isAvid()||v.isAvidNative())){var k;if(k=!f&&a.bootstrapOn("mobOrTab")&&a.bootstrapOn("mobAppWebview")){var g="FBAN FBAV Twitter Instagram Flipboard Snapchat LinkedInApp Pinterest".split(" "),t,f=!1;for(t=0;t<g.length;t++)if(-1<d.indexOf(g[t].toLowerCase())){f=!0;break}k=!f}m=k}if(m&&(e=b.detect(),b.hasDetectedMobileApp())){if("s_serv"===e||"u_cars"===e)pa[pa.length-1].detectionRules.userAgent[0]="/";c.detect();n.getAggregator().trigger("addOutputItem",
...
{AdPaused:"pauseAd",AdVolumeChange:"volumeChanged",AdPlaying:"resumeAd"};return{translate:function(b){var c=b.charAt(0).toLowerCase()+b.slice(1);b in a&&(c=a[b]);return c}}},db=function(){return{getVolumeFromContext:function(a){var b,c=-1;g.isDef(a)&&(g.isDef(a.volume)?c=a.volume:g.isDef(a.adVolume)&&(c=a.adVolume));-1!==c&&(b=c);return b}}},Fb=function(a,b,c){var d="IASid"+a,e="getIasVidBridgeVersion"+a,f,p,m,q=[],t=l.OUT_OF_VIEW,u=!1,x=!1,y=!1,z=!0,F=new Ee,B=Fe(),C=new Ce,E=new db,G=new Qa,H=function(b){var d;
u=!0;var e={};try{e=JSON.parse(unescape(b&&b.data?b.data:b))}catch(Qe){e={}}e.id==a&&(d=F.registerEvent(e,c.getCurrentLoc()),d.indicatesPlaying()?(x=!0,t=y?l.IN_VIEW:!1):d.indicatesNotPlaying()?(x=!1,t=l.OUT_OF_VIEW):d.indicatesFullscreen()?(y=!0,t=x?l.IN_VIEW:l.OUT_OF_VIEW):d.indicatesNormalSize()&&(y=!1,t=x?!1:l.OUT_OF_VIEW),b=parseFloat(d.getVolume(E)),0<b?z=!0:0===b&&(z=!1));q.push(d);m&&N();return d},K=function(b){var c,f,l=Ga().wrapToGlobal(H),m=function(a){g.isStr(a)&&(n.getAggregator().provide("vc",
...
b){var d=r.getDoc().querySelectorAll(b);return f=c(d)}),!f&&b.on("novidnodeerr")&&.1>Math.random()&&__IntegralASDiagnosticCall("novidnode",{message:"node not found*10"},k));return f},O=function(){var a=J();a&&!u&&K(a);return a},R=function(a){a=E.getVolumeFromContext(a);z=g.isDef(a)?0<a:!1},N=function(){G.init();g(q).each(function(a,b){b&&(g.isUndef(b.sl)&&b.updateScreenLoc(c.getCurrentLoc()),b.trigger(),b.indicatesCompletion()&&n.getAggregator().trigger("adSessionComplete"),b.indicatesQuartile()&&
("adVideoComplete"!==b.tp&&n.getAggregator().trigger("sendDt",l.DT_CODES.VIDEO_EVENTS),n.getAggregator().trigger("videoQuartileEvent",b)))});q=[];m=!0};(function(){A.addEvent(r.getWindow(),"message",function(a){H(a)});n.getAggregator().on({volumeChanged:R});n.getAggregator().provide({videoEventsString:F,videoVersion:function(){var a,b=O();try{a=b.getVersion()}catch(fa){a=-1,n.getAggregator().trigger("error",l.ERROR_CODES.NO_VIDEO_AD_INTERFACE)}return a},videoTranslator:function(){return p=p||new Ge},
adNode:O});O();C.listenForResult();B.isApplicable(v)&&B.start(c)})();return{findAdNode:O,getViewStateOverride:function(){return t},isHandshakeComplete:function(){return u},triggerInitializationEvents:N,setVideoSpecificScreenEventFields:function(a){var b=a.viewState===l.NA;a.isVideoPlaying=!0;a.isSoundOn=z;a.isVideoPlayingInFullscreen=!1;if(t){if(t===l.OUT_OF_VIEW){var c=a.reason?a.reason.split("."):[];c[c.length]=l.OUT_OF_VIEW_REASONS.VIDEO;a.reason=c.join(".")}a.viewState=b?a.viewState:t;a.isVideoPlaying=
