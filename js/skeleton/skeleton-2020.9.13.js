...
try {
	var __IntegralASConfig = {
		...
		sp_cdnScripts: {xsca: "static.adsafeprotected.com/xsca.17.4.85.js", sca: "static.adsafeprotected.com/sca.17.4.114.js", main: "static.adsafeprotected.com/main.19.8.127.js"},
		protocol: 'https',
		jsref: "",
		asid: "b1a6b024-f5d2-11ea-a4f7-0a8159578c0e",
...
d?A.getClippedDims():Q,n=a.calcPercentInView(v,w,B,N));return n},S=function(){return a.calcInitialViewState(K())},U=function(){return b===x?!1:J().isHidden()};(function(){var d=p.getWindow(),e=p.getDoc(),f=b===d,h=e.body,n=m.getAggregator(),l=new Y,s=n.request("browser"),v=n.request("features"),n=n.request("context"),t=!u.xDomainIframe,e=f&&h?e.body:b;H=u.friendlyIframe?d.frameElement:e;y.addEvent(e,"click",function(){m.getAggregator().trigger("adComponentClicked")});y.addEvent(e,"mouseover",function(){m.getAggregator().trigger("adComponentMousedOver")});
l.applies(s,v,n)?(q=Pc(b,t),q.start(),C=!0,I&&c!==k.DETECTION_METHODS.AD_PLACEHOLDER&&(d=new xd(J().getRounded()),l=new yd,l=new zd(q.getObservedNode(),l),r=new Ad(d.getSlices(),l))):I&&(z=new Bd(a))})();return{mark:function(){t.setAttributeOf(H,D,"")},cleanup:function(){t.removeAttributeOf(H,D)},isNode:function(a){return b===a},isHidden:U,isObstructed:function(){return!1},getDims:J,getPercentInView:K,getLocationState:S,getOnPageViewability:function(){return U()?k.OUT_OF_VIEW:S()},getDetectionMethod:function(){return c},
...
!b.props||f.isUndef(b.props.type),d=!b.props||b.props.type===k.IMPRESSION_EVENT;(c||d)&&n.push(a+":"+b.output())});b.toString()&&n.push("e:"+b.toString());n.push(c.output());n.push("tt:"+l.mode);n.push("thd:"+f.stringifyTriState(q.supportsVisAPI()));n.push("et:"+(p.now()-l.birthdate));l.perf.mark("si");c.on("swapids")?n.push("oid:"+l.oid):n.push("uid:"+d.unq);n.push("v:19.8.127");n.push("sp:"+(l.isSplitMode?1:0));n.push("fwm:"+("true"===l.fwMonitoring?1:0));c.on("resolution")&&(n.push("wr:"+f(t.windowSize()).toArray().join(".")),
