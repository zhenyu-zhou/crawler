...
try {
	var __IntegralASConfig = {
		...
		sp_cdnScripts: {xsca: "static.adsafeprotected.com/xsca.17.4.85.js", sca: "static.adsafeprotected.com/sca.17.4.114.js", main: "static.adsafeprotected.com/main.19.8.49.js"},
		protocol: 'https',
		jsref: "",
		asid: "aaa6c9a4-4f40-11ea-8233-0a8159578c0e",
...
__IntegralASConfig.initialize=function(m,w,L){function Oa(){var g,a,b;m.perf.markStart(ka);l.startSystem();z=l.getAggregator();z.provide({omidAdSessionContext:{}});z.provide({omidAdSessionVerificationParameters:{}});g=Pa();a=la();b=(new Qa).createInstance(g,a);z.provide({mErrors:g,mJsonp:a,mComm:b});g=__IASOmidVerificationClient;z.provide({omidVerificationClient:g});z.once("callContinueMain",function(){var a,b;m.perf.markStart(ma);b=Y.instantiateModules();a=Y.preImpression(b.mDataTransfer,b.mViewability,
b.mAdTalk,b.iOutput,b.mErrors,b.mAncestorOrigins,b.mBrowser,b.mPageUrls,b.mFeatures,s,b.renderDetector);Y.sendImpression(b.mErrors,b.mFeatures,b.mIds,b.mMode,b.iOutput,b.mBrowser,b.mViewability,a,b.mVideo);Y.postImpression(b.mBrowser,b.mIds,b.mViewability,b.mFeatures,b.mComm,b.mDataTransfer,b.mErrors,b.iOutput,b.loopDelay,b.mAdTalk,b.viewabilityMeasurement,b.mAncestorOrigins,s);m.perf.markEnd(ma)});z.on("tryToCallContinueMain",function(a){m.isResolved?z.trigger("callContinueMain"):z.trigger("requestBootstrapper",
a)});z.once("requestBootstrapper",function(a){var b=m.forcedBootstrapperHost||"http://jsconfig.adsafeprotected.com";"string"===typeof a&&(a=JSON.parse(a));var e=a&&a.config,k=a&&a.sca,v=a&&a.xsca;e&&z.trigger("jsonp",b+"/jsconfig"+e+(m.adSessionId?"&adSessionId="+m.adSessionId:""),function(a){Object.assign(m,"string"===typeof a?JSON.parse(a):a);m.isResolved=!0;m.sp_cdnScripts={sca:k,xsca:v};z.trigger("callContinueMain")},!1,"cbName")});g=[{environment:new ba(g),adSessionReadyStrategy:new Ra(g)},{environment:new Sa,
adSessionReadyStrategy:new Ta}];(new Ua(g)).resolve().adSessionReadyStrategy.start();m.perf.markEnd(ka)}var z,Y=function(){function g(a){var b=new Va(a,s),c=new Wa,d=new Xa(a,s),q=Ya(a,s),p=(new Za(m,s,a)).resolve(),g=[b],A=[];q.applies()&&g.push(q);d.applies()&&g.push(d);c.applies(a,s)&&g.push(c);f(p).each(function(a,b){g.push(new $a(b,s));A.push(b.id)});0<A.length&&(z.trigger("addOutputItem",{output:A.join(".")},"scm",{type:h.IMPRESSION_EVENT}),z.trigger("addOutputItem",{output:A},"metricIdList",
{type:h.DT_CODES.UNLOAD,asION:!0}));return g}function a(a,b,c,d){var q=g(a);z.provide("viewabilityDefinitions",q);return f(q).map(function(q,g){var f;f=new ab(g,b);var u=(new bb(c,a,g.rts)).getCallbacks(),M=new cb(d.createPingJobs(g.type,g.timeInViewThresholds,u,g.metricId));g.rtsCallbacks=u;f=g.thresholdType===h.GROUPM_MOBILE_PASS_THRU_TIME_IN_VIEW_THRESHOLD_TYPE?new db(f,g,M,s.isVideo()):new eb(f,new ca(g.minUnit),M);f.start();return f})}function b(a,b){var c=(new da).accepts(),c=!s.isAvid()&&!c&&
!s.isInMobiMraidVideo();return s.isVideo()&&c?fb(m.videoId,a,b):{}}function c(a,b,c,d,q,p,g,A,u,M){try{m.perf.markStart(na),m.tpiLookupURL&&gb(g,A).init(m.tpiLookupURL),s.isDomless()||M.isStarted()&&M.sendOriginList(),l.runAll(),r.execAtEndOfThread(function(){var p;try{m.perf.markStart(oa);p={output:(new Date).getTime()-q};a.addItem(p,"sinceFw",{type:h.DT_CODES.ADTALK});f.isDef(b.loopStarted())&&a.addItem({output:b.loopStarted()},"readyFired",{type:h.DT_CODES.ADTALK});m.perf.markEnd(oa);var g,y;m.isSplitMode&&
(y=m.protocol+"://"+m.sp_cdnScripts.main,m.perf.markResource(hb,y));m.impUrl&&m.perf.markResource(ib,m.impUrl);g=m.perf.getData();z.trigger("addThrottledProp",h.DT_SLOT.IM,"prf",f(g).toION());c.isApplicable(s)&&c.sendAdTalkCall()}catch(A){d.add(h.ERROR_CODES.ADTALK_DELAY)}}),m.perf.markEnd(na)}catch(R){d.add(h.ERROR_CODES.EVENT_LOOP_ONE)}}function d(a,b,d,n,q,p,g,f,u){var h;"true"!==m.minimizeCalls&&(h=(new Date).getTime(),r.execAtEndOfThread(function(){c(a,b,d,n,h,q,p,g,f,u)}))}return{instantiateModules:function(){var c,
d,v,n,q,p,g,f,u={};m.perf.markStart(pa);z=l.getAggregator();u.mFeatures=z.provide("features",jb());z.provide("mobileApp",function(){return c=c||new kb(u.mFeatures)});z.provide("avidJsClient",function(){return d=d||new lb(r.getWindow())});z.provide("context",s);u.mBrowser=z.provide("browser",(new mb).createInstance());u.mErrors=z.request("mErrors");u.mIds=z.provide("ids",nb());u.iOutput=new ob(z);z.request("mJsonp");u.mComm=z.request("mComm");u.viewabilityMeasurement=(new pb(new qb(u.mIds),u.mFeatures,
u.mBrowser)).create();if((n=z.request("omidAdSessionContext"))&&n.queuedOutputItems)for(p=0;p<n.queuedOutputItems.length;p++)z.trigger("addOutputItem",{output:n.queuedOutputItems[p].value},n.queuedOutputItems[p].code,{type:"impression"});u.mFeatures.on("swapids")&&(m.oid=m.asid,m.asid=u.mIds.unq);u.mAdTalk=(new rb).createInstance(u.mFeatures);v=sb();n=tb(z);q=z.provide("mPage",(new ub).createInstance());u.mAncestorOrigins=vb();u.mPageUrls=z.provide("pageUrls",(new wb).createInstance(u.mAncestorOrigins,
r));p=z.provide("mScreenEvents",xb());z.provide("ieXDomainViewability",yb(u.mBrowser));g=zb(u.mBrowser);f=b(u.mFeatures,p);u.mVideo=z.provide("video",f);Ab(Bb.build());g=(new Cb).createInstance(u.mErrors,g,u.mFeatures);q=(new Db).createInstance(g,u.mErrors,q,s);f=z.provide("jobFactory",Eb());u.mDataTransfer=Fb(g,u.mErrors,u.mFeatures,u.mIds,u.iOutput,u.mBrowser,p,v);v=Gb(u.mErrors,u.mFeatures,z,n);u.mMode=Hb(v,u.mFeatures,u.viewabilityMeasurement.isImmediate());u.mViewability=z.provide("viewability",
Ib(new E,u.viewabilityMeasurement,u.mBrowser,u.mDataTransfer,u.mFeatures,z,u.iOutput,q,p,u.mVideo));a(u.mFeatures,u.mViewability,n,f);u.loopDelay=qa();u.renderDetector=Jb();u.mDataTransfer.setViewabilityMod(u.mViewability);m.perf.markEnd(pa);return u},preImpression:function(a,b,c,d,q,p,g,f,u,l,R){var C,r,I,B,s;m.perf.markStart(ra);m.b11="1"===m.adHeight&&"1"===m.adWidth?"true":"false";m.cnod=m.contextNode?"true":"false";try{c.isApplicable(l)&&(c.start(),d.addItem(c.getFrameMap(),"fm"),u.on("fm2")&&
d.addItem(c.getFrameMapIncludingPeerCase(),"fm2"),u.on("idMap")&&(C=c.getIdMap())&&d.addItem(C,"idMap"))}catch(t){q.add(h.ERROR_CODES.ADTALK_GENERAL)}try{p.isApplicable(g,u,l)&&p.start(),s=f.detectTopURL(),u.on("exch")&&(r=(new Kb).createInstance(q,d),r.parse(s)),I=Lb(),I.isApplicable(u)&&I.start(u),l.usesGroupMCustomMetric()&&Mb(),B=Nb(),B.isApplicable(u)&&(B.start(),z.trigger("sendCookie")),R.start()}catch(O){q.add(h.ERROR_CODES.IMPRESSION_LEADUP)}m.perf.markEnd(ra);return s},sendImpression:function(a,
b,c,d,q,p,g,A,u){try{Ob(a,b,c,d,q,p,g).send(A),f.isFunction(u.triggerInitializationEvents)&&u.triggerInitializationEvents()}catch(h){__IntegralASDiagnosticCall("impsend",h,m)}},postImpression:function(a,b,c,n,q,p,g,f,u,M,r,C,D){try{m.perf.markStart(sa);var I=Pb();I.start();I.addFieldTypes([h.DT_SLOT.IM,h.DT_SLOT.FF,h.DT_SLOT.ENVIRONMENT,h.DT_SLOT.FF_EXP]);var B=Qb(a,b,c);B.isApplicable(n)&&B.start();var s;n.bootstrapOn("getTpl")&&n.on("usetpl")&&(s=Rb(q,p,g,b,f),s.init());d(f,u,M,g,n,q,p,b,C);r&&
r.start&&r.start();D.isDomless()||Sb().start(["sca","xsca","rsrch"],n);Tb();l.runTier(h.TIERS.VIEWABILITY);var t=Ub();t.isApplicable(n)&&(t.start(),S.recordBlockingTime(),m.perf.mark(Vb),S.setupOnLoadTracking(),S.setupBrowserDelayTracking());m.perf.markEnd(sa)}catch(O){g.add(h.ERROR_CODES.POST_IMPRESSION)}}}}(),f=function(g){return new H(g)},H=function(g){this.iterable=g};H.prototype.isObj=function(g){var a=null===this.iterable,a="object"===typeof this.iterable&&!a,b=!this.isArray()&&a;return g?a:
...
DIAGNOSTIC:{BROKEN_IMAGE:"bi",UNQUALIFIED_SIZE:"us",QUALIFIED_SIZE:"qs",STYLED_NODE:"sn",TEXT_NODE:"tn",DOCUMENT_READY:"dr",LOAD_FIRED:"lf",MRAID_DEFAULT:"md",MRAID_READY:"mr"}},RTS_KEY_FOR_VQ:"qiv",UNIQUE_ID_TOKEN:"[IAS_ASID]"},ka="mf",ma="cm",pa="in",ra="pr",sa="po",Vb="bl",na="lo",oa="lt",hb="md",ib="id",Wb=function(){var g,a,b="["+h.AD_IDENTIFIER+"-"+m.asid+"]",c=["STYLE","SCRIPT"],d=h.RENDER.CREATIVE_NODE_TYPES.concat(h.RENDER.CONTAINER_NODE_TYPES),e=function(a){var b=[],e=(a=a&&a.children)&&
...
f,A,u,l=t.getNodeName(p);c=e(p);try{u=d.concat(c);if(p===r.getTop().document.body){q=null;break a}t.isWindow(p)?(A=t.crossQuerySelector(b),a=A.parentNode,f=T(a,u)):("IFRAME"===l&&(p=p.contentWindow.document),f=T(p,u));void 0===f&&void 0!==a&&(a=f=a.parentNode)}catch(R){}q=f}else{q=c;f=t.getNodeName(q);A=e(q);try{l=d.concat(A),t.isWindow(q)?p="HEAD"===t.getNodeName(m.contextNode.parentNode)?T(m.contextNode.parentNode.ownerDocument.body,l):T(null,l):("IFRAME"===f&&(q=q.contentWindow.document),p=T(q,
l))}catch(C){}q=p}n=n(q)}else n=null;return n};return{find:k,getClosestContainerName:function(){return t.getNodeName(g)}}},Jb=function(){var g,a=!1,b={status:h.RENDER.STATUS.OTHER,details:h.RENDER.DETAILS.OTHER},c={status:h.RENDER.STATUS.DETECTED,details:h.RENDER.DETAILS.ENVIRONMENT},d=function(){a=!0},e=function(a){var b={},c=r.getDoc(),d=function(e){var k=e&&e.type;if("readystatechange"===k&&"complete"===e.target.readyState||"load"===k)b.status=h.RENDER.STATUS.DETECTED,b.details=g.build(a,{eventType:k}),
v(b),x.removeEvent(a,"load",d),x.removeEvent(c,"readystatechange",d)};"complete"===c.readyState?(b.status=h.RENDER.STATUS.DETECTED,b.details=g.build(a,{eventType:"readystatechange"})):(x.addEvent(a,"load",d),x.addEvent(c,"readystatechange",d));return b},k=function(a){a===h.RENDER.STATUS.DETECTED&&l.getAggregator().trigger("perfCheckpoint",{type:h.PERF_TIMELINE_TRACKER_CONFIG.RENDER.TYPE,timestamp:r.now(),code:h.PERF_TIMELINE_TRACKER_CONFIG.RENDER.CODE})},v=function(c){var d=new Xb(c),e=c.status||
...
!b.isMobileAppEnvironment()&&g.hasIntersectionObserver()&&a.on("chromeNativeIO")}}},Mb=function(){var g,a,b=!1,c=l.getAggregator().request("mPage"),d=function(){!b&&a&&g&&!c.isHidden()&&(b=!0,l.getAggregator().trigger("sendDt",h.DT_CODES.LARGE_BILLABLE))};l.getAggregator().on("primaryadfound",function(a){g=a.getDims().area()>=h.MRC_LARGE_AD_SIZE;d()});l.getAggregator().on("impressionsent",function(){a=!0;d()});c.onHiddenChange(d)},sb=function(){var g=[],a={},b={percentInView:"piv",sl:"vs",reason:"r",
width:"w",height:"h"};l.getAggregator().on("newScreenEvent",function(c){c=f(c).selectProperties(f(b).keys());c=f(c).asStrings();var d=f(c).compareTo(a);d&&(d.t=s.getTagTime(),g.push(d));f(a).mixin(c)});return{toString:function(){return f(g).toION(b)}}},ta=function(){var g=new Zb,a=new E;return f(g).mixin(a)},E=function(){var g={},a={},b=function(b,c,k){if((b=a[b])&&0!==b)return k&&(b=b.slice(0,1)),f(b).each(function(a,b){c.apply({},b)}),!0},c=function(a,b,c){g[a]=g[a]||new ea;g[a].push(b,c)};return{on:function(a,
...
d){var e=d&&d.getTime();f.isDef(e)&&b>=e&&!a[e]&&(d.getTask().call(),a[e]=!0)})}}},$b=function(){var g,a=new ua,b=function(b,d,e,k){var v,n,q,p;if(JSON&&JSON.parse)try{v=JSON.parse(b.data),n=b.source,p=f.noop,d(v)&&(k&&(q=k(n,v))&&(p=function(){a.send(function(){return q},n)}),e(b,v,p))}catch(g){v&&l.getAggregator().trigger("error",h.ERROR_CODES.MESSAGE_LISTENER)}};return{listen:function(a,d,e){g=function(k){b(k,a,d,e)};x.addEvent(w,"message",g)},stop:function(){g&&x.removeEvent(w,"message",g);g=
null}}},ua=function(){var g=function(a){return f(a).isObj()?[a]:(new fa).getFrames(a)},a=function(a){return f(a).mapToObj(function(a,b){var e;f.isFunction(b)||(e={},e[a]=b);return e})};return{send:function(b,c){if(JSON&&JSON.stringify){var d=g(c);f(d).each(function(c,d){var v;v=f.resolve(b,d)||{};v.sentTime=r.now();v=a(v);d.postMessage(f(v).JSONStringify(),"*")})}}}},ac=function(g,a){return{onAll:function(b){var c={};f(a).each(function(d,e){g.on(e,function(){c[e]=1;f(c).keys().length===a.length&&
(c={},b())})})}}},ob=function(g){var a=0,b={},c=function(b,c,d){if(f.isUndef(b.output))throw Error("item with id "+c+' must have "output" method');this.item=b;this.id=c||++a;this.props=d||{};this.output=function(){var a=f.resolve(b.output);this.props.asION&&(a=f(a).toION());return a}},d=function(a){var c,d,e=[];for(c in b)b.hasOwnProperty(c)&&(d=a(c,b[c]))&&e.push(d);return e},e=function(a,d,e){e=e||d;e="string"!==typeof e?e:{};var q=function(a,d,e){a=new c(a,d,e);b[a.id]=a};f(a.output).isObj()&&
...
d=g[a],e=f(arguments).toArray();e.shift();f.isUndef(d)||(c=f.isFunction(d)?d.apply({},e):d);return c},provide:function(b,c){c?g[b]=c:f(b).each(a);return c}}},Db=function(){return{createInstance:function(g,a,b,c){return s.isDomless()?new bc:new cc(g,a,b,c)}}},cc=function(g,a,b,c){var d;return{collect:function(){var a=g.find(),k=a.getOutOfViewReasons(),v=b.isHidden(),n=c.isDeviceTypeGroupMobile()&&d?d:K(t.calcWinDims()),q=a.getDims();d=n;if(!a.hasAd()||!n.hasValidDims()||!q.hasValidDims())return{viewState:h.NA,
...
sliceStatus:a.getSliceStatus()}}}},bc=function(){return{collect:function(){return{}}}},dc=function(g){g=g||f.identity;var a=[],b=r.now(),c=function(){var c=r.now();a.length&&(a[a.length-1].duration+=c-b,b=c)};return{clear:function(){c();a=[]},fastForward:c,get:function(){return a},hasAlwaysBeen:function(b){return 1===a.length&&a[0].state===b},addState:function(b){var e=a[a.length-1];b=g(b);c();0!==a.length&&b===e.state||a.push({state:b,duration:0})}}},va=function(g,a){var b=g||1,c=0,d=0,e,k=0;return{start:function(){0===
c%b&&(e=r.now())},stop:function(){var v=e||a;0===c%b&&(k+=r.now()-v,d++);c++},getTime:function(){return k},getCount:function(){return d}}},wa=function(){var g,a=0,b=0,c=new E(!0),d=function(){g&&(a++,c.trigger(a),b>a?r.execAtEndOfThread(d):e())},e=function(){g=!1;a=0};return{onTick:function(a,d){var e=f.collapseArgsIntoHash(a,d);f(e).each(function(a,c){a=parseInt(a);b=a>b?a:b});c.on(e)},start:function(){g||(g=!0,r.execAtEndOfThread(d))},kill:e,isActive:function(){return g}}},ec=function(g,a){var b,
...
hostname:e,sub:y,master:A,setParam:function(a,b){p[a]=p[a]||{};f(b).isObj()?f(p[a]).mixin(b):p[a]=b},path:function(a){n=a},toString:function(){var a=y()?y()+".":"",b=n?"/"+n:"",c;q||!f(p).isEmpty()?(c=f(p).isEmpty()?"":f(p).stringify(u,"&"),c="?"+q+(q&&c?"&"+c:c)):c="";return d+"://"+a+A()+b+c}}},Tb=function(){var g=function(a){var c=[];f(a).each(function(a,b){400>=c.concat(b).join("").length&&c.push(b)});return c},a=function(a,c){var d;c&&c.id&&(d=c.id.replace(/[^\w-_.>\/]/g,""));return d};return function(){var b,
...
!(k=n.getComponentVersion(e[v],"componentid").replace(/,/g,"."));v++);}catch(q){}e=k;k=h.NA;n=r.getWindow();f.isDef(n.navigator)&&f.isDef(n.navigator.appName)&&(k=n.navigator.appName.toLowerCase()[0]);return{br:c,abv:e,an:k}},isAndroidWebViewBrowser:function(){var a=c(),b=["SamsungBrowser","FB_IAB","Silk"],k=function(){return f(b).findFirst(function(b,c){return N.contains(a,c)})};return N.contains(a,"Android")&&k()},getIOSVersion:function(){var a,b;(a=c())&&(a=a.match(/OS\s\d+/))&&0<a.length&&(b=
(b=a.toString().match(/\d+/))&&0<b.length&&parseInt(b.toString()));return b}}},fc=function(){var g=function(){return!1},a=function(){return h.NA};return{getDocumentMode:a,getBrowserType:function(){return"u"},getIOSVersion:function(){},params:function(){return{br:"u",abv:a(),an:a()}},browserIs:g,getUserAgent:g,hasPostMessage:g,hasAncestorOrigins:g,hasIntersectionObserver:g,isAndroidWebViewBrowser:g}},Qa=function(){return{createInstance:function(g,a){return s.isDomless()?new hc(a):new ic(g,a)}}},jc=
...
d.style.margin=d.style.border="0px";d&&(d=d.contentWindow.document)&&(d.open().write(a(c,b)),d.close())}}},ic=function(g,a){var b=function(a,b){function c(a,b,d){"script"!==a?(b=L.createElement("DIV"),b.innerHTML=d,d=b.childNodes[0]):(d=L.createElement("SCRIPT"),d.src=b);m.contextNode.parentNode.appendChild(d)}var d,e;b=b||a;a=1<arguments.length?a:"script";d={script:['<script type="text/javascript" src="','">\x3c/script>'],iframe:['<iframe width="100%" height="100%" frameborder="0" vspace="0" hspace="0" scrolling="no" marginheight="0" marginwidth="0" src="',
'"></iframe>'],img:['<img src="','"/>']}[a];d=d[0]+b+d[1];s.isOmid()?(e=new jc,e.isApplicable(b)?e.deployBlockingScriptIntoIframe(b):c(a,b,d)):"true"===m.forceAppend?c(a,b,d):L.write(d)},c=function(a,b,c){var d=!c&&x.getXHR2();d?(d.open("POST",a),d.onreadystatechange=function(){4===d.readyState&&200===d.status&&b&&b()},d.send()):(c=t.createImage(),b&&(c.onload=b),c.src=a)},d=function(a,b,c,d){var e=L.createElement("script");c=c||m.contextNode.parentNode;e.type="text/javascript";e.src=a;b&&(e.onload=
b);d&&(e.setAttribute("defer",""),e.setAttribute("async",""));f.isDef(c)&&c.appendChild(e)},e=function(a){f.isFunction(a)?a({iasImpId:m.asid}):a&&"string"===typeof a&&(a=(new P(a,!0)).toString(),c(a,void 0,!0))},k=function(b,c,e,k){d(a.wrap(b,c,e,k))};l.getAggregator().on({addNode:b,send:c,exec:d,notify:e,jsonp:k});return{addNode:b,send:c,exec:d,notify:e,jsonp:k}},hc=function(g){var a=function(a,b){b=b||a;a=1<arguments.length?a:"script";l.getAggregator().request("omidVerificationClient")["script"===
...
c){return N.contains(c.id,a)}).length},q=function(){return n("grpm")||m.use100v};return{embedded:a,friendly:b,isFriendlyToParent:function(a){var b,c;if(g)a=!0;else{try{c=P(a.document.referrer),b=c.hostname===a.location.hostname}catch(d){}a=b}return a},friendlyIframe:a&&b,xDomainIframe:a&&!b,getTagTime:function(){return r.now()-m.birthdate},getPageTime:function(){var a=h.NA;!g&&f.isDef(w.chrome)&&f.isDef(w.chrome.csi)&&f.isFunction(w.chrome.csi)&&(a=r.round(w.chrome.csi().pageT));return a},isVideo:k,
isMobileApp:c,isSpecifiedAd:function(){var a=!1;g||(a=(a=m._cl_adpath)&&f.isStr(a));return a},isCompoundAd:function(){var a=!1,b=/\[(.*)\]/;g||(a=b.exec(m._cl_adpath),a=null!==a&&0!==a[1].length&&1<a[1].split(",").length);return a},isAvid:function(){return!g&&f.isDef(r.getWindow().avid)},isOmid:function(){var a=l.getAggregator().request("omidVerificationClient");return a&&a.isSupported()},isOmidNative:function(){return(new da).accepts()},isOmidForWeb:function(){return(new xa).accepts()},isDomless:function(){return g},
...
m.use100v},usesGroupMCustomMetric:q,isCeltra:function(){var a=!1;g||(a=ya().isApplicable());return a},usesGroupMCustomMetricMobilePassThru:function(){return q()&&v()},usesZeroPivCustomMetric:function(){return!1===f(m.customViewability).isArray()?!1:0<f(m.customViewability).filter(function(a,b){return f(b.thresholds).findFirst(function(a,b){return 0===b.piv})}).length},isRefreshable:function(a){try{var b=r.getTop();window.addEventListener("message",function(b){/isRefreshable/g.test(b.data)&&a(null,
...
b);c&&a.oneTime&&(a.flagForRemoval=!0);return c},e);a.setParam("tv",e)},M=function(c,g){var f,p={};d.filterOutput(function(a){return a.standalone&&!a.minDt&&a.type===g},function(a,b){c.setParam(a,b.replace("%3A",":"))});k.fastForward();if(g===h.DT_CODES.CUSTOM||g===h.DT_CODES.UNLOAD||g===h.DT_CODES.VIDEO_EVENTS||g===h.DT_CODES.FULLY_INVIEW||g===h.DT_CODES.PING||g===h.DT_CODES.VIEWABILITY_READY||g===h.DT_CODES.ADTALK)p.clog=v,s.isVideo()&&(f=s.isOmid()&&!s.isOmidForWeb()?"omidVideoEventsString":"videoEventsString",
...
(b=!0);return b},unq:a,getAvidIds:function(){return c},setAvidAdSessionContext:function(a){c=a}}},gb=function(a,b){return{init:function(c){a.jsonp(c,function(a){b.send(h.DT_CODES.THIRD_PARTY,void 0,!1,!0,{field:"tpiLookup",value:a})},!1,"callback")}}},mc=function(a,b,c,d){return{getTime:function(){return 1E3*a.getTimeInViewInSeconds()},getTask:function(){return function(){var e=a.getTimeInViewInSeconds(),k=a.getTimeInViewForRts();f.isDef(d)&&(l.getAggregator().trigger("addOutputItem",{output:d},"metricId",
{type:b}),l.getAggregator().trigger("addOutputItem",{output:"t"},"cmr",{type:b}));l.getAggregator().trigger("sendDt",b,e);if(c[k])c[k]()}}}},Eb=function(){return{createPingJobs:function(a,b,c,d){return f(b.getTimeThresholds()).map(function(b,k){return new mc(k,a,c,d)})}}},za=function(){var a,b=[],c=function(a){return{type:a.tp||a.type||"",time:a.t||a.timestamp&&a.timestamp-m.birthdate||""}},d=function(){a||(a=l.getAggregator().request("viewabilityDefinitions"));a&&0==b.length&&f(a).each(function(a,
...
getMaxNumber:function(){return Number.MAX_VALUE},getTop:function(){s.isDomless();return top},getDoc:function(){s.isDomless();return L},getIntersectionObserver:function(a,b){s.isDomless();return new IntersectionObserver(a,b)},pow:function(a,b){return Math.pow(a,b)}},ub=function(){return{createInstance:function(){return s.isDomless()?new nc:new oc}}},oc=function(){var a,b=!1,c=!1,d=l.getAggregator().request("features"),e=new ea,k=function(){var b;b=923747==m.anId||925955==m.anId;d.on("blur")||d.on("abcAudit")&&
...
k,v.ps=k,v.ts=r.now(),v.psfr=f.stringifyTriState(a.isCurrentIframeTheHiddenFrame()),b.events.trigger("newState",v));c=d}catch(n){l.getAggregator().trigger("error",h.ERROR_CODES.HIDDEN2)}};return{start:function(){if(a.isHidden()){d();var b=a.getWindowWithHiddenViewport();if(b)tc(b).onResize(d)}}}},{emits:!0,applies:function(a,b,c){return c.embedded&&!c.isBustedIframe()&&!c.isSpecifiedAd()}});l("hA",["AS_Finder"],function(a){var b=0,c=function(a,b){l.getAggregator().trigger("addThrottledProp",h.DT_SLOT.FF,
a,f(b).toION())},d=function(a){2>b&&c("ha1",a);b++};(function(){var b,k;if(s.embedded)try{k=m.contextNode.parentNode,b=sc().getDFPValue(k),k={},k.df=b.type,b.size&&(k.sz=b.size.width+"."+b.size.height),b.tag&&(k.dom=b.tag),c("dfp",k),b.size&&a&&(a.events.on("newState",d),a.start())}catch(f){l.getAggregator().trigger("error",h.ERROR_CODES.HIDDEN)}})()},{tier:h.TIERS.PRE_IMPRESSION_FRAUD,applies:function(a,b,c){return a.on("usehaps")}});var Aa=function(a,b,c,d){var e,k=0,v=0,n=!1,q=function(){e=Math.round(t.getNodeArea(a.body));
...
l.getAggregator().trigger("stopAdTalk"));return c},isCandidateForMyIdMap:f}},Cc=function(a){var b=new fa,c=function(a){var b=a,c="IFRAME"===t.getNodeName(a),d=t.isWindow(a);c?b=a.contentWindow.document:d&&(b=a.document);return b},d=function(a,b){return t.querySelector(c(a),b)},e=function(c,e){var n,q,p;try{q=d(c,e),q||(n=b.getFrames(!0,a),f(n).findFirst(function(a,b){return p=d(b,e)}))}catch(h){}return q||p||null};return{queryFor:function(b){var c=null;b&&(c=e(a,b));return c}}},zc=function(a){var b=
...
n,m,s,t;try{k=a.request("frameCollection");n=a.request("adTalkMessageCollection");m=d.messageContent.self;n.add(d);var D=k.getMe();D.unifiedId>m.unifiedId&&(D.unifiedId=m.unifiedId);var I;I=r.now()-d.sentTime;d.transferDuration=I;n=s=k.getFrame(m.id);f.isUndef(n)||f.isUndef(n.selfDescription)?(s=s||k.addFrame(c.source,m.id.split("-"),d),s.addInformationFromSrc(d,m),e()):s.addInformationFromSrc(d,m);(t=b&&a.request("idMapModule").isCandidateForMyIdMap(d))&&v()}catch(B){l.getAggregator().trigger("error",
h.ERROR_CODES.ADTALK_DUBIOUS)}};return{sendAdTalkCall:v,sendToKnownFrames:function(){(new ua).send(k)},startListening:function(){c=new $b;c.listen(e,n,k)},stopListening:function(){c&&c.stop()},validateMessage:e,processMessage:n,createMessage:k}},Ec=function(){var a=l.getAggregator().request("ids"),b=a.getAsid();return{tagId:a.getFwId(),adSafeId:b}},yc=function(){var a,b=[],c=function(a){a=new Ec(a);b.push(a);return a};a=c();return{createNew:c,getAll:function(){return b},myIdCard:a}},yb=function(a){var b,
...
p()},isStarted:function(){return k},getAdNodeDimensions:function(){var a;c&&(a=K({scrX:void 0,scrY:void 0,width:c.width,height:c.height}));return a},isReady:function(){return d!==h.NA}}},qa=function(){var a=!1;(function(){x.whenReady(function(){l.getAggregator().trigger("startViewabilityLoop");a=!0})})();return{loopStarted:function(){return a}}};l("loopDelay",[],qa,{applies:function(a,b,c){return a.bootstrapOn("allowViewability")},tier:h.TIERS.VIEWABILITY});var Gc=function(){return{start:function(a){l.getAggregator().on("measurable",
function(){a()})},isApplicable:function(a,b){return!b.browserIs(h.BROWSERS.WEBKIT)||!a.isImmediatelyMeasurable()}}},Hc=function(){return{start:function(a){a()},isApplicable:function(a){return a.isImmediatelyMeasurable()}}},Qb=function(a,b,c){var d=!1,e=function(){b.impressionIsIdentifiable()&&!d&&(d=!0,l.getAggregator().trigger("notify",m._onMeasurable))};return{start:function(){var b;b=[Ic(),Jc(),Hc(),Gc()];(b=f(b).findFirst(function(b,d){return d.isApplicable(c,a)}))&&b.start(e)},isApplicable:function(a){return a.bootstrapOn("useViewabilityNotification")&&
f.isDef(m._onMeasurable)}}},Jc=function(){return{start:function(a){ac(l.getAggregator(),["adImpression","measurable"]).onAll(function(){a()})},isApplicable:function(a,b){var c=9<=b.getIOSVersion();return(!b.browserIs(h.BROWSERS.WEBKIT)||c)&&s.isVideo()}}},Ic=function(){return{start:function(a){l.getAggregator().once("adImpression",function(){a()})},isApplicable:function(a){return a.isImmediatelyMeasurable()&&s.isVideo()}}},Kc=function(a,b,c){var d=["rjss","jss","jload"],e=function(){var b=!1,c=a.getAvidAdSessionContext();
f.isDef(c)&&(b=c.isDeferred);return!b};return{accepts:function(){var a=f.isDef(f(d).find(function(a,b){return b===c}));return b.accepts()&&b.isMediaType(h.MEDIA_TYPE.DISPLAY)&&a},isImmediate:e,isMediaType:b.isMediaType,supportsAdContainerGeometry:function(){return b.supportsAdContainerGeometry()},start:function(){e()||a.addEventListener("ready",function(){l.getAggregator().trigger("adImpression")})}}},Lc=function(a){return{accepts:function(){return a.isAvidAvailable()},getAvidAdSessionContext:function(){return a.getAvidAdSessionContext()},
isMediaType:function(b){var c,d=a.getAvidAdSessionContext();a.isAvidAvailable()&&f.isDef(d)&&(c=d.mediaType||h.MEDIA_TYPE.DISPLAY);return b===c},supportsAdContainerGeometry:function(){var b=!1,c=a.getAvidAdSessionContext();f.isDef(c)&&(b=c.avidJsVersion,(c=f.isUndef(b))||(c=f.getNum(b.split(".")[0]),b=f.getNum(b.split(".")[1]),c=2===c?7<=b:3<=c),b=c);return b}}},Mc=function(a,b,c){var d=["rjss","jss","jload"];return{accepts:function(){var a=f.isDef(f(d).find(function(a,b){return b===c}));return b.accepts()&&
b.isMediaType(h.MEDIA_TYPE.VIDEO)&&a},isImmediate:function(){return!1},isMediaType:b.isMediaType,supportsAdContainerGeometry:function(){return b.supportsAdContainerGeometry()},start:function(){try{a.addEventListener("video",function(a){"AdImpression"===a.eventSubType&&l.getAggregator().trigger("adImpression")})}catch(b){}}}},Nc=function(a,b,c){var d=["rjss","jss","jload"];return{accepts:function(){var a=f.isDef(f(d).find(function(a,b){return b===c}));return b.accepts()&&b.isMediaType(h.MEDIA_TYPE.DISPLAY)&&
...
a?l.getAggregator().trigger("tryToCallContinueMain",n()):(b=!0,q())}},y=function(a){d.mediaType=a.data.mediaType;d.queuedOutputItems.push({code:"omtp",value:d.mediaType});a.data.viewport&&a.data.adView&&(d.impressionViewabilityMeasurement={data:{viewport:a.data.viewport,adView:a.data.adView}});d.isNativeVideo=d.isNative&&"video"===a.data.mediaType;d.isDisplay="display"===a.data.mediaType;c=!0;q()};return{start:function(){h.registerSessionObserver(p,"IAS");h.addEventListener("impression",y)}}},Sa=
function(){return{accepts:function(){return!0}}},xa=function(){var a=l.getAggregator().request("omidAdSessionContext"),b=l.getAggregator().request("omidVerificationClient"),c=new ba(b),d=a.isHtml&&a.isWeb;return{accepts:function(){return c.accepts()&&d}}},Ta=function(){return{start:function(){l.getAggregator().trigger("tryToCallContinueMain","")}}},Pc=function(a,b){var c=function(a){try{b.trigger("videoPlaybackEvent",{eventType:a.eventSubType,eventData:a.eventData})}catch(c){}};return{start:function(){a.addEventListener("video",
...
!0},isMeasurable:function(){return k()?e.isMeasurable():!1},isMediaType:function(a){return k()?d.isMediaType(a):!1},supportsAdContainerGeometry:function(){return a.environment.supportsAdContainerGeometry()},start:function(){k()&&d.start()},requiresDelayedViewabilityEvent:function(){k()&&b.requiresDelayedViewabilityEvent()}}},pb=function(a,b,c){var d=l.getAggregator().request("mobileApp");return{create:function(){var e=[],e=e.concat(a.getOmidMeasurementStrategies()),e=e.concat(a.getAvidMeasurementStrategies()),
e=e.concat(a.getMraidMeasurementStrategies());(e=(new ha(e)).resolve())||l.getAggregator().trigger("addOutputItem",{output:"0"},"oam",{type:"impression"});var f=new Tc(e),h=new Da(b,c,s,d);return!e&&h.accepts()?new Uc(s.isVideo(),new E):new Sc(e,f,d.isMobileAppEnvironment())}}},qb=function(a){var b=l.getAggregator().request("mobileApp");return{getOmidMeasurementStrategies:function(){var a=l.getAggregator().request("omidVerificationClient"),b=new ba(a),e=new xa,f=[];if(b.accepts()&&!e.accepts()){var h=
new da,n=new Vc,e=new Wc(a,new E),h=[{environment:h,measurementStrategy:new Xc(a,new E)},{environment:n,measurementStrategy:new Ea(new ia,r.getWindow(),new E)}],h=(h=(new ha(h)).resolve())?h.measurementStrategy:{},q=new Fa(new Ga(new U),new U,n.accepts()),n=new Nc(a,b,m.mode),p=new Ha(e,h,new E,q),b=new Oc(a,b,m.mode),a=new Ia(e,h,new Rc(a,new E),new E,q);f.push({environment:n,measurementStrategy:p});f.push({environment:b,measurementStrategy:a})}return f},getAvidMeasurementStrategies:function(){var b=
l.getAggregator().request("avidJsClient"),d=new Lc(b),e=[];if(d.accepts()){var f=new Kc(b,d,m.mode),h=new Mc(b,d,m.mode),n;n=new Pc(b,new E);if(d.supportsAdContainerGeometry()){var q=new Yc,p=new Zc,y=new Ea(new ia,r.getWindow(),new E),A=new $c(b,new E),q=(q=(new ha([{environment:q,measurementStrategy:A},{environment:p,measurementStrategy:y}])).resolve())?q.measurementStrategy:{},p=new Fa(new Ga(new U),new U,p.accepts()),y=new ad(b,new E),b=new Ha(y,q,new E,p);n=new Ia(y,q,n,new E,p)}else p=new Qc(b,
new E),b=new Ca(p,new E),n=new Ja(p,n,new E);e.push({environment:f,measurementStrategy:b});e.push({environment:h,measurementStrategy:n});a.setAvidAdSessionContext(d.getAvidAdSessionContext())}return e},getMraidMeasurementStrategies:function(){var a=[],d=b.isSafeToInjectMraid(),d=new bd(r.getWindow(),d,b.isMobileAppEnvironment());if(d.accepts()){var e=l.getAggregator().request("context"),e=new cd(r.getWindow(),e),f=new dd(r.getWindow(),new E);e.accepts()?(d=new ed(r.getWindow(),new E),d=new Ja(f,d,
new E),d={environment:e,measurementStrategy:d}):(e=new Ca(f,new E),d={environment:d,measurementStrategy:e});a.push(d)}return a}}},ha=function(a){return{resolve:function(){var b=f(a).findFirst(function(a,b){return b.environment.accepts()});if(f.isDef(b))return b}}},Tc=function(a){var b=!1,c,d={winDimensions:K({scrX:0,scrY:0,width:0,height:0}),adDimensions:K({scrX:0,scrY:0,width:0,height:0}),containerDimensions:K({scrX:0,scrY:0,width:0,height:0}),method:h.NA,viewState:h.NA,percentInView:h.PIV_NA,reason:"",
...
b,e.method=c.method;else if(0===c.percentInView||75<=c.percentInView)e=c;return e},start:function(){var b;f.isDef(a)&&f.isDef(a.measurementStrategy)&&(b=a.measurementStrategy,b.addMeasurementChangedListener(k),b.start())},requiresDelayedViewabilityEvent:function(){b=!0}}},Ja=function(a,b,c){var d=!1,e=!1,k=!1,v,n,q,p,y=function(){if(!f.isUndef(n)){var a=[],b,l;d?(e?(l=!1,b=100):(l=p,b=q),50>b&&a.push(h.OUT_OF_VIEW_REASONS.GEOM)):(l=!1,b=0,a.push(h.OUT_OF_VIEW_REASONS.VIDEO));k=!0;n.shouldDelegateToDomBasedViewability=
...
u=m.obstructions,s=u&&0<u.length,t=e.originalAdContainer,C=p.adGeometry,D=p.adFound,I=e.detectionMethod,B=0,l={x:0,y:0,width:l.width,height:l.height},F=v(t,C),G=e.outOfViewReason,O=0,J=0,w=s||!1,O=1>=C.width*C.height;c&&O&&(D=!1,G=G||"",D||-1!==G.indexOf(h.OUT_OF_VIEW_REASONS.GEOM)||(G=h.OUT_OF_VIEW_REASONS.GEOM+(""!==G?"."+G:"")));if(D&&0<e.percentageInView){O=d(l,m,F);s?(B=n(m,F),B=k(l,m,B),B=v(m,B),B=a.calculateObstructedArea(B,u)):B=0;J=B;B=Math.round((O-J)/(F.width*F.height)*100);s&&0===J&&(w=
!1);for(var C=w,x,s=0,D=b.getConfig(F).numberOfSlices,J=r.floor(F.height/D)||1,u=[],O=C?a.getObstructionStatusBySlice(D):[],V,s=0;s<D;s++)x=F.y+J*s,s==D-1&&(J=F.y+F.height-x),x={x:F.x,y:x,width:F.width,height:J},V=d(l,m,x),x=1==V/(x.width*x.height),u.push(x);if(C)for(m=r.min(O.length,D),s=0;s<m;s++)u[s]=u[s]&&!O[s];m=u}else m=b.getConfig(C).defaultSliceArray;return{windowDimensions:l,containerDimensions:t,adDimensions:F,percentageInView:B,viewState:50<=B?h.IN_VIEW:h.OUT_OF_VIEW,outOfViewReason:50<=
B?"":G||h.OUT_OF_VIEW_REASONS.GEOM,detectionMethod:I,isObstructed:w,sliceStatus:m}}}}},Yc=function(){return{accepts:function(){return s.isAvidNative()}}},$c=function(a,b){var c=function(a){a=a.eventData.originalAdContainer;var c=!!a;b.trigger("avidNativeGeometryChanged",{adGeometry:{x:0,y:0,width:c?a.width:0,height:c?a.height:0},adFound:c})};return{start:function(){a.addEventListener("viewability",c)},addAdGeometryMeasurementChangedListener:function(a){b.on("avidNativeGeometryChanged",a)}}},Zc=function(){return{accepts:function(){return s.isAvid()&&
...
c?l.viewState=h.IN_VIEW:(l.viewState=h.OUT_OF_VIEW,l.outOfViewReason=a.outOfViewReason||h.OUT_OF_VIEW_REASONS.VIDEO);n=l;d.trigger("videoGeometryMeasurementChanged",n)}},s=function(a){q=a;u()},t=function(a){p=a;u()},C=function(a){m=a;a=a.eventType;"AdEnteredFullscreen"===a?v=!0:"AdExitedFullscreen"===a?v=!1:-1!=="AdStarted|AdVideoStart|AdPlaying".indexOf(a)?k=!0:-1!=="AdSkipped|AdUserClose|AdPaused|AdVideoComplete|AdStopped|AdError".indexOf(a)&&(k=!1);u()};return{start:function(){l.getAggregator().trigger("addOutputItem",
{output:h.MEDIA_TYPE.VIDEO_CODE},h.MEDIA_TYPE_CODE,{type:h.IMPRESSION_EVENT});a.addAdContainerGeometryMeasurementChangedListener(s);a.start();b.addAdGeometryMeasurementChangedListener(t);b.start();c.addVideoPlaybackEventListener(C);c.start()},getStrategyName:function(){return h.MEASUREMENT_STRATEGY.VIDEO},addMeasurementChangedListener:function(a){d.on("videoGeometryMeasurementChanged",a)},isMeasurable:function(){return r}}},Ea=function(a,b,c){var d,e=function(){var b=a.find(),e,n=!0;f.isDef(b)?(e=
b.getBoundingClientRect(),e={x:e.left,y:e.top,width:e.width,height:e.height},b.hasOwnProperty("adWasClipped")&&(e.adWasClipped=!0)):n=!1;if(b=n)b=e,b=!f.isDef(d)||!1!==f(b).compareTo(d);b&&(d=e,c.trigger(h.MOBILE_APP_GEOMETRY_MEASUREMENT_CHANGED,{adGeometry:e,adFound:n}))};return{start:function(){e();b.setInterval(e,50)},addAdGeometryMeasurementChangedListener:function(a){c.on(h.MOBILE_APP_GEOMETRY_MEASUREMENT_CHANGED,a)}}},bd=function(a,b,c){return{accepts:function(){var d=f(a.mraid).isObj();return c&&
...
r.max(a.fullPercentInView||0,a.percentInView);return-1!==(h.IN_VIEW+"|"+h.PARTIAL_VIEW_PLUS).indexOf(a.viewState)&&100===b};c=c?new Q({tiv:f}):d?new Q({tiv:n}):new Q({tiv:m});l.getAggregator().provide("isFullyInViewProvider",{isFullyInView:q});return{timeInViewThresholds:c,type:h.DT_CODES.FULLY_INVIEW,isInView:q,applies:function(){return e},minUnit:1E3,shouldIncludeSound:!1}},Xa=function(a,b){return{timeInViewThresholds:new Q({tiv:[0]}),type:h.DT_CODES.FULLY_INVIEW,rts:{0:m._onInViewFull},isInView:function(a){var b=
...
0===a.tiv&&(c=!1);l&&(c=c&&b.isVideoPlaying,q&&(c=c&&b.isSoundOn));return c},metricId:n,minUnit:a.minunit?1E3*a.minunit:1E3,thresholdType:a.thresholdType,shouldIncludeSound:q}},Za=function(a,b,c){var d=b.isVideo()?"video":"display",e=b.isMobileApp()?"app":"web",k=b.isDeviceTypeGroupMobile()?"mobile":"desktop",h=f(a.customViewability).isArray()&&0<a.customViewability.length,n=c.on("customMetric"),q=c.on("groupmCM"),p=function(a,b){var c,h,n,p,l;c=f(b.mediaTypes).contains(d);h=f(b.distributionChannels).contains(e);
n=f.isDef(b.deviceGroups)?f(b.deviceGroups).contains(k):!0;p=N.contains(b.id,"fiv");l=N.contains(b.id,"groupmCM");p=!p;l&&(p=q);return p&&c&&h&&n};return{resolve:function(){var b=[],c;n&&h&&(c=f(a.customViewability).filter(p),f(c).each(function(a,c){b.push(c)}));return b}}},Q=function(a){var b=[];if(f(a.tiv).isArray())f(a.tiv).each(function(a,c){b.push(new ja(c))});else if("string"===typeof a.tiv){a=a.tiv.split("|");var c=new fd;b.push(new gd(c,parseInt(a[1].replace("%"))));b.push(new ja(1E3*parseInt(a[0])))}else f.isDef(a.tiv)&&
b.push(new ja(1E3*a.tiv));return{getTimeThresholds:function(){return b}}},fd=function(){var a=-1,b=function(b){0<a||(b=f.isDef(b.ad_duration)?b.ad_duration:b.adRemainingTime,void 0!==b&&0<b&&(a=Math.ceil(b)))};l.getAggregator().on({omidAdDuration:b,adVideoStart:b,adDurationChange:b});return{getAdDuration:function(){return a},isVideoDurationResolved:function(){return 0<a}}},ja=function(a){var b=0,c;0<a&&(b=a/1E3);c=1E3*b;return{getTimeInViewInSeconds:function(){return b},getTimeInViewForRts:function(){return c}}},
gd=function(a,b){var c=0,d=!1,e=function(a){c=0;0<b&&0<a&&(c=r.ceil(b/100*a))};e(15);return{getTimeInViewInSeconds:function(){!d&&a.isVideoDurationResolved()&&(d=!0,e(a.getAdDuration()));return c},getTimeInViewForRts:function(){return 0}}},eb=function(a,b,c){var d=function(d){a.isInView(d)?(b.mark(),c.doEligibleJobs(b.getTotalTime())):b.stop()};return{start:function(){a.addMeasurementChangedListener(d)}}},db=function(a,b,c,d){var e,k,h,n,q,p,m=function(a,b){return!b&&a},r=function(a,b,c,d){return d?
...
v,u)?(q=Fc(b,t),q.start(),B=!0,O&&(c=new md(z().getRounded()),n=new nd,h=new od(h,n),p=new pd(c.getSlices(),h))):O&&(y=new qd(a))})();return{mark:function(){t.setAttributeOf(J,I,"")},cleanup:function(){t.removeAttributeOf(J,I)},isNode:function(a){return b===a},isHidden:Ka,isObstructed:function(){return!1},getDims:z,getPercentInView:E,getLocationState:V,getOnPageViewability:function(){return Ka()?h.OUT_OF_VIEW:V()},getDetectionMethod:function(){return c},getContainerDims:function(){return D.allowsOptimization?
v:K(d)},refresh:function(){R=M=u=A=n=v=void 0;if(k){var a,c;if(!s.isDomless()&&(c=b.parentNode)){for(;b!==w&&c&&c!==L&&!a;)a=c===d,c=c.parentNode;a||(d=b.parentNode)}}},getAdNode:function(){return b},getSliceStatus:function(){var a;p&&p.isReadyToMeasure()?a=p.getSliceStatus():s.friendly&&y&&f.isDef(M)&&(a=y.getSliceStatus(M,u,A,R));return a}}},sd=function(a,b){var c=[],d,e=f([]),k=function(){return c[0]&&c[0].getDetectionMethod()===h.DETECTION_METHODS.AD_PLACEHOLDER},m=function(q,n,p,m){var v=k()||
0===c.length;q=rd(a,q,n,p,b,m);k()&&(p=c.shift(),e=f(c),p.cleanup(),d=void 0);c.push(q);e=f(c);v&&q.mark();v&&n!==h.DETECTION_METHODS.AD_PLACEHOLDER&&l.getAggregator().trigger("primaryadfound",q)},n=function(){if(d)return d;var a,b=!1,c=0,f=0;e.each(function(d,e){var k;k=e.getDims();k.hasValidDims()&&(a=e.getPercentInView(),b=a!==h.NA,k=k.area(),c+=k,f+=a/100*k)});return d={totalArea:c,totalInView:f,hasMeasurement:b}},q=function(){var a;a=n();a=a.hasMeasurement?r.round(a.totalInView/a.totalArea*100):
...
!d[h.IAS_DETECTOR]&&(c=d);return c},zd=function(){return{detectionMethod:h.DETECTION_METHODS.IFRAME,find:function(){return w},isApplicable:function(){return s.embedded},getAdContainer:function(){return m.contextNode.parentNode},allowForAdContainerChange:!0}},Cd=function(){var a,b=r.getDoc().scripts,c=function(){a||(a=f(b).findFirst(function(a,b){return N.contains(b.src,"servedby.flashtalking")}));return a},d=function(){var b,d=a||c(),f=/;(\d+);/;d&&d.src&&(b=d.src.match(f)[1]);return b};return{detectionMethod:h.DETECTION_METHODS.BUSTED_IFRAME_FLASHTALKING,
isApplicable:function(a,b){return b.on("bustediframe")&&a.embedded&&void 0!==c()},getCssSelector:function(){var a,b=d();try{a=f(["#ftdiv"+b,"#ftframe"+b]).findFirst(function(a,b){return t.crossQuerySelector(b,!0)})}catch(c){}return a}}},Dd=function(){return{isApplicable:function(a,b){var c;try{c=t.getFrameId()}catch(d){}return b.on("yieldmo")&&c&&N.contains(c,"_tpi")&&t.crossQuerySelector("[data-href*='ads.yieldmo.com']",!0)},getCssSelector:function(){return"[id='"+t.getFrameId().replace("_tpi","")+
...
K(h).isOneByOne(),p=function(){var a=r.getDoc().scripts;return f(a).findFirst(function(a,b){return N.contains(b.src,"bs.serving-sys.com/BurstingPipe/adServer")})}(),c=c.EBG&&c.EBG.ads&&!f(c.EBG.ads).isEmpty();return b.on("sizmek")&&p&&c&&h&&d()&&e()},getCssSelector:e}},ga=function(){var a,b=l.getAggregator().request("features");a||(a=[Ed(),Dd(),Cd()]);return f(a).findFirst(function(a,d){return d.isApplicable(s,b)})},yd=function(){var a,b=function(){r.execAtEndOfThread(function(){l.getAggregator().trigger("delayedViewabilityReadyCallOnly")})};
return{usePlaceholder:!1,detectionMethod:h.DETECTION_METHODS.VENDOR_CELTRA,isApplicable:function(a,b){return b.on("celtra")&&a.isCeltra()},find:function(){var c,d=ya().find();d&&d.celtra&&d.celtra.loaded&&(c=d.celtra.viewabilityObservee,a=t.getElementsWindow(c).frameElement||c.parentNode,b());return c},getAdContainer:function(){return a},allowForAdContainerChange:!1}},ya=function(){var a,b=function(){var b;(b=m.contextNode.parentNode)&&N.contains(b.className,"celtra-ad-v3")?a=b:(b=b&&t.querySelector(b,
".celtra-ad-v3"))&&(a=b);return a};return{find:b,isApplicable:function(){return void 0!==b()}}},ia=function(){var a=l.getAggregator().request("mobileApp");return{usePlaceholder:!0,detectionMethod:h.DETECTION_METHODS.AD_HUNT,isApplicable:a.isMobileAppEnvironment,find:function(){var a=t.findChildWithLargestContent(r.getDoc().body);return a&&a.hasValidSizeForMobileApp&&!a[h.IAS_DETECTOR]?a:void 0},getAdContainer:function(){return m.contextNode.parentNode},allowForAdContainerChange:!0}},vd=function(){var a;
...
detect:function(a){return!!f(a).findFirst(function(a,c){var d=!1;(d=f.isDef(N.stringToProp(c)))&&l.getAggregator().trigger("addOutputItem",{output:W.javascript.STRINGIFIED_METHOD+"_"+c.substring(0,4)},"drul",{type:"impression"});return d})}},scriptSrc:{STRINGIFIED_METHOD:"s",detect:function(a){return s.isDomless()?!1:!!f(a).findFirst(function(a,c){return t.containsScriptTagWithSrc(function(a){var b=!1;(b=f.isDef(a)&&-1!==a.indexOf(c))&&l.getAggregator().trigger("addOutputItem",{output:W.scriptSrc.STRINGIFIED_METHOD+
"_"+c.substring(0,4)},"drul",{type:"impression"});return b})})}}},La=function(){var a=function(a,c){var d,e=W[a];e.detect(c)&&(d=e.STRINGIFIED_METHOD);return d};return{process:function(b){return f(b).map(a).join("")}}},Nd={url:"file: content: applewebdata: afma-sdk adsx.greystripe.com/openx/www/delivery/ia.php ads.mopub.com ogury.io".split(" "),userAgent:["QuantcastSDK","afma-sdk"],scriptSrc:["file:"],javascript:"ADMARVEL mopubFinishLoad InmobiObj PandoraApp mraid.sasSendMessage omidSupported avid.getAvidAdSessionContext".split(" ")},
Ld=function(){var a,b=function(){return void 0!==a&&""!==a};return{detect:function(){a=m.hasOwnProperty("serverSideAppDetection")&&0!==m.serverSideAppDetection.length?!0:La().process(Nd);b()&&l.getAggregator().trigger("addOutputItem",{output:"1"},"mapp",{type:"impression"})},hasDetectedMobileApp:b}},Md=function(){var a=[],b=[],c=function(b,c){var f,h=La().process(c.detectionRules);h&&(a.push(c.STRINGIFIED_SDK+"*"+h),f=c);return f};return{detect:function(){b=f(Od).map(c);0<b.length&&l.getAggregator().trigger("addOutputItem",
{output:function(){return a.join(".")}},"sdk",{type:"impression"})},isSafeToInjectMraid:function(){return 1==b.length&&f.isDef(b[0].safeToInjectMraid)&&b[0].safeToInjectMraid}}},Od=[{STRINGIFIED_SDK:"adma",safeToInjectMraid:!0,detectionRules:{javascript:["ADMARVEL"],url:["AdMarvel"]}},{STRINGIFIED_SDK:"admb",safeToInjectMraid:!0,detectionRules:{userAgent:["afma-sdk"],url:["afma-sdk"]}},{STRINGIFIED_SDK:"imbi",safeToInjectMraid:!0,detectionRules:{javascript:["InmobiObj"]}},{STRINGIFIED_SDK:"mmed",
...
l=l&&null!==l.match(/(FBAN)/)?1:0,m=k.getUserAgent(),m=m&&null!==m.match(/(iPad)/)?1:0,u=h()?1:0,s=k.getUserAgent(),s=s&&null!==s.match(/(Version\/9\.0)|(CriOS\/55)/)?1:0;e=r.pow(Math.E,0.0033*c-9.26E-4*f-0.340351*l-0.874412*m+0.646972*u+0.28118*s+2.987259*(1E3<d?1:0)-2.463292);e/=1+e;a={mbah:c,mbsh:f,mbfb:l,mbip:m,mbhs:u,mbbr:s,mblr:d,mbp:e};b&&r.clearInterval(b);return 0.15<e},getDebugState:function(){return a}}},Uc=function(a,b,c){var d,e,k,v,n,q=[],p=m.contextNode.parentNode,y=0,t=0,u=!1,w=!1,
z=new Pd,C=function(){var a=q.length-1,b=-1;-1<a&&(b=q[a].piv);return b},D=function(){l.getAggregator().trigger("delayedViewabilityReadyCallOnly")},I=function(a){x.whenReady(function(){e=new Qd(a,r.getDoc().body)})},B=function(){e.removePixels()},F=function(){var a=z.getDebugState(),b=C();f.isUndef(a)&&(a={});a.mbm=f.fromBoolToNum(w);a.mbrd=f.fromBoolToNum(u);a.mbtg=f.isDef(p.tagName)?p.tagName:"na";a.mbaf=f.isDef(k)?k:"na";a.mbad=f.isDef(d)?d.getRounded().width+"_"+d.getRounded().height:"na";a.piv=
...
C=function(a,b){u||(p=a,u=b)},D=function(){var a,b,c;if(u)return!1;if(t)return!0;try{if(s.contentWindow&&s.contentWindow.document&&s.contentWindow.document.body){c=s.contentWindow.document.body;if(a=c.getAttribute("data-err"))throw Error(a);"iasInit"===c.getAttribute("data-st")&&C(104);(b=c.isReady?c.isReady():!1)&&(t=c.isInView?c.isInView:void 0)&&C(105)}}catch(d){C(106,d)}return f.isDef(t)},I=function(a,b,c){var k=L.createElement("iframe");k.id=q;f(k.style).mixin({position:"absolute",width:d+"px",
height:e+"px",backgroundColor:"transparent",border:"none",padding:"0px",margin:"0px",zIndex:"-999"});var n=k.style;k[h.IAS_DETECTOR]="true";n.left=b;n.top=c;a.appendChild(k);s=k;C(102);a=s;try{var p=a.contentWindow,l=x();p.document.open();a.contentWindow.document.write(l);p.document.close()}catch(m){C(103,m)}return k}(a,b,c);return{isInView:function(){var a,b,c=!1;r.now();D()&&(a=t(!0),c=a.isInView,w=!1,n&&(b=20*n.rate+n.lastUpdateTimestamp,0<b&&b<a.lastUpdateTimestamp&&(c=!1,w=!0)),C(107),n=a);return c},
isNotReadyToReport:function(){return!D()},createdElement:s,remove:function(){I.parentNode&&I.parentNode.removeChild(I)},getStatus:function(){return p},getError:function(){return u},isReadingInvalid:function(){return w},getRate:function(){return s.contentWindow&&s.contentWindow.document&&s.contentWindow.document.body&&s.contentWindow.document.body.getRate?s.contentWindow.document.body.getRate():-1},percentInView:k}},Qd=function(a,b,c){var d,e=a.getRounded(),k=[],h=!1;a=U().getConfig(e);var n=a.percentInViewSliceArray,
...
d){var e=new Rd(b,d.x,d.y,d.width,d.height,d.percentInView,c);k.push(e)})})();return{getPercentInView:function(){var a=m(),b=x();p.mbrd=a?1:0;b!=p.mbp&&p.mbivs.push([s.getTagTime(),b]);p.mbp=b;return a?b:-1},removePixels:function(){void 0!==c&&c.stop();f(k).each(function(a,b){try{b.remove()}catch(c){}})},getPixelStateForDebug:function(){p.mbm=1;k&&0<k.length&&(p.mbpr=[],p.mbir=[],f(k).each(function(a,b){p.mbpr.push(b.getRate());p.mbir.push(b.isReadingInvalid()?1:0)}));return p},isReadyToMeasure:m,
getSliceStatus:function(){var a;k&&0<k.length&&(a=[],f(k).each(function(b,c){a.push(c.isInView())}));return a}}},pd=function(a,b){var c={mbrd:!1,mbvs:[],mbe:"n",mbv:9,mbs:[],mbm:1,mbivs:[]},d=function(a,b){var c=[],d=a.geometry.value();f(b).each(function(b,e){if(a.geometry.doesIntersect(e)){var f=e.value(),k=Math.max(d.leftX,f.leftX),h=Math.min(d.rightX,f.rightX),n=Math.max(d.topY,f.topY),f=Math.min(d.bottomY,f.bottomY);c.push(new X(k,h,n,f))}});return c},e=function(a,b){var c=0,e=d(a,b),k;f(e).each(function(a,
...
return!b||c&&c.isFullyInView(a)})}}},Wd=function(){var a={AdPaused:"pauseAd",AdVolumeChange:"volumeChanged",AdPlaying:"resumeAd"};return{translate:function(b){var c=b.charAt(0).toLowerCase()+b.slice(1);b in a&&(c=a[b]);return c}}},Ma=function(){return{getVolumeFromContext:function(a){var b,c=-1;f.isDef(a)&&(f.isDef(a.volume)?c=a.volume:f.isDef(a.adVolume)&&(c=a.adVolume));-1!==c&&(b=c);return b}}},fb=function(a,b,c){var d="IASid"+a,e="getIasVidBridgeVersion"+a,k,v,n,q=[],p=h.OUT_OF_VIEW,t=!1,w=!1,
u=!1,z=!0,E=new Ud,C=Vd(),D=new Sd,I=new Ma,B=new za,F=function(b){var d;t=!0;var e={};try{e=JSON.parse(unescape(b&&b.data?b.data:b))}catch(f){e={}}e.id==a&&(d=E.registerEvent(e,c.getCurrentLoc()),d.indicatesPlaying()?(w=!0,p=u?h.IN_VIEW:!1):d.indicatesNotPlaying()?(w=!1,p=h.OUT_OF_VIEW):d.indicatesFullscreen()?(u=!0,p=w?h.IN_VIEW:h.OUT_OF_VIEW):d.indicatesNormalSize()&&(u=!1,p=w?!1:h.OUT_OF_VIEW),b=parseFloat(d.getVolume(I)),0<b?z=!0:0===b&&(z=!1));q.push(d);n&&L();return d},G=function(b){var c,
h,k=la().wrapToGlobal(F),p=function(a){f.isStr(a)&&(l.getAggregator().provide("vc",function(){return a}),l.getAggregator().trigger("addOutputItem",{output:a},"vc",{type:"impression"}))};try{h=b[e]||b.getIasVidBridgeVersion,c=f.isFunction(h)&&"2"===h.call(b)?unescape(b[d].call(b,a,k)):unescape(b[d].call(b,a)),t=!0,p(c||"n")}catch(n){__IntegralASDiagnosticCall("handshakefailure",n,m)}},H=function(){var c=function(a){return f(f(a).toArray()).findFirst(function(a,b){return f.isFunction(b[d])})};k||(f([".integral-vid-"+
...
("adVideoComplete"!==b.tp&&l.getAggregator().trigger("sendDt",h.DT_CODES.VIDEO_EVENTS),l.getAggregator().trigger("videoQuartileEvent",b)))});q=[];n=!0};(function(){x.addEvent(r.getWindow(),"message",function(a){F(a)});l.getAggregator().on({volumeChanged:K});l.getAggregator().provide({videoEventsString:E,videoVersion:function(){var a,b=J();try{a=b.getVersion()}catch(c){a=-1,l.getAggregator().trigger("error",h.ERROR_CODES.NO_VIDEO_AD_INTERFACE)}return a},videoTranslator:function(){return v=v||new Wd},
adNode:J});J();D.listenForResult();C.isApplicable(s)&&C.start(c)})();return{findAdNode:J,getViewStateOverride:function(){return p},isHandshakeComplete:function(){return t},triggerInitializationEvents:L,setVideoSpecificScreenEventFields:function(a){var b=a.viewState===h.NA;a.isVideoPlaying=!0;a.isSoundOn=z;a.isVideoPlayingInFullscreen=!1;if(p){if(p===h.OUT_OF_VIEW){var c=a.reason?a.reason.split("."):[];c[c.length]=h.OUT_OF_VIEW_REASONS.VIDEO;a.reason=c.join(".")}a.viewState=b?a.viewState:p;a.isVideoPlaying=
p===h.IN_VIEW}u&&w&&(a.percentInView=100,a.isVideoPlayingInFullscreen=!0)}}},Xd=function(){return new aa(h.PERF_TIMELINE_TRACKER_CONFIG.WRAPPERS.AS.TYPE,h.PERF_TIMELINE_TRACKER_CONFIG.WRAPPERS.AS.COUNT)},Pb=function(){var a,b,c={},d=0,e=function(c){if(c||a)d+=5,b.onTick(d,function(){a?e():l.getAggregator().trigger("sendDt",h.DT_CODES.PERFORMANCE)}),a=!1},k=function(){b=new wa;d=0;e(!0);b.start()},m=function(d,e,h,l){d=c[d];l?(f.isDef(d[e])||(d[e]=[]),d[e].push(h)):d[e]=h;b&&b.isActive()||k();a=!0},
...
b){c[b]={}})}}},Ub=function(){var a={},b=function(b){a[b]||(a[b]=new va(1,m.birthdate));return a[b]},c=function(a){b(a).start()},d=function(a){var c=b(a);c.stop();l.getAggregator().trigger("addThrottledProp","im",a,c.getTime())};return{start:function(){l.getAggregator().on({markTime:c,measureTime:d})},isApplicable:function(a){return a.on("pIntervals")}}},Yd=function(){return new aa(h.PERF_TIMELINE_TRACKER_CONFIG.WRAPPERS.JS.TYPE,h.PERF_TIMELINE_TRACKER_CONFIG.WRAPPERS.JS.COUNT)},Ab=function(a){var b=
...
B="object"===typeof E?JSON.parse(E):E,F=m.staticServer+m.integration+"a.js",s=D+"adContainerId="+B.adContainerId+"&true_pb="+encodeURIComponent(m.passback)+"&adsafe_pb="+encodeURIComponent(F)+"&";x=s=s.replace(h.UNIQUE_ID_TOKEN,m.asid);var G=s.length,H,J,K=n(m.sp_imp_jsInfo_minLength,0);z="";try{H=t-G-K,0<H&&(J=Zd(q,H,14,b.on("partialUrls")),z+=J.join("&"))}catch(L){a.add(h.ERROR_CODES.IMPRESSION_URLS)}s=x+z;q=s+="&"===s.slice(-1)?"":"&";var N,G="";try{N=t-s.length,G+=$d(N,"adsafe_jsinfo=",a,b,c,
e,k,r)}catch(Q){a.add(h.ERROR_CODES.JSINFO),G+="adsafe_jsinfo=e:"+a.toString()}s=q+G;d.macroUrl&&(s+="&"===s.slice(-1)?"":"&",s+=d.macroUrl);p=s;d.sendImpression(p);m.impUrl=p;l.getAggregator().trigger("impressionsent")}catch(P){__IntegralASDiagnosticCall("impsend",P,m)}}}},$d=function(a,b,c,d,e,k,l,n){return function(c){var d=c.primary.join(","),h=b,k=0,l=function(a){if(a)return","+a};h.length+d.length+5<=a&&(h+=l(d),e.impressionIsIdentifiable(!0),f(c.secondary).each(function(b,c){h.length+c.length+
...
t.push("apn:"+b.partner),t.push("apv:"+b.partnerVersion));a=ae(a,c,d,e,k,l,n);return{primary:t,secondary:a}}())},ae=function(a,b,c,d,e,k,v){var n=[],q=l.getAggregator().request("mPage");n.push("mn:"+m.mn);n.push("pt:"+function(){var b=v.stringifyPingTimes();a.viewState!==h.NA&&(b+=a.details);return b}());n.push(f(k.params()).toParams());c.on("mrcAudit")&&!s.isDomless()&&n.push("dvs:"+r.getDoc().visibilityState);e.iterate(function(a,b){var c=!b.props||f.isUndef(b.props.type),d=!b.props||b.props.type===
h.IMPRESSION_EVENT;(c||d)&&n.push(a+":"+b.output())});b.toString()&&n.push("e:"+b.toString());n.push(c.output());n.push("tt:"+m.mode);n.push("thd:"+f.stringifyTriState(q.supportsVisAPI()));n.push("et:"+(r.now()-m.birthdate));m.perf.mark("si");c.on("swapids")?n.push("oid:"+m.oid):n.push("uid:"+d.unq);n.push("v:19.8.49");n.push("sp:"+(m.isSplitMode?1:0));c.on("resolution")&&(n.push("wr:"+f(t.windowSize()).toArray().join(".")),n.push("sr:"+f(t.screenSize()).toArray().join(".")));b=function(){var a;a=
String(m.scriptUrl).toLowerCase();var b=a.indexOf("ias_xpc");-1<b?(a=a.substring(b+7+1),b=a.indexOf("&"),a=-1<b?a.substring(0,b):a):a="NotFound";return a||""}();"NotFound"!==b&&n.push("x_xpc:"+b);return n},Zd=function(a,b,c,d){var e,h=[],l=function(a){return-1!==a.key.indexOf("q")||-1!==a.key.indexOf("g")};a&&a.length&&(e=f(a).map(function(a,b){if(l(b))return b}),a=f(a).map(function(a,b){if(!l(b))return b}),f(e.concat(a)).each(function(a,e){var f;f=e.val;var l=e.key,m;m=24+h.join("&").length+l.length+
c;m=b-m;d&&m<f.length&&0<m&&(f=f.substr(0,m));if(f.length||""===e.val||""===e.type)f="adsafe_url="+f+"&adsafe_type="+l,l=h.join("&").length,f.length+l<=b&&h.push(f)}));return h},Lb=function(){return{isApplicable:function(a){a=r.getWindow();return!(!a.navigator||!a.navigator.plugins)},start:function(a){a=r.getWindow();a=be(a.navigator.plugins);var b=a.hash(),c=b.join(".");l.getAggregator().trigger("addOutputItem",{output:c},"pl",{type:h.IMPRESSION_EVENT});b.length&&(a=a.decode(b),a=a.join("."),l.getAggregator().trigger("addOutputItem",
{output:a},"pd",{type:h.DT_CODES.ADTALK}))}}},ee=function(a,b){return{start:function(){try{var c=ce(),d=c.getMethodName(a),e=new P(b.getEnabledScriptUrl(a)),f=de,m=r.getDoc();(new f(m.body||m.head||m.documentElement,e)).getWindow()[d]=c.getMethod(b)}catch(n){l.getAggregator().trigger("error",h.ERROR_CODES.FEATURE_SCRIPT)}}}},ce=function(){var a=function(a,c,d){a===m.asid&&(d.unshift(c),l.getAggregator().trigger.apply(null,d))};return{getMethod:function(b){return function(c){var d={asid:m.asid,constant:h,
features:b,context:s,dtBaseURL:m.dtBaseURL};"function"===typeof c&&c(a,d)}},getMethodName:function(a){return"register_"+a}}},Sb=function(){return{start:function(a,b){f(a).each(function(a,d){b.getEnabledScriptUrl(d)&&ee(d,b).start()})}}},be=function(a){return{hash:function(){for(var b=0,c=a.length,d=[],e;b<c;b++)e=a[b].filename.replace(/\.plugin$/,""),e=N.hashCode(e),e=f.toBase(e,62).slice(-4),d.push(e);return d},decode:function(b){var c,d;c=r.floor(r.random()*b.length);d=encodeURIComponent(a[c].filename.replace(/\.plugin$/,
