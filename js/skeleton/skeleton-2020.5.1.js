...
try {
	...
	var __IntegralASConfig = {
		...
		sp_cdnScripts: {xsca: "static.adsafeprotected.com/xsca.17.4.85.js", sca: "static.adsafeprotected.com/sca.17.4.114.js", main: "static.adsafeprotected.com/main.19.8.75.js"},
		protocol: 'https',
		jsref: "",
		asid: "b1c4049d-8be0-11ea-9f3f-0a3d20095233",
...
isSafeToInjectMraid:function(){return c.isSafeToInjectMraid()}}},Pd={url:{STRINGIFIED_METHOD:"u",detect:function(a){if(t.isDomless())return!1;var b=r.getWindow().location.href,c=[b];try{c.push(top.location.href)}catch(e){}try{c.push(parent.location.href)}catch(f){}if(t.embedded){try{c.push(parent.document.referrer)}catch(h){}try{c.push(M.referrer)}catch(g){}}try{"jsi"!==l.mode&&c.push(x.location.href)}catch(n){}try{c.push(l.jsref)}catch(k){}c.sort(function(a,b){return a.length>b.length?1:a.length<
b.length?-1:0});return!!d(a).findFirst(function(a,e){var f=!1,h,g,n="mobfox"===e?c:[b];for(g=0;g<n.length;g++){h=n[g];var k="string"===typeof e?[e]:e;if(d(k).isArray()&&(k[0].substring(0,4),k))for(var p=0;p<k.length&&(f=-1<h.indexOf(k[p]),!1!==f);p++);}return f})}},userAgent:{STRINGIFIED_METHOD:"a",detect:function(a){return t.isDomless()?!1:!!d(a).findFirst(function(a,c){var e;e=!1;var f=r.getWindow();d.isDef(f.navigator)&&d.isDef(f.navigator.userAgent)&&(e=(e=f.navigator.userAgent)&&-1!==e.indexOf(c));
...
k=k&&null!==k.match(/(FBAN)/)?1:0,l=h.getUserAgent(),l=l&&null!==l.match(/(iPad)/)?1:0,v=g()?1:0,t=h.getUserAgent(),t=t&&null!==t.match(/(Version\/9\.0)|(CriOS\/55)/)?1:0;d=r.pow(Math.E,0.0033*c-9.26E-4*f-0.340351*k-0.874412*l+0.646972*v+0.28118*t+2.987259*(1E3<e?1:0)-2.463292);d/=1+d;a={mbah:c,mbsh:f,mbfb:k,mbip:l,mbhs:v,mbbr:t,mblr:e,mbp:d};b&&r.clearInterval(b);return 0.15<d},getDebugState:function(){return a}}},Wc=function(a,b,c){var e,f,h,u,n,p=[],q=l.contextNode.parentNode,w=0,s=0,v=!1,x=!1,
y=new Sd,A=function(){var a=p.length-1,b=-1;-1<a&&(b=p[a].piv);return b},D=function(){k.getAggregator().trigger("delayedViewabilityReadyCallOnly")},L=function(a){z.whenReady(function(){f=new Td(a,r.getDoc().body)})},B=function(){f.removePixels()},I=function(){var a=y.getDebugState(),b=A();d.isUndef(a)&&(a={});a.mbm=d.fromBoolToNum(x);a.mbrd=d.fromBoolToNum(v);a.mbtg=d.isDef(q.tagName)?q.tagName:"na";a.mbaf=d.isDef(h)?h:"na";a.mbad=d.isDef(e)?e.getRounded().width+"_"+e.getRounded().height:"na";a.piv=
d.isDef(b)?b:-1;b={minDt:!1,type:"dm"};try{k.getAggregator().trigger("addOutputItem",{output:a},b),k.getAggregator().trigger("addOutputItem",{output:-101},"pingTime",b),k.getAggregator().trigger("sendDt",b.type)}catch(c){}};return{getScreenLocationInfo:function(b,c){var l;l=d.isDef(e);if(c||!b.adDimensions)return b;l||(h=b.method,e=b.adDimensions,L(e));if(d.isUndef(f)||!f.isReadyToMeasure())l=!1;d.isUndef(u)&&l&&(u=y.isLikelyToProduceFalsePositive(e));if(x=!u&&l){var q;l=f.getPercentInView();var B=
A(),Q=1===b.tabHidden;s=r.now()-w;q=0<w?900>s:!0;w=r.now();0===b.adDimensions.area()&&(l=0);q||(l=0);var z=l;p.push({tm:t.getTagTime(),piv:z});3<p.length&&p.shift();0===l&&0<B&&(q&&(q=p.length-1,z=!0,2<=p.length&&-1<q&&(z=0===p[q].piv&&0===p[q-1].piv),q=!z),q&&(l=B));a?(d.isUndef(n)&&(n=k.getAggregator().request("video")),n.setVideoSpecificScreenEventFields(b),l=b.isVideoPlayingInFullscreen?!0:!Q&&50<=l&&b.isVideoPlaying):l=!Q&&50<=l;b.viewState=l?g.IN_VIEW:g.OUT_OF_VIEW;b.percentInView=A();B=[];
Q=d(b.reason);q=g.OUT_OF_VIEW_REASONS;l||B.push(q.GEOM);Q.contains(q.HIDDEN)&&B.push(q.HIDDEN);Q.contains(q.OBSTRUCTION)&&B.push(q.OBSTRUCTION);b.reason=B;b.sliceStatus=f.getSliceStatus();v||(v=!0,r.execAtEndOfThread(D))}else b.viewState=g.NA,b.percentInView=-1;return b},start:function(){k.getAggregator().on("endAdSession",B);c&&r.setTimeout(I,2E3)},getStrategyName:function(){return"mobileWebXdomainSafari"},isMeasurable:function(){return x},isImmediate:function(){return!0},hasMeasurementStrategy:function(){return!0}}},
Ea=function(a,b,c,d){return{accepts:function(){var f=c.xDomainIframe,h=a.bootstrapOn("mobOrTab"),k=a.on("ios"),n=b.browserIs(g.BROWSERS.WEBKIT),p=9<=b.getIOSVersion(),l=d.isMobileAppEnvironment();return f&&h&&k&&n&&p&&!l},isImmediate:function(){return!1},start:function(){}}},Ud=function(a,b,c,e,f,h,k){var n,p=l.birthdate+""+r.round(1E6*r.random()),q=101,w,t,v,s=!1,x=function(){return'<html><body><script type="text/javascript">'+("("+function(a){var b=a.document;try{b.body.setAttribute("data-st","iasInit");
...
A=function(a,b){v||(q=a,v=b)},z=function(){var a,b,c;if(v)return!1;if(t)return!0;try{if(w.contentWindow&&w.contentWindow.document&&w.contentWindow.document.body){c=w.contentWindow.document.body;if(a=c.getAttribute("data-err"))throw Error(a);"iasInit"===c.getAttribute("data-st")&&A(104);(b=c.isReady?c.isReady():!1)&&(t=c.isInView?c.isInView:void 0)&&A(105)}}catch(e){A(106,e)}return d.isDef(t)},y=function(a,b,c){var h=M.createElement("iframe");h.id=p;d(h.style).mixin({position:"absolute",width:e+"px",
height:f+"px",backgroundColor:"transparent",border:"none",padding:"0px",margin:"0px",zIndex:"-999"});var k=h.style;h[g.IAS_DETECTOR]="true";k.left=b;k.top=c;a.appendChild(h);w=h;A(102);a=w;try{var n=a.contentWindow,l=x();n.document.open();a.contentWindow.document.write(l);n.document.close()}catch(q){A(103,q)}return h}(a,b,c);return{isInView:function(){var a,b,c=!1;r.now();z()&&(a=t(!0),c=a.isInView,s=!1,n&&(b=20*n.rate+n.lastUpdateTimestamp,0<b&&b<a.lastUpdateTimestamp&&(c=!1,s=!0)),A(107),n=a);return c},
isNotReadyToReport:function(){return!z()},createdElement:w,remove:function(){y.parentNode&&y.parentNode.removeChild(y)},getStatus:function(){return q},getError:function(){return v},isReadingInvalid:function(){return s},getRate:function(){return w.contentWindow&&w.contentWindow.document&&w.contentWindow.document.body&&w.contentWindow.document.body.getRate?w.contentWindow.document.body.getRate():-1},percentInView:h}},Td=function(a,b,c){var e,f=a.getRounded(),h=[],g=!1;a=V().getConfig(f);var k=a.percentInViewSliceArray,
p=1==a.numberOfSlices,l={mbrd:!1,mbvs:[],mbe:"n",mbv:9,mbs:[],mbm:1,mbivs:[]},w=function(){var a;if(!g)for(g=!0,a=0;a<h.length;a++)if(h[a].isNotReadyToReport()){g=!1;break}return g},s=function(a){var b=[],c=0;r.floor(a.height/k.length);var e=r.floor(a.width/2-1);d(k).each(function(d,f){c=r.floor(a.height*f);c===a.height&&(c-=2);b.push({y:r.floor(c)+"px",x:r.floor(e)+"px",width:2,height:2,percentInView:100*f})});return{get:function(){return b}}},v=function(a){var b=[{y:"0px",x:"0px",width:a.width,
height:a.height,percentInView:100}];return{get:function(){return b}}},x=function(a,b){var c=0;b&&(a.reverse(),d(a).map(function(a,b){b.percentInView=100-b.percentInView}));d(a).findFirst(function(a,b){b.isInView&&(c=r.max(c,b.percentInView));return!b.isInView});return c},z=function(){var a,b,c,e=[];l.mbs=[];d(h).each(function(b,c){a=c.isInView();l.mbs.push(a);e.push({isInView:a,percentInView:c.percentInView})});b=x(e,!1);c=x(e,!0);return r.max(b,c)};(function(){e=p?v(f):s(f);var a=e.get();d(a).each(function(a,
d){var e=new Ud(b,d.x,d.y,d.width,d.height,d.percentInView,c);h.push(e)})})();return{getPercentInView:function(){var a=w(),b=z();l.mbrd=a?1:0;b!=l.mbp&&l.mbivs.push([t.getTagTime(),b]);l.mbp=b;return a?b:-1},removePixels:function(){void 0!==c&&c.stop();d(h).each(function(a,b){try{b.remove()}catch(c){}})},getPixelStateForDebug:function(){l.mbm=1;h&&0<h.length&&(l.mbpr=[],l.mbir=[],d(h).each(function(a,b){l.mbpr.push(b.getRate());l.mbir.push(b.isReadingInvalid()?1:0)}));return l},isReadyToMeasure:w,
getSliceStatus:function(){var a;h&&0<h.length&&(a=[],d(h).each(function(b,c){a.push(c.isInView())}));return a}}},rd=function(a,b){var c={mbrd:!1,mbvs:[],mbe:"n",mbv:9,mbs:[],mbm:1,mbivs:[]},e=function(a,b){var c=[],e=a.geometry.value();d(b).each(function(b,d){if(a.geometry.doesIntersect(d)){var f=d.value(),h=Math.max(e.leftX,f.leftX),g=Math.min(e.rightX,f.rightX),k=Math.max(e.topY,f.topY),f=Math.min(e.bottomY,f.bottomY);c.push(new W(h,g,k,f))}});return c},f=function(a,b){var c=0,f=e(a,b),h;d(f).each(function(a,
...
return!b||c&&c.isFullyInView(a)})}}},Zd=function(){var a={AdPaused:"pauseAd",AdVolumeChange:"volumeChanged",AdPlaying:"resumeAd"};return{translate:function(b){var c=b.charAt(0).toLowerCase()+b.slice(1);b in a&&(c=a[b]);return c}}},Na=function(){return{getVolumeFromContext:function(a){var b,c=-1;d.isDef(a)&&(d.isDef(a.volume)?c=a.volume:d.isDef(a.adVolume)&&(c=a.adVolume));-1!==c&&(b=c);return b}}},hb=function(a,b,c){var e="IASid"+a,f="getIasVidBridgeVersion"+a,h,u,n,p=[],q=g.OUT_OF_VIEW,s=!1,x=!1,
v=!1,y=!0,O=new Xd,A=Yd(),D=new Vd,E=new Na,B=new Aa,I=function(b){var d;s=!0;var e={};try{e=JSON.parse(unescape(b&&b.data?b.data:b))}catch(f){e={}}e.id==a&&(d=O.registerEvent(e,c.getCurrentLoc()),d.indicatesPlaying()?(x=!0,q=v?g.IN_VIEW:!1):d.indicatesNotPlaying()?(x=!1,q=g.OUT_OF_VIEW):d.indicatesFullscreen()?(v=!0,q=x?g.IN_VIEW:g.OUT_OF_VIEW):d.indicatesNormalSize()&&(v=!1,q=x?!1:g.OUT_OF_VIEW),b=parseFloat(d.getVolume(E)),0<b?y=!0:0===b&&(y=!1));p.push(d);n&&M();return d},F=function(b){var c,
g,h=ma().wrapToGlobal(I),n=function(a){d.isStr(a)&&(k.getAggregator().provide("vc",function(){return a}),k.getAggregator().trigger("addOutputItem",{output:a},"vc",{type:"impression"}))};try{g=b[f]||b.getIasVidBridgeVersion,c=d.isFunction(g)&&"2"===g.call(b)?unescape(b[e].call(b,a,h)):unescape(b[e].call(b,a)),s=!0,n(c||"n")}catch(p){__IntegralASDiagnosticCall("handshakefailure",p,l)}},G=function(){var c=function(a){return d(d(a).toArray()).findFirst(function(a,b){return d.isFunction(b[e])})};h||(d(["*[data-integralas-vid-"+
a+"]",".integral-vid-"+a,"ias-ad","object","embed"]).findFirst(function(a,b){var d=r.getDoc().querySelectorAll(b);return h=c(d)}),!h&&b.on("novidnodeerr")&&__IntegralASDiagnosticCall("novidnode",{},l));return h},J=function(){var a=G();a&&!s&&F(a);return a},K=function(a){a=E.getVolumeFromContext(a);y=d.isDef(a)?0<a:!1},M=function(){B.init();d(p).each(function(a,b){b&&(d.isUndef(b.sl)&&b.updateScreenLoc(c.getCurrentLoc()),b.trigger(),b.indicatesCompletion()&&k.getAggregator().trigger("adSessionComplete"),
b.indicatesQuartile()&&("adVideoComplete"!==b.tp&&k.getAggregator().trigger("sendDt",g.DT_CODES.VIDEO_EVENTS),k.getAggregator().trigger("videoQuartileEvent",b)))});p=[];n=!0};(function(){z.addEvent(r.getWindow(),"message",function(a){I(a)});k.getAggregator().on({volumeChanged:K});k.getAggregator().provide({videoEventsString:O,videoVersion:function(){var a,b=J();try{a=b.getVersion()}catch(c){a=-1,k.getAggregator().trigger("error",g.ERROR_CODES.NO_VIDEO_AD_INTERFACE)}return a},videoTranslator:function(){return u=
u||new Zd},adNode:J});J();D.listenForResult();A.isApplicable(t)&&A.start(c)})();return{findAdNode:J,getViewStateOverride:function(){return q},isHandshakeComplete:function(){return s},triggerInitializationEvents:M,setVideoSpecificScreenEventFields:function(a){var b=a.viewState===g.NA;a.isVideoPlaying=!0;a.isSoundOn=y;a.isVideoPlayingInFullscreen=!1;if(q){if(q===g.OUT_OF_VIEW){var c=a.reason?a.reason.split("."):[];c[c.length]=g.OUT_OF_VIEW_REASONS.VIDEO;a.reason=c.join(".")}a.viewState=b?a.viewState:
...
c="gcd";(function(){var c=N.isFrameworkAvailable("__cmp","__cmpLocator");N.send("gca",!!c);if(c){var f,g;d.isFunction(c)?c("getVendorConsents",[b],a):(f={__cmpCall:{command:"getVendorConsents",parameter:[b],callId:N.getCallId()}},g=N.getMessageHandler("__cmpReturn",a),z.addEvent(r.getWindow(),"message",g),c.postMessage(f,"*"))}})()},{tier:g.TIERS.ENVIRONMENT,applies:function(a,b,c){return b.hasPostMessage()&&!c.isDomless()}});k("GDPRV2ConsentDetector",[],function(){function a(a){var f=d.isDef(a)&&
d.isDef(a.vendor)&&d.isDef(a.vendor.consents)&&d.isDef(a.vendor.consents[b])?a.vendor.consents[b]:void 0;a={appl:d.stringifyTriState(a.gdprApplies),cnst:d.stringifyTriState(f)};N.send(c,d(a).toION())}var b=278,c="gcd2";(function(){var c=N.isFrameworkAvailable("__tcfapi","__tcfapiLocator");N.send("gca2",!!c);if(c){var f,g;d.isFunction(c)?c("getTCData",2,a):(f={__tcfapiCall:{command:"getTCData",parameter:[b],callId:N.getCallId(),version:2}},g=N.getMessageHandler("__tcfapiReturn",a),z.addEvent(r.getWindow(),
...
encodeURIComponent(l.passback)+(A?"&redirectUrl="+encodeURIComponent(I):"")+(A?"&passback=":"&adsafe_pb=")+encodeURIComponent(B)+"&"}var A=s=s.replace(g.UNIQUE_ID_TOKEN,l.asid),F=s.length,G,J,K=n(l.sp_imp_jsInfo_minLength,0),B="";try{G=x-F-K,0<G&&(J=be(p,G,14,b.on("partialUrls")),B+=J.join("&"))}catch(M){a.add(g.ERROR_CODES.IMPRESSION_URLS)}s=A+B;p=s+="&"===s.slice(-1)?"":"&";var N,F="";try{N=x-s.length,F+=ce(N,"adsafe_jsinfo=",a,b,c,f,h,r)}catch(P){a.add(g.ERROR_CODES.JSINFO),F+="adsafe_jsinfo=e:"+
a.toString()}s=p+F;d.macroUrl&&(s+="&"===s.slice(-1)?"":"&",s+=d.macroUrl);q=s;d.sendImpression(q);l.impUrl=q;k.getAggregator().trigger("impressionsent")}catch(R){__IntegralASDiagnosticCall("impsend",R,l)}}}},ce=function(a,b,c,e,f,h,s,n){return function(c){var e=c.primary.join(","),g=b,h=0,k=function(a){if(a)return","+a};g.length+e.length+5<=a&&(g+=k(e),f.impressionIsIdentifiable(!0),d(c.secondary).each(function(b,c){g.length+c.length+5<=a?g+=k(c):h+=1}));return g+=",ov:"+h}(function(){var a,b;b=
...
a=de(a,c,e,f,h,s,n);k.getAggregator().trigger("eligiblerender");return{primary:w,secondary:a}}())},de=function(a,b,c,e,f,h,u){var n=[],p=k.getAggregator().request("mPage");n.push("mn:"+l.mn);n.push("pt:"+function(){var b=u.stringifyPingTimes();a.viewState!==g.NA&&(b+=a.details);return b}());n.push(d(h.params()).toParams());c.on("mrcAudit")&&!t.isDomless()&&n.push("dvs:"+r.getDoc().visibilityState);f.iterate(function(a,b){var c=!b.props||d.isUndef(b.props.type),e=!b.props||b.props.type===g.IMPRESSION_EVENT;
(c||e)&&n.push(a+":"+b.output())});b.toString()&&n.push("e:"+b.toString());n.push(c.output());n.push("tt:"+l.mode);n.push("thd:"+d.stringifyTriState(p.supportsVisAPI()));n.push("et:"+(r.now()-l.birthdate));l.perf.mark("si");c.on("swapids")?n.push("oid:"+l.oid):n.push("uid:"+e.unq);n.push("v:19.8.75");n.push("sp:"+(l.isSplitMode?1:0));n.push("fwm:"+("true"===l.fwMonitoring?1:0));c.on("resolution")&&(n.push("wr:"+d(s.windowSize()).toArray().join(".")),n.push("sr:"+d(s.screenSize()).toArray().join(".")));
b=function(){var a;a=String(l.scriptUrl).toLowerCase();var b=a.indexOf("ias_xpc");-1<b?(a=a.substring(b+7+1),b=a.indexOf("&"),a=-1<b?a.substring(0,b):a):a="NotFound";return a||""}();"NotFound"!==b&&n.push("x_xpc:"+b);return n},be=function(a,b,c,e){var f,g=[],k=function(a){return-1!==a.key.indexOf("q")||-1!==a.key.indexOf("g")};a&&a.length&&(f=d(a).map(function(a,b){if(k(b))return b}),a=d(a).map(function(a,b){if(!k(b))return b}),d(f.concat(a)).each(function(a,d){var f;f=d.val;var k=d.key,l;l=24+g.join("&").length+
