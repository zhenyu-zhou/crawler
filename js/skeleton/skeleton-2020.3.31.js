...
try {
	...
	var __IntegralASConfig = {
		...
		protocol: 'https',
		jsref: "",
		asid: "df087729-7385-11ea-9d21-02e0e6bdca5f",
...
l.use100v},usesGroupMCustomMetric:p,isCeltra:function(){var a=!1;n||(a=za().isApplicable());return a},usesGroupMCustomMetricMobilePassThru:function(){return p()&&u()},usesZeroPivCustomMetric:function(){return!1===d(l.customViewability).isArray()?!1:0<d(l.customViewability).filter(function(a,b){return d(b.thresholds).findFirst(function(a,b){return 0===b.piv})}).length},isRefreshable:function(a){try{var b=r.getTop();window.addEventListener("message",function(b){/isRefreshable/g.test(b.data)&&a(null,
b&&b.data)},!1);b.postMessage(JSON.stringify({requestTop:"isRefreshable"}),"*")}catch(c){a(c)}},isPossiblyRefreshable:function(){return!n&&!c()&&!h()&&a&&"jload"===l.mode}}}(),y={addEvent:function(n,a,b,c){d.isDef(n.addEventListener)?"mouseenter"===a?n.addEventListener("mouseover",y.mouseEnter(b),c):"mouseleave"===a?n.addEventListener("mouseout",y.mouseEnter(b),c):n.addEventListener(a,b,c):d.isDef(n.attachEvent)&&("DOMContentLoaded"===a&&(a="load"),n.attachEvent("on"+a,b))},removeEvent:function(n,
...
l.oid):m.push("uid:"+e.unq);m.push("v:19.8.66");m.push("sp:"+(l.isSplitMode?1:0));m.push("fwm:"+("true"===l.fwMonitoring?1:0));c.on("resolution")&&(m.push("wr:"+d(t.windowSize()).toArray().join(".")),m.push("sr:"+d(t.screenSize()).toArray().join(".")));b=function(){var a;a=String(l.scriptUrl).toLowerCase();var b=a.indexOf("ias_xpc");-1<b?(a=a.substring(b+7+1),b=a.indexOf("&"),a=-1<b?a.substring(0,b):a):a="NotFound";return a||""}();"NotFound"!==b&&m.push("x_xpc:"+b);return m},ae=function(a,b,c,e){var f,
