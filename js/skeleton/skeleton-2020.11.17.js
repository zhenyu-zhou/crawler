...
try {
	var __IntegralASConfig = {
		...
		sp_cdnScripts: {xsca: "static.adsafeprotected.com/xsca.17.4.85.js", sca: "static.adsafeprotected.com/sca.17.4.114.js", main: "static.adsafeprotected.com/main.19.8.145.js"},
		protocol: 'https',
		jsref: "",
		asid: "c4fec9ab-28f6-11eb-93a8-0ad7ec459248",
...
width:r.getMaxNumber(),height:r.getMaxNumber()};for(var d,e=b.parent.frames,f=!1,h=0,l=e.length;h<l;h++)if(e[h]==b){d=e[h];f=!0;break}if(f){d=s.getRect(d.frameElement);c.left+=d.left;c.top+=d.top;try{c.width=r.min(c.width,d.width),c.height=r.min(c.height,d.height)}catch(t){n.getAggregator().trigger("error",k.ERROR_CODES.GET_AD_DIMENSIONS)}b!==r.getTop()&&m(b.parent,c)}return c},l=function(){var l,u={};try{var w,D,x,v,A,y,C=r.getMaxNumber(),B=r.getMaxNumber();t.friendly?(w=m(),x=w.left,v=w.top,C=w.width,
...
0===z&&0<F.offsetWidth&&(z=F.offsetWidth),0===G&&0<F.offsetHeight&&(G=F.offsetHeight)):a.frameElement&&f.isDef(a.frameElement.clientWidth)&&(z=a.frameElement.clientWidth,G=a.frameElement.clientHeight);l=z;u.height=G;u.width=l}catch(E){n.getAggregator().trigger("error",k.ERROR_CODES.GET_AD_DIMENSIONS)}return u};return{calcDims:function(){return new B(l())},getClippedDims:function(){var a=l();return new B({scrX:a.scrX,scrY:a.scrY,width:a.iFrameClippingWidth,height:a.iFrameClippingHeight})}}},Rb=function(){return{createInstance:function(a,
...
c=-1;f.isDef(a)&&(f.isDef(a.volume)?c=a.volume:f.isDef(a.adVolume)&&(c=a.adVolume));-1!==c&&(b=c);return b}}},vb=function(a,b,c){var d="IASid"+a,e="getIasVidBridgeVersion"+a,h,q,l,p=[],u=k.OUT_OF_VIEW,s=!1,v=!1,x=!1,z=!0,A=new ve,B=we(),C=new te,E=new Sa,I=new Ga,G=function(b){var d;s=!0;var e={};try{e=JSON.parse(unescape(b&&b.data?b.data:b))}catch(f){e={}}e.id==a&&(d=A.registerEvent(e,c.getCurrentLoc()),d.indicatesPlaying()?(v=!0,u=x?k.IN_VIEW:!1):d.indicatesNotPlaying()?(v=!1,u=k.OUT_OF_VIEW):d.indicatesFullscreen()?
(x=!0,u=v?k.IN_VIEW:k.OUT_OF_VIEW):d.indicatesNormalSize()&&(x=!1,u=v?!1:k.OUT_OF_VIEW),b=parseFloat(d.getVolume(E)),0<b?z=!0:0===b&&(z=!1));p.push(d);l&&M();return d},F=function(b){var c,h,k=xa().wrapToGlobal(G),l=function(a){f.isStr(a)&&(n.getAggregator().provide("vc",function(){return a}),n.getAggregator().trigger("addOutputItem",{output:a},"vc",{type:"impression"}))};try{h=b[e]||b.getIasVidBridgeVersion,c=f.isFunction(h)&&"2"===h.call(b)?unescape(b[d].call(b,a,k)):unescape(b[d].call(b,a)),s=!0,
...
z=f.isDef(a)?0<a:!1},M=function(){I.init();f(p).each(function(a,b){b&&(f.isUndef(b.sl)&&b.updateScreenLoc(c.getCurrentLoc()),b.trigger(),b.indicatesCompletion()&&n.getAggregator().trigger("adSessionComplete"),b.indicatesQuartile()&&("adVideoComplete"!==b.tp&&n.getAggregator().trigger("sendDt",k.DT_CODES.VIDEO_EVENTS),n.getAggregator().trigger("videoQuartileEvent",b)))});p=[];l=!0};(function(){y.addEvent(r.getWindow(),"message",function(a){G(a)});n.getAggregator().on({volumeChanged:K});n.getAggregator().provide({videoEventsString:A,
...
z;a.isVideoPlayingInFullscreen=!1;if(u){if(u===k.OUT_OF_VIEW){var c=a.reason?a.reason.split("."):[];c[c.length]=k.OUT_OF_VIEW_REASONS.VIDEO;a.reason=c.join(".")}a.viewState=b?a.viewState:u;a.isVideoPlaying=u===k.IN_VIEW}x&&v&&(a.percentInView=100,a.isVideoPlayingInFullscreen=!0)}}},ye=function(){return new Z(k.PERF_TIMELINE_TRACKER_CONFIG.WRAPPERS.AS.TYPE,k.PERF_TIMELINE_TRACKER_CONFIG.WRAPPERS.AS.COUNT)},bb=function(){var a,b,c={},d=0,e=function(c){if(c||a)d+=5,b.onTick(d,function(){a?e():n.getAggregator().trigger("sendDt",
...
a.bootstrapperHas(["protocol","cookieBaseURL","asid"])}}},ab=function(a,b,c,d,e,f,q){var l=function(a,b){return isNaN(a)||0>a||""===a?b:a};return{send:function(p){try{var r,s=d.baseUrl,v,x,y=f.getDocumentMode();"number"===typeof y?(x=2E3,8===y?x=4E3:8<y&&(x=8E3)):x=l(m.sp_imp_maxLength,2E3);v=x;if(t.integratedBlockingApplies(s)){x=s;var A=n.getAggregator().request("mobileApp"),z=A&&A.isMobileAppEnvironment&&A.isMobileAppEnvironment(),C=m.contextNode.getAttribute("data-ias-container"),B=m.contextNode.getAttribute("data-ias-callback"),
A=x+"adContainerId="+C+"&cbFunctionName="+B,A=z?A.replace("monitoring","blocking"):A.replace("skeleton.js",m.integration+".js"),E=m.protocol+":"+m.staticServer+m.integration+"a.js",G=m.protocol+":"+m.staticServer+m.integration+".js",s=A+"&true_pb="+encodeURIComponent(m.passback)+(z?"&redirectUrl="+encodeURIComponent(G):"")+(z?"&passback=":"&adsafe_pb=")+encodeURIComponent(E)+"&"}var z=s=s.replace(k.UNIQUE_ID_TOKEN,m.asid),F=s.length,I,H,K=l(m.sp_imp_jsInfo_minLength,0),E="";try{I=v-F-K,0<I&&(H=Ae(p,
I,14,b.on("partialUrls")),E+=H.join("&"))}catch(M){a.add(k.ERROR_CODES.IMPRESSION_URLS)}s=z+E;p=s+="&"===s.slice(-1)?"":"&";var N,F="";try{N=v-s.length,F+=Be(N,"adsafe_jsinfo=",a,b,c,e,f,q)}catch(R){a.add(k.ERROR_CODES.JSINFO),F+="adsafe_jsinfo=e:"+a.toString()}s=p+F;d.macroUrl&&(s+="&"===s.slice(-1)?"":"&",s+=d.macroUrl);r=s;d.sendImpression(r);m.impUrl=r;n.getAggregator().trigger("impressionsent")}catch(Q){__IntegralASDiagnosticCall("impsend",Q,m)}}}},Be=function(a,b,c,d,e,h,q,l){return function(c){var d=
...
m.oid):l.push("uid:"+d.unq);l.push("v:19.8.145");l.push("sp:"+(m.isSplitMode?1:0));l.push("fwm:"+("true"===m.fwMonitoring?1:0));c.on("resolution")&&(l.push("wr:"+f(s.windowSize()).toArray().join(".")),l.push("sr:"+f(s.screenSize()).toArray().join(".")));b=function(){var a;a=String(m.scriptUrl).toLowerCase();var b=a.indexOf("ias_xpc");-1<b?(a=a.substring(b+7+1),b=a.indexOf("&"),a=-1<b?a.substring(0,b):a):a="NotFound";return a||""}();"NotFound"!==b&&l.push("x_xpc:"+b);return l},Ae=function(a,b,c,d){var e,
