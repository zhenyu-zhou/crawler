...
try {
	...
	var __IntegralASConfig = {
		...
		sp_cdnScripts: {xsca: "static.adsafeprotected.com/xsca.17.4.85.js", sca: "static.adsafeprotected.com/sca.17.4.114.js", main: "static.adsafeprotected.com/main.19.8.56.js"},
		protocol: 'https',
		jsref: "",
		asid: "ace922ca-5fc4-11ea-b892-0ad4d7b160f1",
...
u.documentElement.style)k="11";else for(n.style.behavior="url(#default#clientcaps)",u=0;u<e.length&&!(k=n.getComponentVersion(e[u],"componentid").replace(/,/g,"."));u++);}catch(p){}e=k;k=h.NA;n=r.getWindow();f.isDef(n.navigator)&&f.isDef(n.navigator.appName)&&(k=n.navigator.appName.toLowerCase()[0]);return{br:c,abv:e,an:k}},isAndroidWebViewBrowser:function(){var a=c(),b=["SamsungBrowser","FB_IAB","Silk"],k=function(){return f(b).findFirst(function(b,c){return M.contains(a,c)})};return M.contains(a,
...
d)}catch(k){}},e=function(){var b=a.mraid;return f(b).isObj()&&f.isFunction(b.isViewable)},k=function(){var b=a.mraid;d();b.addEventListener("viewableChange",d)},u=function(){var b=a.mraid;e()&&(c=!0,"loading"===b.getState()?b.addEventListener("ready",function(){k()}):k())},n=function(){c||u()};return{start:function(){var b=!0;if(f.isDef(a.mraid)||t.containsScriptTagWithSrc("mraid.js"))b=!1;l.getAggregator().trigger("addOutputItem",{output:f.stringifyTriState(b)},"mi",{type:"impression"});b?l.getAggregator().trigger("exec",
"mraid.js",n):u()},addScreenLocationChangedListener:function(a){b.on("mraidScreenLocationChanged",a)}}},db=function(a,b,c){var d={},e=function(c){var d=f.noop;b.bootstrapOn("useViewabilityNotification")&&(d=function(){a.skipAsFraudulent()||l.getAggregator().trigger("notify",c)});return d};(function(){c&&f(c).map(function(a,b){d[a]=e(b)})})();return{getCallbacks:function(){return d}}},Ya=function(){var a=new P({tiv:[1E4]}),b=f([h.IN_VIEW,h.PARTIAL_VIEW_PLUS]);return{timeInViewThresholds:a,type:h.DT_CODES.FULLY_INVIEW,
...
1:0,v=h()?1:0,s=k.getUserAgent(),s=s&&null!==s.match(/(Version\/9\.0)|(CriOS\/55)/)?1:0;e=r.pow(Math.E,0.0033*c-9.26E-4*f-0.340351*l-0.874412*m+0.646972*v+0.28118*s+2.987259*(1E3<d?1:0)-2.463292);e/=1+e;a={mbah:c,mbsh:f,mbfb:l,mbip:m,mbhs:v,mbbr:s,mblr:d,mbp:e};b&&r.clearInterval(b);return 0.15<e},getDebugState:function(){return a}}},Vc=function(a,b,c){var d,e,k,u,n,p=[],q=m.contextNode.parentNode,y=0,t=0,v=!1,w=!1,A=new Qd,B=function(){var a=p.length-1,b=-1;-1<a&&(b=p[a].piv);return b},D=function(){l.getAggregator().trigger("delayedViewabilityReadyCallOnly")},
H=function(a){x.whenReady(function(){e=new Rd(a,r.getDoc().body)})},C=function(){e.removePixels()},F=function(){var a=A.getDebugState(),b=B();f.isUndef(a)&&(a={});a.mbm=f.fromBoolToNum(w);a.mbrd=f.fromBoolToNum(v);a.mbtg=f.isDef(q.tagName)?q.tagName:"na";a.mbaf=f.isDef(k)?k:"na";a.mbad=f.isDef(d)?d.getRounded().width+"_"+d.getRounded().height:"na";a.piv=f.isDef(b)?b:-1;b={minDt:!1,type:"dm"};try{l.getAggregator().trigger("addOutputItem",{output:a},b),l.getAggregator().trigger("addOutputItem",{output:-101},
"pingTime",b),l.getAggregator().trigger("sendDt",b.type)}catch(c){}};return{getScreenLocationInfo:function(b,c){var q;q=f.isDef(d);if(c||!b.adDimensions)return b;q||(k=b.method,d=b.adDimensions,H(d));if(f.isUndef(e)||!e.isReadyToMeasure())q=!1;f.isUndef(u)&&q&&(u=A.isLikelyToProduceFalsePositive(d));if(w=!u&&q){var m;q=e.getPercentInView();var C=B(),x=1===b.tabHidden;t=r.now()-y;m=0<y?900>t:!0;y=r.now();0===b.adDimensions.area()&&(q=0);m||(q=0);var F=q;p.push({tm:s.getTagTime(),piv:F});3<p.length&&
p.shift();0===q&&0<C&&(m&&(m=p.length-1,F=!0,2<=p.length&&-1<m&&(F=0===p[m].piv&&0===p[m-1].piv),m=!F),m&&(q=C));a?(f.isUndef(n)&&(n=l.getAggregator().request("video")),n.setVideoSpecificScreenEventFields(b),q=b.isVideoPlayingInFullscreen?!0:!x&&50<=q&&b.isVideoPlaying):q=!x&&50<=q;b.viewState=q?h.IN_VIEW:h.OUT_OF_VIEW;b.percentInView=B();C=[];x=f(b.reason);m=h.OUT_OF_VIEW_REASONS;q||C.push(m.GEOM);x.contains(m.HIDDEN)&&C.push(m.HIDDEN);x.contains(m.OBSTRUCTION)&&C.push(m.OBSTRUCTION);b.reason=C;
b.sliceStatus=e.getSliceStatus();v||(v=!0,r.execAtEndOfThread(D))}else b.viewState=h.NA,b.percentInView=-1;return b},start:function(){l.getAggregator().on("endAdSession",C);c&&r.setTimeout(F,2E3)},getStrategyName:function(){return"mobileWebXdomainSafari"},isMeasurable:function(){return w},isImmediate:function(){return!0},hasMeasurementStrategy:function(){return!0}}},Ea=function(a,b,c,d){return{accepts:function(){var e=c.xDomainIframe,f=a.bootstrapOn("mobOrTab"),l=a.on("ios"),n=b.browserIs(h.BROWSERS.WEBKIT),
p=9<=b.getIOSVersion(),q=d.isMobileAppEnvironment();return e&&f&&l&&n&&p&&!q},isImmediate:function(){return!1},start:function(){}}},Sd=function(a,b,c,d,e,k,l){var n,p=m.birthdate+""+r.round(1E6*r.random()),q=101,s,t,v,w=!1,x=function(){return'<html><body><script type="text/javascript">'+("("+function(a){var b=a.document;try{b.body.setAttribute("data-st","iasInit");var c,d=0,e=0,f=!1,k=(new Date).getTime(),h=function(){e=(new Date).getTime()-d;(f=b.body.isReady())&&(c=0<d?900>=e:void 0);d=(new Date).getTime();
...
s.contentWindow.document.body){c=s.contentWindow.document.body;if(a=c.getAttribute("data-err"))throw Error(a);"iasInit"===c.getAttribute("data-st")&&B(104);(b=c.isReady?c.isReady():!1)&&(t=c.isInView?c.isInView:void 0)&&B(105)}}catch(d){B(106,d)}return f.isDef(t)},H=function(a,b,c){var k=L.createElement("iframe");k.id=p;f(k.style).mixin({position:"absolute",width:d+"px",height:e+"px",backgroundColor:"transparent",border:"none",padding:"0px",margin:"0px",zIndex:"-999"});var l=k.style;k[h.IAS_DETECTOR]=
"true";l.left=b;l.top=c;a.appendChild(k);s=k;B(102);a=s;try{var n=a.contentWindow,q=x();n.document.open();a.contentWindow.document.write(q);n.document.close()}catch(m){B(103,m)}return k}(a,b,c);return{isInView:function(){var a,b,c=!1;r.now();D()&&(a=t(!0),c=a.isInView,w=!1,n&&(b=20*n.rate+n.lastUpdateTimestamp,0<b&&b<a.lastUpdateTimestamp&&(c=!1,w=!0)),B(107),n=a);return c},isNotReadyToReport:function(){return!D()},createdElement:s,remove:function(){H.parentNode&&H.parentNode.removeChild(H)},getStatus:function(){return q},
getError:function(){return v},isReadingInvalid:function(){return w},getRate:function(){return s.contentWindow&&s.contentWindow.document&&s.contentWindow.document.body&&s.contentWindow.document.body.getRate?s.contentWindow.document.body.getRate():-1},percentInView:k}},Rd=function(a,b,c){var d,e=a.getRounded(),k=[],h=!1;a=U().getConfig(e);var l=a.percentInViewSliceArray,p=1==a.numberOfSlices,q={mbrd:!1,mbvs:[],mbe:"n",mbv:9,mbs:[],mbm:1,mbivs:[]},m=function(){var a;if(!h)for(h=!0,a=0;a<k.length;a++)if(k[a].isNotReadyToReport()){h=
!1;break}return h},t=function(a){var b=[],c=0;r.floor(a.height/l.length);var d=r.floor(a.width/2-1);f(l).each(function(e,f){c=r.floor(a.height*f);c===a.height&&(c-=2);b.push({y:r.floor(c)+"px",x:r.floor(d)+"px",width:2,height:2,percentInView:100*f})});return{get:function(){return b}}},v=function(a){var b=[{y:"0px",x:"0px",width:a.width,height:a.height,percentInView:100}];return{get:function(){return b}}},w=function(a,b){var c=0;b&&(a.reverse(),f(a).map(function(a,b){b.percentInView=100-b.percentInView}));
f(a).findFirst(function(a,b){b.isInView&&(c=r.max(c,b.percentInView));return!b.isInView});return c},x=function(){var a,b,c,d=[];q.mbs=[];f(k).each(function(b,c){a=c.isInView();q.mbs.push(a);d.push({isInView:a,percentInView:c.percentInView})});b=w(d,!1);c=w(d,!0);return r.max(b,c)};(function(){d=p?v(e):t(e);var a=d.get();f(a).each(function(a,d){var e=new Sd(b,d.x,d.y,d.width,d.height,d.percentInView,c);k.push(e)})})();return{getPercentInView:function(){var a=m(),b=x();q.mbrd=a?1:0;b!=q.mbp&&q.mbivs.push([s.getTagTime(),
b]);q.mbp=b;return a?b:-1},removePixels:function(){void 0!==c&&c.stop();f(k).each(function(a,b){try{b.remove()}catch(c){}})},getPixelStateForDebug:function(){q.mbm=1;k&&0<k.length&&(q.mbpr=[],q.mbir=[],f(k).each(function(a,b){q.mbpr.push(b.getRate());q.mbir.push(b.isReadingInvalid()?1:0)}));return q},isReadyToMeasure:m,getSliceStatus:function(){var a;k&&0<k.length&&(a=[],f(k).each(function(b,c){a.push(c.isInView())}));return a}}},qd=function(a,b){var c={mbrd:!1,mbvs:[],mbe:"n",mbv:9,mbs:[],mbm:1,
...
b.slice(1);b in a&&(c=a[b]);return c}}},Na=function(){return{getVolumeFromContext:function(a){var b,c=-1;f.isDef(a)&&(f.isDef(a.volume)?c=a.volume:f.isDef(a.adVolume)&&(c=a.adVolume));-1!==c&&(b=c);return b}}},hb=function(a,b,c){var d="IASid"+a,e="getIasVidBridgeVersion"+a,k,u,n,p=[],q=h.OUT_OF_VIEW,t=!1,z=!1,v=!1,w=!0,A=new Vd,B=Wd(),D=new Td,H=new Na,C=new Aa,F=function(b){var d;t=!0;var e={};try{e=JSON.parse(unescape(b&&b.data?b.data:b))}catch(f){e={}}e.id==a&&(d=A.registerEvent(e,c.getCurrentLoc()),
d.indicatesPlaying()?(z=!0,q=v?h.IN_VIEW:!1):d.indicatesNotPlaying()?(z=!1,q=h.OUT_OF_VIEW):d.indicatesFullscreen()?(v=!0,q=z?h.IN_VIEW:h.OUT_OF_VIEW):d.indicatesNormalSize()&&(v=!1,q=z?!1:h.OUT_OF_VIEW),b=parseFloat(d.getVolume(H)),0<b?w=!0:0===b&&(w=!1));p.push(d);n&&L();return d},G=function(b){var c,k,h=ma().wrapToGlobal(F),q=function(a){f.isStr(a)&&(l.getAggregator().provide("vc",function(){return a}),l.getAggregator().trigger("addOutputItem",{output:a},"vc",{type:"impression"}))};try{k=b[e]||
b.getIasVidBridgeVersion,c=f.isFunction(k)&&"2"===k.call(b)?unescape(b[d].call(b,a,h)):unescape(b[d].call(b,a)),t=!0,q(c||"n")}catch(n){__IntegralASDiagnosticCall("handshakefailure",n,m)}},E=function(){var c=function(a){return f(f(a).toArray()).findFirst(function(a,b){return f.isFunction(b[d])})};k||(f([".integral-vid-"+a,"ias-ad","object","embed"]).findFirst(function(a,b){var d=r.getDoc().querySelectorAll(b);return k=c(d)}),!k&&b.on("novidnodeerr")&&__IntegralASDiagnosticCall("novidnode",{},m));
return k},I=function(){var a=E();a&&!t&&G(a);return a},J=function(a){a=H.getVolumeFromContext(a);w=f.isDef(a)?0<a:!1},L=function(){C.init();f(p).each(function(a,b){b&&(f.isUndef(b.sl)&&b.updateScreenLoc(c.getCurrentLoc()),b.trigger(),b.indicatesCompletion()&&l.getAggregator().trigger("adSessionComplete"),b.indicatesQuartile()&&("adVideoComplete"!==b.tp&&l.getAggregator().trigger("sendDt",h.DT_CODES.VIDEO_EVENTS),l.getAggregator().trigger("videoQuartileEvent",b)))});p=[];n=!0};(function(){x.addEvent(r.getWindow(),
"message",function(a){F(a)});l.getAggregator().on({volumeChanged:J});l.getAggregator().provide({videoEventsString:A,videoVersion:function(){var a,b=I();try{a=b.getVersion()}catch(c){a=-1,l.getAggregator().trigger("error",h.ERROR_CODES.NO_VIDEO_AD_INTERFACE)}return a},videoTranslator:function(){return u=u||new Xd},adNode:I});I();D.listenForResult();B.isApplicable(s)&&B.start(c)})();return{findAdNode:I,getViewStateOverride:function(){return q},isHandshakeComplete:function(){return t},triggerInitializationEvents:L,
setVideoSpecificScreenEventFields:function(a){var b=a.viewState===h.NA;a.isVideoPlaying=!0;a.isSoundOn=w;a.isVideoPlayingInFullscreen=!1;if(q){if(q===h.OUT_OF_VIEW){var c=a.reason?a.reason.split("."):[];c[c.length]=h.OUT_OF_VIEW_REASONS.VIDEO;a.reason=c.join(".")}a.viewState=b?a.viewState:q;a.isVideoPlaying=q===h.IN_VIEW}v&&z&&(a.percentInView=100,a.isVideoPlayingInFullscreen=!0)}}},Yd=function(){return new aa(h.PERF_TIMELINE_TRACKER_CONFIG.WRAPPERS.AS.TYPE,h.PERF_TIMELINE_TRACKER_CONFIG.WRAPPERS.AS.COUNT)},
...
b}}},Db=function(){function a(){}a.build=function(){var a=[];a.push(new aa(h.PERF_TIMELINE_TRACKER_CONFIG.RENDER.TYPE,h.PERF_TIMELINE_TRACKER_CONFIG.RENDER.COUNT));var c;c=l.getAggregator().request("vc");var d={jv3:Oa,av3:Oa,jvw:Zd,avw:Yd};(c=c?d[c]:void 0)&&a.push(c());return a};return a}(),Oa=function(){return new aa(h.PERF_TIMELINE_TRACKER_CONFIG.VANS.TYPE,h.PERF_TIMELINE_TRACKER_CONFIG.VANS.COUNT)},Q={IDS:{BLOCK_TIME:"pBlk",ON_LOAD:"pLoad",IN_BROWSER_DELAY:"pWait"},recordBlockingTime:function(){l.getAggregator().trigger("measureTime",
...
{tier:h.TIERS.ENVIRONMENT,applies:function(a,b,c){return a.on("sfdetect")}});var Pb=function(){var a=m.asid,b=m.cookieBaseURL,c=m.protocol,d=function(a){f(a).each(function(a,b){l.getAggregator().trigger("notify",b)})},e=function(){var e;e=new R(c+"://"+b,!0);e.setParam("asid",a);e=e.toString();l.getAggregator().trigger("jsonp",e,d,!0);l.getAggregator().trigger("updateDtCount")};return{start:function(){l.getAggregator().on("sendCookie",e)},isApplicable:function(a){return a.on("cookie")&&a.bootstrapOn("sendCookie")&&
a.bootstrapperHas(["protocol","cookieBaseURL","asid"])}}},Qb=function(a,b,c,d,e,k,r){var n=function(a,b){return isNaN(a)||0>a||""===a?b:a};return{send:function(p){try{var q,s=d.baseUrl,t,v,w=k.getDocumentMode();"number"===typeof w?(v=2E3,8===w?v=4E3:8<w&&(v=8E3)):v=n(m.sp_imp_maxLength,2E3);t=v;v=s;var x,B;m.contextNode&&f.isFunction(m.contextNode.getAttribute)&&(x=m.contextNode.getAttribute("data-ias-check-tag"),B=m.contextNode.getAttribute("data-ias-check-done"));if(m.integration&&!b.bootstrapOn("fwMonitoring")&&
f.isDef(JSON)&&f.isFunction(JSON.parse)&&"true"===x&&"false"===B&&0<v.indexOf("skeleton.js")){var A=s.replace("skeleton.js",m.integration+".js"),H=m.contextNode.getAttribute("data-ias-parameters"),C;try{C=JSON.parse(H)}catch(F){C=H}var G=m.staticServer+m.integration+"a.js",s=A+"adContainerId="+C.adContainerId+"&true_pb="+encodeURIComponent(m.passback)+"&adsafe_pb="+encodeURIComponent(G)+"&"}x=s=s.replace(h.UNIQUE_ID_TOKEN,m.asid);var E=s.length,I,J,L=n(m.sp_imp_jsInfo_minLength,0);B="";try{I=t-E-
L,0<I&&(J=$d(p,I,14,b.on("partialUrls")),B+=J.join("&"))}catch(M){a.add(h.ERROR_CODES.IMPRESSION_URLS)}s=x+B;p=s+="&"===s.slice(-1)?"":"&";var P,E="";try{P=t-s.length,E+=ae(P,"adsafe_jsinfo=",a,b,c,e,k,r)}catch(R){a.add(h.ERROR_CODES.JSINFO),E+="adsafe_jsinfo=e:"+a.toString()}s=p+E;d.macroUrl&&(s+="&"===s.slice(-1)?"":"&",s+=d.macroUrl);q=s;d.sendImpression(q);m.impUrl=q;l.getAggregator().trigger("impressionsent")}catch(Q){__IntegralASDiagnosticCall("impsend",Q,m)}}}},ae=function(a,b,c,d,e,k,l,n){return function(c){var d=
