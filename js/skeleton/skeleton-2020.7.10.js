...
try {
	...
	var __IntegralASConfig = {
		...
		sp_cdnScripts: {xsca: "static.adsafeprotected.com/xsca.17.4.85.js", sca: "static.adsafeprotected.com/sca.17.4.114.js", main: "static.adsafeprotected.com/main.19.8.103.js"},
		protocol: 'https',
		jsref: "",
		asid: "4b5e225c-c2b9-11ea-93e6-0ad4d7b160f1",
...
__IntegralASConfig.initialize=function(m,w,M){function Va(){var h,a,b;m.perf.markStart(na);l.startSystem();A=l.getAggregator();A.provide({omidAdSessionContext:{}});A.provide({omidAdSessionVerificationParameters:{}});h=Wa();a=oa();b=(new Xa).createInstance(h,a);A.provide({mErrors:h,mJsonp:a,mComm:b});h=__IASOmidVerificationClient;A.provide({omidVerificationClient:h});A.once("callContinueMain",function(){var a,b;m.perf.markStart(pa);b=Y.instantiateModules();a=Y.preImpression(b.mDataTransfer,b.mViewability,
b.mAdTalk,b.iOutput,b.mErrors,b.mAncestorOrigins,b.mBrowser,b.mPageUrls,b.mFeatures,t,b.renderDetector);Y.sendImpression(b.mErrors,b.mFeatures,b.mIds,b.mMode,b.iOutput,b.mBrowser,b.mViewability,a,b.mVideo);Y.postImpression(b.mBrowser,b.mIds,b.mViewability,b.mFeatures,b.mComm,b.mDataTransfer,b.mErrors,b.iOutput,b.loopDelay,b.mAdTalk,b.viewabilityMeasurement,b.mAncestorOrigins,t);m.perf.markEnd(pa)});A.on("tryToCallContinueMain",function(a){m.isResolved?A.trigger("callContinueMain"):A.trigger("requestBootstrapper",
a)});A.once("requestBootstrapper",function(a){var b=m.forcedBootstrapperHost||"http://jsconfig.adsafeprotected.com";"string"===typeof a&&(a=JSON.parse(a));var e=a&&a.config,k=a&&a.sca,u=a&&a.xsca;e&&A.trigger("jsonp",b+"/jsconfig"+e+(m.adSessionId?"&adSessionId="+m.adSessionId:""),function(a){Object.assign(m,"string"===typeof a?JSON.parse(a):a);m.isResolved=!0;m.sp_cdnScripts={sca:k,xsca:u};A.trigger("callContinueMain")},!1,"cbName")});h=[{environment:new da(h),adSessionReadyStrategy:new Ya(h)},{environment:new Za,
adSessionReadyStrategy:new $a}];(new ab(h)).resolve().adSessionReadyStrategy.start();m.perf.markEnd(na)}var A,Y=function(){function h(a){var b=new bb(a,t),c=new cb,d=new db(a,t),p=eb(a,t),q=(new fb(m,t,a)).resolve(),h=[b],E=[];p.applies()&&h.push(p);d.applies()&&h.push(d);c.applies(a,t)&&h.push(c);f(q).each(function(a,b){h.push(new gb(b,t));E.push(b.id)});0<E.length&&(A.trigger("addOutputItem",{output:E.join(".")},"scm",{type:g.IMPRESSION_EVENT}),A.trigger("addOutputItem",{output:E},"metricIdList",
{type:g.DT_CODES.UNLOAD,asION:!0}));return h}function a(a,b,c,d){var p=h(a);A.provide("viewabilityDefinitions",p);return f(p).map(function(q,p){var h,f,l;h=new qa(p,b);var J=(new hb(c,a,p.rts)).getCallbacks(),x=new ra(d.createPingJobs(p.type,p.timeInViewThresholds,J,p.metricId));p.sendOtherwiseInViewSignal&&(l=new qa(p,b,p.sendOtherwiseInViewSignal),f=new ra(d.createPingJobs(p.type,p.timeInViewThresholds,J,p.metricId,p.sendOtherwiseInViewSignal)));p.rtsCallbacks=J;p.thresholdType===g.GROUPM_MOBILE_PASS_THRU_TIME_IN_VIEW_THRESHOLD_TYPE?
h=new ib(h,p,x,t.isVideo()):(h=new sa(h,new Z(p.minUnit),x),p.sendOtherwiseInViewSignal&&(f=new sa(l,new Z(p.minUnit),f,p.sendOtherwiseInViewSignal),f.start()));h.start();return h})}function b(a,b){var c=(new ea).accepts(),c=!t.isAvid()&&!c&&!t.isInMobiMraidVideo();return t.isVideo()&&c?jb(m.videoId,a,b):{}}function c(a,b,c,d,p,q,h,E,B,z){try{m.perf.markStart(ta),m.tpiLookupURL&&kb(h,E).init(m.tpiLookupURL),t.isDomless()||z.isStarted()&&z.sendOriginList(),l.runAll(),r.execAtEndOfThread(function(){var q;
try{m.perf.markStart(ua);q={output:(new Date).getTime()-p};a.addItem(q,"sinceFw",{type:g.DT_CODES.ADTALK});f.isDef(b.loopStarted())&&a.addItem({output:b.loopStarted()},"readyFired",{type:g.DT_CODES.ADTALK});m.perf.markEnd(ua);var h,v;m.isSplitMode&&(v=m.protocol+"://"+m.sp_cdnScripts.main,m.perf.markResource(lb,v));m.impUrl&&m.perf.markResource(mb,m.impUrl);h=m.perf.getData();A.trigger("addThrottledProp",g.DT_SLOT.IM,"prf",f(h).toION());c.isApplicable(t)&&c.sendAdTalkCall()}catch(E){d.add(g.ERROR_CODES.ADTALK_DELAY)}}),
m.perf.markEnd(ta)}catch(J){d.add(g.ERROR_CODES.EVENT_LOOP_ONE)}}function d(a,b,d,n,p,q,h,f,g){var l;"true"!==m.minimizeCalls&&(l=(new Date).getTime(),r.execAtEndOfThread(function(){c(a,b,d,n,l,p,q,h,f,g)}))}return{instantiateModules:function(){var c,d,u,n,p,q,h,f,g={};m.perf.markStart(va);A=l.getAggregator();g.mFeatures=A.provide("features",nb());A.provide("mobileApp",function(){return c=c||new ob(g.mFeatures)});A.provide("avidJsClient",function(){return d=d||new pb(r.getWindow())});A.provide("context",
t);g.mBrowser=A.provide("browser",(new qb).createInstance());g.mErrors=A.request("mErrors");g.mIds=A.provide("ids",rb());g.iOutput=new sb(A);A.request("mJsonp");g.mComm=A.request("mComm");g.viewabilityMeasurement=(new tb(new ub(g.mIds),g.mFeatures,g.mBrowser)).create();if((n=A.request("omidAdSessionContext"))&&n.queuedOutputItems)for(q=0;q<n.queuedOutputItems.length;q++)A.trigger("addOutputItem",{output:n.queuedOutputItems[q].value},n.queuedOutputItems[q].code,{type:"impression"});g.mFeatures.on("swapids")&&
(m.oid=m.asid,m.asid=g.mIds.unq);g.mAdTalk=(new vb).createInstance(g.mFeatures);u=wb();n=xb(A);p=A.provide("mPage",(new yb).createInstance());g.mAncestorOrigins=zb();g.mPageUrls=A.provide("pageUrls",(new Ab).createInstance(g.mAncestorOrigins,r));q=A.provide("mScreenEvents",Bb());A.provide("ieXDomainViewability",Cb(g.mBrowser));h=Db(g.mBrowser);f=b(g.mFeatures,q);g.mVideo=A.provide("video",f);Eb(Fb.build());h=(new Gb).createInstance(g.mErrors,h,g.mFeatures);p=(new Hb).createInstance(h,g.mErrors,p,
t);f=A.provide("jobFactory",Ib());g.mDataTransfer=Jb(h,g.mErrors,g.mFeatures,g.mIds,g.iOutput,g.mBrowser,q,u);u=Kb(g.mErrors,g.mFeatures,A,n);g.mMode=Lb(u,g.mFeatures,g.viewabilityMeasurement.isImmediate());g.mViewability=A.provide("viewability",Mb(new G,g.viewabilityMeasurement,g.mBrowser,g.mDataTransfer,g.mFeatures,A,g.iOutput,p,q,g.mVideo));a(g.mFeatures,g.mViewability,n,f);g.loopDelay=wa();g.renderDetector=Nb();g.mDataTransfer.setViewabilityMod(g.mViewability);m.perf.markEnd(va);return g},preImpression:function(a,
b,c,d,p,q,h,f,B,l,J){var x,D,r,C,I;m.perf.markStart(xa);m.b11="1"===m.adHeight&&"1"===m.adWidth?"true":"false";m.cnod=m.contextNode?"true":"false";try{c.isApplicable(l)&&(c.start(),d.addItem(c.getFrameMap(),"fm"),B.on("fm2")&&d.addItem(c.getFrameMapIncludingPeerCase(),"fm2"),B.on("idMap")&&(x=c.getIdMap())&&d.addItem(x,"idMap"))}catch(t){p.add(g.ERROR_CODES.ADTALK_GENERAL)}try{q.isApplicable(h,B,l)&&q.start(),I=f.detectTopURL(),B.on("exch")&&(D=(new Ob).createInstance(p,d),D.parse(I)),r=Pb(),r.isApplicable(B)&&
r.start(B),l.usesGroupMCustomMetric()&&Qb(),C=Rb(),C.isApplicable(B)&&(C.start(),A.trigger("sendCookie")),J.start()}catch(s){p.add(g.ERROR_CODES.IMPRESSION_LEADUP)}m.perf.markEnd(xa);return I},sendImpression:function(a,b,c,d,p,q,h,g,l){try{Sb(a,b,c,d,p,q,h).send(g),f.isFunction(l.triggerInitializationEvents)&&l.triggerInitializationEvents()}catch(z){__IntegralASDiagnosticCall("impsend",z,m)}},postImpression:function(a,b,c,n,p,q,h,f,B,z,J,x,D){try{m.perf.markStart(ya);var r=Tb();r.start();r.addFieldTypes([g.DT_SLOT.IM,
g.DT_SLOT.FF,g.DT_SLOT.ENVIRONMENT,g.DT_SLOT.FF_EXP]);var C=Ub(a,b,c);C.isApplicable(n)&&C.start();var t;n.bootstrapOn("getTpl")&&n.on("usetpl")&&(t=Vb(p,q,h,b,f),t.init());d(f,B,z,h,n,p,q,b,x);J&&J.start&&J.start();D.isDomless()||Wb().start(["sca","xsca","rsrch"],n);Xb();l.runTier(g.TIERS.VIEWABILITY);var F=Yb();F.isApplicable(n)&&(F.start(),T.recordBlockingTime(),m.perf.mark(Zb),T.setupOnLoadTracking(),T.setupBrowserDelayTracking());m.perf.markEnd(ya)}catch(s){h.add(g.ERROR_CODES.POST_IMPRESSION)}}}}(),
...
c:!1},u=function(a,b){var c;try{c=a.document}catch(d){c=m.contextNode.ownerDocument}return V(c,b,e)},n=function(a){var b=[],e=(a=a&&a.getElementsByTagName&&a.getElementsByTagName("*"))&&a.length,k,u;if(a)for(var p=0;p<e;p++)u=(k=a[p])&&k.nodeName&&k.nodeName.toUpperCase(),!k.children||0!==k.children.length||f(d).contains(u)||f(c).contains(u)||f(b).contains(u)||b.push(u);return d.concat(b)},p=function(c){var d;h=h||m.contextNode.parentNode;if(c)if(s.isNodeXDomainIframe(c))d=c;else if(k(c))d=c;else{h=
c;d=p;var f;if((m.useFIF&&t.friendlyIframe||t.isSpecifiedAd())&&3>b)a:{var B=c,z,J,x,D,R=s.getNodeName(B);c=r.getTop()&&r.getTop().document;try{x=n(B);if(c&&B===c.body){f=null;break a}s.isWindow(B)?(z=u(B,x),z||(D="["+g.AD_IDENTIFIER+"-"+m.asid+"]",J=s.crossQuerySelector(D),a=J.parentNode,z=V(a,x,e))):("IFRAME"===R?B=B.contentWindow.document:a=B,x=n(B),z=V(B,x,e));void 0===z&&a&&a.parentNode&&(a=z=a.parentNode,b+=1)}catch(C){l.getAggregator().trigger("renderdiag",C)}f=z}else{f=c;z=s.getNodeName(f);
try{R=n(f),s.isWindow(f)?B=u(f,R):("IFRAME"===z&&(f=f.contentWindow.document,R=n(f)),B=V(f,R,e))}catch(I){l.getAggregator().trigger("renderdiag",I)}f=B}d=d(f)}else d=null;return d};return{find:p,getClosestContainerName:function(){return s.getNodeName(h)}}},Nb=function(){var h,a,b=!1,c={status:g.RENDER.STATUS.OTHER,details:g.RENDER.DETAILS.OTHER},d={status:g.RENDER.STATUS.DETECTED,details:g.RENDER.DETAILS.ENVIRONMENT},e=l.getAggregator().request("omidAdSessionContext"),k=function(){b=!0},u=function(a){a&&
(a.status=g.RENDER.STATUS.DETECTED);l.getAggregator().trigger("adRendered")},n=function(){var a=!1;t.isOmid()&&e&&e.useOMID13Logic&&(a=!0);return a},p=function(a){var b={},c=r.getDoc(),d=function(e){var k=e&&e.type;if("readystatechange"===k&&"complete"===e.target.readyState||"load"===k)u(b),h.saveNode(a),"readystatechange"===k?h.save(g.RENDER.DIAGNOSTIC.DOCUMENT_READY):"load"===k&&h.save(g.RENDER.DIAGNOSTIC.LOAD_FIRED),E(b),y.removeEvent(a,"load",d),y.removeEvent(c,"readystatechange",d)};"complete"===
c.readyState?(u(b),h.saveNode(a),h.save(g.RENDER.DIAGNOSTIC.DOCUMENT_READY)):(y.addEvent(a,"load",d),y.addEvent(c,"readystatechange",d));return b},q=function(){var a=r.getWindow().mraid,b=a&&a.getState&&a.getState(),d=function(){y.removeEvent(a,"ready",d);h.save(g.RENDER.DETAILS.ENVIRONMENT);h.save(g.RENDER.DIAGNOSTIC.MRAID_READY);u();E({status:g.RENDER.STATUS.DETECTED})};h.save(g.RENDER.DETAILS.ENVIRONMENT);"default"===b?(u(),h.save(g.RENDER.DIAGNOSTIC.MRAID_DEFAULT),c.status=g.RENDER.STATUS.DETECTED):
...
'"></iframe>'],img:['<img src="','"/>']}[a];d=d[0]+b+d[1];t.isOmid()?(e=new lc,e.isApplicable(b)?e.deployBlockingScriptIntoIframe(b):c(a,b,d)):"true"===m.forceAppend?c(a,b,d):M.write(d)},c=function(a,b,c){var d=!c&&y.getXHR2();d?(d.open("POST",a),d.onreadystatechange=function(){4===d.readyState&&200===d.status&&b&&b()},d.send()):(c=s.createImage(),b&&(c.onload=b),c.src=a)},d=function(a,b,c,d){var e=M.createElement("script");c=c||m.contextNode.parentNode;e.type="text/javascript";e.src=a;b&&(e.onload=
...
w=r.now();l.getAggregator().trigger("preSendDt",a);s||(L.path("dt"),b.on("usedtdomain")&&L.sub("dt"));B(L,a,e);v&&v.field&&L.setParam(v.field,v.value);h||z(L,a);l.getAggregator().trigger("send",L,function(){p+=1;n=r.now()-w;f.isFunction(E)&&E()},u);a===g.DT_CODES.UNLOAD&&(q=!0);d.cleanup()}catch(y){__IntegralASDiagnosticCall("dt-"+a,y),l.getAggregator().trigger("error",g.ERROR_CODES.PHONE_HOME)}};h=function(){q||v(g.DT_CODES.UNLOAD,-1,!0)};var E=function(a,c){var d={bapi:"a",bapiClient:"b",jload:"c",
jss:"d",jsi:"e"},e=m.mode,d=d[a]||d[e];b.on(c||e+"Diag")&&d&&v(g.DT_CODES.DIAGNOSTIC,-5,!0,!0,{field:"bkp",value:d})},B=function(a,b,e){var k=new ba(b);e=f.isDef(e)?e:k.enumerator;a.setParam("asId",m.asid);e={c:c.getCacheBustId(),pingTime:e,time:t.getTagTime(),type:b};d.filterOutput(function(a){var c=a.minDt&&(!a.type||a.type===b);c&&a.oneTime&&(a.flagForRemoval=!0);return c},e);a.setParam("tv",e)},z=function(c,h){var f,q={};d.filterOutput(function(a){return a.standalone&&!a.minDt&&a.type===h},function(a,
...
diagnostic:E,setViewabilityMod:function(a){}}},H=function(h){var a={},b=!1,c=function(){var a=1===h.nodeType?s.nodeIsHidden(h):0===h.width||0===h.height;return b?!1:a},d=function(){var b={};f(a).each(function(a,c){b[a]=r.round(c)});return b},e=function(a){return f.isNumeric(a)||f.isUndef(a)},k=function(){return r.round(a.width)*r.round(a.height)};(function(){var b;h!==w.parent&&(1!==h.nodeType?a=h:f.isDef(h.getBoundingClientRect)&&(b=s.getRect(h),f(a).mixin({x:f.useIfDef(b.x)||b.scrX,y:f.useIfDef(b.y)||
...
g.MRC_LARGE_AD_SIZE},isOneByOne:function(){return c()&&1>=k()}}},s={findElementsWithSize:function(h){var a=[],b=function(c){1>s.getNodeArea(c)?f(c.children).each(function(a,c){b(c)}):a.push(c)};b(h);return a},nodeIsHidden:function(h){var a=this.getRect(h),b=0!==parseInt(y.getStyle(h,"width"))&&0===a.width,a=0===a.width||0===a.height;h="hidden"===y.getStyle(h,"visibility");return b||a||h},calcWinDims:function(){var h,a,b;try{a=s.browserWindowPosition(),b=s.windowSize(),h={scrX:r.round(a.scrX),scrY:r.round(a.scrY),
...
return e},calcPercentInView:function(a,b,c,d){var e=0,k=a;a.hasValidDims()&&!a.isHidden()&&(f([b,c,d]).each(function(a,b){if(b.hasValidDims()){var c=k.getRounded(),d=b.getRounded(),e=Math.max(c.scrX,d.scrX),f=Math.max(c.scrY,d.scrY),g=Math.min(c.scrX+c.width,d.scrX+d.width),c=Math.min(c.scrY+c.height,d.scrY+d.height),g=g-e,c=c-f;k=H({scrX:e,scrY:f,width:0<g?g:0,height:0<c?c:0})}}),e=r.round(k.area()/a.area()*100));return e}}},rb=function(){var a,b=!1,c;a=function(a){var b=[];b.push(a.slice(0,8));
...
n=d(a,e);l.getAggregator().trigger("send",n,f.noop,!0)}catch(B){__IntegralASDiagnosticCall("fwjsvidimp",B,m)}})}},jspix:{nodeType:"img"}};return new function(){var a=function(a){var b=-1===a.indexOf("?")?"?":"&";return a+b},b=e[m.mode],d=!!b.isFW,f=function(a){var b;b=l.getAggregator().request("mobileApp").isMobileAppEnvironment()&&m.mobFwUrl?m.mobFwUrl:a?m.adsafeSrc:m.requrl;a||(b+="?"+m.reqquery);return b}(d),q=f.indexOf("BEGIN__ADSAFE"),g=-1!==q,E=g?f.slice(q):"",a=g?f.slice(0,q):a(f);return{isFW:d,
...
getMaxNumber:function(){return Number.MAX_VALUE},getTop:function(){t.isDomless();return top},getDoc:function(){t.isDomless();return M},getIntersectionObserver:function(a,b){t.isDomless();return new IntersectionObserver(a,b)},pow:function(a,b){return Math.pow(a,b)}},yb=function(){return{createInstance:function(){return t.isDomless()?new pc:new qc}}},qc=function(){var a,b=!1,c=!1,d=l.getAggregator().request("features"),e=new fa,k=function(){var b;d.on("blur")?(b=r.getWindow(),b=t.friendly&&b.top.document&&
(f.isFunction(b.top.document.hasFocus)||f(b.top.document.hasFocus).isObj())&&!b.top.document.hasFocus()||(f.isDef(a.prop)?r.getDoc()[a.prop]:null)):b=f.isDef(a.prop)?r.getDoc()[a.prop]:null;return b},u=function(){var b=r.getWindow(),c=function(){e.run(k())};y.addEvent(b,"focus",c,!0);y.addEvent(b,"blur",c,!0);a.event&&y.addEvent(r.getDoc(),a.event,c,!0)};a=function(){var a="hidden",c="visibilitychange",d=r.getDoc();f.isUndef(d.hidden)?f(["moz","ms","webkit"]).each(function(e,k){var u=k+"Hidden";f.isDef(d[u])&&
(a=u,c=k+c,b=!0)}):b=!0;return b?{prop:a,event:c}:{}}();return{isHidden:k,onHiddenChange:function(a){e.push(a);c||(c=!0,u())},supportsVisAPI:function(){return b}}},pc=function(){return{isHidden:function(){return!1},onHiddenChange:function(a){},supportsVisAPI:function(){return!0}}},Ab=function(){return{createInstance:function(a,b){return t.isDomless()?new rc:new sc(a,b)}}},sc=function(a,b){var c,d=function(a){for(var b in a)if(a.hasOwnProperty(b)){var c=a[b];(""===c||"null"===c||"undefined"===c||null===
c||f.isUndef(c))&&delete a[b]}return a},e=function(a){var b={},c,d;for(d in a)a.hasOwnProperty(d)&&(c=a[d],f.isUndef(b[c])?b[c]=d:b[c]+=d);a={};for(d in b)b.hasOwnProperty(d)&&(c=b[d],a[c]=d);return a},k=function(){var k,n=function(){var a={};try{a.q=b.getWindow().parent.parent.parent.parent.parent.parent.parent.parent.parent.parent.location.href}catch(c){var d=c.message,d=d.substring(d.lastIndexOf("<")+1,d.lastIndexOf(">")),e;if(e=f.isDef(d)){var k=b.getWindow();e=!1;f.isDef(k.navigator)&&f.isDef(k.navigator.userAgent)&&
(k=k.navigator.userAgent.match(/Firefox\/([\.0-9]+)/),null!==k&&2==k.length&&(k=k[1].split("."),3==parseInt(k[0],10)&&6>=parseInt(k[1],10)&&(3==k.length?13>=parseInt(k[2],10)&&(e=!0):e=!0)))}e&&(a.g=d)}return a},p={};try{p.a=encodeURIComponent(top.location.href)}catch(q){}try{p.b=encodeURIComponent(parent.location.href)}catch(g){}if(t.embedded){try{p.c=encodeURIComponent(parent.document.referrer)}catch(l){}try{p.e=encodeURIComponent(w.document.referrer)}catch(B){}}try{"jsi"!==m.mode&&(p.d=encodeURIComponent(w.location.href))}catch(r){}try{p.f=
encodeURIComponent(m.jsref)}catch(J){}try{k=n(),p.g=encodeURIComponent(k.g||""),p.q=encodeURIComponent(k.q||""),a.isStarted()&&!k.g&&1<a.getMyFrameDepth()&&(p.g=encodeURIComponent(a.getTopDomain()))}catch(x){}p=d(p);p=e(p);k=[];for(var D in p)p.hasOwnProperty(D)&&k.push({key:D,val:p[D]});k.sort(function(a,b){return a.val.length>b.val.length?1:a.val.length<b.val.length?-1:0});return c=k};return{detectTopURL:k,getDetectedURLs:function(){return c?c:k()}}},rc=function(){return{detectTopURL:function(){return[]},
...
c,d=!1,e=function(a){var e=!0;d&&(d=!1,a.stopPropagation?(a.stopPropagation(),a.preventDefault()):a.cancelBubble=!0,b=a.screenX-a.clientX,c=a.screenY-a.clientY,e=!1);return e};a.browserIs(g.BROWSERS.IE)&&y.addEvent(r.getDoc().documentElement,"click",e,!0);return{determineFramePosition:function(){a.browserIs(g.BROWSERS.IE)&&(d=!0,r.getDoc().documentElement.click());return{scrX:b,scrY:c}}}},Hc=function(a,b){var c,d=g.NA,e=d,k=!1,u=!1,n=!1,p=!b,q=function(){var b=r.getIntersectionObserver(function(a){a=
...
k=!0},v=function(b){if(!f.isUndef(b)){if(n){b=a.document;var c=b.createElement("div");f(c.style).mixin({position:"absolute",width:"100%",opacity:"0",height:"100%",zIndex:-999,top:"0px",left:"0px"});c[g.IAS_DETECTOR]=!0;b.body.appendChild(c);b=c}return b}};return{getPiv:function(){return d},start:function(){var b;try{a.document&&(n=!0,b={bodyElement:a.document.body,document:a.document})}catch(c){u=!0}b&&null!==b.bodyElement?q():b&&b.document?y.whenReady(q,b.document):u?l.getAggregator().request("errors").add(g.ERROR_CODES.BUSTED_IFRAME_IN_IO):
q()},isStarted:function(){return k},getAdNodeDimensions:function(){var a;c&&(a=H({scrX:void 0,scrY:void 0,width:c.width,height:c.height}));return a},isReady:function(){return d!==g.NA}}},wa=function(){var a=!1;(function(){y.whenReady(function(){l.getAggregator().trigger("startViewabilityLoop");a=!0})})();return{loopStarted:function(){return a}}};l("loopDelay",[],wa,{applies:function(a,b,c){return a.bootstrapOn("allowViewability")},tier:g.TIERS.VIEWABILITY});var Ic=function(){return{start:function(a){l.getAggregator().on("measurable",
...
v()):(b=!0,E())}},z=function(a){k.mediaType=a.data.mediaType;k.queuedOutputItems.push({code:"omtp",value:k.mediaType});"video"===a.data.mediaType&&(k.isVideo=!0);a.data.viewport&&a.data.adView&&(k.impressionViewabilityMeasurement={data:{viewport:a.data.viewport,adView:a.data.adView}},k.geometryArrived||(k.geometryArrived=g.checkForViewAttachmentBasedOnAdSessionType(k,a.data.adView)));a.data.hasOwnProperty("impressionType")&&!k.hasOwnProperty("impressionType")&&(k.impressionType=a.data.impressionType);
k.isNativeVideo=k.isNative&&"video"===a.data.mediaType;k.isDisplay="display"===a.data.mediaType;c=!0;E()},s=function(a){"loaded"===a.type&&(d=!0,a.data.hasOwnProperty("creativeType")&&(k.creativeType=a.data.creativeType),a.data.hasOwnProperty("impressionType")&&(k.impressionType=a.data.impressionType));E()},x=function(a){a&&"start"===a.type&&(k.videoStartArrived=!0)};return{start:function(){q.registerSessionObserver(B,"IAS");q.addEventListener("impression",z);try{q.addEventListener("media",s)}catch(a){}try{q.addEventListener("video",
...
((0<b?",{":"{")+("t:"+d.t+",")+("tp:"+d.tp+",")+("sl:"+d.sl+",")+("ad_duration:"+d.ad_duration+",")+("volume:"+d.volume)+"}");return a+"]}"}},q=function(){u=!0},v=function(a){try{var p="",q=a.hasOwnProperty("timestamp")?a.timestamp:(new Date).getTime(),n="n",v=!1;switch(a.type){case "start":p="adVideoStart";d=q;k=a.data.duration;1E3<k&&(k/=1E3);e=a.data.videoPlayerVolume;break;case "volumeChange":p="volumeChanged";e=a.data.videoPlayerVolume;break;case "firstQuartile":case "midpoint":case "thirdQuartile":case "complete":p=
"adVideo"+a.type.substring(0,1).toUpperCase()+a.type.substring(1);v=!0;l.getAggregator().trigger("videoQuartileEvent",a);break;case "pause":case "bufferStart":p="pauseAd";break;case "resume":case "bufferFinish":p="resumeAd";break;case "skipped":p="adSkipped"}if(""!==p){var m=l.getAggregator().request("mScreenEvents");m&&(n=m.getCurrentLoc());c.push({t:q-d,tp:p,sl:n,ad_duration:k,volume:e})}if("loaded"===a.type&&f.isDef(a.data)){var r=["preroll","midroll","postroll","standalone"].indexOf(a.data.position),
p=-1!==r?r+1:void 0,t=!0===a.data.autoPlay?"autoplayed":"clicktoplay";!0===u?(f.isDef(p)&&l.getAggregator().trigger("addThrottledProp",g.DT_SLOT.ENVIRONMENT,"vbp",p),l.getAggregator().trigger("addThrottledProp",g.DT_SLOT.ENVIRONMENT,"vps",t)):(f.isDef(p)&&l.getAggregator().trigger("addOutputItem",{output:p},"vbp",{type:g.IMPRESSION_EVENT}),l.getAggregator().trigger("addOutputItem",{output:t},"vps",{type:g.IMPRESSION_EVENT}))}"start"===a.type&&l.getAggregator().trigger("omidAdDuration",{ad_duration:k});
var s;"playerStateChange"===a.type?s="fullscreen"===a.data.state?"AdEnteredFullscreen":"AdExitedFullscreen":-1!=="start|firstQuartile|midpoint|thirdQuartile|resume|bufferFinish".indexOf(a.type)?s="AdPlaying":-1!=="complete|pause|bufferStart|skipped".indexOf(a.type)&&(s="AdPaused");f.isDef(s)&&b.trigger("videoPlaybackEvent",{eventType:s,eventData:null});v&&l.getAggregator().trigger("sendDt",g.DT_CODES.VIDEO_EVENTS)}catch(F){__IntegralASDiagnosticCall("omidvideo",F,w.bootstrapper)}};return{start:function(){l.getAggregator().on("impressionsent",
...
obstructed:g.NA,isHidden:g.NA,tabHidden:g.NA,posViewState:g.NA,adCompCount:1},e=function(a){return a?new H({scrX:a.x,scrY:a.y,width:a.width,height:a.height}):H({scrX:0,scrY:0,width:0,height:0})},k=function(a){c={winDimensions:e(a.windowDimensions),adDimensions:e(a.adDimensions),containerDimensions:e(a.containerDimensions),method:a.detectionMethod||g.NA,viewState:a.viewState||g.NA,percentInView:f.isDef(a.percentageInView)?a.percentageInView:g.PIV_NA,reason:a.outOfViewReason||"",obstructed:f.stringifyTriState(a.isObstructed),
...
return{calculateGeometricMeasurement:function(e,q){if(f.isDef(e)&&f.isDef(q)){var v=e.viewport,l=e.computedAdContainer,m=l.obstructions,t=m&&0<m.length,s=e.originalAdContainer,x=q.adGeometry,D=q.adFound,R=e.detectionMethod,C=0,v={x:0,y:0,width:v.width,height:v.height},I=u(s,x),F=e.outOfViewReason,w=0,L=0,y=t||!1,w=1>=x.width*x.height;c&&w&&(D=!1,F=F||"",D||-1!==F.indexOf(g.OUT_OF_VIEW_REASONS.GEOM)||(F=g.OUT_OF_VIEW_REASONS.GEOM+(""!==F?"."+F:"")));if(D&&0<e.percentageInView){w=d(v,l,I);t?(C=n(l,
I),C=k(v,l,C),C=u(l,C),C=a.calculateObstructedArea(C,m)):C=0;L=C;C=Math.round((w-L)/(I.width*I.height)*100);t&&0===L&&(y=!1);for(var x=(new H(I)).getRoundedGeometry(),D=y,A,t=0,L=b.getConfig(x).numberOfSlices,P=r.floor(x.height/L)||1,m=[],w=D?a.getObstructionStatusBySlice(L):[],W,t=0;t<L;t++)A=x.y+P*t,t==L-1&&(P=x.y+x.height-A),A={x:x.x,y:A,width:x.width,height:P},W=d(v,l,A),A=1==W/(A.width*A.height),m.push(A);if(D)for(l=r.min(w.length,L),t=0;t<l;t++)m[t]=m[t]&&!w[t];l=m}else l=b.getConfig(x).defaultSliceArray;
return{windowDimensions:v,containerDimensions:s,adDimensions:I,percentageInView:C,viewState:50<=C?g.IN_VIEW:g.OUT_OF_VIEW,outOfViewReason:50<=C?"":F||g.OUT_OF_VIEW_REASONS.GEOM,detectionMethod:R,isObstructed:y,sliceStatus:l}}}}},$c=function(){return{accepts:function(){return t.isAvidNative()}}},bd=function(a,b){var c=function(a){var c=a.eventData.originalAdContainer;a=!!c;c=(new H({x:0,y:0,width:a?c.width:0,height:a?c.height:0})).getRoundedGeometry();b.trigger("avidNativeGeometryChanged",{adGeometry:c,
...
l.matrix[k][m]&&(l.matrix[k][m]=1,l.obscuredPixelCount+=1);k=l}l=k.obscuredPixelCount;q=k;if(f.isUndef(q.matrix)||0===q.matrix.length)c=[];else{g=0;p=!1;k=q.matrix[0].length;n=q.matrix.length;p=a.getConfig({height:k}).numberOfSlices;for(var m=r.floor(k/p)||1,t=[],s=0;s<k;s++){p=!1;for(var J=0;J<n;J++)if(1===q.matrix[J][s]){p=!0;break}g++;p&&(s+=m-g,g=m);if(g==m||s===k-1)t.push(p),g=0}c=t}}else c=b;return l},getObstructionStatusBySlice:function(){return c}}},Yc=function(a,b){var c=l.getAggregator().request("omidAdSessionContext"),
...
r.getDoc().getElementById("iasbi"+m.asid);a&&a.hasAttribute("CreativeLoaded")?(e=c.delayingViewabilityEvents=!1,d&&(n(d),d=null)):r.setTimeout(u,50)},n=function(a){if(a&&a.data&&a.data.adView)if(c.delayingViewabilityEvents)d=a,e||(e=!0,u());else{var n=a.data.adView.geometry,l=a.data.adView.containerGeometry,m=!!n,r=a.data.adView.measuringElement&&!!l,n=(new H({x:m&&r?n.x-l.x:0,y:m&&r?n.y-l.y:0,width:m?n.width:0,height:m?n.height:0})).getRoundedGeometry();c.geometryArrived||(c.geometryArrived=f.checkForViewAttachmentBasedOnAdSessionType(c,
...
l.viewState=g.IN_VIEW:(l.viewState=g.OUT_OF_VIEW,l.outOfViewReason=a.outOfViewReason||g.OUT_OF_VIEW_REASONS.VIDEO);n=l;d.trigger("videoGeometryMeasurementChanged",n)}},s=function(a){p=a;t()},J=function(a){q=a;t()},x=function(a){m=a;a=a.eventType;"AdEnteredFullscreen"===a?u=!0:"AdExitedFullscreen"===a?u=!1:-1!=="AdStarted|AdVideoStart|AdPlaying".indexOf(a)?k=!0:-1!=="AdSkipped|AdUserClose|AdPaused|AdVideoComplete|AdStopped|AdError".indexOf(a)&&(k=!1);t()};return{start:function(){l.getAggregator().trigger("addOutputItem",
{output:g.MEDIA_TYPE.VIDEO_CODE},g.MEDIA_TYPE_CODE,{type:g.IMPRESSION_EVENT});a.addAdContainerGeometryMeasurementChangedListener(s);a.start();b.addAdGeometryMeasurementChangedListener(J);b.start();c.addVideoPlaybackEventListener(x);c.start()},getStrategyName:function(){return g.MEASUREMENT_STRATEGY.VIDEO},addMeasurementChangedListener:function(a){d.on("videoGeometryMeasurementChanged",a)},isMeasurable:function(){return r}}},La=function(a,b,c){var d,e=function(){var b=a.find(),e,n,p=!1;f.isDef(b)?
...
d)}catch(k){}},e=function(){var b=a.mraid;return f(b).isObj()&&f.isFunction(b.isViewable)},k=function(){var b=a.mraid;d();b.addEventListener("viewableChange",d)},u=function(){var b=a.mraid;e()&&(c=!0,"loading"===b.getState()?b.addEventListener("ready",function(){k()}):k())},n=function(){c||u()};return{start:function(){var b=!0;if(f.isDef(a.mraid)||s.containsScriptTagWithSrc("mraid.js"))b=!1;l.getAggregator().trigger("addOutputItem",{output:f.stringifyTriState(b)},"mi",{type:"impression"});b?l.getAggregator().trigger("exec",
"mraid.js",n):u()},addScreenLocationChangedListener:function(a){b.on("mraidScreenLocationChanged",a)}}},hb=function(a,b,c){var d={},e=function(c){var d=f.noop;b.bootstrapOn("useViewabilityNotification")&&(d=function(){a.skipAsFraudulent()||l.getAggregator().trigger("notify",c)});return d};(function(){c&&f(c).map(function(a,b){d[a]=e(b)})})();return{getCallbacks:function(){return d}}},cb=function(){var a=new Q({tiv:[1E4]}),b=f([g.IN_VIEW,g.PARTIAL_VIEW_PLUS]);return{timeInViewThresholds:a,type:g.DT_CODES.FULLY_INVIEW,
...
s("slcVt",n);d&&(f(a.sliceStatus).each(function(a,b){r(b,m,v,x)&&t?k[a].mark():k[a].stop();p[a]=k[a].getTotalTime()}),s("slcVtVol",p));q=d&&b&&b.shouldIncludeSound?p:n;a=f(q).findFirst(function(a,b){l=Math.max(l,b);return 0>=b});f.isUndef(a)&&c.doEligibleJobs(l)},s=function(a,b){var c={};c[a]=b;l.getAggregator().trigger("addOutputItem",{output:c},{minDt:!1})},J=function(a){!e&&a.sliceStatus&&(e=[],k=[],n=[],p=[],f(a.sliceStatus).each(function(a){e.push(new Z(1));n.push(0);d&&(k.push(new Z(1)),p.push(0))}))},
x=function(a){f.isUndef(a.sliceStatus)||(e||J(a),t(a))};return{start:function(){g=d?r:m;a.addMeasurementChangedListener(x)}}},qa=function(a,b,c){return{isInView:a.isInView,isInViewIgnoringRender:a.isInViewIgnoringRender,addMeasurementChangedListener:function(a){b.addMeasurementChangedListener(a,c)}}},Mb=function(a,b,c,d,e,f,l,n,p,q){var m=!1,s=t.isVideo(),B=f.request("mobileApp"),z=aa().applies(c,e),J=c.browserIs(g.BROWSERS.GECKO)||c.browserIs(g.BROWSERS.IE)&&e.on("rattie")||z,x=t.xDomainIframe&&
!J,D=new Ca(10),w=function(){e.on("viewabilityready")&&!m&&(d.send(g.DT_CODES.VIEWABILITY_READY),f.trigger("measurable"),m=!0)};f.on("delayedViewabilityReady",function(){C();w()});f.on("delayedViewabilityReadyCallOnly",w);var C=function(c){c=c||!1;try{D.start();var d,e;b.hasMeasurementStrategy()?e=B.isMobileAppEnvironment()&&b.supportsAdContainerGeometry()?b.getScreenLocationInfo({},c):b.getScreenLocationInfo(n.collect(),c):(e=n.collect(),B.isMobileAppEnvironment()?(e.viewState=g.NA,e.method=g.NA,
...
b,d){c=d.usesZeroPivCustomMetric();var e=aa();return b.on("viewabilityOptimization")&&e.applies(a,b,d)&&d.isDeviceTypeGroupMobile()},start:function(a){b=a;b.start(!0);l.getAggregator().on("IOPivChange",e)}}},td=function(a,b,c,d,e,k){var u,n,p,q,v,E,B,z,J,x=s.getElementsWindow(b);s.getElementsDocument(b);l.getAggregator().provide("iframeCalculatorHelper",md(x));var D=nd(b,d),R=g.AD_IDENTIFIER+"-"+m.asid,C=!1,I=H({}),F=t.isDeviceTypeGroupMobile(),A=t.usesGroupMCustomMetricMobilePassThru(),L,$=function(){if(!u)if(u=
D.calcDims(b,d,p),c===g.DETECTION_METHODS.VIDEO&&t.embedded){var a=u,e=(new H(b)).getRounded();try{a.set("width",e.width),a.set("height",e.height)}catch(f){l.getAggregator().trigger("error",g.ERROR_CODES.VIDEO_IN_IFRAME_DIMS_CALC)}}else c===g.DETECTION_METHODS.AD_PLACEHOLDER&&u.treatAsPlaceholder();return u},G=function(){var b,d=t.xDomainIframe&&C;b=F&&C&&p.isReady();b=d||b;d=D.getClippedDims&&(c===g.DETECTION_METHODS.VIDEO&&t.embedded||t.isCeltra());b?n=p.getPiv():f.isUndef(n)&&(b=!F&&(t.friendly||
f.isDef(w.mozInnerScreenX))&&e.on("offscreen"),z=$(),B=new H(s.calcWinDims()),E=new H(b?s.calcMonDims():{}),J=d?D.getClippedDims():I,n=a.calcPercentInView(z,B,E,J));return n},P=function(){return a.calcInitialViewState(G())},W=function(){return b===w?!1:$().isHidden()},K=function(a,b){return t.isVideo()?r.getDoc().body:a.document&&a.document.body?a.document.body:b.contentDocument&&b.contentDocument.body?b.contentDocument.body:b};(function(){var c=r.getWindow(),e=r.getDoc(),f=b===c,k=e.body,g=l.getAggregator(),
n=new aa,m=g.request("browser"),u=g.request("features"),x=g.request("context"),s=!t.xDomainIframe,g=K(b,d),e=f&&k?e.body:b;L=t.friendlyIframe?c.frameElement:e;y.addEvent(e,"click",function(){l.getAggregator().trigger("adComponentClicked")});y.addEvent(e,"mouseover",function(){l.getAggregator().trigger("adComponentMousedOver")});n.applies(m,u,x)?(p=Hc(b,s),p.start(),C=!0,A&&(c=new od($().getRounded()),n=new pd,g=new qd(g,n),q=new rd(c.getSlices(),g))):A&&(v=new sd(a))})();return{mark:function(){s.setAttributeOf(L,
R,"")},cleanup:function(){s.removeAttributeOf(L,R)},isNode:function(a){return b===a},isHidden:W,isObstructed:function(){return!1},getDims:$,getPercentInView:G,getLocationState:P,getOnPageViewability:function(){return W()?g.OUT_OF_VIEW:P()},getDetectionMethod:function(){return c},getContainerDims:function(){return D.allowsOptimization?u:H(d)},refresh:function(){J=z=B=E=n=u=void 0;if(k){var a,c;if(!t.isDomless()&&(c=b.parentNode)){for(;b!==w&&c&&c!==M&&!a;)a=c===d,c=c.parentNode;a||(d=b.parentNode)}}},
getAdNode:function(){return b},getSliceStatus:function(){var a;q&&q.isReadyToMeasure()?a=q.getSliceStatus():t.friendly&&v&&f.isDef(z)&&(a=v.getSliceStatus(z,B,E,J));return a}}},ud=function(a,b){var c=[],d,e=f([]),k=b.on("rvCombo"),m=function(){return c[0]&&c[0].getDetectionMethod()===g.DETECTION_METHODS.AD_PLACEHOLDER},n=function(k,n,p,q){var r=m()||0===c.length;k=td(a,k,n,p,b,q);m()&&(q=c.shift(),e=f(c),q.cleanup(),d=void 0);c.push(k);e=f(c);r&&k.mark();r&&n!==g.DETECTION_METHODS.AD_PLACEHOLDER&&
...
d(c);return c},getAdContainer:function(){return a},allowForAdContainerChange:!0}},V=function(a,b,c){var d;a=s.findChildWithLargestContent(a||m.contextNode.parentNode,b,c);1<s.getNodeArea(a)&&!a[g.IAS_DETECTOR]&&(d=a);return d},Bd=function(){return{detectionMethod:g.DETECTION_METHODS.IFRAME,find:function(){return w},isApplicable:function(){return t.embedded},getAdContainer:function(){return m.contextNode.parentNode},allowForAdContainerChange:!0}},Ed=function(){var a,b=r.getDoc().scripts,c=function(){a||
...
d()+"']",!0))&&a.id)&&"#"+a);return b};return{detectionMethod:g.DETECTION_METHODS.BUSTED_IFRAME_SIZMEK,isApplicable:function(a,b){var c=r.getWindow(),g=a.friendlyIframe&&r.getWindow().frameElement,g=g&&H(g).isOneByOne(),q=function(){var a=r.getDoc().scripts;return f(a).findFirst(function(a,b){return O.contains(b.src,"bs.serving-sys.com/BurstingPipe/adServer")})}(),c=c.EBG&&c.EBG.ads&&!f(c.EBG.ads).isEmpty();return b.on("sizmek")&&q&&c&&g&&d()&&e()},getCssSelector:e}},ia=function(){var a,b=l.getAggregator().request("features");
...
q={};try{var v,E,B,z,w,x,D=r.getMaxNumber(),y=r.getMaxNumber();t.friendly?(v=m(),B=v.left,z=v.top,D=v.width,y=v.height,E=s.browserWindowPosition(),w=E.scrX+B,x=E.scrY+z):e.on("rattie")&&k.browserIs(g.BROWSERS.IE)?(d=d||l.getAggregator().request("ieXDomainViewability"),c=d.determineFramePosition(),w=c.scrX,x=c.scrY):f.isDef(a.mozInnerScreenX)&&(w=r.round(a.mozInnerScreenX),x=r.round(a.mozInnerScreenY));var q={scrX:w,scrY:x,iFrameClippingWidth:D,iFrameClippingHeight:y},C,I,F=b||s.getIeDimObj(a);b=F;
f.isDef(a.innerWidth)?(C=a.innerWidth,I=a.innerHeight):F&&f.isDef(F.clientWidth)?(C=F.clientWidth,I=F.clientHeight,0===C&&0<F.offsetWidth&&(C=F.offsetWidth),0===I&&0<F.offsetHeight&&(I=F.offsetHeight)):a.frameElement&&f.isDef(a.frameElement.clientWidth)&&(C=a.frameElement.clientWidth,I=a.frameElement.clientHeight);n=C;q.height=I;q.width=n}catch(A){l.getAggregator().trigger("error",g.ERROR_CODES.GET_AD_DIMENSIONS)}return q};return{calcDims:function(){return new H(n())},getClippedDims:function(){var a=
...
r.now();d=a-e;e=a;c++;10<=c&&b&&r.clearInterval(b)},50);return{isLikelyToProduceFalsePositive:function(c){var e;c=c.getRounded().height;var f=s.calcMonDims().height,l=k.getUserAgent(),l=l&&null!==l.match(/(FBAN)/)?1:0,m=k.getUserAgent(),m=m&&null!==m.match(/(iPad)/)?1:0,t=g()?1:0,z=k.getUserAgent(),z=z&&null!==z.match(/(Version\/9\.0)|(CriOS\/55)/)?1:0;e=r.pow(Math.E,0.0033*c-9.26E-4*f-0.340351*l-0.874412*m+0.646972*t+0.28118*z+2.987259*(1E3<d?1:0)-2.463292);e/=1+e;a={mbah:c,mbsh:f,mbfb:l,mbip:m,
mbhs:t,mbbr:z,mblr:d,mbp:e};b&&r.clearInterval(b);return 0.15<e},getDebugState:function(){return a}}},Wc=function(a,b,c){var d,e,k,u,n,p=[],q=m.contextNode.parentNode,v=0,s=0,B=!1,z=!1,w=new Sd,x=function(){var a=p.length-1,b=-1;-1<a&&(b=p[a].piv);return b},D=function(){l.getAggregator().trigger("delayedViewabilityReadyCallOnly")},A=function(a){y.whenReady(function(){e=new Td(a,r.getDoc().body)})},C=function(){e.removePixels()},I=function(){var a=w.getDebugState(),b=x();f.isUndef(a)&&(a={});a.mbm=
f.fromBoolToNum(z);a.mbrd=f.fromBoolToNum(B);a.mbtg=f.isDef(q.tagName)?q.tagName:"na";a.mbaf=f.isDef(k)?k:"na";a.mbad=f.isDef(d)?d.getRounded().width+"_"+d.getRounded().height:"na";a.piv=f.isDef(b)?b:-1;b={minDt:!1,type:"dm"};try{l.getAggregator().trigger("addOutputItem",{output:a},b),l.getAggregator().trigger("addOutputItem",{output:-101},"pingTime",b),l.getAggregator().trigger("sendDt",b.type)}catch(c){}};return{getScreenLocationInfo:function(b,c){var q;q=f.isDef(d);if(c||!b.adDimensions)return b;
q||(k=b.method,d=b.adDimensions,A(d));if(f.isUndef(e)||!e.isReadyToMeasure())q=!1;f.isUndef(u)&&q&&(u=w.isLikelyToProduceFalsePositive(d));if(z=!u&&q){var m;q=e.getPercentInView();var C=x(),P=1===b.tabHidden;s=r.now()-v;m=0<v?900>s:!0;v=r.now();0===b.adDimensions.area()&&(q=0);m||(q=0);var y=q;p.push({tm:t.getTagTime(),piv:y});3<p.length&&p.shift();0===q&&0<C&&(m&&(m=p.length-1,y=!0,2<=p.length&&-1<m&&(y=0===p[m].piv&&0===p[m-1].piv),m=!y),m&&(q=C));a?(f.isUndef(n)&&(n=l.getAggregator().request("video")),
n.setVideoSpecificScreenEventFields(b),q=b.isVideoPlayingInFullscreen?!0:!P&&50<=q&&b.isVideoPlaying):q=!P&&50<=q;b.viewState=q?g.IN_VIEW:g.OUT_OF_VIEW;b.percentInView=x();C=[];P=f(b.reason);m=g.OUT_OF_VIEW_REASONS;q||C.push(m.GEOM);P.contains(m.HIDDEN)&&C.push(m.HIDDEN);P.contains(m.OBSTRUCTION)&&C.push(m.OBSTRUCTION);b.reason=C;b.sliceStatus=e.getSliceStatus();B||(B=!0,r.execAtEndOfThread(D))}else b.viewState=g.NA,b.percentInView=-1;return b},start:function(){l.getAggregator().on("endAdSession",
C);c&&r.setTimeout(I,2E3)},getStrategyName:function(){return"mobileWebXdomainSafari"},isMeasurable:function(){return z},isImmediate:function(){return!0},hasMeasurementStrategy:function(){return!0}}},Ka=function(a,b,c,d){return{accepts:function(){var e=c.xDomainIframe,f=a.bootstrapOn("mobOrTab"),l=a.on("ios"),n=b.browserIs(g.BROWSERS.WEBKIT),p=9<=b.getIOSVersion(),q=d.isMobileAppEnvironment();return e&&f&&l&&n&&p&&!q},isImmediate:function(){return!1},start:function(){}}},Ud=function(a,b,c,d,e,k,l){var n,
p=m.birthdate+""+r.round(1E6*r.random()),q=101,v,t,s,z=!1,w=function(){return'<html><body><script type="text/javascript">'+("("+function(a){var b=a.document;try{b.body.setAttribute("data-st","iasInit");var c,d=0,e=0,f=!1,k=(new Date).getTime(),g=function(){e=(new Date).getTime()-d;(f=b.body.isReady())&&(c=0<d?900>=e:void 0);d=(new Date).getTime();a.requestAnimationFrame(g)};a.requestAnimationFrame(g);b.body.isInView=function(a){return{isInView:c,rate:e,lastUpdateTimestamp:d}};b.body.getRate=function(){return e};
...
(b=c.isReady?c.isReady():!1)&&(t=c.isInView?c.isInView:void 0)&&x(105)}}catch(d){x(106,d)}return f.isDef(t)},y=function(a,b,c){var k=M.createElement("iframe");k.id=p;f(k.style).mixin({position:"absolute",width:d+"px",height:e+"px",backgroundColor:"transparent",border:"none",padding:"0px",margin:"0px",zIndex:"-999"});var n=k.style;k[g.IAS_DETECTOR]="true";n.left=b;n.top=c;a.appendChild(k);v=k;x(102);a=v;try{var l=a.contentWindow,q=w();l.document.open();a.contentWindow.document.write(q);l.document.close()}catch(m){x(103,
m)}return k}(a,b,c);return{isInView:function(){var a,b,c=!1;r.now();D()&&(a=t(!0),c=a.isInView,z=!1,n&&(b=20*n.rate+n.lastUpdateTimestamp,0<b&&b<a.lastUpdateTimestamp&&(c=!1,z=!0)),x(107),n=a);return c},isNotReadyToReport:function(){return!D()},createdElement:v,remove:function(){y.parentNode&&y.parentNode.removeChild(y)},getStatus:function(){return q},getError:function(){return s},isReadingInvalid:function(){return z},getRate:function(){return v.contentWindow&&v.contentWindow.document&&v.contentWindow.document.body&&
...
[];f(k).each(function(b,c){a=c.isInView();q.mbs.push(a);d.push({isInView:a,percentInView:c.percentInView})});b=z(d,!1);c=z(d,!0);return r.max(b,c)};(function(){d=l?B(e):s(e);var a=d.get();f(a).each(function(a,d){var e=new Ud(b,d.x,d.y,d.width,d.height,d.percentInView,c);k.push(e)})})();return{getPercentInView:function(){var a=m(),b=w();q.mbrd=a?1:0;b!=q.mbp&&q.mbivs.push([t.getTagTime(),b]);q.mbp=b;return a?b:-1},removePixels:function(){void 0!==c&&c.stop();f(k).each(function(a,b){try{b.remove()}catch(c){}})},
...
{AdPaused:"pauseAd",AdVolumeChange:"volumeChanged",AdPlaying:"resumeAd"};return{translate:function(b){var c=b.charAt(0).toLowerCase()+b.slice(1);b in a&&(c=a[b]);return c}}},Sa=function(){return{getVolumeFromContext:function(a){var b,c=-1;f.isDef(a)&&(f.isDef(a.volume)?c=a.volume:f.isDef(a.adVolume)&&(c=a.adVolume));-1!==c&&(b=c);return b}}},jb=function(a,b,c){var d="IASid"+a,e="getIasVidBridgeVersion"+a,k,u,n,p=[],q=g.OUT_OF_VIEW,v=!1,s=!1,w=!1,z=!0,A=new Yd,x=Zd(),D=new Wd,H=new Sa,C=new Ga,I=function(b){var d;
v=!0;var e={};try{e=JSON.parse(unescape(b&&b.data?b.data:b))}catch(f){e={}}e.id==a&&(d=A.registerEvent(e,c.getCurrentLoc()),d.indicatesPlaying()?(s=!0,q=w?g.IN_VIEW:!1):d.indicatesNotPlaying()?(s=!1,q=g.OUT_OF_VIEW):d.indicatesFullscreen()?(w=!0,q=s?g.IN_VIEW:g.OUT_OF_VIEW):d.indicatesNormalSize()&&(w=!1,q=s?!1:g.OUT_OF_VIEW),b=parseFloat(d.getVolume(H)),0<b?z=!0:0===b&&(z=!1));p.push(d);n&&M();return d},F=function(b){var c,g,k=oa().wrapToGlobal(I),n=function(a){f.isStr(a)&&(l.getAggregator().provide("vc",
...
b){var d=r.getDoc().querySelectorAll(b);return k=c(d)}),!k&&b.on("novidnodeerr")&&__IntegralASDiagnosticCall("novidnode",{},m));return k},L=function(){var a=G();a&&!v&&F(a);return a},K=function(a){a=H.getVolumeFromContext(a);z=f.isDef(a)?0<a:!1},M=function(){C.init();f(p).each(function(a,b){b&&(f.isUndef(b.sl)&&b.updateScreenLoc(c.getCurrentLoc()),b.trigger(),b.indicatesCompletion()&&l.getAggregator().trigger("adSessionComplete"),b.indicatesQuartile()&&("adVideoComplete"!==b.tp&&l.getAggregator().trigger("sendDt",
g.DT_CODES.VIDEO_EVENTS),l.getAggregator().trigger("videoQuartileEvent",b)))});p=[];n=!0};(function(){y.addEvent(r.getWindow(),"message",function(a){I(a)});l.getAggregator().on({volumeChanged:K});l.getAggregator().provide({videoEventsString:A,videoVersion:function(){var a,b=L();try{a=b.getVersion()}catch(c){a=-1,l.getAggregator().trigger("error",g.ERROR_CODES.NO_VIDEO_AD_INTERFACE)}return a},videoTranslator:function(){return u=u||new $d},adNode:L});L();D.listenForResult();x.isApplicable(t)&&x.start(c)})();
return{findAdNode:L,getViewStateOverride:function(){return q},isHandshakeComplete:function(){return v},triggerInitializationEvents:M,setVideoSpecificScreenEventFields:function(a){var b=a.viewState===g.NA;a.isVideoPlaying=!0;a.isSoundOn=z;a.isVideoPlayingInFullscreen=!1;if(q){if(q===g.OUT_OF_VIEW){var c=a.reason?a.reason.split("."):[];c[c.length]=g.OUT_OF_VIEW_REASONS.VIDEO;a.reason=c.join(".")}a.viewState=b?a.viewState:q;a.isVideoPlaying=q===g.IN_VIEW}w&&s&&(a.percentInView=100,a.isVideoPlayingInFullscreen=
...
"__cmpLocator");N.send("gca",!!c);if(c){var e,g;f.isFunction(c)?c("getVendorConsents",[b],a):(e={__cmpCall:{command:"getVendorConsents",parameter:[b],callId:N.getCallId()}},g=N.getMessageHandler("__cmpReturn",a),y.addEvent(r.getWindow(),"message",g),c.postMessage(e,"*"))}})()},{tier:g.TIERS.ENVIRONMENT,applies:function(a,b,c){return b.hasPostMessage()&&!c.isDomless()}});l("GDPRV2ConsentDetector",[],function(){function a(a){var e=f.isDef(a)&&f.isDef(a.vendor)&&f.isDef(a.vendor.consents)&&f.isDef(a.vendor.consents[b])?
a.vendor.consents[b]:void 0;a={appl:f.stringifyTriState(a.gdprApplies),cnst:f.stringifyTriState(e)};N.send(c,f(a).toION())}var b=278,c="gcd2";(function(){var c=N.isFrameworkAvailable("__tcfapi","__tcfapiLocator");N.send("gca2",!!c);if(c){var e,g;f.isFunction(c)?c("getTCData",2,a):(e={__tcfapiCall:{command:"getTCData",parameter:[b],callId:N.getCallId(),version:2}},g=N.getMessageHandler("__tcfapiReturn",a),y.addEvent(r.getWindow(),"message",g),c.postMessage(e,"*"))}})()},{tier:g.TIERS.ENVIRONMENT,applies:function(a,
b,c){return b.hasPostMessage()&&!c.isDomless()}});l("postMessageDetector",[],function(){var a=!1,b="pmdetector"+m.asid,c=function(c){(c&&c.data)===b&&(a=!0)};(function(){var d=r.getWindow();y.addEvent(d,"message",c);d.postMessage(b,"*");r.execAtEndOfThread(function(){l.getAggregator().trigger("addThrottledProp",g.DT_SLOT.IM,"pom",f.stringifyTriState(a));y.removeEvent(d,"message",c)})})()},{tier:g.TIERS.ENVIRONMENT,applies:function(a,b,c){return a.on("pmdetect")&&b.hasPostMessage()}});l("safeFrameDetector",
...
e)},isApplicable:function(a){return a.on("cookie")&&a.bootstrapOn("sendCookie")&&a.bootstrapperHas(["protocol","cookieBaseURL","asid"])}}},Sb=function(a,b,c,d,e,f,r){var n=function(a,b){return isNaN(a)||0>a||""===a?b:a};return{send:function(p){try{var q,s=d.baseUrl,w,y,z=f.getDocumentMode();"number"===typeof z?(y=2E3,8===z?y=4E3:8<z&&(y=8E3)):y=n(m.sp_imp_maxLength,2E3);w=y;if(t.integratedBlockingApplies(s)){y=s;var A=l.getAggregator().request("mobileApp"),x=A&&A.isMobileAppEnvironment&&A.isMobileAppEnvironment(),
D=m.contextNode.getAttribute("data-ias-container"),H=m.contextNode.getAttribute("data-ias-callback"),A=y+"adContainerId="+D+"&cbFunctionName="+H,A=x?A.replace("monitoring","blocking"):A.replace("skeleton.js",m.integration+".js"),C=m.protocol+":"+m.staticServer+m.integration+"a.js",I=m.protocol+":"+m.staticServer+m.integration+".js",s=A+"&true_pb="+encodeURIComponent(m.passback)+(x?"&redirectUrl="+encodeURIComponent(I):"")+(x?"&passback=":"&adsafe_pb=")+encodeURIComponent(C)+"&"}var x=s=s.replace(g.UNIQUE_ID_TOKEN,
m.asid),F=s.length,G,L,K=n(m.sp_imp_jsInfo_minLength,0),C="";try{G=w-F-K,0<G&&(L=ce(p,G,14,b.on("partialUrls")),C+=L.join("&"))}catch(M){a.add(g.ERROR_CODES.IMPRESSION_URLS)}s=x+C;p=s+="&"===s.slice(-1)?"":"&";var N,F="";try{N=w-s.length,F+=de(N,"adsafe_jsinfo=",a,b,c,e,f,r)}catch(O){a.add(g.ERROR_CODES.JSINFO),F+="adsafe_jsinfo=e:"+a.toString()}s=p+F;d.macroUrl&&(s+="&"===s.slice(-1)?"":"&",s+=d.macroUrl);q=s;d.sendImpression(q);m.impUrl=q;l.getAggregator().trigger("impressionsent")}catch(Q){__IntegralASDiagnosticCall("impsend",
...
m.perf.mark("si");c.on("swapids")?n.push("oid:"+m.oid):n.push("uid:"+d.unq);n.push("v:19.8.103");n.push("sp:"+(m.isSplitMode?1:0));n.push("fwm:"+("true"===m.fwMonitoring?1:0));c.on("resolution")&&(n.push("wr:"+f(s.windowSize()).toArray().join(".")),n.push("sr:"+f(s.screenSize()).toArray().join(".")));b=function(){var a;a=String(m.scriptUrl).toLowerCase();var b=a.indexOf("ias_xpc");-1<b?(a=a.substring(b+7+1),b=a.indexOf("&"),a=-1<b?a.substring(0,b):a):a="NotFound";return a||""}();"NotFound"!==b&&n.push("x_xpc:"+
