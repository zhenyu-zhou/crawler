...
try {
	var __IntegralASConfig = {
		...
		sp_cdnScripts:{xsca: "static.adsafeprotected.com/xsca.17.4.47.js", sca: "static.adsafeprotected.com/sca.17.4.72.js", main: "static.adsafeprotected.com/main.17.4.99.js"},
		protocol:'https',
		jsref : "",
		asid : "1cbc236f-50b3-11e8-8273-00259036a24a",
...
(c||e)&&m.push(a+":"+b.output())});b.toString()&&m.push("e:"+b.toString());m.push(c.output());m.push("uf:0");m.push("tt:"+n.mode);m.push("et:"+(r.now()-n.birthdate));c.on("swapids")?m.push("oid:"+n.oid):m.push("uid:"+e.unq);m.push("v:17.4.99");m.push("sp:"+(n.isSplitMode?1:0));m.push("ct:"+t.getPageTime());m.push("dtm:"+(c.on("postDts")&&y.getXHR2()?"p":"i"));m.push("gtpl:"+("true"===n.getTpl?1:0));c.on("resolution")&&(m.push("wr:"+d(u.windowSize()).toArray().join(".")),m.push("sr:"+d(u.screenSize()).toArray().join(".")));
