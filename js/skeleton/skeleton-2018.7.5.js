...
try {
	var __IntegralASConfig = {
		...
		protocol: 'https',
		jsref: "",
		asid: "6fa401ec-806d-11e8-8140-305a3ac870f3",
...
__IntegralASConfig.initialize=function(n,x,I){function Ka(){var g;n.perf.markStart(ga);M.startSystem();l=M.getAggregator();l.provide({omidAdSessionContext:{}});g=__IASOmidVerificationClient;l.provide({omidVerificationClient:g});g=[{environment:new ha(g),adSessionReadyStrategy:new La(ia,g)},{environment:{accepts:function(){return!0}},adSessionReadyStrategy:{start:function(){ia()}}}];(new Ma(g)).resolve().adSessionReadyStrategy.start();n.perf.markEnd(ga)}function ia(){var g,a;n.perf.markStart(ja);a=
...
k,f);q.loopDelay=oa();q.mDataTransfer.setViewabilityMod(q.mViewability);n.perf.markEnd(ma);return q},preImpression:function(a,b,c,u,m,r,g,f,q,L){var B,K,C,A,s;n.perf.markStart(pa);try{c.isApplicable(L)&&(c.start(),u.addItem(c.getFrameMap(),"fm"),q.on("fm2")&&u.addItem(c.getFrameMapIncludingPeerCase(),"fm2"),q.on("idMap")&&(B=c.getIdMap())&&u.addItem(B,"idMap"))}catch(z){m.add(h.ERROR_CODES.ADTALK_GENERAL)}try{r.isApplicable(g,q,L)&&r.start(),s=f.detectTopURL(),q.on("exch")&&(K=(new Db).createInstance(m,
u),K.parse(s)),C=Eb(),C.isApplicable(q)&&C.start(q),L.usesGroupMCustomMetric()&&Fb(),A=Gb(),A.isApplicable(q)&&(A.start(),l.trigger("sendCookie"))}catch(t){m.add(h.ERROR_CODES.IMPRESSION_LEADUP)}n.perf.markEnd(pa);return s},sendImpression:function(a,b,c,u,m,r,g,w,q){try{Hb(a,b,c,u,m,r,g).send(w),f.isFunction(q.triggerInitializationEvents)&&q.triggerInitializationEvents()}catch(h){__IntegralASDiagnosticCall("impsend",h,n)}},postImpression:function(a,b,k,u,m,r,g,f,q,l,B,K,C){try{n.perf.markStart(qa);
var s=Ib();s.start();s.addFieldTypes([h.DT_SLOT.IM,h.DT_SLOT.FRAUD,h.DT_SLOT.ENVIRONMENT,h.DT_SLOT.FRAUDEXP]);var O=Jb(a,b,k);O.isApplicable(u)&&O.start();var z;u.bootstrapOn("getTpl")&&u.on("usetpl")&&(z=Kb(m,r,g,b,f),z.init());c(f,q,l,g,u,m,r,b,K);B&&B.start&&B.start();C.isDomless()||Lb().start(["sca","xsca","rsrch"],u);Mb();M.runTier(h.TIERS.VIEWABILITY);var t=Nb();t.isApplicable(u)&&(t.start(),S.recordBlockingTime(),n.perf.mark(Ob),S.setupOnLoadTracking(),S.setupBrowserDelayTracking());n.perf.markEnd(qa)}catch(H){g.add(h.ERROR_CODES.POST_IMPRESSION)}}}}(),
...
f(c).compareTo(a);d&&(d.t=t.getTagTime(),g.push(d));f(a).mixin(c)});return{toString:function(){return f(g).toION(b)}}},ra=function(){var g=new Pb,a=new D;return f(g).mixin(a)},D=function(){var g={},a={},b=function(b,c,k){if((b=a[b])&&0!==b)return k&&(b=b.slice(0,1)),f(b).each(function(a,b){c.apply({},b)}),!0},c=function(a,b,c){g[a]=g[a]||new $;g[a].push(b,c)};return{on:function(a,e){var k={};e?k[a]=e:k=a;f(k).each(c);f(k).each(b)},once:function(a,e){b(a,e,!0)||c(a,e,1)},trigger:function(a){var b=
...
"componentid").replace(/,/g,"."));w++);}catch(l){}k=p;p=h.NA;q=s.getWindow();f.isDef(q.navigator)&&f.isDef(q.navigator.appName)&&(p=q.navigator.appName.toLowerCase()[0]);return{br:a,fv:b,abv:k,an:p}},isAndroidWebViewBrowser:function(){var a=k(),b=["SamsungBrowser","FB_IAB","Silk"],c=function(){return f(b).findFirst(function(b,c){return J.contains(a,c)})};return J.contains(a,"Android")&&c()},getIOSVersion:function(){var a,b;(a=k())&&(a=a.match(/OS\s\d+/))&&0<a.length&&(b=(b=a.toString().match(/\d+/))&&
...
(a=s.getWindow().inmobi)&&a.IASDocumentVideoBuffer,a=a&&b&&f.isFunction(b.addVideoEventListener),a=c()&&!!a;return a},e=function(){return n.mobOrTab},k=function(a){return!1===f(n.customViewability).isArray()?!1:0<f(n.customViewability).filter(function(b,c){return J.contains(c.id,a)}).length},u=function(){return k("grpm")||n.use100v};return{embedded:a,friendly:b,isFriendlyToParent:function(a){var b,c;if(g)a=!0;else{try{c=T(a.document.referrer),b=c.hostname===a.location.hostname}catch(d){}a=b}return a},
...
b&&b[g];f.isDef(d)&&0!==d&&f(c).contains(g)&&(a=a+"."+d);d=b[g];b[g]=f.isDef(d)?d+1:1;return a}();return{callType:g,enumerator:a}};Y.callTypeCounter={};var zb=function(g,a,b,c,d,e,k,u){var m=0,r=0,p=!1,w=function(a,e,u,g,q,w){u=u||!b.on("postDts");var t=a===h.DT_CODES.DIAGNOSTIC||a===h.DT_CODES.ADTALK||a===h.DT_CODES.SCA||a===h.DT_CODES.XSCA||a===h.DT_CODES.EXTERNAL||a===h.DT_CODES.LARGE_BILLABLE;if(c.impressionIsIdentifiable()&&(t||"n"!==k.getCurrentLoc()))try{var v=n.dtBaseURL,Q=new T(v,!0),x=s.now();
l.trigger("preSendDt",a);v||(Q.path("dt"),b.on("usedtdomain")&&Q.sub("dt"));L(Q,a,e);q&&q.field&&Q.setParam(q.field,q.value);g||B(Q,a);l.trigger("send",Q,function(){r+=1;m=s.now()-x;f.isFunction(w)&&w()},u);a===h.DT_CODES.UNLOAD&&(p=!0);d.cleanup()}catch(N){__IntegralASDiagnosticCall("dt-"+a,N),l.trigger("error",h.ERROR_CODES.PHONE_HOME)}};g=function(){p||w(h.DT_CODES.UNLOAD,-1,!0)};var q=function(a,c){var d={bapi:"a",bapiClient:"b",jload:"c",jss:"d",jsi:"e"},e=n.mode,d=d[a]||d[e];b.on(c||e+"Diag")&&
...
a.getTimeInViewInSeconds(),e=a.getTimeInViewForRts();l.trigger("sendDt",b,d);if(c[e])c[e]()}}}},yb=function(){return{createPingJobs:function(a,b,c,d){f.isDef(d)&&l.trigger("addOutputItem",{output:d},"metricId",{type:a});return f(b.getTimeThresholds()).map(function(b,d){return new bc(d,a,c)})}}},na=function(){var a=function(a,b){-1!==a.indexOf(b+"&")&&(b+="&");return a.replace(b,"")},b=function(a,b,c){var f=a.indexOf("?");b=b+"="+c;if(-1===f)return a+"?"+b;f++;return a.slice(0,f)+b+"&"+a.slice(f)},
c=function(){return"__IntegralAS_"+n.asid.replace(/\-/g,"")+"_"+s.round(1E4*Math.random())};return{wrap:function(d,e,k,f){var m=c(),r,p,w;f=f||"ias_callback";d=""+d;RegExp(f).test(d)&&(r=RegExp("("+f+"=)(.[^&]*)").exec(d)[0],p=r.split("=")[1],w=J.stringToFn(p),d=a(d,r));x[m]=function(a){e(a);k&&w&&w(a);x[m]=void 0};return d=b(d,f,m)},wrapToGlobal:function(a){var b=c();x[b]=function(c){a(c);x[b]=void 0};return b}}},Bb=function(a,b,c){var d=function(a,b){var c=a,d;b&&(d=","+f(b).stringify(function(a,
...
var b=a.getWindowWithHiddenViewport();if(b)ic(b).onResize(d)}}}},{emits:!0,applies:function(a,b,c){return c.embedded&&!c.isBustedIframe()&&!c.isSpecifiedAd()}});M("hiddenAds",["adStuffingDetector"],function(a){var b=0,c=function(a,b){l.trigger("addThrottledProp",h.DT_SLOT.FRAUD,a,f(b).toION())},d=function(a){2>b&&c("ha1",a);b++};(function(){var b,k;if(t.embedded)try{k=n.contextNode.parentNode,b=hc().getDFPValue(k),k={},k.df=b.type,b.size&&(k.sz=b.size.width+"."+b.size.height),b.tag&&(k.dom=b.tag),
...
d=b+"*";c=a.request("adTalkMessageCollection").map(function(a,b){var c;a!==n.asid&&f(b)&&(c=b.positionStr+"."+b.srcAsid+"."+b.transferDuration+"_"+b.srcTagId);return c});c.push(d);c=c.join("|");120<c.length&&(c=e(c),l.trigger("stopAdTalk"));return c},isCandidateForMyIdMap:f}},rc=function(a){var b=new aa,c=function(a){var b=a,c="IFRAME"===v.getNodeName(a),d=v.isWindow(a);c?b=a.contentWindow.document:d&&(b=a.document);return b},d=function(a,b){return v.querySelector(c(a),b)},e=function(c,e){var m,r,
...
b.bodyElement?p():b&&b.document?y.whenReady(p,b.document):u?l.request("errors").add(h.ERROR_CODES.BUSTED_IFRAME_IN_IO):p()},isStarted:function(){return k},getAdNodeDimensions:function(){var a;c&&(a=G({scrX:void 0,scrY:void 0,width:c.width,height:c.height}));return a},isReady:function(){return d!==h.NA}}},oa=function(){var a=!1;(function(){y.whenReady(function(){l.trigger("startViewabilityLoop");a=!0})})();return{loopStarted:function(){return a}}};M("loopDelay",[],oa,{applies:function(a,b,c){return a.bootstrapOn("allowViewability")},
...
c}));return b.accepts()&&b.isMediaType(h.MEDIA_TYPE.DISPLAY)&&a},isImmediate:function(){return!0},isMediaType:b.isMediaType,supportsAdContainerGeometry:function(){return b.supportsAdContainerGeometry()},start:function(){}}},ha=function(a){var b=l.request("omidAdSessionContext");return{accepts:function(){return a&&a.isSupported&&a.isSupported()},isMediaType:function(a){return a===b.mediaType},supportsAdContainerGeometry:function(){return!0}}},Dc=function(a,b,c){var d=["rjss","jss","jload"];return{accepts:function(){var a=
...
A=p.adFound,v=e.detectionMethod,z=0,w={x:0,y:0,width:w.width,height:w.height},E=u(t,C),H=e.outOfViewReason,P=0,x=0,y=n||!1,N,P=1>=C.width*C.height;c&&P&&(A=!1,H=H||"",A||-1!==H.indexOf(h.OUT_OF_VIEW_REASONS.GEOM)||(H=h.OUT_OF_VIEW_REASONS.GEOM+(""!==H?"."+H:"")));if(A&&0<e.percentageInView){P=d(w,q,E);n?(z=m(q,E),z=k(w,q,z),z=u(q,z),z=a.calculateObstructedArea(z,l)):z=0;x=z;z=Math.round((P-x)/(E.width*E.height)*100);n&&0===x&&(y=!1);C=y;n=0;A=b.getConfig(E).numberOfSlices;N=s.floor(E.height/A)||1;
for(var l=[],P=C?a.getObstructionStatusBySlice(A):[],V,n=0;n<A;n++)x=E.y+N*n,n==A-1&&(N=E.y+E.height-x),x={x:E.x,y:x,width:E.width,height:N},V=d(w,q,x),x=1==V/(x.width*x.height),l.push(x);if(C)for(q=s.min(P.length,A),n=0;n<q;n++)l[n]=l[n]&&!P[n];N=l}else A&&(N=b.getConfig(C).defaultSliceArray);return{windowDimensions:w,containerDimensions:t,adDimensions:E,percentageInView:z,viewState:50<=z?h.IN_VIEW:h.OUT_OF_VIEW,outOfViewReason:50<=z?"":H||h.OUT_OF_VIEW_REASONS.GEOM,detectionMethod:v,isObstructed:y,
sliceStatus:N}}}}},Oc=function(){return{accepts:function(){return t.isAvidNative()}}},Qc=function(a,b){var c=function(a){a=a.eventData.originalAdContainer;var c=!!a;b.trigger("avidNativeGeometryChanged",{adGeometry:{x:0,y:0,width:c?a.width:0,height:c?a.height:0},adFound:c})};return{start:function(){a.addEventListener("viewability",c)},addAdGeometryMeasurementChangedListener:function(a){b.on("avidNativeGeometryChanged",a)}}},Pc=function(){return{accepts:function(){return t.isAvid()&&!t.isAvidNative()}}},
...
return c},metricId:a.id,minUnit:a.minunit?1E3*a.minunit:1E3,thresholdType:a.thresholdType}},Ra=function(a,b,c){var d=b.isVideo()?"video":"display",e=b.isMobileApp()?"app":"web",k=b.isDeviceTypeGroupMobile()?"mobile":"desktop",h=f(a.customViewability).isArray()&&0<a.customViewability.length,m=c.on("customMetric"),r=c.on("groupmCM"),p=function(a,b){var c,h,m,p,l;c=f(b.mediaTypes).contains(d);h=f(b.distributionChannels).contains(e);m=f.isDef(b.deviceGroups)?f(b.deviceGroups).contains(k):!0;p=J.contains(b.id,
...
function(a,b,c,d){var e,k=Yc(c),u=[new Zc,new $c(k)],m=function(){return f(u).findFirst(function(a,e){return e.applies(d,b,c)?e:void 0})},r=function(a){"sessionFinish"===a.type&&l.trigger("adSessionComplete")},p=function(a){y.addEvent(x,a,function(){l.trigger("adSessionComplete")},!1)},w=function(){var a=new Y(h.DT_CODES.VIDEO_EVENTS);l.trigger("sendDt",a.callType,a.enumerator,function(){var a={id:n.videoId,msg:"unloadComplete",messageType:"misc"};s.getWindow().postMessage(JSON.stringify(a),"*")})};
...
start:function(a){b=a;b.start(!0);l.on("IOPivChange",e)}}},ed=function(a,b,c,d,e,k){var u,m,r,p,w,q,L,B,K,C=v.getElementsWindow(b);v.getElementsDocument(b);l.provide("iframeCalculatorHelper",ad(C));var A=bd(b,d),O=h.AD_IDENTIFIER+"-"+n.asid,z=!1,E=G({}),H=t.isDeviceTypeGroupMobile(),P=t.usesGroupMCustomMetricMobilePassThru(),Q,D=function(){if(!u)if(u=A.calcDims(b,d,r),c===h.DETECTION_METHODS.VIDEO&&t.embedded){var a=u,e=(new G(b)).getRounded();try{a.set("width",e.width),a.set("height",e.height)}catch(f){l.trigger("error",
h.ERROR_CODES.VIDEO_IN_IFRAME_DIMS_CALC)}}else c===h.DETECTION_METHODS.AD_PLACEHOLDER&&u.treatAsPlaceholder();return u},N=function(){var b,d=t.xDomainIframe&&z;b=H&&z&&r.isReady();b=d||b;d=A.getClippedDims&&(c===h.DETECTION_METHODS.VIDEO&&t.embedded||t.isCeltra());b?m=r.getPiv():f.isUndef(m)&&(b=!H&&(t.friendly||f.isDef(x.mozInnerScreenX))&&e.on("offscreen"),B=D(),L=new G(v.calcWinDims()),q=new G(b?v.calcMonDims():{}),K=d?A.getClippedDims():E,m=a.calcPercentInView(B,L,q,K));return m},V=function(){return a.calcInitialViewState(N())},
Fa=function(){return b===x?!1:D().isHidden()},F=function(a,b){return t.isVideo()?s.getDoc().body:a.document&&a.document.body?a.document.body:b.contentDocument&&b.contentDocument.body?b.contentDocument.body:b};(function(){var c=s.getWindow(),e=s.getDoc(),f=b===c,k=e.body,h=new X,m=l.request("browser"),q=l.request("features"),u=l.request("context"),n=!t.xDomainIframe,B=F(b,d),e=f&&k?e.body:b;Q=t.friendlyIframe?c.frameElement:e;y.addEvent(e,"click",function(){l.trigger("adComponentClicked")});y.addEvent(e,
"mouseover",function(){l.trigger("adComponentMousedOver")});h.applies(m,q,u)?(r=uc(b,n),r.start(),z=!0,P&&(p=new Ga(cd,D(),B))):P&&(w=new dd(a))})();return{mark:function(){v.setAttributeOf(Q,O,"")},cleanup:function(){v.removeAttributeOf(Q,O)},isNode:function(a){return b===a},isHidden:Fa,isObstructed:function(){return!1},getDims:D,getPercentInView:N,getLocationState:V,getOnPageViewability:function(){return Fa()?h.OUT_OF_VIEW:V()},getDetectionMethod:function(){return c},getContainerDims:function(){return A.allowsOptimization?
u:G(d)},refresh:function(){K=B=L=q=m=u=void 0;if(k){var a,c;if(!t.isDomless()&&(c=b.parentNode)){for(;b!==x&&c&&c!==I&&!a;)a=c===d,c=c.parentNode;a||(d=b.parentNode)}}},getAdNode:function(){return b},getSliceStatus:function(){var a;p&&p.isReadyToMeasure()?a=p.getSliceStatus():t.friendly&&w&&f.isDef(B)&&(a=w.getSliceStatus(B,L,q,K));return a}}},fd=function(a,b){var c=[],d,e=f([]),k=function(){return c[0]&&c[0].getDetectionMethod()===h.DETECTION_METHODS.AD_PLACEHOLDER},u=function(m,r,p,q){var u=k()||
...
getAdContainer:function(){return n.contextNode.parentNode},allowForAdContainerChange:!0}},pd=function(){var a,b=s.getDoc().scripts,c=function(){a||(a=f(b).findFirst(function(a,b){return J.contains(b.src,"servedby.flashtalking")}));return a};return{detectionMethod:h.DETECTION_METHODS.BUSTED_IFRAME_FLASHTALKING,isApplicable:function(a,b){return b.on("bustediframe")&&a.embedded&&void 0!==c()},getCssSelector:function(){var b,e=a||c(),f=/;(\d+);/;e&&e.src&&(b=e.src.match(f)[1]);return"#ftdiv"+b}}},qd=
function(){return{isApplicable:function(a,b){var c;try{c=v.getFrameId()}catch(d){}return b.on("yieldmo")&&c&&J.contains(c,"_tpi")&&v.crossQuerySelector("[data-href*='ads.yieldmo.com']",!0)},getCssSelector:function(){return"[id='"+v.getFrameId().replace("_tpi","")+"']"},detectionMethod:h.DETECTION_METHODS.BUSTED_IFRAME_YIELDMO}},rd=function(){var a,b,c=s.getDoc(),d=function(){var b;a||(a=(b=(b=v.querySelector(c,"div[id*='ebDiv']"))&&b.id)&&b.split("ebDiv")[1]);return a},e=function(){var a;b||(b=(a=
(a=v.crossQuerySelector("iframe[id*='ebBannerIFrame_'][id$='"+d()+"']",!0))&&a.id)&&"#"+a);return b};return{detectionMethod:h.DETECTION_METHODS.BUSTED_IFRAME_SIZMEK,isApplicable:function(a,b){var c=s.getWindow(),h=a.friendlyIframe&&s.getWindow().frameElement,h=h&&G(h).isOneByOne(),p=function(){var a=s.getDoc().scripts;return f(a).findFirst(function(a,b){return J.contains(b.src,"bs.serving-sys.com/BurstingPipe/adServer")})}(),c=c.EBG&&c.EBG.ads&&!f(c.EBG.ads).isEmpty();return b.on("sizmek")&&p&&c&&
...
!b.adDimensions)return b;p||(k=b.method,d=b.adDimensions,d.isMrcLarge(),O(d));if(f.isUndef(e)||!e.isReadyToMeasure())p=!1;f.isUndef(u)&&p&&(u=x.isLikelyToProduceFalsePositive(d));if(B=!u&&p){var n;p=e.getPercentInView();var z=C(),E=1===b.tabHidden,y=b.adDimensions.isMrcLarge()?30:50;q=s.now()-w;n=0<w?900>q:!0;w=s.now();0===b.adDimensions.area()&&(p=0);n||(p=0);var D=p;r.push({tm:t.getTagTime(),piv:D});3<r.length&&r.shift();0===p&&0<z&&(n&&(n=r.length-1,D=!0,2<=r.length&&-1<n&&(D=0===r[n].piv&&0===
...
return!b.isInView});return c},K=function(){var a,b,c,d=[];p.mbs=[];f(k).each(function(b,c){a=c.isInView();p.mbs.push(a);d.push({isInView:a,percentInView:c.percentInView})});b=x(d,!1);c=x(d,!0);return s.max(b,c)};(function(){d=l?v(e):q(e);var b=d.get();f(b).each(function(b,d){var e=new a(c,d.x,d.y,d.width,d.height,d.percentInView);k.push(e)})})();return{getPercentInView:function(){var a=n(),b=K();p.mbrd=a?1:0;b!=p.mbp&&p.mbivs.push([t.getTagTime(),b]);p.mbp=b;return a?b:-1},removePixels:function(){f(k).each(function(a,
...
(x=!0,w=v?h.IN_VIEW:h.OUT_OF_VIEW):d.indicatesNormalSize()&&(x=!1,w=v?!1:h.OUT_OF_VIEW));b=d;p.push(b);r&&J();return b},E=function(b){var c,k,h=na().wrapToGlobal(z),p=function(a){f.isStr(a)&&(l.provide("vc",function(){return a}),l.trigger("addOutputItem",{output:a},"vc",{type:"impression"}))};try{k=b[e]||b.getIasVidBridgeVersion,c=f.isFunction(k)&&"2"===k.call(b)?unescape(b[d].call(b,a,h)):unescape(b[d].call(b,a)),q=!0,p(c||"n")}catch(m){__IntegralASDiagnosticCall("handshakefailure",m,n)}},H=function(){var c=
function(a){return f(f(a).toArray()).findFirst(function(a,b){return f.isFunction(b[d])})};k||(f([".integral-vid-"+a,"ias-ad","object","embed"]).findFirst(function(a,b){var d=s.getDoc().querySelectorAll(b);return k=c(d)}),!k&&b.on("novidnodeerr")&&__IntegralASDiagnosticCall("novidnode",{},n));return k},G=function(){var a=H();a&&!q&&E(a);return a},I=function(a){a=(new Ia).getVolumeFromContext(a);D=f.isDef(a)?0<a:!1},J=function(){f(p).each(function(a,b){b&&(f.isUndef(b.sl)&&b.updateScreenLoc(c.getCurrentLoc()),
b.trigger(),b.indicatesCompletion()&&l.trigger("adSessionComplete"))});p=[];r=!0};(function(){y.addEvent(s.getWindow(),"message",function(a){z(a)});l.on({volumeChanged:I});l.provide({videoEventsString:C,videoVersion:function(){var a,b=G();try{a=b.getVersion()}catch(c){a=-1,l.trigger("error",h.ERROR_CODES.NO_VIDEO_AD_INTERFACE)}return a},videoTranslator:function(){return u=u||new Kd},videoAutoplay:function(){return m=m||new Fd},adNode:G});G();F.listenForResult();A.isApplicable(t)&&A.start(c)})();return{findAdNode:G,
getViewStateOverride:function(){return w},isHandshakeComplete:function(){return q},triggerInitializationEvents:J,setVideoSpecificScreenEventFields:function(a){var b=a.viewState===h.NA;a.isVideoPlaying=!0;a.isSoundOn=D;a.isVideoPlayingInFullscreen=!1;if(w){if(w===h.OUT_OF_VIEW){var c=a.reason?a.reason.split("."):[];c[c.length]=h.OUT_OF_VIEW_REASONS.VIDEO;a.reason=c.join(".")}a.viewState=b?a.viewState:w;a.isVideoPlaying=w===h.IN_VIEW}x&&v&&(a.percentInView=100,a.isVideoPlayingInFullscreen=!0)}}},Ld=
...
Lb=function(){return{start:function(a,b){f(a).each(function(a,d){b.getEnabledScriptUrl(d)&&Td(d,b).start()})}}},Qd=function(a){return{hash:function(){for(var b=0,c=a.length,d=[],e;b<c;b++)e=a[b].filename.replace(/\.plugin$/,""),e=J.hashCode(e),e=f.toBase(e,62).slice(-4),d.push(e);return d},decode:function(b){var c,d;c=s.floor(s.random()*b.length);d=encodeURIComponent(a[c].filename.replace(/\.plugin$/,""));return[b[c],d]}}},Sd=function(a,b){var c,d=/MSIE [1-9][^0-9]/g;(function(b){var f;c=v.createHiddenIframe();
