...
try {
	...
	var __IntegralASConfig = {
		...
		protocol: 'https',
		jsref: "",
		asid: "e7dee575-bec9-11ea-b4de-0a30f786b825",
...
e.height<a&&(a=1,b=[100]);for(e=0;e<a;e++)c.push(!1);return d={numberOfSlices:a,defaultSliceArray:c,percentInViewSliceArray:b}}}},Sd=function(){var a,b,c=0,d=-1,e=0,k=l.getAggregator().request("browser"),g=function(){var a,b;a=l.getAggregator().request("pageUrls").getDetectedURLs();a=f(a).findFirst(function(a,c){b=void 0;return(b=c&&decodeURIComponent(c).match(/^(?:https?:\/\/)?(?:[^@\n]+@)?(?:www\.)?([^:\/\n]+)/im)[0])&&null!==b.match(/(insider)|(bustle)|(wikia)/i)});return f.isDef(a)};b=r.setInterval(function(){var a=
r.now();d=a-e;e=a;c++;10<=c&&b&&r.clearInterval(b)},50);return{isLikelyToProduceFalsePositive:function(c){var e;c=c.getRounded().height;var f=s.calcMonDims().height,l=k.getUserAgent(),l=l&&null!==l.match(/(FBAN)/)?1:0,m=k.getUserAgent(),m=m&&null!==m.match(/(iPad)/)?1:0,t=g()?1:0,B=k.getUserAgent(),B=B&&null!==B.match(/(Version\/9\.0)|(CriOS\/55)/)?1:0;e=r.pow(Math.E,0.0033*c-9.26E-4*f-0.340351*l-0.874412*m+0.646972*t+0.28118*B+2.987259*(1E3<d?1:0)-2.463292);e/=1+e;a={mbah:c,mbsh:f,mbfb:l,mbip:m,
mbhs:t,mbbr:B,mblr:d,mbp:e};b&&r.clearInterval(b);return 0.15<e},getDebugState:function(){return a}}},Wc=function(a,b,c){var d,e,k,u,n,p=[],q=m.contextNode.parentNode,v=0,s=0,A=!1,B=!1,w=new Sd,x=function(){var a=p.length-1,b=-1;-1<a&&(b=p[a].piv);return b},D=function(){l.getAggregator().trigger("delayedViewabilityReadyCallOnly")},y=function(a){z.whenReady(function(){e=new Td(a,r.getDoc().body)})},C=function(){e.removePixels()},F=function(){var a=w.getDebugState(),b=x();f.isUndef(a)&&(a={});a.mbm=
f.fromBoolToNum(B);a.mbrd=f.fromBoolToNum(A);a.mbtg=f.isDef(q.tagName)?q.tagName:"na";a.mbaf=f.isDef(k)?k:"na";a.mbad=f.isDef(d)?d.getRounded().width+"_"+d.getRounded().height:"na";a.piv=f.isDef(b)?b:-1;b={minDt:!1,type:"dm"};try{l.getAggregator().trigger("addOutputItem",{output:a},b),l.getAggregator().trigger("addOutputItem",{output:-101},"pingTime",b),l.getAggregator().trigger("sendDt",b.type)}catch(c){}};return{getScreenLocationInfo:function(b,c){var q;q=f.isDef(d);if(c||!b.adDimensions)return b;
q||(k=b.method,d=b.adDimensions,y(d));if(f.isUndef(e)||!e.isReadyToMeasure())q=!1;f.isUndef(u)&&q&&(u=w.isLikelyToProduceFalsePositive(d));if(B=!u&&q){var m;q=e.getPercentInView();var C=x(),P=1===b.tabHidden;s=r.now()-v;m=0<v?900>s:!0;v=r.now();0===b.adDimensions.area()&&(q=0);m||(q=0);var F=q;p.push({tm:t.getTagTime(),piv:F});3<p.length&&p.shift();0===q&&0<C&&(m&&(m=p.length-1,F=!0,2<=p.length&&-1<m&&(F=0===p[m].piv&&0===p[m-1].piv),m=!F),m&&(q=C));a?(f.isUndef(n)&&(n=l.getAggregator().request("video")),
n.setVideoSpecificScreenEventFields(b),q=b.isVideoPlayingInFullscreen?!0:!P&&50<=q&&b.isVideoPlaying):q=!P&&50<=q;b.viewState=q?g.IN_VIEW:g.OUT_OF_VIEW;b.percentInView=x();C=[];P=f(b.reason);m=g.OUT_OF_VIEW_REASONS;q||C.push(m.GEOM);P.contains(m.HIDDEN)&&C.push(m.HIDDEN);P.contains(m.OBSTRUCTION)&&C.push(m.OBSTRUCTION);b.reason=C;b.sliceStatus=e.getSliceStatus();A||(A=!0,r.execAtEndOfThread(D))}else b.viewState=g.NA,b.percentInView=-1;return b},start:function(){l.getAggregator().on("endAdSession",
C);c&&r.setTimeout(F,2E3)},getStrategyName:function(){return"mobileWebXdomainSafari"},isMeasurable:function(){return B},isImmediate:function(){return!0},hasMeasurementStrategy:function(){return!0}}},Ka=function(a,b,c,d){return{accepts:function(){var e=c.xDomainIframe,f=a.bootstrapOn("mobOrTab"),l=a.on("ios"),n=b.browserIs(g.BROWSERS.WEBKIT),p=9<=b.getIOSVersion(),q=d.isMobileAppEnvironment();return e&&f&&l&&n&&p&&!q},isImmediate:function(){return!1},start:function(){}}},Ud=function(a,b,c,d,e,k,l){var n,
p=m.birthdate+""+r.round(1E6*r.random()),q=101,v,t,s,w=!1,z=function(){return'<html><body><script type="text/javascript">'+("("+function(a){var b=a.document;try{b.body.setAttribute("data-st","iasInit");var c,d=0,e=0,f=!1,k=(new Date).getTime(),g=function(){e=(new Date).getTime()-d;(f=b.body.isReady())&&(c=0<d?900>=e:void 0);d=(new Date).getTime();a.requestAnimationFrame(g)};a.requestAnimationFrame(g);b.body.isInView=function(a){return{isInView:c,rate:e,lastUpdateTimestamp:d}};b.body.getRate=function(){return e};
...
(b=c.isReady?c.isReady():!1)&&(t=c.isInView?c.isInView:void 0)&&x(105)}}catch(d){x(106,d)}return f.isDef(t)},y=function(a,b,c){var k=M.createElement("iframe");k.id=p;f(k.style).mixin({position:"absolute",width:d+"px",height:e+"px",backgroundColor:"transparent",border:"none",padding:"0px",margin:"0px",zIndex:"-999"});var n=k.style;k[g.IAS_DETECTOR]="true";n.left=b;n.top=c;a.appendChild(k);v=k;x(102);a=v;try{var l=a.contentWindow,q=z();l.document.open();a.contentWindow.document.write(q);l.document.close()}catch(m){x(103,
m)}return k}(a,b,c);return{isInView:function(){var a,b,c=!1;r.now();D()&&(a=t(!0),c=a.isInView,w=!1,n&&(b=20*n.rate+n.lastUpdateTimestamp,0<b&&b<a.lastUpdateTimestamp&&(c=!1,w=!0)),x(107),n=a);return c},isNotReadyToReport:function(){return!D()},createdElement:v,remove:function(){y.parentNode&&y.parentNode.removeChild(y)},getStatus:function(){return q},getError:function(){return s},isReadingInvalid:function(){return w},getRate:function(){return v.contentWindow&&v.contentWindow.document&&v.contentWindow.document.body&&
...
[];f(k).each(function(b,c){a=c.isInView();q.mbs.push(a);d.push({isInView:a,percentInView:c.percentInView})});b=w(d,!1);c=w(d,!0);return r.max(b,c)};(function(){d=l?A(e):s(e);var a=d.get();f(a).each(function(a,d){var e=new Ud(b,d.x,d.y,d.width,d.height,d.percentInView,c);k.push(e)})})();return{getPercentInView:function(){var a=m(),b=z();q.mbrd=a?1:0;b!=q.mbp&&q.mbivs.push([t.getTagTime(),b]);q.mbp=b;return a?b:-1},removePixels:function(){void 0!==c&&c.stop();f(k).each(function(a,b){try{b.remove()}catch(c){}})},
getPixelStateForDebug:function(){q.mbm=1;k&&0<k.length&&(q.mbpr=[],q.mbir=[],f(k).each(function(a,b){q.mbpr.push(b.getRate());q.mbir.push(b.isReadingInvalid()?1:0)}));return q},isReadyToMeasure:m,getSliceStatus:function(){var a;k&&0<k.length&&(a=[],f(k).each(function(b,c){a.push(c.isInView())}));return a}}},rd=function(a,b){var c={mbrd:!1,mbvs:[],mbe:"n",mbv:9,mbs:[],mbm:1,mbivs:[]},d=function(a,b){var c=[],d=a.geometry.value();f(b).each(function(b,e){if(a.geometry.doesIntersect(e)){var f=e.value(),
...
e?l.getAggregator().persistentTrigger(e,g,u):l.getAggregator().trigger(e,g,u)},toString:function(){return"{"+f(d).toParams()+"}"}}).mixin(d)},Yd=function(){var a=[];return{registerEvent:function(b,c,d){b=new Xd(b,c,d);a.push(b);return b},toString:function(){return"{"+f({vEventCount:a.length,vEvents:"["+a.join(",")+"]"}).toParams()+"}"},isEmpty:function(){return 0===a.length}}},Zd=function(){var a,b,c,d=function(d){c=f.isDef(d)?0===d:c;b&&c&&a.addState({isFullyInView:function(){return!1}})},e=function(){a&&
a.hasAlwaysBeen(!0)&&l.getAggregator().trigger("sendDt",g.DT_CODES.QUARTILE_FULLY_INVIEW)},k=function(){b=!0;d()},m=function(a){a=(new Sa).getVolumeFromContext(a);d(a)};return{isApplicable:function(a){return a.usesGroupMCustomMetric()},start:function(c){l.getAggregator().on({adVideoStart:k,adImpression:k,volumeChanged:m,adVideoMidpoint:e});a=c.createViewabilityTracker("mpt",function(a){var c=l.getAggregator().request("isFullyInViewProvider");return!b||c&&c.isFullyInView(a)})}}},$d=function(){var a=
{AdPaused:"pauseAd",AdVolumeChange:"volumeChanged",AdPlaying:"resumeAd"};return{translate:function(b){var c=b.charAt(0).toLowerCase()+b.slice(1);b in a&&(c=a[b]);return c}}},Sa=function(){return{getVolumeFromContext:function(a){var b,c=-1;f.isDef(a)&&(f.isDef(a.volume)?c=a.volume:f.isDef(a.adVolume)&&(c=a.adVolume));-1!==c&&(b=c);return b}}},jb=function(a,b,c){var d="IASid"+a,e="getIasVidBridgeVersion"+a,k,u,n,p=[],q=g.OUT_OF_VIEW,v=!1,s=!1,w=!1,B=!0,y=new Yd,x=Zd(),D=new Wd,I=new Sa,C=new Ga,F=function(b){var d;
v=!0;var e={};try{e=JSON.parse(unescape(b&&b.data?b.data:b))}catch(f){e={}}e.id==a&&(d=y.registerEvent(e,c.getCurrentLoc()),d.indicatesPlaying()?(s=!0,q=w?g.IN_VIEW:!1):d.indicatesNotPlaying()?(s=!1,q=g.OUT_OF_VIEW):d.indicatesFullscreen()?(w=!0,q=s?g.IN_VIEW:g.OUT_OF_VIEW):d.indicatesNormalSize()&&(w=!1,q=s?!1:g.OUT_OF_VIEW),b=parseFloat(d.getVolume(I)),0<b?B=!0:0===b&&(B=!1));p.push(d);n&&M();return d},H=function(b){var c,g,k=oa().wrapToGlobal(F),n=function(a){f.isStr(a)&&(l.getAggregator().provide("vc",
...
b){var d=r.getDoc().querySelectorAll(b);return k=c(d)}),!k&&b.on("novidnodeerr")&&__IntegralASDiagnosticCall("novidnode",{},m));return k},L=function(){var a=G();a&&!v&&H(a);return a},J=function(a){a=I.getVolumeFromContext(a);B=f.isDef(a)?0<a:!1},M=function(){C.init();f(p).each(function(a,b){b&&(f.isUndef(b.sl)&&b.updateScreenLoc(c.getCurrentLoc()),b.trigger(),b.indicatesCompletion()&&l.getAggregator().trigger("adSessionComplete"),b.indicatesQuartile()&&("adVideoComplete"!==b.tp&&l.getAggregator().trigger("sendDt",
g.DT_CODES.VIDEO_EVENTS),l.getAggregator().trigger("videoQuartileEvent",b)))});p=[];n=!0};(function(){z.addEvent(r.getWindow(),"message",function(a){F(a)});l.getAggregator().on({volumeChanged:J});l.getAggregator().provide({videoEventsString:y,videoVersion:function(){var a,b=L();try{a=b.getVersion()}catch(c){a=-1,l.getAggregator().trigger("error",g.ERROR_CODES.NO_VIDEO_AD_INTERFACE)}return a},videoTranslator:function(){return u=u||new $d},adNode:L});L();D.listenForResult();x.isApplicable(t)&&x.start(c)})();
return{findAdNode:L,getViewStateOverride:function(){return q},isHandshakeComplete:function(){return v},triggerInitializationEvents:M,setVideoSpecificScreenEventFields:function(a){var b=a.viewState===g.NA;a.isVideoPlaying=!0;a.isSoundOn=B;a.isVideoPlayingInFullscreen=!1;if(q){if(q===g.OUT_OF_VIEW){var c=a.reason?a.reason.split("."):[];c[c.length]=g.OUT_OF_VIEW_REASONS.VIDEO;a.reason=c.join(".")}a.viewState=b?a.viewState:q;a.isVideoPlaying=q===g.IN_VIEW}w&&s&&(a.percentInView=100,a.isVideoPlayingInFullscreen=
...
g.PERF_TIMELINE_TRACKER_CONFIG.VANS.COUNT)},T={IDS:{BLOCK_TIME:"pBlk",ON_LOAD:"pLoad",IN_BROWSER_DELAY:"pWait"},recordBlockingTime:function(){l.getAggregator().trigger("measureTime",T.IDS.BLOCK_TIME)},setupOnLoadTracking:function(){z.addEvent(w,"load",function(){l.getAggregator().trigger("measureTime",T.IDS.ON_LOAD)})},setupBrowserDelayTracking:function(){var a=new Da;a.onTick({4:function(){l.getAggregator().trigger("markTime",T.IDS.IN_BROWSER_DELAY)},5:function(){l.getAggregator().trigger("measureTime",
T.IDS.IN_BROWSER_DELAY)}});a.start()}},N={isFrameworkAvailable:function(a,b){var c,d,e=r.getTop(),f=r.getWindow();try{c=e[a]}catch(g){for(;!d;){try{f.frames[b]&&(d=frame)}catch(l){}if(f===e)break;f=f.parent}}return c||d},getMessageHandler:function(a,b){var c=N.getCallId(),d=function(e){try{e&&e.data&&e.data[a]&&e.data[a].callId===c&&e.data[a].returnValue&&(b(e.data[a].returnValue),z.removeEvent(r.getWindow(),"message",d))}catch(f){l.getAggregator().trigger("error",g.ERROR_CODES.GDPR)}};return d},
getCallId:function(){return"ias_"+m.asid},send:function(a,b){l.getAggregator().trigger("addThrottledProp",g.DT_SLOT.ENVIRONMENT,a,b)}};l("CCPAConsentDetector",[],function(){function a(a){a&&N.send(b,f(a).toION())}var b="ccd";(function(){var b=N.isFrameworkAvailable("__uspapi","__uspapiLocator");N.send("cca",!!b);if(b){var d,e;f.isFunction(b)?b("getUSPData",1,a):(d={__uspapiCall:{command:"getUSPData",version:1,callId:N.getCallId()}},e=N.getMessageHandler("__uspapiReturn",a),z.addEvent(r.getWindow(),
"message",e),b.postMessage(d,"*"))}})()},{tier:g.TIERS.ENVIRONMENT,applies:function(a,b,c){return b.hasPostMessage()&&!c.isDomless()}});l("GDPRConsentDetector",[],function(){function a(a){var e=f.isDef(a)&&f.isDef(a.vendorConsents)&&f.isDef(a.vendorConsents[b])?a.vendorConsents[b]:void 0;a={appl:f.stringifyTriState(a.gdprApplies),cnst:f.stringifyTriState(e),glbl:f.stringifyTriState(a.hasGlobalScope),mtdt:encodeURIComponent(a.metadata)};N.send(c,f(a).toION())}var b=278,c="gcd";(function(){var c=N.isFrameworkAvailable("__cmp",
"__cmpLocator");N.send("gca",!!c);if(c){var e,g;f.isFunction(c)?c("getVendorConsents",[b],a):(e={__cmpCall:{command:"getVendorConsents",parameter:[b],callId:N.getCallId()}},g=N.getMessageHandler("__cmpReturn",a),z.addEvent(r.getWindow(),"message",g),c.postMessage(e,"*"))}})()},{tier:g.TIERS.ENVIRONMENT,applies:function(a,b,c){return b.hasPostMessage()&&!c.isDomless()}});l("GDPRV2ConsentDetector",[],function(){function a(a){var e=f.isDef(a)&&f.isDef(a.vendor)&&f.isDef(a.vendor.consents)&&f.isDef(a.vendor.consents[b])?
a.vendor.consents[b]:void 0;a={appl:f.stringifyTriState(a.gdprApplies),cnst:f.stringifyTriState(e)};N.send(c,f(a).toION())}var b=278,c="gcd2";(function(){var c=N.isFrameworkAvailable("__tcfapi","__tcfapiLocator");N.send("gca2",!!c);if(c){var e,g;f.isFunction(c)?c("getTCData",2,a):(e={__tcfapiCall:{command:"getTCData",parameter:[b],callId:N.getCallId(),version:2}},g=N.getMessageHandler("__tcfapiReturn",a),z.addEvent(r.getWindow(),"message",g),c.postMessage(e,"*"))}})()},{tier:g.TIERS.ENVIRONMENT,applies:function(a,
b,c){return b.hasPostMessage()&&!c.isDomless()}});l("postMessageDetector",[],function(){var a=!1,b="pmdetector"+m.asid,c=function(c){(c&&c.data)===b&&(a=!0)};(function(){var d=r.getWindow();z.addEvent(d,"message",c);d.postMessage(b,"*");r.execAtEndOfThread(function(){l.getAggregator().trigger("addThrottledProp",g.DT_SLOT.IM,"pom",f.stringifyTriState(a));z.removeEvent(d,"message",c)})})()},{tier:g.TIERS.ENVIRONMENT,applies:function(a,b,c){return a.on("pmdetect")&&b.hasPostMessage()}});l("safeFrameDetector",
[],function(){l.getAggregator().trigger("addThrottledProp",g.DT_SLOT.IM,"sf",f.stringifyTriState(t.isSafeFrame()))},{tier:g.TIERS.ENVIRONMENT,applies:function(a,b,c){return a.on("sfdetect")}});var Rb=function(){var a=m.asid,b=m.cookieBaseURL,c=m.protocol,d=function(a){f(a).each(function(a,b){l.getAggregator().trigger("notify",b)})},e=function(){var e;e=new S(c+"://"+b,!0);e.setParam("asid",a);e=e.toString();l.getAggregator().trigger("jsonp",e,d,!0);l.getAggregator().trigger("updateDtCount")};return{start:function(){l.getAggregator().on("sendCookie",
e)},isApplicable:function(a){return a.on("cookie")&&a.bootstrapOn("sendCookie")&&a.bootstrapperHas(["protocol","cookieBaseURL","asid"])}}},Sb=function(a,b,c,d,e,f,r){var n=function(a,b){return isNaN(a)||0>a||""===a?b:a};return{send:function(p){try{var q,s=d.baseUrl,w,A,B=f.getDocumentMode();"number"===typeof B?(A=2E3,8===B?A=4E3:8<B&&(A=8E3)):A=n(m.sp_imp_maxLength,2E3);w=A;if(t.integratedBlockingApplies(s)){A=s;var y=l.getAggregator().request("mobileApp"),x=y&&y.isMobileAppEnvironment&&y.isMobileAppEnvironment(),
z=m.contextNode.getAttribute("data-ias-container"),I=m.contextNode.getAttribute("data-ias-callback"),y=A+"adContainerId="+z+"&cbFunctionName="+I,y=x?y.replace("monitoring","blocking"):y.replace("skeleton.js",m.integration+".js"),C=m.protocol+":"+m.staticServer+m.integration+"a.js",F=m.protocol+":"+m.staticServer+m.integration+".js",s=y+"&true_pb="+encodeURIComponent(m.passback)+(x?"&redirectUrl="+encodeURIComponent(F):"")+(x?"&passback=":"&adsafe_pb=")+encodeURIComponent(C)+"&"}var x=s=s.replace(g.UNIQUE_ID_TOKEN,
m.asid),H=s.length,G,L,J=n(m.sp_imp_jsInfo_minLength,0),C="";try{G=w-H-J,0<G&&(L=ce(p,G,14,b.on("partialUrls")),C+=L.join("&"))}catch(M){a.add(g.ERROR_CODES.IMPRESSION_URLS)}s=x+C;p=s+="&"===s.slice(-1)?"":"&";var N,H="";try{N=w-s.length,H+=de(N,"adsafe_jsinfo=",a,b,c,e,f,r)}catch(O){a.add(g.ERROR_CODES.JSINFO),H+="adsafe_jsinfo=e:"+a.toString()}s=p+H;d.macroUrl&&(s+="&"===s.slice(-1)?"":"&",s+=d.macroUrl);q=s;d.sendImpression(q);m.impUrl=q;l.getAggregator().trigger("impressionsent")}catch(Q){__IntegralASDiagnosticCall("impsend",
Q,m)}}}},de=function(a,b,c,d,e,k,s,n){return function(c){var d=c.primary.join(","),g=b,k=0,l=function(a){if(a)return","+a};g.length+d.length+5<=a&&(g+=l(d),e.impressionIsIdentifiable(!0),f(c.secondary).each(function(b,c){g.length+c.length+5<=a?g+=l(c):k+=1}));return g+=",ov:"+k}(function(){var a,b;b=a={viewState:g.NA};t.isDomless()?b=n.checkScreenLoc(!0)||a:d.on("impFailSafe")?r.getDoc().body&&(b=(b=n.checkScreenLoc(!0))?b:a):f.isDef(r.getDoc().body)&&(b=n.checkScreenLoc(!0));n.isImmediatelyMeasurable()||
n.requiresDelayedViewabilityEvent();a=b;var v=a.viewState;b=e.getAvidIds();v=["id:"+m.asid,"c:"+e.getCacheBustId(),"sl:"+v,"em:"+t.embedded,"fr:"+t.friendly];d.on("avidPropertiesInImpression")&&f.isDef(b)&&(v.push("abi:"+b.bundleIdentifier),v.push("apn:"+b.partner),v.push("apv:"+b.partnerVersion));a=ee(a,c,d,e,k,s,n);l.getAggregator().trigger("eligiblerender");return{primary:v,secondary:a}}())},ee=function(a,b,c,d,e,k,u){var n=[],p=l.getAggregator().request("mPage");n.push("mn:"+m.mn);n.push("pt:"+
function(){var b=u.stringifyPingTimes();a.viewState!==g.NA&&(b+=a.details);return b}());n.push(f(k.params()).toParams());c.on("mrcAudit")&&!t.isDomless()&&n.push("dvs:"+r.getDoc().visibilityState);e.iterate(function(a,b){var c=!b.props||f.isUndef(b.props.type),d=!b.props||b.props.type===g.IMPRESSION_EVENT;(c||d)&&n.push(a+":"+b.output())});b.toString()&&n.push("e:"+b.toString());n.push(c.output());n.push("tt:"+m.mode);n.push("thd:"+f.stringifyTriState(p.supportsVisAPI()));n.push("et:"+(r.now()-m.birthdate));
m.perf.mark("si");c.on("swapids")?n.push("oid:"+m.oid):n.push("uid:"+d.unq);n.push("v:19.8.100");n.push("sp:"+(m.isSplitMode?1:0));n.push("fwm:"+("true"===m.fwMonitoring?1:0));c.on("resolution")&&(n.push("wr:"+f(s.windowSize()).toArray().join(".")),n.push("sr:"+f(s.screenSize()).toArray().join(".")));b=function(){var a;a=String(m.scriptUrl).toLowerCase();var b=a.indexOf("ias_xpc");-1<b?(a=a.substring(b+7+1),b=a.indexOf("&"),a=-1<b?a.substring(0,b):a):a="NotFound";return a||""}();"NotFound"!==b&&n.push("x_xpc:"+
