...
try {
	var __IntegralASConfig = {
		...
		sp_cdnScripts: {xsca: "static.adsafeprotected.com/xsca.17.4.85.js", sca: "static.adsafeprotected.com/sca.17.5.12.js", main: "static.adsafeprotected.com/main.19.8.240.js"},
		protocol: 'https',
		jsref: "",
		asid: "d592d67e-0818-11ec-8524-067641d02172",
...
f.integratedBlocking&&p&&p.on("exitOASRSEarly")&&(f.omidEarlyExit=!0,q="1",f.omidEarlyExit&&-1<l.mobFwUrl.indexOf("xmtp=v")&&(f.mediaType="video")),!a.data.mediaType||"display"!==a.data.mediaType&&"video"!==a.data.mediaType||(f.mediaType=a.data.mediaType));f.omidEarlyExit&&(c=!0,x("omtp",f.mediaType),g()&&(d=!0),"video"===f.mediaType&&(f.isVideo=!0),f.isNativeVideo=f.isNative&&f.isVideo,f.isDisplay="display"===f.mediaType);for(var k=[{root:"omidNativeInfo",code:"onpn",field:"partnerName"},{root:"omidNativeInfo",
...
a.data.hasOwnProperty("impressionType")&&(f.impressionType=a.data.impressionType),!0!==f.omidEarlyExit||t||(A("addThrottledOutputItem","oiet",f.impressionType),A("addThrottledOutputItem","oct",f.creativeType),t=!0),G())};return{start:function(){y.registerSessionObserver(ib,"IAS");y.addEventListener("impression",kb)}}},Bc=function(){return{accepts:function(){return!0}}},Ia=function(){var a=n.getAggregator().request("omidAdSessionContext"),b=n.getAggregator().request("omidVerificationClient"),c=new aa(b),
...
addScreenLocationChangedListener:function(a){b.on("screenLocationChanged",a)}}},Ad=function(a,b){var c=[],d=(new Date).getTime(),e=0,f=0,q=!1,m=new Ka,p=n.getAggregator().request("omidAdSessionContext"),u=r.getWindow(),y=(u=u&&u.omid3p)&&g.isFunction(u.registerSessionObserver)&&g.isFunction(u.addEventListener)?u:a,v=!1,s={isEmpty:function(){return 0===c.length},toString:function(){for(var a="{vEventCount:"+c.length+",vEvents:[",b=0;b<c.length;b++)var d=c[b],a=a+((0<b?",{":"{")+("t:"+d.t+",")+("rt:"+
d.rt+",")+("tp:"+d.tp+",")+("sl:"+d.sl+",")+("ad_duration:"+d.ad_duration+",")+("volume:"+d.volume)+"}");return a+"]}"}},x=function(){q=!0},A=function(a){if(-1!=="|start|firstQuartile|midpoint|thirdQuartile|resume|bufferFinish|complete|pause|bufferStart|skipped|playerStateChange|loaded|volumeChange|".indexOf("|"+a.type+"|")){v&&(p.cachedVideoEventsReceived=!0,p.cachedEvents.push(a));try{var m="",u=a.hasOwnProperty("timestamp")?a.timestamp:(new Date).getTime(),y=u-(l.birthdate||u+1),x="n",r=!1;switch(a.type){case "start":m=
...
v=!0;y.addEventListener("video",A);v=!1;p.cachedVideoEventsChecked=!0;p.cachedVideoEventsReceived&&p.processCachedEvents();m.init()},addVideoPlaybackEventListener:function(a){b.on("videoPlaybackEvent",a)}}},Oa=function(a,b){var c=!1,d=function(a){var d=a.percentageInView;c=!0;a.viewState=50<=d?k.IN_VIEW:k.OUT_OF_VIEW;a.outOfViewReason=50<=d?"":k.OUT_OF_VIEW_REASONS.GEOM;b.trigger("measurementChanged",a)};return{start:function(){n.getAggregator().trigger("addOutputItem",{output:k.MEDIA_TYPE.DISPLAY_CODE},
...
P=q(t,G),I=e.outOfViewReason,N=0,M=0,B=A||!1,N=1>=G.width*G.height;c&&N&&(w=!1,I=I||"",w||-1!==I.indexOf(k.OUT_OF_VIEW_REASONS.GEOM)||(I=k.OUT_OF_VIEW_REASONS.GEOM+(""!==I?"."+I:"")));if(w&&0<e.percentageInView){N=d(n,v,P);A?(F=m(v,P),F=f(n,v,F),F=q(v,F),F=a.calculateObstructedArea(F,s)):F=0;M=F;F=Math.round((N-M)/(P.width*P.height)*100);A&&0===M&&(B=!1);for(var G=(new D(P)).getRoundedGeometry(),w=B,O,A=0,M=b.getConfig(G).numberOfSlices,T=r.floor(G.height/M)||1,s=[],N=w?a.getObstructionStatusBySlice(M):
[],Ea,A=0;A<M;A++)O=G.y+T*A,A==M-1&&(T=G.y+G.height-O),O={x:G.x,y:O,width:G.width,height:T},Ea=d(n,v,O),O=1==Ea/(O.width*O.height),s.push(O);if(w)for(v=r.min(N.length,M),A=0;A<v;A++)s[A]=s[A]&&!N[A];v=s}else v=b.getConfig(G).defaultSliceArray;t={windowDimensions:n,containerDimensions:t,adDimensions:P,percentageInView:F,viewState:50<=F?k.IN_VIEW:k.OUT_OF_VIEW,outOfViewReason:50<=F?"":I||k.OUT_OF_VIEW_REASONS.GEOM,detectionMethod:z,isObstructed:B,sliceStatus:v};g.isDef(x)&&""!==x&&(t.omidObstructions=
...
p=a.getConfig({height:f}).numberOfSlices;for(var n=r.floor(f/p)||1,s=[],x=0;x<f;x++){p=!1;for(var A=0;A<m;A++)if(1===k.matrix[A][x]){p=!0;break}q++;p&&(x+=n-q,q=n);if(q==n||x===f-1)s.push(p),q=0}c=s}}else c=b;return l},getObstructionStatusBySlice:function(){return c}}},Ed=function(a,b){var c=n.getAggregator().request("omidAdSessionContext");c.geometryChangeEvents=[];var d=null,e=!1,f=r.getWindow(),q=(f=f&&f.omid3p)&&g.isFunction(f.registerSessionObserver)&&g.isFunction(f.addEventListener)?f:a,m=new ga,
p=!1,u=!1,y=function(){var a=r.getDoc().getElementById("iasbi"+l.asid);a&&a.hasAttribute("CreativeLoaded")?(e=c.delayingViewabilityEvents=!1,d&&(v(d),d=null)):r.setTimeout(y,50)},v=function(a){if(a&&"geometryChange"===a.type&&a.data&&a.data.adView){p&&(c.cachedGeometryEventsReceived=!0,c.cachedEvents.push(a));var f=a.data.adView,q=!!(f.measuringElement&&f.containerGeometry&&f.onScreenContainerGeometry);10>c.geometryChangeEvents.length&&(c.geometryChangeEvents.push(s.getTagTime()+"."+f.percentageInView),
...
addMeasurementChangedListener:function(a){d.on("videoGeometryMeasurementChanged",a)},isMeasurable:function(){return v}}},Qa=function(a,b,c){var d,e=function(){var b=a.find(),e,m,p=!1;g.isDef(b)?(m=!0,e=b.getBoundingClientRect(),e={x:e.left,y:e.top,width:e.width,height:e.height},b.hasOwnProperty("adWasClipped")&&(e.adWasClipped=!0)):(d&&(p=!0,e={x:0,y:0,width:0,height:0}),m=!1);if(b=m)b=e,b=!g.isDef(d)||!1!==g(b).compareTo(d);if(b||p)d=e,c.trigger(k.OMID_GEOMETRY_MEASUREMENT_CHANGED,{adGeometry:e,
...
a},v=function(a,b,c,d){return d?!0:!b&&(a||d)&&c},s=function(a){var n=0,r=1===a.tabHidden,s=a.isVideoPlaying,y=a.isSoundOn,t=a.isVideoPlayingInFullscreen;g(a.sliceStatus).each(function(a,b){k(b,r,s,t)?e[a].mark():e[a].stop();m[a]=e[a].getTotalTime()});x("slcVt",m);d&&(g(a.sliceStatus).each(function(a,b){v(b,r,s,t)&&y?f[a].mark():f[a].stop();p[a]=f[a].getTotalTime()}),x("slcVtVol",p));l=d&&b&&b.shouldIncludeSound?p:m;a=g(l).findFirst(function(a,b){n=Math.max(n,b);return 0>=b});g.isUndef(a)&&c.doEligibleJobs(n)},
...
e);n.getAggregator().on("nodesAdded",f)}}},ae=function(a,b,c,d,e,f){var q,m,p,u,y,v,K,x,A,E=t.getElementsWindow(b);t.getElementsDocument(b);n.getAggregator().provide("iframeCalculatorHelper",Ud(E));var G=Vd(b,d),B=k.AD_IDENTIFIER+"-"+l.asid,C=!1,F=D({}),P=s.isDeviceTypeGroupMobile(),I=s.usesGroupMCustomMetricMobilePassThru(),N,M=function(){if(!q)if(q=G.calcDims(b,d,p),l.autotagSizeSet&&1<l.adWidth&&1<l.adHeight&&(q.set("width",l.adWidth),q.set("height",l.adHeight)),c===k.DETECTION_METHODS.VIDEO&&
s.embedded){var a=q,e=(new D(b)).getRounded();try{a.set("width",e.width),a.set("height",e.height)}catch(f){n.getAggregator().trigger("error",k.ERROR_CODES.VIDEO_IN_IFRAME_DIMS_CALC)}}else c===k.DETECTION_METHODS.AD_PLACEHOLDER&&q.treatAsPlaceholder();return q},H=function(){var b,d=s.xDomainIframe&&C;b=P&&C&&p.isReady();b=d||b;d=G.getClippedDims&&(c===k.DETECTION_METHODS.VIDEO&&s.embedded||s.isCeltra());b?m=p.getPiv():g.isUndef(m)&&(b=!P&&(s.friendly||g.isDef(w.mozInnerScreenX))&&e.on("offscreen"),
x=M(),K=new D(t.calcWinDims()),v=new D(b?t.calcMonDims():{}),A=d?G.getClippedDims():F,m=a.calcPercentInView(x,K,v,A));return m},O=function(){return a.calcInitialViewState(H())},T=function(){return b===w?!1:M().isHidden()};(function(){var d=r.getWindow(),e=r.getDoc(),f=b===d,g=e.body,m=n.getAggregator(),l=new Y,q=m.request("browser"),v=m.request("features"),m=m.request("context"),x=!s.xDomainIframe,e=f&&g?e.body:b;N=s.friendlyIframe?d.frameElement:e;z.addEvent(e,"click",function(){n.getAggregator().trigger("adComponentClicked")});
z.addEvent(e,"mouseover",function(){n.getAggregator().trigger("adComponentMousedOver")});l.applies(q,v,m)?(p=od(b,x),p.start(),C=!0,I&&c!==k.DETECTION_METHODS.AD_PLACEHOLDER&&(d=new Wd(M().getRounded()),l=new Xd,l=new Yd(p.getObservedNode(),l),u=new Zd(d.getSlices(),l))):I&&(y=new $d(a))})();return{mark:function(){t.setAttributeOf(N,B,"")},cleanup:function(){t.removeAttributeOf(N,B)},isNode:function(a){return b===a},isHidden:T,isObstructed:function(){return!1},getDims:M,getPercentInView:H,getLocationState:O,
getOnPageViewability:function(){return T()?k.OUT_OF_VIEW:O()},getDetectionMethod:function(){return c},getContainerDims:function(){return G.allowsOptimization?q:D(d)},refresh:function(){A=x=K=v=m=q=void 0;if(f){var a,c;if(!s.isDomless()&&(c=b.parentNode)){for(;b!==w&&c&&c!==J&&!a;)a=c===d,c=c.parentNode;a||(d=b.parentNode)}}},getAdNode:function(){return b},getSliceStatus:function(){var a;u&&u.isReadyToMeasure()?a=u.getSliceStatus():s.friendly&&y&&g.isDef(x)&&(a=y.getSliceStatus(x,K,v,A));return a}}},
...
b,c){return s.isDomless()?new re:new se(a,b,c)}}},se=function(a,b,c){var d,e,f=n.getAggregator().request("browser"),q=l&&l.contextNode&&l.contextNode.parentNode?l.contextNode.parentNode:null,m=be(b,c),p=function(){var a,b,e;d=d||je(s,c);a=d.find();s.friendlyIframe&&s.isBlockingSizmekTag()&&w(a);!a&&d.usePlaceholder?(u(),s.isDeviceTypeGroupMobile()&&f.hasMutationObserver()&&r.getMutationObserver(y).observe(q,{childList:!0})):a&&(a=g(a).isArray()?a:[a],b=d.getAdContainer(),e=d.allowForAdContainerChange,
g(a).each(function(a,c){m.addAdComponent(c,g.resolve(d.detectionMethod),b,e)}))},u=function(){var a;m.hasAd()||(a=t.getPlaceholderSpan(),q.insertBefore(a,l.contextNode.nextSibling),m.addAdComponent(a,k.DETECTION_METHODS.AD_PLACEHOLDER,t.getParent(a)))},y=function(a,b){var c=!1;g(a).each(function(a,b){b.addedNodes&&0<b.addedNodes.length&&(c=!0)});c&&(n.getAggregator().trigger("nodesAdded"),b.disconnect())},v=function(a,b){var e=!1;g(a).each(function(a,b){1>=b.target.height*b.target.width&&(e=!0)});
...
var b=r.getWindow().location.href,c=[b];try{c.push(top.location.href)}catch(d){}try{c.push(parent.location.href)}catch(e){}if(s.embedded){try{c.push(parent.document.referrer)}catch(f){}try{c.push(J.referrer)}catch(k){}}try{"jsi"!==l.mode&&c.push(w.location.href)}catch(m){}try{c.push(l.jsref)}catch(p){}c.sort(function(a,b){return a.length>b.length?1:a.length<b.length?-1:0});return!!g(a).findFirst(function(a,d){var e=!1,f,m,k="mobfox"===d?c:[b];for(m=0;m<k.length;m++){f=k[m];var l="string"===typeof d?
...
b=N();try{a=b.getVersion()}catch(c){a=-1,n.getAggregator().trigger("error",k.ERROR_CODES.NO_VIDEO_AD_INTERFACE)}return a},videoTranslator:function(){return q=q||new Ce},adNode:N});N();G.listenForResult();E.isApplicable(s)&&E.start(c)})();return{findAdNode:N,getViewStateOverride:function(){return u},isHandshakeComplete:function(){return t},triggerInitializationEvents:J,setVideoSpecificScreenEventFields:function(a){var b=a.viewState===k.NA;a.isVideoPlaying=!0;a.isSoundOn=x;a.isVideoPlayingInFullscreen=
!1;if(u){if(u===k.OUT_OF_VIEW){var c=a.reason?a.reason.split("."):[];c[c.length]=k.OUT_OF_VIEW_REASONS.VIDEO;a.reason=c.join(".")}a.viewState=b?a.viewState:u;a.isVideoPlaying=u===k.IN_VIEW}w&&v&&(a.percentInView=100,a.isVideoPlayingInFullscreen=!0)}}},De=function(){return new $(k.PERF_TIMELINE_TRACKER_CONFIG.WRAPPERS.AS.TYPE,k.PERF_TIMELINE_TRACKER_CONFIG.WRAPPERS.AS.COUNT)},hb=function(){var a,b,c={},d=0,e=function(c){if(c||a)d+=5,b.onTick(d,function(){a?e():n.getAggregator().trigger("sendDt",k.DT_CODES.PERFORMANCE)}),
