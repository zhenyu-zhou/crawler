...
try {
	...
	var __IntegralASConfig = {
		...
		protocol: 'https',
		jsref: "",
		asid: "6106f57f-b7b9-11ea-9ca1-0e076086e305",
...
m.oid):n.push("uid:"+d.unq);n.push("v:19.8.97");n.push("sp:"+(m.isSplitMode?1:0));n.push("fwm:"+("true"===m.fwMonitoring?1:0));c.on("resolution")&&(n.push("wr:"+f(s.windowSize()).toArray().join(".")),n.push("sr:"+f(s.screenSize()).toArray().join(".")));b=function(){var a;a=String(m.scriptUrl).toLowerCase();var b=a.indexOf("ias_xpc");-1<b?(a=a.substring(b+7+1),b=a.indexOf("&"),a=-1<b?a.substring(0,b):a):a="NotFound";return a||""}();"NotFound"!==b&&n.push("x_xpc:"+b);return n},ce=function(a,b,c,d){var e,
