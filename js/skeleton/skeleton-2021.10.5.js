...
try {
	...
	var __IntegralASConfig = {
		...
		sp_cdnScripts: {xsca: "static.adsafeprotected.com/xsca.17.4.85.js", sca: "static.adsafeprotected.com/sca.17.5.12.js", main: "static.adsafeprotected.com/main.19.8.248.js"},
		protocol: 'https',
		jsref: "",
		asid: "a7028cd9-25f5-11ec-87d8-02cb33a7e8c8",
...
p));l.impUrl&&l.perf.markResource(tb,l.impUrl);f=l.perf.getData();n.getAggregator().trigger("addThrottledProp",k.DT_SLOT.IM,"prf",g(f).toION());b.isApplicable(s)&&b.sendAdTalkCall()}catch(m){c.add(k.ERROR_CODES.ADTALK_DELAY)}}),l.perf.markEnd(oa)}catch(u){c.add(k.ERROR_CODES.EVENT_LOOP_ONE)}}function ub(h){var a=new vb(h,s),b=new wb,c=new xb(h,s),d=yb(h,s),e=(new zb(l,s,h)).resolve(),f=[a],p=[];d.applies()&&f.push(d);c.applies()&&f.push(c);b.applies(h,s)&&f.push(b);g(e).each(function(a,b){f.push(new Ab(b,
s));p.push(b.id)});0<p.length&&(n.getAggregator().trigger("addOutputItem",{output:p.join(".")},"scm",{type:k.IMPRESSION_EVENT}),n.getAggregator().trigger("addOutputItem",{output:p},"metricIdList",{type:k.DT_CODES.UNLOAD,asION:!0}));return f}function Bb(h,a){return!s.isVideo()||s.isAvid()||s.isOmid()||s.isInMobiMraidVideo()?{}:Cb(l.videoId,h,a)}function cb(){var h,a,b,c,d,e,f,p,m={};l.perf.markStart(ra);var q=n.getAggregator();Db();m.mFeatures=q.request("features");m.mFeatures||(m.mFeatures=q.provide("features",
sa()));l.integration&&m.mFeatures.setReportedBootstrapFeatures("intblk","integration");l.autotagSizeSet&&m.mFeatures.setReportedBootstrapFeatures("ats","autotagSizeSet");l.encodeInvalidUrlChars=s.isDomless()?!1:m.mFeatures.on("encodeInvalidUrlChars");q.provide("mobileApp",function(){return h=h||new Eb(m.mFeatures)});q.provide("avidJsClient",function(){return a=a||new Fb(r.getWindow())});q.provide("context",s);m.mBrowser=q.provide("browser",(new Gb).createInstance());m.mErrors=q.request("mErrors");
...
Sb());q.provide("ieXDomainViewability",Tb(m.mBrowser));f=Ub(m.mBrowser);p=Bb(m.mFeatures,e);m.mVideo=q.provide("video",p);Vb(Wb.build());f=(new Xb).createInstance(m.mErrors,f,m.mFeatures);d=(new Yb).createInstance(f,m.mErrors,d,s);p=q.provide("jobFactory",Zb());m.mDataTransfer=$b(f,m.mErrors,m.mFeatures,m.mIds,m.iOutput,m.mBrowser,e,b);b=ac(m.mErrors,m.mFeatures,q,c);m.mMode=bc(b,m.mFeatures,m.viewabilityMeasurement.isImmediate());m.mViewability=q.provide("viewability",cc(B(),m.viewabilityMeasurement,
...
CONTENT_STYLED:"cs",MRAID_DEFAULT:"md",MRAID_READY:"mr",MRAID_LOADING:"ml",MRAID_UNKNOWN:"mu",OMID_RENDERED:"or",OMID_UNRENDERED:"ou"}},RTS_KEY_FOR_VQ:"qiv",UNIQUE_ID_TOKEN:"[IAS_ASID]"},za="mf",la="cm",ra="in",ma="pr",na="po",qb="bl",oa="lo",pa="lt",qa="md",tb="id",bb=function(h){return{verifyContextNode:function(){if(!(__IASScope.isDomless||h.contextNode&&null!==h.contextNode.parentNode)){var a,b=J.getElementsByTagName("script"),c=b.length,d=b[c-1],e=h.scriptUrl;try{for(;0<=--c;)if(a=b[c],a.src&&
0===a.src.indexOf(e)&&null===a.getAttribute("data-ias-script-tag")){d=a;a.setAttribute("data-ias-script-tag","found");break}}catch(f){}h.contextNode=d}}}},Fc=function(){var h,a=["STYLE","SCRIPT","HEAD","META"],b=k.RENDER.CREATIVE_NODE_TYPES.concat(k.RENDER.CONTAINER_NODE_TYPES),c=0,d=l.useFIF&&s.friendlyIframe||s.isSpecifiedAd(),e=0,f=[],p=function(p){var q=t.isNodeXDomainIframe(p)||t.isNodeCreative(p),u=!p;h=u?l.contextNode.parentNode:p;if(q||u){var y=f.length;0<y&&(e<y?e=y:(e=0,f=[]));n.getAggregator().trigger("evaluateCreativeFinderResult",
p)}else{if(d){var v;v=q=p;u=s.friendly?r.getTop().document.body:l.contextNode.ownerDocument.body;for(;3>c;){if(u&&q===u){v=q;c=3;break}t.isWindow(q)&&(v=t.crossQuerySelector("["+k.AD_IDENTIFIER+"-"+l.asid+"]"),q=g.isDef(v)?v:q);v=q=g.isDef(q)?q.parentNode||q:q;c++}q=v}else q=p;if(t.isWindow(q)){try{y=q.document}catch(K){y=l.contextNode.ownerDocument}p=y}else"IFRAME"===t.getNodeName(q)?(f.push(p),p=p.contentWindow.document):p=q;var y=[],u=(q=p&&p.getElementsByTagName&&p.getElementsByTagName("*"))&&
q.length,x;if(q)for(var A=0;A<u;A++)x=(v=q[A])&&v.nodeName&&v.nodeName.toUpperCase(),!v.children||0!==v.children.length||g(b).contains(x)||g(a).contains(x)||g(y).contains(x)||y.push(x);y=b.concat(y);(new Ec(y,f)).searchDescendants(p)}};n.getAggregator().on("creativeFinderBatchCompleted",p);return{find:p,getClosestContainerName:function(){return t.getNodeName(h)}}},Ec=function(h,a){var b=function(b){function d(b){var c=t.getNodeName(b),d=t.isNodeCreative(b)||"IFRAME"===c;c&&d&&!t.isEmptyFriendlyFrame(b)&&
(c=t.getNodeArea(b),c>m&&!g(a).contains(b)&&(p=b,m=c))}function e(){do d(b[f]),f+=1;while(0!==f%q&&f<b.length);f<b.length?r.execAtEndOfThread(e,0):n.getAggregator().trigger("creativeFinderBatchCompleted",p)}var f=0,p=null,m=-1,q=500;if(b.length&&n.getAggregator().request("useYieldSearch"))e();else{for(f;f<b.length;f++)d(b[f]);n.getAggregator().trigger("creativeFinderBatchCompleted",p)}};return{searchDescendants:function(a){a=a||l.contextNode.parentNode;var d,e,f=[];for(d=0;d<h.length;d++){e=h[d].toLowerCase();
var p=a.getElementsByTagName&&a.getElementsByTagName(e);if(p&&p.length)for(e=0;e<p.length;e++)f.push(p[e])}b(f)}}},ec=function(){var h,a=!1,b=!1,c=!1,d={status:k.RENDER.STATUS.OTHER,details:k.RENDER.DETAILS.OTHER},e={status:k.RENDER.STATUS.DETECTED,details:k.RENDER.DETAILS.ENVIRONMENT},f=n.getAggregator().request("omidAdSessionContext"),p=function(){c=a=!0},m=function(a){a&&(a.status=k.RENDER.STATUS.DETECTED);n.getAggregator().trigger("adRendered")},q=function(){var a=!1;s.isOmid()&&f&&f.useOMID13Logic&&
...
r.clearInterval(b):f=!1,c=y(a);else if(a){var d=!1,p=t.getRect(a),q;if(q=a&&"IMG"===t.getNodeName(a)){q=!0;var v=g.isDef(a.naturalWidth)?a.naturalHeight*a.naturalWidth:0,l=getComputedStyle(a),n=0===a.src.length&&H.contains(l.content,"url"),A=a.getAttribute&&a.getAttribute("data-ias-rend-bi");0<v&&!n&&(q=!1);"false"===A&&(h.save(k.RENDER.DIAGNOSTIC.CONTENT_STYLED),q=!1);n&&!A&&u(a,l)}q&&(d=!0,h.save(k.RENDER.DIAGNOSTIC.BROKEN_IMAGE));!d&&p.width>=k.RENDER.WIDTH_THRESHOLD&&p.height>=k.RENDER.HEIGHT_THRESHOLD&&
(m(c),b?r.clearInterval(b):f=!1);h.saveNode(a)}else a=e.getClosestContainerName()||h.getAdNodeName(a)||c.details,h.save(a);x(c)});var p=function(){var b=a&&a.getAdNode();try{e.find(b)}catch(c){n.getAggregator().trigger("renderdiag",c)}},q=n.getAggregator().request("mobileApp");q&&q.isMobileAppEnvironment&&q.isMobileAppEnvironment()&&s.isMraid()?v():(p(),f&&(b=r.setInterval(p,500)));n.getAggregator().trigger("eligiblerender")})},F=function(){var a=f&&!!f.isVideo,c=!q()||f&&!!f.videoStartArrived,d=
...
code:"initial"});n.getAggregator().on("adRendered",function(){a=!0});n.getAggregator().provide("adRenderStatus",function(){return a});n.getAggregator().provide("useYieldSearch",function(){return c});h=new Gc;new Hc;n.getAggregator().on("impressionsent",p);q()||f.omidEarlyExit?F()||(h.save(k.RENDER.DETAILS.ENVIRONMENT),h.save(k.RENDER.DIAGNOSTIC.OMID_UNRENDERED),x(d),n.getAggregator().on("omidrendgeoupdate",function(){F()}),n.getAggregator().on("omidrendvideostart",function(){F()}),f.omidEarlyExit&&
(n.getAggregator().on("omidimpressionarrived",function(){F()}),n.getAggregator().on("omidloadedarrived",function(){F()}))):s.isAvid()||s.isOmid()||s.isVideo()?(n.getAggregator().trigger("eligiblerender"),h.save(e.details),m(),x(e)):(x(d),A())}}},Gc=function(){var h=[],a=[],b=function(a){var b;if(t.isWindow(a))b="WINDOW";else if(t.isNodeXDomainIframe(a))b="XIFRAME";else try{b=t.getNodeName(a)}catch(f){c("nen")}return b},c=function(a){h.push(a)};return{build:function(){var b=[];g(a).each(function(a,
c){b.push(c)});g(h).each(function(a,c){b.push(c)});a=[];h=[];return b.join(".")},getAdNodeName:b,save:c,saveNode:function(d){try{var e=d&&b(d),f=d&&t.getRect(d),p=d&&t.hasBackgroundImage(d),m=d&&d.innerText&&0<d.innerText.length,q=d&&d.children&&0===d.children.length&&m,h=f&&f.width>=k.RENDER.WIDTH_THRESHOLD&&f.height>=k.RENDER.HEIGHT_THRESHOLD?k.RENDER.DIAGNOSTIC.QUALIFIED_SIZE:k.RENDER.DIAGNOSTIC.UNQUALIFIED_SIZE;a.push(e);a.push(h);p&&a.push(k.RENDER.DIAGNOSTIC.STYLED_NODE);q&&a.push(k.RENDER.DIAGNOSTIC.TEXT_NODE)}catch(g){c("sne")}}}},
Hc=function(h){var a,b=!1,c=!1,d=function(){n.getAggregator().trigger("addOutputItem",{output:!a&&b?"1":"0"},"rmeas");a&&a.message&&!c&&(__IntegralASDiagnosticCall("renderloop",a,l),n.getAggregator().trigger("addThrottledProp",k.DT_SLOT.ENVIRONMENT,"rle",1),c=!0)};n.getAggregator().on("eligiblerender",function(){b=!0;d()});n.getAggregator().on("renderdiag",function(b){a=b;d()});d()},Y=function(){return{applies:function(h,a){var b=n.getAggregator().request("mobileApp");return(h.browserIs(k.BROWSERS.CHROME)||
h.isAndroidWebViewBrowser()||h.browserIs(k.BROWSERS.WEBKIT)||h.browserIs(k.BROWSERS.MSEDGE))&&!b.isMobileAppEnvironment()&&h.hasIntersectionObserver()}}},Ic=function(){return{applies:function(h){var a=n.getAggregator().request("mobileApp");return(h.browserIs(k.BROWSERS.CHROME)||h.isAndroidWebViewBrowser()||h.browserIs(k.BROWSERS.WEBKIT)||h.browserIs(k.BROWSERS.MSEDGE))&&!a.isMobileAppEnvironment()&&h.hasResizeObserver()}}},fb=function(){var h,a,b=!1,c=n.getAggregator().request("mPage"),d=function(){!b&&
a&&h&&!c.isHidden()&&(b=!0,n.getAggregator().trigger("sendDt",k.DT_CODES.LARGE_BILLABLE))};n.getAggregator().on("primaryadfound",function(a){h=a.getDims().area()>=k.MRC_LARGE_AD_SIZE;d()});n.getAggregator().on("impressionsent",function(){a=!0;d()});c.onHiddenChange(d)},Nb=function(){var h=[],a={},b={percentInView:"piv",sl:"vs",reason:"r",width:"w",height:"h",omidObstructions:"oobs"},c={omidObstructions:["sl","percentInView","reason"]};n.getAggregator().on("newScreenEvent",function(c){c=g(c).selectProperties(g(b).keys());
c=g(c).asStrings();var f=g(c).compareTo(a);(f=d(f))&&JSON.stringify(f)!==JSON.stringify({})&&(f.t=s.getTagTime(),h.push(f));g(a).mixin(c)});var d=function(a){g(c).each(function(b,c){var d=!1;g(c).each(function(b,c){a[c]&&(d=!0)});!1===d&&delete a[b]});return a};return{toString:function(){return g(h).toION(b)}}},Da=function(){var h=new Jc,a=new B;return g(h).mixin(a)},B=function(){var h={},a={},b=function(b,c,f){if((b=a[b])&&0!==b)return f&&(b=b.slice(0,1)),g(b).each(function(a,b){c.apply({},b)}),
!0},c=function(a,b,c){h[a]=h[a]||new ba;h[a].push(b,c)};return{on:function(a,e){var f={};e?f[a]=e:f=a;g(f).each(c);g(f).each(b)},once:function(a,e){b(a,e,!0)||c(a,e,1)},trigger:function(a){var b=g(arguments).toArray();b.shift();var c;(c=h[a])&&c.run.apply({},b)},persistentTrigger:function(b){var c=g(arguments).toArray();c.shift();var f=b;a[f]=a[f]||[];a[f].push(c);(f=h[b])&&f.run.apply({},c)}}},ca=function(){var h=function(a,c,d){var e,f=c.length,p=t.isWindow(a)?a.frames:t.getChildWindowsOf(a);d&&
d(a,c);if(p&&p.length){for(a=0;a<p.length;a++)(e=p[a])&&t.isWindow(e)&&(c[f]=a,h(e,c,d));c.pop()}},a=function(a,c){try{h(c||top,[0],a)}catch(d){}};return{traverse:a,getFrames:function(b,c){var d=[];a(function(a){var b;if(b=t.isWindow(a)){var c=!0;for(b=0;b<d.length;b++)if(d[b]===a){c=!1;break}b=c}b&&d.push(a)},c);return g(d).filter(b)}}},ba=function(){var h=[];return{push:function(a,b){var c=0;b=b||Number.MAX_VALUE;h[h.length]=function(){c<b&&(c++,a.apply({},arguments))}},run:function(){var a=arguments;
g(h).each(function(b,c){c.apply({},a)})}}},xa=function(h){var a={};return{doEligibleJobs:function(b){g(h).each(function(c,d){var e=d&&d.getTime();g.isDef(e)&&b>=e&&!a[e]&&(d.getTask().call(),a[e]=!0)})}}},Fa=function(){var h,a=new da,b=function(b,d,e,f){var p,m,q,h;if(JSON&&JSON.parse)try{p=JSON.parse(b.data),m=b.source,h=g.noop,d(p)&&(f&&(q=f(m,p))&&(h=function(){a.send(function(){return q},m)}),e(b,p,h))}catch(y){p&&n.getAggregator().trigger("error",k.ERROR_CODES.MESSAGE_LISTENER)}};return{listen:function(a,
...
d){var e=g.collapseArgsIntoHash(a,d);g(e).each(function(a,c){a=parseInt(a);b=a>b?a:b});c.on(e)},start:function(){h||(h=!0,r.execAtEndOfThread(d))},kill:e,isActive:function(){return h}}},Oc=function(h,a){var b,c=a,d=function(a){b||(a&&h(),b=r.setInterval(h,c))},e=function(a){b&&(a&&h(),r.clearInterval(b),b=null)};return{start:d,stop:e,updateFrequency:function(a,p){c=a;b&&(e(),d(p))}}},X=function(h){var a,b,c=0,d=s.getTagTime(),e=0,f=!1;return{getTotalTime:function(){return e},stop:function(){c=0;d=
s.getTagTime();f=!1},mark:function(){a=f?s.getTagTime()-d:0;c+=a;c>=h&&(b=c-a<h,e+=b?c:a);d=s.getTagTime();f=!0}}},R=function(h,a){var b=h||l.adsafeSrc||l.requrl;b&&0===b.indexOf("http")||(b=0===b.indexOf("//")?l.protocol+":"+b:l.protocol+"://"+b);var b=/((http|https):\/\/(([^\/\.]*)\.([^\/]*)))(?:\/(.[^?]*)\??(.+)?)*/.exec(b),c=b[1],d=b[2],e=b[3],f=b[4],p=b[5],m=h?b[6]:"",q=a?b[7]:"",u={},y=function(a){g.isDef(a)&&(f=a);return f},v=function(a){g.isDef(a)&&(p=a);return p},k=function(a,b){var c=a+
"="+g(b).toION();return g.encodeInvalidUrlChars(c,l.encodeInvalidUrlChars)},q=q?q.replace(/&$/,""):"";return{appendToParamValue:function(b,c){var d,e;(d=u[b])?u[b]=d+c:a&&q.length&&(d=q.split(b),e=1<d.length)&&(e=d[1].split("&")[0],d=[d[0],e].join(b),q=q.replace(d,d+c))},fullDom:c,hostname:e,sub:y,master:v,setParam:function(a,b){u[a]=u[a]||{};g(b).isObj()?g(u[a]).mixin(b):u[a]=b},path:function(a){m=a},toString:function(){var a=y()?y()+".":"",b=m?"/"+m:"",c;q||!g(u).isEmpty()?(c=g(u).isEmpty()?"":
g(u).stringify(k,"&"),c="?"+q+(q&&c?"&"+c:c)):c="";return d+"://"+a+v()+b+c}}},ob=function(){var h=function(a){var c=[];g(a).each(function(a,b){400>=c.concat(b).join("").length&&c.push(b)});return c},a=function(a,c){var d;c&&c.id&&(d=c.id.replace(/[^\w-_.>\/]/g,""));return d};return function(){var b,c;try{if(s.friendly&&!s.isMobileApp())if(b=n.getAggregator().request("adSlotIds"))c=b;else{var d,e;if(d=t.getOurNodeInTop()){var f=t.getAncestorNodes(d);e=g(f).map(a)}if(b=e=e&&h(e))n.getAggregator().trigger("addOutputItem",
...
k.DT_CODES.PING&&h===e&&(r.execAtEndOfThread(function(){f.postMessage(JSON.stringify({requestTop:"refreshAd",adUnitId:a,cacheId:c}),"*")}),d.sendAutoRefreshProp(e))})},sendAutoRefreshProp:function(a){n.getAggregator().trigger("addThrottledProp",k.DT_SLOT.ENVIRONMENT,"ir",a);n.getAggregator().trigger("adSessionComplete")}};s.isRefreshable(function(b,c){var d;if(!b&&c)try{d=JSON.parse(c),d.isRefreshable&&d.adServerName&&a.start()}catch(e){n.getAggregator().trigger("error",k.ERROR_CODES.AD_REFRESH)}});
return a},settings:{tier:k.TIERS.ENVIRONMENT,applies:function(h,a,b){return b.isPossiblyRefreshable()}}},Qb=function(){var h,a,b=function(a,b){-1!==b.indexOf("https")&&(b+="*");return b.replace(/^https?:\/\//,"")};return{isApplicable:function(a,b,e){var f;if(f=e.isVideo()&&!(e.isAvid()||e.isMraid()||e.isOmid()))f=n.getAggregator().request("adNode")?parseFloat(n.getAggregator().request("videoVersion")):void 0,f=3.7>f;return!f&&a.hasAncestorOrigins&&a.hasAncestorOrigins()&&b.on("ancestor")&&e.xDomainIframe},
...
getUserAgent:h,hasPostMessage:h,hasAncestorOrigins:h,hasIntersectionObserver:h,hasMutationObserver:h,isAndroidWebViewBrowser:h}},zc=function(){return{createInstance:function(h,a){return s.isDomless()?new Rc(a):new Sc(h,a)}}},Tc=function(){var h,a=function(a,c){var d="",e="",f=r.getDoc().getElementsByTagName("ins");if(f&&0<f.length){e=f[0];d="<ins";for(f=0;f<e.attributes.length;f++)d+=" "+e.attributes[f].nodeName+'="'+e.attributes[f].nodeValue+'"';d+=">";e="</ins>"}return'<!doctype html><html><head></head><body style="margin:0px;border:0px;padding:0px;font-size:0px"><script>var IASid = "'+
...
f,g){var m=a.request("adProxy").getAll();e=new md(e,f,m,g);b.push(e);c[e.id]=e;e.isMe&&(d=e);return e},getFrame:function(a){return c[a]},list:b,dictionary:c,getMe:function(){return d}}},Na=function(a,b){var c=function(a,c){var g=c.adProxies,m="";if(c.isValidForMapping()){if(b)m+=d(g,c.getStringifiedPosition());else{var q;q=""+c.getStringifiedPosition();q+=c.isMe?"*":"";q+=g.length?"."+g[0].tagId:"";m+=q}return m}},d=function(a,b){var c="";return c=a.length?c+g(a).stringify(function(a,c){return b+
(l.asid===c.adSafeId?"*":"")+"."+c.tagId},"|"):c+b};return{output:function(){var b=a.request("frameCollection"),d=g(b.list).stringify(c,"|");return g.toBase(b.getMe().unifiedId,62)+"+"+d}}},jd=function(a){var b=a.request("frameCollection").getMe().getStringifiedPosition(),c=l.contextNode.parentNode,d=a.request("interFrameQuerySelector",c),e=function(a){return a&&a.substr(0,120)+".of"+a.length},f=function(a){var e=!1,e=!s.embedded,f="BODY"!==t.getNodeName(c)&&"HEAD"!==t.getNodeName(c),g;if(g=a.srcIsEmbedded){g=
...
n.getAggregator().trigger("stopAdTalk"));return c},isCandidateForMyIdMap:f}},ld=function(a){var b=new ca,c=function(a){var b=a,c="IFRAME"===t.getNodeName(a),d=t.isWindow(a);c?b=a.contentWindow.document:d&&(b=a.document);return b},d=function(a,b){return t.querySelector(c(a),b)},e=function(c,e){var m,q,k;try{q=d(c,e),q||(m=b.getFrames(!0,a),g(m).findFirst(function(a,b){return k=d(b,e)}))}catch(l){}return q||k||null};return{queryFor:function(b){var c=null;b&&(c=e(a,b));return c}}},id=function(a){var b=
...
m,l,A,F;try{f=a.request("frameCollection");m=a.request("adTalkMessageCollection");l=d.messageContent.self;m.add(d);var G=f.getMe();G.unifiedId>l.unifiedId&&(G.unifiedId=l.unifiedId);var s;s=r.now()-d.sentTime;d.transferDuration=s;m=A=f.getFrame(l.id);g.isUndef(m)||g.isUndef(m.selfDescription)?(A=A||f.addFrame(c.source,l.id.split("-"),d),A.addInformationFromSrc(d,l),e()):A.addInformationFromSrc(d,l);(F=b&&a.request("idMapModule").isCandidateForMyIdMap(d))&&p()}catch(t){n.getAggregator().trigger("error",
...
u&&r.execAtEndOfThread(function(){e===k.NA&&(e=0)});b.observe(x(a));u&&r.execAtEndOfThread(function(){s.isBustedIframe()||n.getAggregator().trigger("delayedViewabilityReady")});p=!0},x=function(b){if(!g.isUndef(b)){if(q){b=a.document;var c=b.createElement("div");g(c.style).mixin({position:"absolute",width:"100%",opacity:"0",height:"100%",zIndex:-999,top:"0px",left:"0px"});c[k.IAS_DETECTOR]=!0;b.body.appendChild(c);b=c}return d=b}};return{start:function(){var b;try{a.document&&(q=!0,b={bodyElement:a.document.body,
...
g.isFunction(b.addEventListener));return{accepts:function(){return(d||e)&&!l.videoId},isMediaType:function(a){return a===c.mediaType},supportsAdContainerGeometry:function(){return!0}}},xd=function(a,b,c){var d=n.getAggregator().request("omidAdSessionContext"),d=d.isHtml&&d.isWeb,e,f=r.getWindow(),p=(f=f&&f.omid3p)&&g.isFunction(f.registerSessionObserver)&&g.isFunction(f.addEventListener)?f:a;e=d?["rjss","jss","jload","jsvid","fwjsvid"]:["rjss","jss","jload"];return{accepts:function(){var a=g.isDef(g(e).find(function(a,
b){return b===c}));return b.accepts()&&b.isMediaType(k.MEDIA_TYPE.VIDEO)&&a},isImmediate:function(){return!0},isMediaType:b.isMediaType,supportsAdContainerGeometry:function(){return b.supportsAdContainerGeometry()},start:function(){p.addEventListener("start",function(a){n.getAggregator().trigger("adImpression")})}}},Dc=function(a){return{resolve:function(){return g(a).findFirst(function(a,c){return c.environment.accepts()})}}},Ac=function(a){var b=!1,c=!1,d=!1,e=!1,f=n.getAggregator().request("omidAdSessionContext");
f.queuedOutputItems=[];f.cachedEvents=[];f.cachedGeometryEventsReceived=!1;f.cachedVideoEventsReceived=!1;f.recoveredTime=-1;var p=new ga,m=n.getAggregator().request("omidAdSessionVerificationParameters"),q=n.getAggregator().request("features"),k=r.getWindow(),y=(k=k&&k.omid3p)&&g.isFunction(k.registerSessionObserver)&&g.isFunction(k.addEventListener)?k:a,v=!1;f.omidEarlyExit=!1;f.mediaType="display";var t=!1,x=function(a,b){f.queuedOutputItems.push({code:a,value:b})},A=function(a,b,c){n.getAggregator().trigger(a,
b,c)},F=function(a){n.getAggregator().trigger(a)},G=function(){if(b&&c&&(!e||d)){w.omidSupported=!0;f.hasOwnProperty("impressionType")&&x("oiet",f.impressionType);f.hasOwnProperty("creativeType")&&x("oct",f.creativeType);f.underEvaluation&&x("oef",!0);v=f.exitedOASRS=!0;var a=m&&m.IAS&&0<Object.keys(m.IAS).length;va(a?m.IAS:m)}},ib=function(a){function g(){return s.isOmidForWeb()||a.data.hasOwnProperty("supportsLoadedEvent")&&("true"===a.data.supportsLoadedEvent||!0===a.data.supportsLoadedEvent)&&
...
x("ocon",encodeURIComponent(f.contentUrl||""));x("oerl",p);x("oses",s.getTagTime());b=!0;G()}"sessionError"===a.type&&(p=("string"===typeof a.data.errorType?a.data.errorType:"NoErrType")+"_"+encodeURIComponent("string"===typeof a.data.message?a.data.message:"NoMessage"),v?A("addOutputItem",{output:p},"oser"):x("oser",p))},kb=function(a){"impression"===a.type&&(f.omidImpressionArrived=!0,F("omidimpressionarrived"),f.mediaType="web"===f.environment?a.data.mediaType||"video":a.data.mediaType,x("omtp",
f.mediaType),x("oimp",s.getTagTime()),"video"===a.data.mediaType&&(f.isVideo=!0),a.data.adView&&(a.data.viewport||f.isWeb)&&(f.impressionViewabilityMeasurement={type:"geometryChange",data:{viewport:a.data.viewport,adView:a.data.adView},timestamp:a.timestamp},"undefined"===typeof f.geometryArrived&&p.checkForViewAttachmentBasedOnAdSessionType(f,a.data.adView)&&(f.geometryArrived=!0,F("omidrendgeoupdate"))),a.data.hasOwnProperty("impressionType")&&!d&&(f.impressionType=a.data.impressionType),f.isNativeVideo=
f.isNative&&"video"===a.data.mediaType,f.isDisplay="display"===a.data.mediaType,c=!0,G())},E=function(a){a&&"start"===a.type?(f.videoStartArrived=!0,F("omidrendvideostart")):"loaded"===a.type&&(x("oloa",s.getTagTime()),d=!0,f.omidLoadedArrived=!0,F("omidloadedarrived"),a.data.hasOwnProperty("creativeType")&&(f.creativeType=a.data.creativeType),a.data.hasOwnProperty("impressionType")&&(f.impressionType=a.data.impressionType),!0!==f.omidEarlyExit||t||(A("addThrottledOutputItem","oiet",f.impressionType),
A("addThrottledOutputItem","oct",f.creativeType),t=!0),G())};return{start:function(){y.registerSessionObserver(ib,"IAS");y.addEventListener("impression",kb)}}},Bc=function(){return{accepts:function(){return!0}}},Ia=function(){var a=n.getAggregator().request("omidAdSessionContext"),b=n.getAggregator().request("omidVerificationClient"),c=new aa(b),d=a.isHtml&&a.isWeb;return{accepts:function(){return c.accepts()&&d}}},Cc=function(){return{start:function(){va(l.contextNode&&(l.contextNode.dataset.iasParameters||
l.iasParameters))}}},yd=function(a,b){var c=function(a){try{b.trigger("videoPlaybackEvent",{eventType:a.eventSubType,eventData:a.eventData})}catch(c){}};return{start:function(){a.addEventListener("video",c)},addVideoPlaybackEventListener:function(a){b.on("videoPlaybackEvent",a)}}},zd=function(a,b){var c,d=function(a){var d,g,m;try{d=a.eventData.percentageInView,g=c&&75<=d,m={windowDimensions:{x:0,y:0,width:0,height:0},adDimensions:{x:0,y:0,width:0,height:0},containerDimensions:{x:0,y:0,width:0,height:0},
...
new Ka,q=n.getAggregator().request("omidAdSessionContext"),u=r.getWindow(),y=(u=u&&u.omid3p)&&g.isFunction(u.registerSessionObserver)&&g.isFunction(u.addEventListener)?u:a,v=!1,s={isEmpty:function(){return 0===c.length},toString:function(){for(var a="{vEventCount:"+c.length+",vEvents:[",b=0;b<c.length;b++)var d=c[b],a=a+((0<b?",{":"{")+("t:"+d.t+",")+("rt:"+d.rt+",")+("tp:"+d.tp+",")+("sl:"+d.sl+",")+("ad_duration:"+d.ad_duration+",")+("volume:"+d.volume)+"}");return a+"]}"}},x=function(){p=!0},A=
function(a){if(-1!=="|start|firstQuartile|midpoint|thirdQuartile|resume|bufferFinish|complete|pause|bufferStart|skipped|playerStateChange|loaded|volumeChange|".indexOf("|"+a.type+"|")){v&&(q.cachedVideoEventsReceived=!0,q.cachedEvents.push(a));try{var m="",u=a.hasOwnProperty("timestamp")?a.timestamp:(new Date).getTime(),y=u-(l.birthdate||u+1),x="n",r=!1;switch(a.type){case "start":m="adVideoStart";q.videoStartArrived=!0;n.getAggregator().trigger("omidrendvideostart");d=u;f=a.data.duration;1E3<f&&
(f/=1E3);e=a.data.videoPlayerVolume;break;case "volumeChange":m="volumeChanged";e=a.data.videoPlayerVolume;break;case "firstQuartile":case "midpoint":case "thirdQuartile":case "complete":m="adVideo"+a.type.substring(0,1).toUpperCase()+a.type.substring(1);r=!0;n.getAggregator().trigger("videoQuartileEvent",a);break;case "pause":case "bufferStart":m="pauseAd";break;case "resume":case "bufferFinish":m="resumeAd";break;case "skipped":m="adSkipped"}if(""!==m){var A=n.getAggregator().request("mScreenEvents");
A&&(x=A.getCurrentLoc());c.push({t:u-d,rt:y,tp:m,sl:x,ad_duration:f,volume:e})}if("loaded"===a.type&&g.isDef(a.data)){var s=["preroll","midroll","postroll","standalone"].indexOf(a.data.position),m=-1!==s?s+1:void 0,u=[];!0===a.data.autoPlay?u.push("autoplayed"):u.push("clicktoplay");!0===a.data.skippable&&u.push("skippable");"fullscreen"===a.data.state&&u.push("fullscreen");var t=u.join(".");!0===p?(g.isDef(m)&&n.getAggregator().trigger("addThrottledProp",k.DT_SLOT.ENVIRONMENT,"vbp",m),n.getAggregator().trigger("addThrottledProp",
...
-1!=="complete|pause|bufferStart|skipped".indexOf(a.type)&&(K="AdPaused");g.isDef(K)&&b.trigger("videoPlaybackEvent",{eventType:K,eventData:null});r&&n.getAggregator().trigger("sendDt",k.DT_CODES.VIDEO_EVENTS)}catch(O){__IntegralASDiagnosticCall("omidvideo",O,w.bootstrapper)}}};return{start:function(){n.getAggregator().on("impressionsent",x);n.getAggregator().provide({omidVideoEventsString:s});v=!0;y.addEventListener("video",A);v=!1;q.cachedVideoEventsChecked=!0;q.cachedVideoEventsReceived&&q.processCachedEvents();
m.init()},addVideoPlaybackEventListener:function(a){b.on("videoPlaybackEvent",a)}}},Oa=function(a,b){var c=!1,d=function(a){var d=a.percentageInView;c=!0;a.viewState=50<=d?k.IN_VIEW:k.OUT_OF_VIEW;a.outOfViewReason=50<=d?"":k.OUT_OF_VIEW_REASONS.GEOM;b.trigger("measurementChanged",a)};return{start:function(){n.getAggregator().trigger("addOutputItem",{output:k.MEDIA_TYPE.DISPLAY_CODE},k.MEDIA_TYPE_CODE,{type:k.IMPRESSION_EVENT});a.addScreenLocationChangedListener(d);a.start()},getStrategyName:function(){return k.MEASUREMENT_STRATEGY.DISPLAY},
...
b,e.method=c.method;else if(0===c.percentInView||75<=c.percentInView)e=c;return e},start:function(){var b;g.isDef(a)&&g.isDef(a.measurementStrategy)&&(b=a.measurementStrategy,b.addMeasurementChangedListener(f),b.start())},requiresDelayedViewabilityEvent:function(){b=!0}}},Va=function(a,b,c){var d=!1,e=!1,f=!1,p,m,q,u,l=function(){if(!g.isUndef(m)){var a=[],b,l;d?(e?(l=!1,b=100):(l=u,b=q),50>b&&a.push(k.OUT_OF_VIEW_REASONS.GEOM)):(l=!1,b=0,a.push(k.OUT_OF_VIEW_REASONS.VIDEO));f=!0;m.shouldDelegateToDomBasedViewability=
l;m.percentageInView=b;m.viewState=50>b?k.OUT_OF_VIEW:k.IN_VIEW;m.outOfViewReason=a.join(".");p=m;c.trigger("measurementChanged",p)}},v=function(a){m=a;q=a.percentageInView;u=a.shouldDelegateToDomBasedViewability;l()},r=function(a){a=a.eventType;"AdEnteredFullscreen"===a?e=!0:"AdExitedFullscreen"===a?e=!1:-1!=="AdStarted|AdVideoStart|AdPlaying".indexOf(a)?d=!0:-1!=="AdSkipped|AdUserClose|AdPaused|AdVideoComplete|AdStopped".indexOf(a)&&(d=!1);l()};return{start:function(){n.getAggregator().trigger("addOutputItem",
...
Ra=function(a,b,c){function d(a,b,c){c=m(b,c);a=f(a,b,c);return a.width*a.height}var e=function(a,b){var c=Math.max(a.x,b.x),d=Math.max(a.y,b.y),e=Math.min(a.x+a.width,b.x+b.width),f=Math.min(a.y+a.height,b.y+b.height),e=e-c,f=f-d;return{x:c,y:d,width:0<e?e:0,height:0<f?f:0}},f=function(a,b,c){a=e(b,a);return e(c,{x:0,y:0,width:a.width,height:a.height})},p=function(a,b){var c=s.isOmidForWeb(),d=!s.isOmidSandboxedEnvironment(),c=c&&d;return{x:c?b.x:a.x+b.x,y:c?b.y:a.y+b.y,width:b.width,height:b.height}},
m=function(a,b){return{x:b.x-a.x,y:b.y-a.y,width:b.width,height:b.height}};return{calculateGeometricMeasurement:function(e,l){if(g.isDef(e)&&g.isDef(l)){var n=e.viewport,v=e.computedAdContainer,s=v.obstructions,x=e.omidObstructions,A=s&&0<s.length,t=e.originalAdContainer,G=l.adGeometry,w=l.adFound,z=e.detectionMethod,E=0,n={x:0,y:0,width:n.width,height:n.height},P=p(t,G),I=e.outOfViewReason,N=0,M=0,B=A||!1,N=1>=G.width*G.height;c&&N&&(w=!1,I=I||"",w||-1!==I.indexOf(k.OUT_OF_VIEW_REASONS.GEOM)||(I=
k.OUT_OF_VIEW_REASONS.GEOM+(""!==I?"."+I:"")));if(w&&0<e.percentageInView){N=d(n,v,P);A?(E=m(v,P),E=f(n,v,E),E=p(v,E),E=a.calculateObstructedArea(E,s)):E=0;M=E;E=Math.round((N-M)/(P.width*P.height)*100);A&&0===M&&(B=!1);for(var G=(new D(P)).getRoundedGeometry(),w=B,O,A=0,M=b.getConfig(G).numberOfSlices,T=r.floor(G.height/M)||1,s=[],N=w?a.getObstructionStatusBySlice(M):[],Ea,A=0;A<M;A++)O=G.y+T*A,A==M-1&&(T=G.y+G.height-O),O={x:G.x,y:O,width:G.width,height:T},Ea=d(n,v,O),O=1==Ea/(O.width*O.height),
s.push(O);if(w)for(v=r.min(N.length,M),A=0;A<v;A++)s[A]=s[A]&&!N[A];v=s}else v=b.getConfig(G).defaultSliceArray;t={windowDimensions:n,containerDimensions:t,adDimensions:P,percentageInView:E,viewState:50<=E?k.IN_VIEW:k.OUT_OF_VIEW,outOfViewReason:50<=E?"":I||k.OUT_OF_VIEW_REASONS.GEOM,detectionMethod:z,isObstructed:B,sliceStatus:v};g.isDef(x)&&""!==x&&(t.omidObstructions=x);return t}}}},Hd=function(){return{accepts:function(){return s.isAvidNative()}}},Jd=function(a,b){var c=function(a){var c=a.eventData.originalAdContainer;
...
isMeasurable:function(){return p}}},Sa=function(a){var b=[],c;return{calculateObstructedArea:function(d,e){var f,p,m,q;p=e&&0<e.length;var k;if(p){k=Math.round(d.width);var l=Math.round(d.height);f=Array(k);for(m=0;m<k;m++)f[m]=Array(l);k={matrix:f,obscuredPixelCount:0,x:Math.round(d.x),y:Math.round(d.y),width:k,height:l}}else k={};f=k;l=k=0;if(p){for(;k<e.length;k++){p=e[k];m=l=f;var n=p;f=Math.max(m.x,n.x);p=Math.max(m.y,n.y);q=Math.min(m.x+m.width,n.x+n.width);n=Math.min(m.y+m.height,n.y+n.height);
m=q-f;q=n-p;m=0<m?m:0;q=0<q?q:0;f-=l.x;p-=l.y;m=f+m;q=p+q;for(f=Math.round(f);f<Math.round(m);f++)for(n=Math.round(p);n<Math.round(q);n++)void 0!==l.matrix[f]&&void 0===l.matrix[f][n]&&(l.matrix[f][n]=1,l.obscuredPixelCount+=1);f=l}l=f.obscuredPixelCount;k=f;if(g.isUndef(k.matrix)||0===k.matrix.length)c=[];else{p=0;q=!1;f=k.matrix[0].length;m=k.matrix.length;q=a.getConfig({height:f}).numberOfSlices;for(var n=r.floor(f/q)||1,s=[],x=0;x<f;x++){q=!1;for(var A=0;A<m;A++)if(1===k.matrix[A][x]){q=!0;break}p++;
q&&(x+=n-p,p=n);if(p==n||x===f-1)s.push(q),p=0}c=s}}else c=b;return l},getObstructionStatusBySlice:function(){return c}}},Ed=function(a,b){var c=n.getAggregator().request("omidAdSessionContext");c.geometryChangeEvents=[];var d=null,e=!1,f=r.getWindow(),p=(f=f&&f.omid3p)&&g.isFunction(f.registerSessionObserver)&&g.isFunction(f.addEventListener)?f:a,m=new ga,q=!1,u=!1,y=function(){var a=r.getDoc().getElementById("iasbi"+l.asid);a&&a.hasAttribute("CreativeLoaded")?(e=c.delayingViewabilityEvents=!1,d&&
(v(d),d=null)):r.setTimeout(y,50)},v=function(a){if(a&&"geometryChange"===a.type&&a.data&&a.data.adView){q&&(c.cachedGeometryEventsReceived=!0,c.cachedEvents.push(a));var f=a.data.adView,p=!!(f.measuringElement&&f.containerGeometry&&f.onScreenContainerGeometry);10>c.geometryChangeEvents.length&&(c.geometryChangeEvents.push(a.timestamp-l.birthdate+"-"+f.percentageInView),n.getAggregator().trigger("addOutputItem",{output:c.geometryChangeEvents.join("_")},"og"));if(c.delayingViewabilityEvents)d=a,e||
(e=!0,y());else{var u=[];f.onScreenGeometry&&f.onScreenGeometry.obstructions&&0<f.onScreenGeometry.obstructions.length&&(p&&(f.onScreenContainerGeometry.obstructions=f.onScreenGeometry.obstructions),f.reasons&&-1<f.reasons.indexOf("obstructed")&&100>f.percentageInView&&(f.onScreenGeometry.obstructions=f.onScreenGeometry.obstructions.slice(0,4),g(f.onScreenGeometry.obstructions).each(function(a,b){u.push(Math.round(b.x)+"."+Math.round(b.y)+"."+Math.round(b.width)+"."+Math.round(b.height))})));var v=
s.isOmidForWeb()?t.calcWinDims():{width:0,height:0},v=new D(a.data.viewport||v),r=new D(p?f.containerGeometry:f.geometry||{x:0,y:0,width:0,height:0}),p=new D(p?f.onScreenContainerGeometry:f.onScreenGeometry||{x:0,y:0,width:0,height:0}),f={viewport:v.getRoundedGeometry(),originalAdContainer:r.getRoundedGeometry(),computedAdContainer:p.getRoundedGeometry(),percentageInView:f.percentageInView,detectionMethod:k.DETECTION_METHODS.OMID,outOfViewReason:K(f.reasons),omidObstructions:u.join("_")};"undefined"===
typeof c.geometryArrived&&m.checkForViewAttachmentBasedOnAdSessionType(c,a.data.adView)&&(c.geometryArrived=!0,n.getAggregator().trigger("omidrendgeoupdate"));b.trigger(k.CONTAINER_GEOMETRY_MEASUREMENT_CHANGED,f)}}},K=function(a){var b={inactive:k.OUT_OF_VIEW_REASONS.FOCUS,viewport:k.OUT_OF_VIEW_REASONS.GEOM,clipped:k.OUT_OF_VIEW_REASONS.GEOM,obstructed:k.OUT_OF_VIEW_REASONS.OBSTRUCTION,backgrounded:k.OUT_OF_VIEW_REASONS.FOCUS,notFound:k.OUT_OF_VIEW_REASONS.HIDDEN,hidden:k.OUT_OF_VIEW_REASONS.HIDDEN},
c=[];if(!a)return"";g(a).each(function(a,d){var e=b[d];e&&0>c.indexOf(c)&&c.push(e)});return c.join(".")};c.processCachedEvents=function(){if(!u&&c.omidNativeInfo&&"string"===typeof c.omidNativeInfo.partnerName&&"bytedance"===c.omidNativeInfo.partnerName.toLowerCase()){var a="video"===c.mediaType,b=c.supports&&-1<c.supports.join().indexOf("clid"),d="full"===c.accessMode,e=!a||c.cachedVideoEventsChecked,f=c.cachedGeometryEventsChecked;if(("limited"===c.accessMode||d&&b)&&f&&e&&0<c.cachedEvents.length){for(var g=
d="o",b=f=e=0,a=!a,m=(new Date).getTime(),q=0;q<c.cachedEvents.length;q++){for(var g=m,p=-1,k=0;k<c.cachedEvents.length;k++)!c.cachedEvents[k].alreadyOrdered&&c.cachedEvents[k].timestamp<g&&(g=c.cachedEvents[k].timestamp,p=k);-1!==p&&(p=c.cachedEvents[p],p.alreadyOrdered=!0,"geometryChange"===p.type&&p.data&&p.data.adView?e=p.data.adView.percentageInView:a=-1<"start|firstQuartile|midpoint|thirdQuartile|resume|bufferFinish".indexOf(p.type),g=e&&50<=e&&a?"i":"o","o"===d&&"i"===g?f=p.timestamp:"i"===
d&&"o"===g?b+=p.timestamp-f:"i"===d&&"i"===g&&(b+=p.timestamp-f,f=p.timestamp),d=g)}u=!0;0<b&&(c.recoveredTime=b,(d=n.getAggregator().request("mScreenEvents"))&&d.setRecoveredTimeInSlTimes&&d.setRecoveredTimeInSlTimes(b))}}};return{start:function(){q=!0;void 0!==c.impressionViewabilityMeasurement&&v(c.impressionViewabilityMeasurement);p.addEventListener("geometryChange",v);q=!1;c.cachedGeometryEventsChecked=!0;c.cachedGeometryEventsReceived&&c.processCachedEvents()},addAdContainerGeometryMeasurementChangedListener:function(a){b.on(k.CONTAINER_GEOMETRY_MEASUREMENT_CHANGED,
a)},translateOmidOutOfViewReasons:K}},ea=function(){var a=n.getAggregator().request("omidAdSessionContext");return{accepts:function(){return a&&(a.isNative||a.isLimitedSandbox)}}},Fd=function(a,b){var c=n.getAggregator().request("omidAdSessionContext"),d=null,e=!1,f=r.getWindow(),p=(f=f&&f.omid3p)&&g.isFunction(f.registerSessionObserver)&&g.isFunction(f.addEventListener)?f:a,m=new ga,q=function(){var a=r.getDoc().getElementById("iasbi"+l.asid);a&&a.hasAttribute("CreativeLoaded")?(e=c.delayingViewabilityEvents=
...
s=a.omidObstructions;g.isDef(s)&&""!==s&&(n.omidObstructions=s);b&&(n.percentageInView=100);b||c?n.viewState=k.IN_VIEW:(n.viewState=k.OUT_OF_VIEW,n.outOfViewReason=a.outOfViewReason||k.OUT_OF_VIEW_REASONS.VIDEO);m=n;d.trigger("videoGeometryMeasurementChanged",m)}},x=function(a){q=a;s()},t=function(a){l=a;s()},F=function(a){r=a;a=a.eventType;"AdEnteredFullscreen"===a?p=!0:"AdExitedFullscreen"===a?p=!1:-1!=="AdStarted|AdVideoStart|AdPlaying".indexOf(a)?f=!0:-1!=="AdSkipped|AdUserClose|AdPaused|AdVideoComplete|AdStopped|AdError".indexOf(a)&&
(f=!1);s()};return{start:function(){n.getAggregator().trigger("addOutputItem",{output:k.MEDIA_TYPE.VIDEO_CODE},k.MEDIA_TYPE_CODE,{type:k.IMPRESSION_EVENT});a.addAdContainerGeometryMeasurementChangedListener(x);a.start();b.addAdGeometryMeasurementChangedListener(t);b.start();c.addVideoPlaybackEventListener(F);c.start()},getStrategyName:function(){return k.MEASUREMENT_STRATEGY.VIDEO},addMeasurementChangedListener:function(a){d.on("videoGeometryMeasurementChanged",a)},isMeasurable:function(){return v}}},
...
sliceStatus:e};b.trigger("mraidScreenLocationChanged",d)}catch(g){}},e=function(){var b=a.mraid;return g(b).isObj()&&g.isFunction(b.isViewable)},f=function(){var b=a.mraid;d();b.addEventListener("viewableChange",d)},p=function(){var b=a.mraid;e()&&(c=!0,"loading"===b.getState()?b.addEventListener("ready",function(){f()}):f())},m=function(){c||p()};return{start:function(){var b=!0;if(g.isDef(a.mraid)||t.containsScriptTagWithSrc("mraid.js"))b=!1;n.getAggregator().trigger("addOutputItem",{output:g.stringifyTriState(b)},
"mi",{type:"impression"});b?n.getAggregator().trigger("exec","mraid.js",m):p()},addScreenLocationChangedListener:function(a){b.on("mraidScreenLocationChanged",a)}}},gc=function(a,b,c){var d={},e=function(c){var d=g.noop;b.bootstrapOn("useViewabilityNotification")&&(d=function(){a.skipAsFraudulent()||n.getAggregator().trigger("notify",c)});return d};(function(){c&&g(c).map(function(a,b){d[a]=e(b)})})();return{getCallbacks:function(){return d}}},wb=function(){var a=new Q({tiv:[1E4]}),b=g([k.IN_VIEW,
...
isInView:q,applies:function(){return e},minUnit:1E3,shouldIncludeSound:!1}},xb=function(a,b){return{timeInViewThresholds:new Q({tiv:[0]}),type:k.DT_CODES.FULLY_INVIEW,rts:{0:l._onInViewFull},isInView:function(a){var b=r.max(a.fullPercentInView||0,a.percentInView);return-1!==(k.IN_VIEW+"|"+k.PARTIAL_VIEW_PLUS).indexOf(a.viewState)&&100===b},applies:function(){return b.usesGroupMCustomMetric()},minUnit:1E3,shouldIncludeSound:!1}},Ab=function(a,b){var c,d,e,f=r.getMaxNumber(),p=b.isVideo(),m=a.id;d=
...
g(a.sliceStatus).each(function(a,b){k(b,r,s,t)?e[a].mark():e[a].stop();m[a]=e[a].getTotalTime()});x("slcVt",m);d&&(g(a.sliceStatus).each(function(a,b){v(b,r,s,t)&&y?f[a].mark():f[a].stop();q[a]=f[a].getTotalTime()}),x("slcVtVol",q));l=d&&b&&b.shouldIncludeSound?q:m;a=g(l).findFirst(function(a,b){n=Math.max(n,b);return 0>=b});g.isUndef(a)&&c.doEligibleJobs(n)},x=function(a,b){var c={};c[a]=b;n.getAggregator().trigger("addOutputItem",{output:c},{minDt:!1})},t=function(a){!e&&a.sliceStatus&&(e=[],f=
[],m=[],q=[],g(a.sliceStatus).each(function(a){e.push(new X(1));m.push(0);d&&(f.push(new X(1)),q.push(0))}))},F=function(a){g.isUndef(a.sliceStatus)||(e||t(a),s(a))};return{start:function(){k=d?v:r;a.addMeasurementChangedListener(F)}}},wa=function(a,b,c){return{isInView:a.isInView,isInViewIgnoringRender:a.isInViewIgnoringRender,addMeasurementChangedListener:function(a){b.addMeasurementChangedListener(a,c)}}},cc=function(a,b,c,d,e,f,g,m,q,l){var n=!1,v=s.isVideo(),t=f.request("mobileApp"),x=Y().applies(c,
e),A=c.browserIs(k.BROWSERS.GECKO)||c.browserIs(k.BROWSERS.IE)&&e.on("rattie")||x,F=s.xDomainIframe&&!A,w=new Ga(10),z=function(){e.on("viewabilityready")&&!n&&(d.send(k.DT_CODES.VIEWABILITY_READY),f.trigger("measurable"),n=!0)};f.on("delayedViewabilityReady",function(){D();z()});f.on("delayedViewabilityReadyCallOnly",z);var D=function(c){c=c||!1;try{w.start();var d,e;b.hasMeasurementStrategy()?e=(t.isMobileAppEnvironment()||s.isOmidNative())&&b.supportsAdContainerGeometry()?b.getScreenLocationInfo({},
c):b.getScreenLocationInfo(m.collect(),c):(e=m.collect(),t.isMobileAppEnvironment()?(e.viewState=k.NA,e.method=k.NA,e.percentInView=k.NA):F&&(e.viewState=k.NA,e.percentInView=k.PIV_NA),v&&!s.isAvid()&&l.setVideoSpecificScreenEventFields(e));d=q.registerLocation(e);c||a.trigger("measurementChanged",e);w.stop();var n=r.round(w.getTime()/w.getCount());g.addItem({output:n},"lt",{type:k.DT_CODES.UNLOAD});return d}catch(y){f.trigger("error",k.ERROR_CODES.CHECK_SCREEN_LOC)}};return{checkScreenLoc:D,stringifyPingTimes:function(){return e.on("everySecond")?
...
n.getAggregator().trigger("sendDt",a.callType,a.enumerator,function(){var a={id:l.videoId,msg:"unloadComplete",messageType:"misc"};r.getWindow().postMessage(JSON.stringify(a),"*")})};n.getAggregator().once("startViewabilityLoop",function(){var b,c=n.getAggregator().request("mobileApp").isMobileAppEnvironment();n.getAggregator().request("ids").impressionIsIdentifiable()&&(e=Oc(a.checkScreenLoc,f.getPollingFrequency()),(b=m())?b.start(e):e.start(!0),s.isOmid()?n.getAggregator().request("omidVerificationClient").registerSessionObserver(q,
...
!d&&1>f)d=!0,r.setTimeout(function(){e(f)},1E3);else return 1>f?(a||b.stop(!0),a=!0):a&&(a=!1,b.start(!0)),a},f=function(){b.start(!0)};return{applies:function(a,b,d){c=d.usesZeroPivCustomMetric();var e=Y();return b.on("viewabilityOptimization")&&e.applies(a,b,d)&&d.isDeviceTypeGroupMobile()},start:function(a){b=a;b.start(!0);n.getAggregator().on("IOPivChange",e);n.getAggregator().on("nodesAdded",f)}}},ae=function(a,b,c,d,e,f){var p,m,q,u,y,v,K,x,A,F=t.getElementsWindow(b);t.getElementsDocument(b);
n.getAggregator().provide("iframeCalculatorHelper",Ud(F));var G=Vd(b,d),B=k.AD_IDENTIFIER+"-"+l.asid,C=!1,E=D({}),P=s.isDeviceTypeGroupMobile(),I=s.usesGroupMCustomMetricMobilePassThru(),N,M=function(){if(!p)if(p=G.calcDims(b,d,q),l.autotagSizeSet&&1<l.adWidth&&1<l.adHeight&&(p.set("width",l.adWidth),p.set("height",l.adHeight)),c===k.DETECTION_METHODS.VIDEO&&s.embedded){var a=p,e=(new D(b)).getRounded();try{a.set("width",e.width),a.set("height",e.height)}catch(f){n.getAggregator().trigger("error",
k.ERROR_CODES.VIDEO_IN_IFRAME_DIMS_CALC)}}else c===k.DETECTION_METHODS.AD_PLACEHOLDER&&p.treatAsPlaceholder();return p},H=function(){var b,d=s.xDomainIframe&&C;b=P&&C&&q.isReady();b=d||b;d=G.getClippedDims&&(c===k.DETECTION_METHODS.VIDEO&&s.embedded||s.isCeltra());b?m=q.getPiv():g.isUndef(m)&&(b=!P&&(s.friendly||g.isDef(w.mozInnerScreenX))&&e.on("offscreen"),x=M(),K=new D(t.calcWinDims()),v=new D(b?t.calcMonDims():{}),A=d?G.getClippedDims():E,m=a.calcPercentInView(x,K,v,A));return m},O=function(){return a.calcInitialViewState(H())},
T=function(){return b===w?!1:M().isHidden()};(function(){var d=r.getWindow(),e=r.getDoc(),f=b===d,g=e.body,m=n.getAggregator(),p=new Y,l=m.request("browser"),v=m.request("features"),m=m.request("context"),x=!s.xDomainIframe,e=f&&g?e.body:b;N=s.friendlyIframe?d.frameElement:e;z.addEvent(e,"click",function(){n.getAggregator().trigger("adComponentClicked")});z.addEvent(e,"mouseover",function(){n.getAggregator().trigger("adComponentMousedOver")});p.applies(l,v,m)?(q=od(b,x),q.start(),C=!0,I&&c!==k.DETECTION_METHODS.AD_PLACEHOLDER&&
(d=new Wd(M().getRounded()),p=new Xd,p=new Yd(q.getObservedNode(),p),u=new Zd(d.getSlices(),p))):I&&(y=new $d(a))})();return{mark:function(){t.setAttributeOf(N,B,"")},cleanup:function(){t.removeAttributeOf(N,B)},isNode:function(a){return b===a},isHidden:T,isObstructed:function(){return!1},getDims:M,getPercentInView:H,getLocationState:O,getOnPageViewability:function(){return T()?k.OUT_OF_VIEW:O()},getDetectionMethod:function(){return c},getContainerDims:function(){return G.allowsOptimization?p:D(d)},
refresh:function(){A=x=K=v=m=p=void 0;if(f){var a,c;if(!s.isDomless()&&(c=b.parentNode)){for(;b!==w&&c&&c!==J&&!a;)a=c===d,c=c.parentNode;a||(d=b.parentNode)}}},getAdNode:function(){return b},getSliceStatus:function(){var a;u&&u.isReadyToMeasure()?a=u.getSliceStatus():s.friendly&&y&&g.isDef(x)&&(a=y.getSliceStatus(x,K,v,A));return a}}},be=function(a,b){var c=[],d,e=g([]),f=function(){return c[0]&&c[0].getDetectionMethod()===k.DETECTION_METHODS.AD_PLACEHOLDER},p=function(m,q,p,l){var u=f()||0===c.length;
m=ae(a,m,q,p,b,l);f()&&(p=c.shift(),e=g(c),p.cleanup(),d=void 0);c.push(m);e=g(c);u&&m.mark();u&&q!==k.DETECTION_METHODS.AD_PLACEHOLDER&&n.getAggregator().trigger("primaryadfound",m)},m=function(){if(d)return d;var a,b=!1,c=0,f=0;e.each(function(d,e){var g;g=e.getDims();g.hasValidDims()&&(a=e.getPercentInView(),b=a!==k.NA,g=g.area(),c+=g,f+=a/100*g)});return d={totalArea:c,totalInView:f,hasMeasurement:b}},q=function(a){var b=n.getAggregator().request("adRenderStatus");return!a&&!b},l=function(a){var b;
b=m();b=b.hasMeasurement?r.round(b.totalInView/b.totalArea*100):k.PIV_NA;if(isNaN(b)||q(a))b=0;return b},y=function(c){var d=b.bootstrapOn("mobOrTab"),d=m().totalArea>=k.MRC_LARGE_AD_SIZE&&b.on("largeAd")&&!d&&!s.isVideo();return a.calcInitialViewState(l(c),d)},v=function(a){var b=-1;e.each(function(c,d){d.isNode(a)&&(b=c)});return b},t=function(a){return function(){return c[0]&&c[0][a]()}};n.getAggregator().on("adComponentAdded",function(a){g(a).each(function(a,b){-1===v(b)&&p(b,k.DETECTION_METHODS.MUTATION)})});
n.getAggregator().on("adComponentRemoved",function(a){g(a).each(function(a,b){var d=v(b);-1<d&&c.splice(d,1)})});return{getDims:t("getDims"),isObstructed:t("isObstructed"),getDetectionMethod:t("getDetectionMethod"),getContainerDims:t("getContainerDims"),getViewState:y,getViewStateIgnoringRender:function(){return y(!0)},getPercentInView:l,getPercentInViewIgnoringRender:function(){return l(!0)},isHidden:t("isHidden"),isUsingPlaceholder:f,hasAd:function(){return!!c.length},refresh:function(){d=void 0;
...
f=!0;break}if(f){d=t.getRect(d.frameElement);c.left+=d.left;c.top+=d.top;try{c.width=r.min(c.width,d.width),c.height=r.min(c.height,d.height)}catch(s){n.getAggregator().trigger("error",k.ERROR_CODES.GET_AD_DIMENSIONS)}b!==r.getTop()&&l(b.parent,c)}return c},m=function(){var m,u={};try{var y,v,w,x,A,F,z=r.getMaxNumber(),D=r.getMaxNumber();s.friendly?(y=l(),w=y.left,x=y.top,z=y.width,D=y.height,v=t.browserWindowPosition(),A=v.scrX+w,F=v.scrY+x):e.on("rattie")&&f.browserIs(k.BROWSERS.IE)?(d=d||n.getAggregator().request("ieXDomainViewability"),
c=d.determineFramePosition(),A=c.scrX,F=c.scrY):g.isDef(a.mozInnerScreenX)&&(A=r.round(a.mozInnerScreenX),F=r.round(a.mozInnerScreenY));var u={scrX:A,scrY:F,iFrameClippingWidth:z,iFrameClippingHeight:D},B,E,C=b||t.getIeDimObj(a);b=C;g.isDef(a.innerWidth)?(B=a.innerWidth,E=a.innerHeight):C&&g.isDef(C.clientWidth)?(B=C.clientWidth,E=C.clientHeight,0===B&&0<C.offsetWidth&&(B=C.offsetWidth),0===E&&0<C.offsetHeight&&(E=C.offsetHeight)):a.frameElement&&g.isDef(a.frameElement.clientWidth)&&(B=a.frameElement.clientWidth,
E=a.frameElement.clientHeight);m=B;u.height=E;u.width=m}catch(I){n.getAggregator().trigger("error",k.ERROR_CODES.GET_AD_DIMENSIONS)}return u};return{calcDims:function(){return new D(m())},getClippedDims:function(){var a=m();return new D({scrX:a.scrX,scrY:a.scrY,width:a.iFrameClippingWidth,height:a.iFrameClippingHeight})}}},Xb=function(){return{createInstance:function(a,b,c){return s.isDomless()?new re:new se(a,b,c)}}},se=function(a,b,c){var d,e,f=n.getAggregator().request("browser"),p=l&&l.contextNode&&
l.contextNode.parentNode?l.contextNode.parentNode:null,m=be(b,c),q=function(){var a,b,e;d=d||je(s,c);a=d.find();s.friendlyIframe&&s.isBlockingSizmekTag()&&w(a);!a&&d.usePlaceholder?(u(),s.isDeviceTypeGroupMobile()&&f.hasMutationObserver()&&r.getMutationObserver(y).observe(p,{childList:!0})):a&&(a=g(a).isArray()?a:[a],b=d.getAdContainer(),e=d.allowForAdContainerChange,g(a).each(function(a,c){m.addAdComponent(c,g.resolve(d.detectionMethod),b,e)}))},u=function(){var a;m.hasAd()||(a=t.getPlaceholderSpan(),
p.insertBefore(a,l.contextNode.nextSibling),m.addAdComponent(a,k.DETECTION_METHODS.AD_PLACEHOLDER,t.getParent(a)))},y=function(a,b){var c=!1;g(a).each(function(a,b){b.addedNodes&&0<b.addedNodes.length&&(c=!0)});c&&(n.getAggregator().trigger("nodesAdded"),b.disconnect())},v=function(a,b){var e=!1;g(a).each(function(a,b){1>=b.target.height*b.target.width&&(e=!0)});var f;e&&(f=Xa(),f.isApplicable(s,c)&&(b.disconnect(),d=Wa(),m.clearCollection(),n.getAggregator().trigger("nodesAdded")))},w=function(a){var b;
...
l.mode&&c.push(w.location.href)}catch(m){}try{c.push(l.jsref)}catch(q){}c.sort(function(a,b){return a.length>b.length?1:a.length<b.length?-1:0});return!!g(a).findFirst(function(a,d){var e=!1,f,m,k="mobfox"===d?c:[b];for(m=0;m<k.length;m++){f=k[m];var l="string"===typeof d?[d]:d;if(g(l).isArray()&&(l[0].substring(0,4),l))for(var p=0;p<l.length&&(e=-1<f.indexOf(l[p]),!1!==e);p++);if(e)break}return e})}},userAgent:{STRINGIFIED_METHOD:"a",detect:function(a){return s.isDomless()?!1:!!g(a).findFirst(function(a,
...
return!b||c&&c.isFullyInView(a)})}}},Ce=function(){var a={AdPaused:"pauseAd",AdVolumeChange:"volumeChanged",AdPlaying:"resumeAd"};return{translate:function(b){var c=b.charAt(0).toLowerCase()+b.slice(1);b in a&&(c=a[b]);return c}}},Za=function(){return{getVolumeFromContext:function(a){var b,c=-1;g.isDef(a)&&(g.isDef(a.volume)?c=a.volume:g.isDef(a.adVolume)&&(c=a.adVolume));-1!==c&&(b=c);return b}}},Cb=function(a,b,c){var d="IASid"+a,e="getIasVidBridgeVersion"+a,f,p,m,q=[],u=k.OUT_OF_VIEW,t=!1,v=!1,
w=!1,x=!0,A=new Ae,F=Be(),G=new ye,B=new Za,C=new Ka,E=function(b){var d;t=!0;var e={};try{e=JSON.parse(unescape(b&&b.data?b.data:b))}catch(f){e={}}e.id==a&&(d=A.registerEvent(e,c.getCurrentLoc()),d.indicatesPlaying()?(v=!0,u=w?k.IN_VIEW:!1):d.indicatesNotPlaying()?(v=!1,u=k.OUT_OF_VIEW):d.indicatesFullscreen()?(w=!0,u=v?k.IN_VIEW:k.OUT_OF_VIEW):d.indicatesNormalSize()&&(w=!1,u=v?!1:k.OUT_OF_VIEW),b=parseFloat(d.getVolume(B)),0<b?x=!0:0===b&&(x=!1));q.push(d);m&&J();return d},D=function(b){var c,
f,k=Aa().wrapToGlobal(E),m=function(a){g.isStr(a)&&(n.getAggregator().provide("vc",function(){return a}),n.getAggregator().trigger("addOutputItem",{output:a},"vc",{type:"impression"}))};try{f=b[e]||b.getIasVidBridgeVersion,c=g.isFunction(f)&&"2"===f.call(b)?unescape(b[d].call(b,a,k)):unescape(b[d].call(b,a)),t=!0,m(c||"n")}catch(p){__IntegralASDiagnosticCall("handshakefailure",p,l)}},I=function(){var c=function(a){return g(g(a).toArray()).findFirst(function(a,b){return g.isFunction(b[d])})};f||(g(["*[data-integralas-vid-"+
a+"]",".integral-vid-"+a,"ias-ad","object","embed"]).findFirst(function(a,b){var d=r.getDoc().querySelectorAll(b);return f=c(d)}),!f&&b.on("novidnodeerr")&&__IntegralASDiagnosticCall("novidnode",{message:"node not found"},l));return f},N=function(){var a=I();a&&!t&&D(a);return a},H=function(a){a=B.getVolumeFromContext(a);x=g.isDef(a)?0<a:!1},J=function(){C.init();g(q).each(function(a,b){b&&(g.isUndef(b.sl)&&b.updateScreenLoc(c.getCurrentLoc()),b.trigger(),b.indicatesCompletion()&&n.getAggregator().trigger("adSessionComplete"),
b.indicatesQuartile()&&("adVideoComplete"!==b.tp&&n.getAggregator().trigger("sendDt",k.DT_CODES.VIDEO_EVENTS),n.getAggregator().trigger("videoQuartileEvent",b)))});q=[];m=!0};(function(){z.addEvent(r.getWindow(),"message",function(a){E(a)});n.getAggregator().on({volumeChanged:H});n.getAggregator().provide({videoEventsString:A,videoVersion:function(){var a,b=N();try{a=b.getVersion()}catch(c){a=-1,n.getAggregator().trigger("error",k.ERROR_CODES.NO_VIDEO_AD_INTERFACE)}return a},videoTranslator:function(){return p=
p||new Ce},adNode:N});N();G.listenForResult();F.isApplicable(s)&&F.start(c)})();return{findAdNode:N,getViewStateOverride:function(){return u},isHandshakeComplete:function(){return t},triggerInitializationEvents:J,setVideoSpecificScreenEventFields:function(a){var b=a.viewState===k.NA;a.isVideoPlaying=!0;a.isSoundOn=x;a.isVideoPlayingInFullscreen=!1;if(u){if(u===k.OUT_OF_VIEW){var c=a.reason?a.reason.split("."):[];c[c.length]=k.OUT_OF_VIEW_REASONS.VIDEO;a.reason=c.join(".")}a.viewState=b?a.viewState:
...
D=l.contextNode.getAttribute("data-ias-callback"),z=x+"adContainerId="+C+"&cbFunctionName="+D,z=B?z.replace("monitoring","blocking"):z.replace("skeleton.js",l.integration+".js"),E=l.protocol+":"+l.staticServer+l.integration+"a.js",J=l.protocol+":"+l.staticServer+l.integration+".js",v=z+"&true_pb="+encodeURIComponent(l.passback)+(B?"&redirectUrl="+encodeURIComponent(J):"")+(B?"&passback=":"&adsafe_pb=")+encodeURIComponent(E)+"&"}var B=v=v.replace(k.UNIQUE_ID_TOKEN,l.asid),I=v.length,H,M,L=m(l.sp_imp_jsInfo_minLength,
0),E="";try{H=w-I-L,0<H&&(M=Fe(r,H,14,b.on("partialUrls")),E+=M.join("&"))}catch(O){a.add(k.ERROR_CODES.IMPRESSION_URLS)}v=B+E;r=v+=q(v);var Q,I="";try{Q=w-v.length,I+=Ge(Q,"adsafe_jsinfo=",a,b,c,e,f,p)}catch(S){a.add(k.ERROR_CODES.JSINFO),I+="adsafe_jsinfo=e:"+a.toString()}v=r+I;d.macroUrl&&(v+=q(v),v+=d.macroUrl);l.staticFwjsMacros&&(v+=q(v),v+=l.staticFwjsMacros);if(s.isAMZN()&&-1===v.indexOf("gdpr_consent")){var R=n.getAggregator().request("tcString");g.isDef(R)&&(v+=q(v),v+="gdpr_consent="+R)}t=
v;l.impUrl=t;d.sendImpression(t);n.getAggregator().trigger("impressionsent")}catch(W){__IntegralASDiagnosticCall("impsend",W,l)}}}},La=function(){try{var a=l.perf,b,c,d,e,f,p;a.markEnd("ec");b=a.getEnd("ec");c=w.performance&&"function"===typeof w.performance.getEntriesByName&&w.performance.getEntriesByName(l.impUrl)[0];var m=a.getStart("bd"),q=a.getStart(qa);d=l.jsDoSplit?Math.round(b-m):Math.round(b-q);e=Math.round(c&&c.duration);f=Math.round(b-(c&&c.responseEnd));g.isNumeric(d)&&g.isNumeric(e)&&
