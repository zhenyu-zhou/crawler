...
try {
	var __IntegralASConfig = {
		...
		protocol: 'https',
		jsref: "",
		asid: "d0370b3e-2051-11eb-900c-0a925a1cc084",
...
m.oid):l.push("uid:"+d.unq);l.push("v:19.8.141");l.push("sp:"+(m.isSplitMode?1:0));l.push("fwm:"+("true"===m.fwMonitoring?1:0));c.on("resolution")&&(l.push("wr:"+f(s.windowSize()).toArray().join(".")),l.push("sr:"+f(s.screenSize()).toArray().join(".")));b=function(){var a;a=String(m.scriptUrl).toLowerCase();var b=a.indexOf("ias_xpc");-1<b?(a=a.substring(b+7+1),b=a.indexOf("&"),a=-1<b?a.substring(0,b):a):a="NotFound";return a||""}();"NotFound"!==b&&l.push("x_xpc:"+b);return l},Ae=function(a,b,c,d){var e,
