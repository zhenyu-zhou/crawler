				...
				var gen = function(code, err, config) {
					...
					try {
						...
						if (config) {
							...
							if (typeof config.mn === 'string' && config.mn.length > 2) {
								url += '&region:' + config.mn.substring(config.mn.length-2);
							}
...
try {
	...
	var __IntegralASConfig = {
		...
		sp_cdnScripts: {xsca: "static.adsafeprotected.com/xsca.17.4.85.js", sca: "static.adsafeprotected.com/sca.17.5.12.js", main: "static.adsafeprotected.com/main.19.8.254.js"},
		protocol: 'https',
		jsref: "",
		asid: "426168fb-373f-11ec-82ff-0adc51855674",
...
f=!0}}},R=function(h,a){var c=h||l.adsafeSrc||l.requrl;c&&0===c.indexOf("http")||(c=0===c.indexOf("//")?l.protocol+":"+c:l.protocol+"://"+c);var c=/((http|https):\/\/(([^\/\.]*)\.([^\/]*)))(?:\/(.[^?]*)\??(.+)?)*/.exec(c),b=c[1],d=c[2],e=c[3],f=c[4],q=c[5],m=h?c[6]:"",p=a?c[7]:"",u={},y=function(a){g.isDef(a)&&(f=a);return f},v=function(a){g.isDef(a)&&(q=a);return q},k=function(a,b){var c=a+"="+g(b).toION();return g.encodeInvalidUrlChars(c,l.encodeInvalidUrlChars)},p=p?p.replace(/&$/,""):"";return{appendToParamValue:function(b,
c){var d,e;(d=u[b])?u[b]=d+c:a&&p.length&&(d=p.split(b),e=1<d.length)&&(e=d[1].split("&")[0],d=[d[0],e].join(b),p=p.replace(d,d+c))},fullDom:b,hostname:e,sub:y,master:v,setParam:function(a,b){u[a]=u[a]||{};g(b).isObj()?g(u[a]).mixin(b):u[a]=b},path:function(a){m=a},toString:function(){var a=y()?y()+".":"",b=m?"/"+m:"",c;p||!g(u).isEmpty()?(c=g(u).isEmpty()?"":g(u).stringify(k,"&"),c="?"+p+(p&&c?"&"+c:c)):c="";return d+"://"+a+v()+b+c}}},ob=function(){var h=function(a){var b=[];g(a).each(function(a,
c){400>=b.concat(c).join("").length&&b.push(c)});return b},a=function(a,b){var d;b&&b.id&&(d=b.id.replace(/[^\w-_.>\/]/g,""));return d};return function(){var c,b;try{if(s.friendly&&!s.isMobileApp())if(c=n.getAggregator().request("adSlotIds"))b=c;else{var d,e;if(d=t.getOurNodeInTop()){var f=t.getAncestorNodes(d);e=g(f).map(a)}if(c=e=e&&h(e))n.getAggregator().trigger("addOutputItem",{output:c},"slid",{type:k.DT_CODES.ADTALK,asION:!0}),n.getAggregator().provide("adSlotIds",c),b=c}return b}catch(q){n.getAggregator().trigger("error",
k.ERROR_CODES.AD_SLOT_ID)}}()},tc={name:"AdRefreshDetection",dependencies:[],creator:function(){var h=[15,30,45,60,90],a={start:function(){var a=this,b=l.asid,d=this.getChanId(),e=l&&l.contextNode&&l.contextNode.nextSibling&&l.contextNode.nextSibling.id;b&&d&&(this.recordAdSlotImpression(b,d,e,function(b,d){b?n.getAggregator().trigger("error",k.ERROR_CODES.AD_REFRESH):a.sendRefreshSession(d)}),a.registerInternalViewabilityListener(d,e))},adRefreshIntervalIsValid:function(a){return-1!==h.indexOf(a)},
getChanId:function(){for(var a=l.reqquery.split("&"),b,d=/(\S+)=(\S+)/g,e=0;e<a.length;e+=1){d.lastIndex=0;var f=d.exec(a[e]);f&&3===f.length&&"chanId"===f[1]&&(b=f[2])}return b},sendRefreshSession:function(a){a=(0===a.refreshCount?"self":a.refreshSessionId)+"."+a.refreshCount;n.getAggregator().trigger("addThrottledProp",k.DT_SLOT.ENVIRONMENT,"ar",a)},recordAdSlotImpression:function(a,b,d,e){var f=r.getTop();a={requestTop:"recordAdSlotImpression",asid:a,adUnitId:b,cacheId:d};window.addEventListener("message",
...
var f=d.length,p=0,u=0;e(f,0,0);g(d).each(function(a,c){h.send(c.replace("%%CBS%%",b.getCacheBustId()),function(){e(f,p,++u)},!0);e(f,++p,u)})}catch(y){c.add(k.ERROR_CODES.AT_SEND)}};return{init:function(){try{var a=(new R).fullDom;"/"!==a.slice(-1)&&(a+="/");a+="tpl?asId="+l.asid;h.jsonp(a,f)}catch(b){c.add(k.ERROR_CODES.AT_INIT)}}}},ac=function(h,a,c,b){return{enabled:"true"===l.useBapiCallback,callback:function(a){c.trigger("sendDiag");try{"true"===l.accountForSadImps&&b.measure(a),l._onAPIResult&&
l._onAPIResult(a)}catch(e){h.add(k.ERROR_CODES.BAPI_CALLBACK),c.trigger("sendDiag","bapiClient")}}}},Gb=function(){return{createInstance:function(h,a,c,b){return s.isDomless()?new Pc:new Qc}}},Qc=function(){var h=k.BROWSERS,a=function(a){return c()===a},c=function(){var a="u",b=r.getWindow();try{g.isDef(b.opera)&&g.isDef(b.opera.buildNumber)?a=h.OPERA:g.isDef(b.mozInnerScreenY)?a=h.GECKO:g.isDef(b.chrome)&&g.isDef(b.chrome.csi)?a=h.CHROME:g.isDef(b.msWriteProfilerMark)&&g.isDef(b.crypto)?a=h.MSEDGE:
g.isDef(b.attachEvent)||g.isDef(b.msCrypto)?a=h.IE:g.isDef(b.WebKitPoint)&&(a=h.WEBKIT)}catch(c){}return a},b=function(){var a=!1,b=r.getWindow();g.isDef(b.navigator)&&g.isDef(b.navigator.userAgent)&&(a=b.navigator.userAgent);return a};return{browserIs:a,hasIntersectionObserver:function(){return"function"===typeof IntersectionObserver},hasMutationObserver:function(){return"function"===typeof MutationObserver},hasResizeObserver:function(){return"function"===typeof ResizeObserver},hasAncestorOrigins:function(){var a=
r.getWindow().location;return!(!a||!a.ancestorOrigins)},hasPostMessage:function(){var a=r.getWindow();return!(!a||!g.isFunction(a.postMessage))},getDocumentMode:function(){var a=r.getDoc();return a&&a.documentMode?a.documentMode:k.NA},getBrowserType:c,getUserAgent:b,params:function(){var b=c(),e;e=["{45EA75A0-A269-11D1-B5BF-0000F8051515}","{3AF36230-A269-11D1-B5BF-0000F8051515}","{89820200-ECBD-11CF-8B85-00AA005B4383}"];var f=k.NA,q=r.getDoc(),m=q.createElement("div");if(a(h.IE))try{if("-ms-ime-align"in
q.documentElement.style)f="11";else for(m.style.behavior="url(#default#clientcaps)",q=0;q<e.length&&!(f=m.getComponentVersion(e[q],"componentid").replace(/,/g,"."));q++);}catch(p){}e=f;f=k.NA;m=r.getWindow();g.isDef(m.navigator)&&g.isDef(m.navigator.appName)&&(f=m.navigator.appName.toLowerCase()[0]);return{br:b,abv:e,an:f}},isAndroidWebViewBrowser:function(){var a=b(),c=["SamsungBrowser","FB_IAB","Silk"],f=function(){return g(c).findFirst(function(b,c){return H.contains(a,c)})};return H.contains(a,
"Android")&&f()},getIOSVersion:function(){var a,c;(a=b())&&(a=a.match(/OS\s\d+/))&&0<a.length&&(c=(c=a.toString().match(/\d+/))&&0<c.length&&parseInt(c.toString()));return c}}},Pc=function(){var h=function(){return!1},a=function(){return k.NA};return{getDocumentMode:a,getBrowserType:function(){return"u"},getIOSVersion:function(){},params:function(){return{br:"u",abv:a(),an:a()}},browserIs:h,getUserAgent:h,hasPostMessage:h,hasAncestorOrigins:h,hasIntersectionObserver:h,hasMutationObserver:h,isAndroidWebViewBrowser:h}},
zc=function(){return{createInstance:function(h,a){return s.isDomless()?new Rc(a):new Sc(h,a)}}},Tc=function(){var h,a=function(a,b){var d="",e="",f=r.getDoc().getElementsByTagName("ins");if(f&&0<f.length){e=f[0];d="<ins";for(f=0;f<e.attributes.length;f++)d+=" "+e.attributes[f].nodeName+'="'+e.attributes[f].nodeValue+'"';d+=">";e="</ins>"}return'<!doctype html><html><head></head><body style="margin:0px;border:0px;padding:0px;font-size:0px"><script>var IASid = "'+a+'", largestSize = 0;var IASmonitorDom = function () {  var DOM_MONITOR_PERIOD = 100;  var i, us, thisSize, thisWidth, thisHeight;  var elems = document.body.getElementsByTagName("*");  for (i = 0; i < elems.length; i++) {    if (elems[i].tagName && elems[i].tagName.toLowerCase() === "ins")      continue;    thisWidth = elems[i].offsetWidth;    thisHeight = elems[i].offsetHeight;    thisSize = thisWidth * thisHeight;    if (thisSize > largestSize) {      largestSize = thisSize;      us = parent.document.getElementById(IASid);      if (us) {        us.setAttribute("CreativeLoaded","true");        if (elems[i].style.left !== "") {          us.style.left = elems[i].style.left;          elems[i].style.left = "0px";        }        if (elems[i].style.top !== "") {          us.style.top = elems[i].style.top;          elems[i].style.top = "0px";        }      }    }  }  setTimeout(IASmonitorDom, DOM_MONITOR_PERIOD);};setTimeout(IASmonitorDom,50);\x3c/script>'+
...
a+"]",".integral-vid-"+a,"ias-ad","object","embed"]).findFirst(function(a,c){var d=r.getDoc().querySelectorAll(c);return f=b(d)}),!f&&c.on("novidnodeerr")&&0.1>Math.random()&&__IntegralASDiagnosticCall("novidnode",{message:"node not found*10"},l));return f},L=function(){var a=I();a&&!t&&C(a);return a},J=function(a){a=D.getVolumeFromContext(a);w=g.isDef(a)?0<a:!1},H=function(){E.init();g(p).each(function(a,c){c&&(g.isUndef(c.sl)&&c.updateScreenLoc(b.getCurrentLoc()),c.trigger(),c.indicatesCompletion()&&
n.getAggregator().trigger("adSessionComplete"),c.indicatesQuartile()&&("adVideoComplete"!==c.tp&&n.getAggregator().trigger("sendDt",k.DT_CODES.VIDEO_EVENTS),n.getAggregator().trigger("videoQuartileEvent",c)))});p=[];m=!0};(function(){z.addEvent(r.getWindow(),"message",function(a){G(a)});n.getAggregator().on({volumeChanged:J});n.getAggregator().provide({videoEventsString:A,videoVersion:function(){var a,b=L();try{a=b.getVersion()}catch(c){a=-1,n.getAggregator().trigger("error",k.ERROR_CODES.NO_VIDEO_AD_INTERFACE)}return a},
videoTranslator:function(){return q=q||new Ce},adNode:L});L();B.listenForResult();F.isApplicable(s)&&F.start(b)})();return{findAdNode:L,getViewStateOverride:function(){return u},isHandshakeComplete:function(){return t},triggerInitializationEvents:H,setVideoSpecificScreenEventFields:function(a){var b=a.viewState===k.NA;a.isVideoPlaying=!0;a.isSoundOn=w;a.isVideoPlayingInFullscreen=!1;if(u){if(u===k.OUT_OF_VIEW){var c=a.reason?a.reason.split("."):[];c[c.length]=k.OUT_OF_VIEW_REASONS.VIDEO;a.reason=
c.join(".")}a.viewState=b?a.viewState:u;a.isVideoPlaying=u===k.IN_VIEW}x&&v&&(a.percentInView=100,a.isVideoPlayingInFullscreen=!0)}}},De=function(){return new aa(k.PERF_TIMELINE_TRACKER_CONFIG.WRAPPERS.AS.TYPE,k.PERF_TIMELINE_TRACKER_CONFIG.WRAPPERS.AS.COUNT)},jb=function(){var a,c,b={},d=0,e=function(b){if(b||a)d+=5,c.onTick(d,function(){a?e():n.getAggregator().trigger("sendDt",k.DT_CODES.PERFORMANCE)}),a=!1},f=function(){c=new Ja;d=0;e(!0);c.start()},l=function(d,e,k,l){d=b[d];l?(g.isDef(d[e])||
(d[e]=[]),d[e].push(k)):d[e]=k;c&&c.isActive()||f();a=!0},m=function(b,d,e){n.getAggregator().trigger("addOutputItem",{output:d},b,e);c&&c.isActive()||f();a=!0},p=function(c){g(b).each(function(d,e){var f=b[d],k={type:c,oneTime:!0,minDt:!0,asION:!0};g(f).isEmpty()||(n.getAggregator().trigger("addOutputItem",{output:f},d,k),b[d]={});a=!1})};return{start:function(){n.getAggregator().on("preSendDt",function(a){p(a);c&&c.kill()});n.getAggregator().on("addThrottledProp",l);n.getAggregator().on("addThrottledOutputItem",
m)},addFieldTypes:function(a){g(a).each(function(a,c){b[c]={}})}}},pb=function(){var a={},c=function(b){a[b]||(a[b]=new Ia(1,l.birthdate));return a[b]},b=function(a){c(a).start()},d=function(a){var b=c(a);b.stop();n.getAggregator().trigger("addThrottledProp","im",a,b.getTime())};return{start:function(){n.getAggregator().on({markTime:b,measureTime:d})},isApplicable:function(a){return a.on("pIntervals")}}},Ee=function(){return new aa(k.PERF_TIMELINE_TRACKER_CONFIG.WRAPPERS.JS.TYPE,k.PERF_TIMELINE_TRACKER_CONFIG.WRAPPERS.JS.COUNT)},
Vb=function(a){var c={},b=a instanceof Array&&0<a.length;b&&(g(a).each(function(a,b){c[b.getType()]=b}),n.getAggregator().on("perfCheckpoint",function(a){var b=c[a.type];if(b)try{b.addPoint(a),b.isFinished()&&n.getAggregator().trigger("addThrottledProp",k.DT_SLOT.IM,"pci",b.toString())}catch(f){}}));n.getAggregator().provide("perfActive",function(){return b});return{isActive:b}},aa=function(a,c){var b=0,d=[],e=function(){d.sort(function(a,b){return a.timestamp-b.timestamp})},f=function(){var a,c=
{};e();g(d).each(function(d,e){a&&(c[e.code]=e.timestamp-a);d===b&&(a=e.timestamp)});return c};return{addPoint:function(a){d.push(a)},toString:function(){return g(f()).toION()},getType:function(){return a},setBaseOrdinal:function(a){b=a},isFinished:function(){return d.length===c}}},Wb=function(){function a(){}a.build=function(){var a=[];a.push(new aa(k.PERF_TIMELINE_TRACKER_CONFIG.RENDER.TYPE,k.PERF_TIMELINE_TRACKER_CONFIG.RENDER.COUNT));var b;b=n.getAggregator().request("vc");var d={jv3:bb,av3:bb,
jvw:Ee,avw:De};(b=b?d[b]:void 0)&&a.push(b());return a};return a}(),bb=function(){return new aa(k.PERF_TIMELINE_TRACKER_CONFIG.VANS.TYPE,k.PERF_TIMELINE_TRACKER_CONFIG.VANS.COUNT)},S={IDS:{BLOCK_TIME:"pBlk",ON_LOAD:"pLoad",IN_BROWSER_DELAY:"pWait"},recordBlockingTime:function(){n.getAggregator().trigger("measureTime",S.IDS.BLOCK_TIME)},setupOnLoadTracking:function(){z.addEvent(x,"load",function(){n.getAggregator().trigger("measureTime",S.IDS.ON_LOAD)})},setupBrowserDelayTracking:function(){var a=
new Ja;a.onTick({4:function(){n.getAggregator().trigger("markTime",S.IDS.IN_BROWSER_DELAY)},5:function(){n.getAggregator().trigger("measureTime",S.IDS.IN_BROWSER_DELAY)}});a.start()}},N={isFrameworkAvailable:function(a,c){var b,d,e=r.getTop(),f=r.getWindow();try{b=e[a]}catch(g){for(;!d;){try{f.frames[c]&&(d=f.frames[c].parent)}catch(k){}if(f===e)break;f=f.parent}}return b||d},getMessageHandler:function(a,c){var b=N.getCallId(),d=function(e){try{e&&e.data&&e.data[a]&&e.data[a].callId===b&&e.data[a].returnValue&&
...
cnst:g.stringifyTriState(e),glbl:g.stringifyTriState(a.hasGlobalScope),mtdt:encodeURIComponent(a.metadata)},f=a&&a.tcString;n.getAggregator().provide("tcString",function(){return f});N.send(b,g(e).toION())}var c=278,b="gcd";(function(){var b=N.isFrameworkAvailable("__cmp","__cmpLocator");N.send("gca",!!b);if(b){var e,f;g.isFunction(b)?b("getVendorConsents",[c],a):(e={__cmpCall:{command:"getVendorConsents",parameter:[c],callId:N.getCallId()}},f=N.getMessageHandler("__cmpReturn",a),z.addEvent(r.getWindow(),
"message",f),b.postMessage(e,"*"))}})()},settings:{tier:k.TIERS.ENVIRONMENT,applies:function(a,c,b){return c.hasPostMessage()&&!b.isDomless()}}},lc={name:"GDPRV2ConsentDetector",dependencies:[],creator:function(){function a(a){var e=g.isDef(a)&&g.isDef(a.vendor)&&g.isDef(a.vendor.consents)&&g.isDef(a.vendor.consents[c])?a.vendor.consents[c]:void 0;a={appl:g.stringifyTriState(a.gdprApplies),cnst:g.stringifyTriState(e)};N.send(b,g(a).toION())}var c=278,b="gcd2";(function(){var b=N.isFrameworkAvailable("__tcfapi",
"__tcfapiLocator");N.send("gca2",!!b);if(b){var e,f;g.isFunction(b)?b("getTCData",2,a):(e={__tcfapiCall:{command:"getTCData",parameter:[c],callId:N.getCallId(),version:2}},f=N.getMessageHandler("__tcfapiReturn",a),z.addEvent(r.getWindow(),"message",f),b.postMessage(e,"*"))}})()},settings:{tier:k.TIERS.ENVIRONMENT,applies:function(a,c,b){return c.hasPostMessage()&&!b.isDomless()}}},rc={name:"postMessageDetector",dependencies:[],creator:function(){var a=!1,c="pmdetector"+l.asid,b=function(b){(b&&b.data)===
c&&(a=!0)};(function(){var d=r.getWindow();z.addEvent(d,"message",b);d.postMessage(c,"*");r.execAtEndOfThread(function(){n.getAggregator().trigger("addThrottledProp",k.DT_SLOT.IM,"pom",g.stringifyTriState(a));z.removeEvent(d,"message",b)})})()},settings:{tier:k.TIERS.ENVIRONMENT,applies:function(a,c,b){return a.on("pmdetect")&&c.hasPostMessage()}}},sc={name:"safeFrameDetector",dependencies:[],creator:function(){n.getAggregator().trigger("addThrottledProp",k.DT_SLOT.IM,"sf",g.stringifyTriState(s.isSafeFrame()))},
settings:{tier:k.TIERS.ENVIRONMENT,applies:function(a,c,b){return a.on("sfdetect")}}},ib=function(a,c,b,d,e,f,q){var m=function(a,b){return isNaN(a)||0>a||""===a?b:a},p=function(a){return"&"===a.slice(-1)?"":"&"};return{send:function(r){try{var t,v=d.baseUrl,x,w,A=f.getDocumentMode();"number"===typeof A?(w=2E3,8===A?w=4E3:8<A&&(w=8E3)):w=m(l.sp_imp_maxLength,2E3);x=w;if(s.integratedBlockingApplies(v)){w=v;var z=n.getAggregator().request("mobileApp"),B=z&&z.isMobileAppEnvironment&&z.isMobileAppEnvironment(),
D=l.contextNode.getAttribute("data-ias-container"),E=l.contextNode.getAttribute("data-ias-callback"),z=w+"adContainerId="+D+"&cbFunctionName="+E,z=B?z.replace("monitoring","blocking"):z.replace("skeleton.js",l.integration+".js"),C=l.protocol+":"+l.staticServer+l.integration+"a.js",H=l.protocol+":"+l.staticServer+l.integration+".js",v=z+"&true_pb="+encodeURIComponent(l.passback)+(B?"&redirectUrl="+encodeURIComponent(H):"")+(B?"&passback=":"&adsafe_pb=")+encodeURIComponent(C)+"&"}var B=v=v.replace(k.UNIQUE_ID_TOKEN,
l.asid),I=v.length,L,J,M=m(l.sp_imp_jsInfo_minLength,0),C="";try{L=x-I-M,0<L&&(J=Fe(r,L,14,c.on("partialUrls")),C+=J.join("&"))}catch(N){a.add(k.ERROR_CODES.IMPRESSION_URLS)}v=B+C;r=v+=p(v);var P,I="";try{P=x-v.length,I+=Ge(P,"adsafe_jsinfo=",a,c,b,e,f,q)}catch(S){a.add(k.ERROR_CODES.JSINFO),I+="adsafe_jsinfo=e:"+a.toString()}v=r+I;d.macroUrl&&(v+=p(v),v+=d.macroUrl);l.staticFwjsMacros&&(v+=p(v),v+=l.staticFwjsMacros);if(s.isAMZN()&&-1===v.indexOf("gdpr_consent")){var R=n.getAggregator().request("tcString");
g.isDef(R)&&(v+=p(v),v+="gdpr_consent="+R)}t=v;l.impUrl=t;d.sendImpression(t);n.getAggregator().trigger("impressionsent")}catch(W){__IntegralASDiagnosticCall("impsend",W,l)}}}},Na=function(){try{var a=l.perf,c,b,d,e,f,q;a.markEnd("ec");c=a.getEnd("ec");b=x.performance&&"function"===typeof x.performance.getEntriesByName&&x.performance.getEntriesByName(l.impUrl)[0];var m=a.getStart("bd"),p=a.getStart(sa);d=l.jsDoSplit?Math.round(c-m):Math.round(c-p);e=Math.round(b&&b.duration);f=Math.round(c-(b&&b.responseEnd));
g.isNumeric(d)&&g.isNumeric(e)&&g.isNumeric(f)&&(q={ttecl:d,ecd:e,tsecr:f},n.getAggregator().trigger("addThrottledProp",k.DT_SLOT.IM,"imprf",g(q).toION()))}catch(r){n.getAggregator().trigger("error",k.ERROR_CODES.IMPRESSION_PERFORMANCE)}},Ge=function(a,c,b,d,e,f,q,m){return function(b){var d=g.encodeInvalidUrlChars(b.primary.join(","),l.encodeInvalidUrlChars),f=c,k=0,m=function(a){if(a)return","+a};f.length+d.length+5<=a?(f+=m(d),e.impressionIsIdentifiable(!0),g(b.secondary).each(function(b,c){var d=
g.encodeInvalidUrlChars(c,l.encodeInvalidUrlChars);f.length+d.length+5<=a?f+=m(d):k+=1})):k+=b.primary.length;return f+=",ov:"+k}(function(){var a,c;c=a={viewState:k.NA};s.isDomless()?c=m.checkScreenLoc(!0)||a:d.on("impFailSafe")?r.getDoc().body&&(c=(c=m.checkScreenLoc(!0))?c:a):g.isDef(r.getDoc().body)&&(c=m.checkScreenLoc(!0));m.isImmediatelyMeasurable()||m.requiresDelayedViewabilityEvent();a=c;var t=a.viewState,v=n.getAggregator().request("mPage");c=e.getAvidIds();t=["id:"+l.asid,"c:"+e.getCacheBustId(),
"sl:"+t,"em:"+s.embedded,"fr:"+s.friendly,"thd:"+g.stringifyTriState(v.supportsVisAPI())];d.on("avidPropertiesInImpression")&&g.isDef(c)&&(t.push("abi:"+c.bundleIdentifier),t.push("apn:"+c.partner),t.push("apv:"+c.partnerVersion));a=He(a,b,d,e,f,q,m);n.getAggregator().trigger("eligiblerender");return{primary:t,secondary:a}}())},He=function(a,c,b,d,e,f,n){var m=[];m.push("mn:"+l.mn);l.iasProxyPartnerDomain&&m.push("ipp:"+encodeURIComponent(l.iasProxyPartnerDomain));m.push("pt:"+function(){var b=n.stringifyPingTimes();
a.viewState!==k.NA&&(b+=a.details);return b}());m.push(g(f.params()).toParams());b.on("mrcAudit")&&!s.isDomless()&&m.push("dvs:"+r.getDoc().visibilityState);e.iterate(function(a,b){var c=!b.props||g.isUndef(b.props.type),d=!b.props||b.props.type===k.IMPRESSION_EVENT;(c||d)&&m.push(a+":"+b.output())});c.toString()&&m.push("e:"+c.toString());m.push(b.output());m.push("tt:"+l.mode);m.push("et:"+(r.now()-l.birthdate));l.perf.mark("si");b.on("swapids")?m.push("oid:"+l.oid):m.push("uid:"+d.unq);m.push("v:19.8.254");
