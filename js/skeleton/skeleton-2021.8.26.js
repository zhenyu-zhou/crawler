...
try {
	var __IntegralASConfig = {
		...
		sp_cdnScripts: {xsca: "static.adsafeprotected.com/xsca.17.4.85.js", sca: "static.adsafeprotected.com/sca.17.5.12.js", main: "static.adsafeprotected.com/main.19.8.235.js"},
		protocol: 'https',
		jsref: "",
		asid: "8b938e07-0686-11ec-bf89-02cb33a7e8c8",
...
e=function(c,d,e,p,u){u=u||{};var w,v,k=function(a){0===b.length&&(b=g(a).map(function(a,b){return h.request(b)}))},y=function(){if(!w){var a=[];w=!0;k(["features","browser","context"]);u.emits&&(c.events=new B);if(!u.applies||u.applies.apply(u,b))v=!0,a=g(e).map(function(a,b){return h.request(b)},!0),a.push(c),g(c).mixin(p.apply({},a))}};(function(){var b=u.tier;g.isDef(b)&&(a[b]=a[b]||new ba,a[b].push(y))})();h.provide(d,function(){var a;y();v&&(a=c);return a});return c};d.runAll=function(){var b=
...
q;if(p||u){var w=f.length;0<w&&(e<w?e=w:(e=0,f=[]));n.getAggregator().trigger("evaluateCreativeFinderResult",q)}else{if(d){var v;v=p=q;u=s.friendly?r.getTop().document.body:l.contextNode.ownerDocument.body;for(;3>c;){if(u&&p===u){v=p;c=3;break}t.isWindow(p)&&(v=t.crossQuerySelector("["+k.AD_IDENTIFIER+"-"+l.asid+"]"),p=g.isDef(v)?v:p);v=p=g.isDef(p)?p.parentNode||p:p;c++}p=v}else p=q;if(t.isWindow(p)){try{w=p.document}catch(K){w=l.contextNode.ownerDocument}q=w}else"IFRAME"===t.getNodeName(p)?(f.push(q),
q=q.contentWindow.document):q=p;var w=[],u=(p=q&&q.getElementsByTagName&&q.getElementsByTagName("*"))&&p.length,y;if(p)for(var A=0;A<u;A++)y=(v=p[A])&&v.nodeName&&v.nodeName.toUpperCase(),!v.children||0!==v.children.length||g(b).contains(y)||g(a).contains(y)||g(w).contains(y)||w.push(y);w=b.concat(w);(new Ec(w,f)).searchDescendants(q)}};n.getAggregator().on("creativeFinderBatchCompleted",q);return{find:q,getClosestContainerName:function(){return t.getNodeName(h)}}},Ec=function(h,a){var b=function(b){function d(b){var c=
...
c=d,e=new Fc,f=!0;n.getAggregator().on("evaluateCreativeFinderResult",function(a){if(t.isNodeXDomainIframe(a))b?r.clearInterval(b):f=!1,c=w(a);else if(a){var d=!1,q=t.getRect(a),p;if(p=a&&"IMG"===t.getNodeName(a)){p=!0;var v=g.isDef(a.naturalWidth)?a.naturalHeight*a.naturalWidth:0,l=getComputedStyle(a),n=0===a.src.length&&H.contains(l.content,"url"),E=a.getAttribute&&a.getAttribute("data-ias-rend-bi");0<v&&!n&&(p=!1);"false"===E&&(h.save(k.RENDER.DIAGNOSTIC.CONTENT_STYLED),p=!1);n&&!E&&u(a,l)}p&&
(d=!0,h.save(k.RENDER.DIAGNOSTIC.BROKEN_IMAGE));!d&&q.width>=k.RENDER.WIDTH_THRESHOLD&&q.height>=k.RENDER.HEIGHT_THRESHOLD&&(m(c),b?r.clearInterval(b):f=!1);h.saveNode(a)}else a=e.getClosestContainerName()||h.getAdNodeName(a)||c.details,h.save(a);y(c)});var q=function(){var b=a&&a.getAdNode();try{e.find(b)}catch(c){n.getAggregator().trigger("renderdiag",c)}},p=n.getAggregator().request("mobileApp");p&&p.isMobileAppEnvironment&&p.isMobileAppEnvironment()&&s.isMraid()?v():(q(),f&&(b=r.setInterval(q,
...
m=h?b[6]:"",p=a?b[7]:"",u={},w=function(a){g.isDef(a)&&(f=a);return f},v=function(a){g.isDef(a)&&(q=a);return q},k=function(a,b){var c=a+"="+g(b).toION();return g.encodeInvalidUrlChars(c,l.encodeInvalidUrlChars)},p=p?p.replace(/&$/,""):"";return{appendToParamValue:function(b,c){var d,e;(d=u[b])?u[b]=d+c:a&&p.length&&(d=p.split(b),e=1<d.length)&&(e=d[1].split("&")[0],d=[d[0],e].join(b),p=p.replace(d,d+c))},fullDom:c,hostname:e,sub:w,master:v,setParam:function(a,b){u[a]=u[a]||{};g(b).isObj()?g(u[a]).mixin(b):
u[a]=b},path:function(a){m=a},toString:function(){var a=w()?w()+".":"",b=m?"/"+m:"",c;p||!g(u).isEmpty()?(c=g(u).isEmpty()?"":g(u).stringify(k,"&"),c="?"+p+(p&&c?"&"+c:c)):c="";return d+"://"+a+v()+b+c}}},ob=function(){var h=function(a){var c=[];g(a).each(function(a,b){400>=c.concat(b).join("").length&&c.push(b)});return c},a=function(a,c){var d;c&&c.id&&(d=c.id.replace(/[^\w-_.>\/]/g,""));return d};return function(){var b,c;try{if(s.friendly&&!s.isMobileApp())if(b=n.getAggregator().request("adSlotIds"))c=
...
e=function(){return!a&&g.isDef(r.getWindow().mraid)},f=function(){var b=!1;if(!a)var c=(b=r.getWindow().inmobi)&&b.IASDocumentVideoBuffer,b=b&&c&&g.isFunction(c.addVideoEventListener),b=e()&&!!b;return b},q=function(){var b;if(!(b=-1!==l.mode.indexOf("jsvid"))){var c;b=!1;var d=n.getAggregator();if(!a&&(d=d.request("avidJsClient"),d.isAvidAvailable()))try{c=d.getAvidAdSessionContext(),b=c.mediaType===k.MEDIA_TYPE.VIDEO}catch(e){}(c=b)||(d=n.getAggregator(),c=d.request("omidVerificationClient"),b=
!1,d=d.request("omidAdSessionContext"),c&&d&&(b=d.mediaType===k.MEDIA_TYPE.VIDEO),c=b||f());b=c}return b},m=function(){return!1===l.fwMonitoring||"false"===l.fwMonitoring},p=function(){return l.mobOrTab},u=function(a){return!1===g(l.customViewability).isArray()?!1:0<g(l.customViewability).filter(function(b,c){return H.contains(c.id,a)}).length},w=function(){return u("grpm")||l.use100v};return{embedded:b,friendly:c,isFriendlyToParent:function(b){var c,d;if(a)b=!0;else{try{d=R(b.document.referrer),
c=d.hostname===b.location.hostname}catch(e){}b=c}return b},friendlyIframe:b&&c,xDomainIframe:b&&!c,getTagTime:function(){return r.now()-l.birthdate},getPageTime:function(){var b=k.NA;!a&&g.isDef(h.chrome)&&g.isDef(h.chrome.csi)&&g.isFunction(h.chrome.csi)&&(b=r.round(h.chrome.csi().pageT));return b},isVideo:q,isMobileApp:d,isSpecifiedAd:function(){var b=!1;a||(b=(b=g.isFunction(l.contextNode.getAttribute)&&l.contextNode.getAttribute("data-ias-container")||l._cl_adpath)&&g.isStr(b));return b},isCompoundAd:function(){var b=
...
l.use100v||!w()},usesGroupMCustomMetric:w,isCeltra:function(){var b=!1;a||(b=Ja().isApplicable());return b},usesGroupMCustomMetricMobilePassThru:function(){return w()&&p()},usesZeroPivCustomMetric:function(){return!1===g(l.customViewability).isArray()?!1:0<g(l.customViewability).filter(function(a,b){return g(b.thresholds).findFirst(function(a,b){return 0===b.piv})}).length},isRefreshable:function(a){try{var b=r.getTop();window.addEventListener("message",function(b){/isRefreshable/g.test(b.data)&&
...
b);c&&a.oneTime&&(a.flagForRemoval=!0);return c},e);a.setParam("tv",e)},y=function(c,h){var g,u={};d.filterOutput(function(a){return a.standalone&&!a.minDt&&a.type===h},function(a,b){c.setParam(a,b.replace("%3A",":"))});f.fastForward();if(h===k.DT_CODES.CUSTOM||h===k.DT_CODES.UNLOAD||h===k.DT_CODES.VIDEO_EVENTS||h===k.DT_CODES.FULLY_INVIEW||h===k.DT_CODES.PING||h===k.DT_CODES.VIEWABILITY_READY||h===k.DT_CODES.ADTALK)u.clog=q,s.isVideo()&&(g=s.isOmid()?"omidVideoEventsString":"videoEventsString",(g=
...
b,c){w(a,g.resolve(b),void 0,void 0,void 0,c)},sendMinDt:function(a,b){w(a,b,void 0,!0)},sendDiag:v,updateDtCount:function(){p++},unload:h});return{send:w,unload:h,diagnostic:v,setViewabilityMod:function(a){}}},D=function(h){var a={},b=!1,c=function(){var a=1===h.nodeType?t.nodeIsHidden(h):0===h.width||0===h.height;return b?!1:a},d=function(){var b={};g(a).each(function(a,c){b[a]=r.round(c)});return b},e=function(a){return g.isNumeric(a)||g.isUndef(a)},f=function(){return r.round(a.width)*r.round(a.height)};
...
var g=b.getElementsByTagName&&b.getElementsByTagName(e);if(g&&g.length)for(e=0,f=g.length;e<f;e++)h.push(g[e])}return h}(h));q&&(f=c(q),f.hasValidSizeForMobileApp=q.hasValidSizeForMobileApp);return f},screenSize:function(){if(s.isDomless())return{width:0,height:0};var h={width:-1,height:-1};try{g.isDef(x.screen)&&(h={width:x.screen.width,height:x.screen.height})}catch(a){}return h},calcMonDims:function(){var h=g(t.screenSize()).mixin({scrX:0,scrY:0});g.isDef(screen.availLeft)&&(h={scrX:x.screen.availLeft,
...
{};try{p.a=encodeURIComponent(top.location.href)}catch(u){}try{p.b=encodeURIComponent(parent.location.href)}catch(k){}if(s.embedded){try{p.c=encodeURIComponent(parent.document.referrer)}catch(n){}try{p.e=encodeURIComponent(x.document.referrer)}catch(r){}}try{"jsi"!==l.mode&&(p.d=encodeURIComponent(x.location.href))}catch(y){}try{p.f=encodeURIComponent(l.jsref)}catch(A){}try{f=m(),p.g=encodeURIComponent(f.g||""),p.q=encodeURIComponent(f.q||""),a.isStarted()&&!f.g&&1<a.getMyFrameDepth()&&(p.g=encodeURIComponent(a.getTopDomain()))}catch(E){}p=
...
b.cc=a.containerDimensions);g({piv:"percentInView",obst:"obstructed",th:"tabHidden",reas:"reason"}).each(function(c,d){var e=a[d];g.isDef(e)&&(b[c]=e)});c=g(b).toParams();return""===c?"":","+c},w=function(a,c){var d=new Nc(c);return b[a]=d},l=function(a,b){return(b||"")+{inView:"i",outOfView:"o",na:"n",partialViewMinus:"pm",partialViewPlus:"pp"}[a]},r=function(){g(c).each(function(b,c){m[c]+=a.length?q-d:q});d=q},y=function(b){a.length&&r();g(b).each(function(a,b){var d=c[a];d!==b&&"n"===d&&(m[b]+=
m.n);c[a]=b});a.length||r()},A=function(a){var c,d=a.adDimensions?a.adDimensions.getRounded():{width:0,height:0};c=u(a);var e=a.omidObstructions,p={sl:l(a.viewState)};q=s.getTagTime();y(p);p.t=q;c=g({toString:function(){g(b).each(function(a,b){b.fastForward()});return"{"+g(p).toParams()+this.details+this.breakdowns+"}"},details:c,breakdowns:{piv:[],as:[],toString:function(){var a,b=function(a,b){return b.duration+"~"+b.state};a=""+("piv:["+g(this.piv).stringify(b)+"]");a+=",as:["+g(this.as).stringify(b)+
...
height:b};return a.width+"."+a.height});var a=n.getAggregator().request("omidAdSessionContext");a&&-1<a.recoveredTime&&p(a.recoveredTime)})();return{fastForward:function(){q=s.getTagTime();r()},registerLocation:function(d){var f,q=!1;c.sl==l(d.viewState)&&a.length?(f=new A(d),a[a.length-1].details=f.details):(f=new A(d),a.push(f),e=d.viewState,q=!0);n.getAggregator().trigger("newScreenEvent",f);g(b).each(function(b,c){-1!=="piv|as".indexOf(b)?(q&&c.clear(),c.addState(f),a[a.length-1].breakdowns[b]=
c.get()):c.addState(f)});return f},stringify:function(b){var c="";a.length&&(c=g({slTimes:"{"+g(m).toParams()+"}",slEvents:"["+a.slice(-b).join(",")+"]",slEventCount:a.length}).toParams());return c},createViewabilityTracker:w,getCurrentLoc:function(){return l(e)},getCurrentEvent:function(){return f},setRecoveredTimeInSlTimes:p}},H={hashCode:function(a){var b=0,c,d,e;if(0===a.length)return b;c=0;for(e=a.length;c<e;c++)d=a.charCodeAt(c),b=(b<<5)-b+d,b|=0;return b},rot:function(a){return a.replace(/[a-zA-Z]/g,
...
a),k=function(){g.isUndef(d)&&(d=new jd(e));return d},l=function(){e.provide({frameCollection:function(){return q},adProxy:function(){return p},adTalkMessage:function(a){return new kd(a,e)},adTalkMessageCollection:function(){return m},idMapModule:k,interFrameQuerySelector:function(a){return new ld(a)}})};return{isApplicable:function(a){return g.isDef(x.JSON)&&g.isDef(x.postMessage)&&!a.isAvid()&&(!a.isOmidNative()||a.isOmidForWeb())},start:function(){l();f.traverse(q.addFrame);u.startListening();
...
c=n.getAggregator().request("features").on("swapids")?l.oid:l.asid;var f=a||{},g=l.asid,d=d.tagId,m=s.embedded,p=s.friendly,u=l.birthdate;c=c.split("-")[2];var w;s.friendly?w="["+k.AD_IDENTIFIER+"-"+l.asid+"]":(w=r.getWindow(),w=w.location&&w.location.href,w='iframe[src*="'+(w&&w.replace(/^https?\:\/\//i,""))+'"]');return{messageContent:f,srcAsid:g,srcTagId:d,srcIsEmbedded:m,srcIsFriendly:p,srcBirthdate:u,iasCommonId:c,nodeSelector:w,positionStr:e,version:"0.1"}},gd=function(){var a={};return{add:function(b){var c=
...
va(a?m.IAS:m)}},ib=function(a){function g(){return s.isOmidForWeb()||a.data.hasOwnProperty("supportsLoadedEvent")&&("true"===a.data.supportsLoadedEvent||!0===a.data.supportsLoadedEvent)&&"string"===typeof a.data.creativeType&&""!==a.data.creativeType}var q="0";if("sessionStart"===a.type){f.adSessionType=a.data.context.adSessionType;f.environment=a.data.context.environment;f.accessMode=a.data.context.accessMode;f.omidNativeInfo=a.data.context.omidNativeInfo;f.omidJsInfo=a.data.context.omidJsInfo;f.deviceInfo=
...
f.integratedBlocking&&p&&p.on("exitOASRSEarly")&&(f.omidEarlyExit=!0,q="1",f.omidEarlyExit&&-1<l.mobFwUrl.indexOf("xmtp=v")&&(f.mediaType="video")),!a.data.mediaType||"display"!==a.data.mediaType&&"video"!==a.data.mediaType||(f.mediaType=a.data.mediaType));f.omidEarlyExit&&(c=!0,y("omtp",f.mediaType),g()&&(d=!0),"video"===f.mediaType&&(f.isVideo=!0),f.isNativeVideo=f.isNative&&f.isVideo,f.isDisplay="display"===f.mediaType);for(var k=[{root:"omidNativeInfo",code:"onpn",field:"partnerName"},{root:"omidNativeInfo",
...
g=c&&75<=d,m={windowDimensions:{x:0,y:0,width:0,height:0},adDimensions:{x:0,y:0,width:0,height:0},containerDimensions:{x:0,y:0,width:0,height:0},shouldDelegateToDomBasedViewability:g,isMeasurable:0===d||75<=d,isObstructed:!1,isHidden:!1,numberOfAdverts:1,percentageInView:d,detectionMethod:"av"},b.trigger("screenLocationChanged",m)}catch(p){}};return{start:function(){try{var b=a.getAvidAdSessionContext().avidAdSessionType;c="display"===b||"video"===b;a.addEventListener("viewability",d)}catch(f){}},
addScreenLocationChangedListener:function(a){b.on("screenLocationChanged",a)}}},Ad=function(a,b){var c=[],d=(new Date).getTime(),e=0,f=0,q=!1,m=new Ka,p=n.getAggregator().request("omidAdSessionContext"),u=r.getWindow(),w=(u=u&&u.omid3p)&&g.isFunction(u.registerSessionObserver)&&g.isFunction(u.addEventListener)?u:a,v=!1,s={isEmpty:function(){return 0===c.length},toString:function(){for(var a="{vEventCount:"+c.length+",vEvents:[",b=0;b<c.length;b++)var d=c[b],a=a+((0<b?",{":"{")+("t:"+d.t+",")+("rt:"+
d.rt+",")+("tp:"+d.tp+",")+("sl:"+d.sl+",")+("ad_duration:"+d.ad_duration+",")+("volume:"+d.volume)+"}");return a+"]}"}},y=function(){q=!0},A=function(a){if(-1!=="|start|firstQuartile|midpoint|thirdQuartile|resume|bufferFinish|complete|pause|bufferStart|skipped|playerStateChange|loaded|volumeChange|".indexOf("|"+a.type+"|")){v&&(p.cachedVideoEventsReceived=!0,p.cachedEvents.push(a));try{var m="",u=a.hasOwnProperty("timestamp")?a.timestamp:(new Date).getTime(),w=u-(l.birthdate||u+1),y="n",r=!1;switch(a.type){case "start":m=
"adVideoStart";p.videoStartArrived=!0;n.getAggregator().trigger("omidrendvideostart");d=u;f=a.data.duration;1E3<f&&(f/=1E3);e=a.data.videoPlayerVolume;break;case "volumeChange":m="volumeChanged";e=a.data.videoPlayerVolume;break;case "firstQuartile":case "midpoint":case "thirdQuartile":case "complete":m="adVideo"+a.type.substring(0,1).toUpperCase()+a.type.substring(1);r=!0;n.getAggregator().trigger("videoQuartileEvent",a);break;case "pause":case "bufferStart":m="pauseAd";break;case "resume":case "bufferFinish":m=
...
v=!0;w.addEventListener("video",A);v=!1;p.cachedVideoEventsChecked=!0;p.cachedVideoEventsReceived&&p.processCachedEvents();m.init()},addVideoPlaybackEventListener:function(a){b.on("videoPlaybackEvent",a)}}},Oa=function(a,b){var c=!1,d=function(a){var d=a.percentageInView;c=!0;a.viewState=50<=d?k.IN_VIEW:k.OUT_OF_VIEW;a.outOfViewReason=50<=d?"":k.OUT_OF_VIEW_REASONS.GEOM;b.trigger("measurementChanged",a)};return{start:function(){n.getAggregator().trigger("addOutputItem",{output:k.MEDIA_TYPE.DISPLAY_CODE},
...
b=b.concat(a.getAvidMeasurementStrategies()),b=b.concat(a.getMraidMeasurementStrategies());(b=(new ha(b)).resolve())||n.getAggregator().trigger("addOutputItem",{output:"0"},"oam",{type:"impression"});var c=new Cd(b);return new Bd(b,c,d.isMobileAppEnvironment())}}},Kb=function(a){var b=n.getAggregator().request("mobileApp");return{getOmidMeasurementStrategies:function(){var a=n.getAggregator().request("omidVerificationClient"),b=new aa(a),e=[];if(b.accepts()){var f=new ea,g=new Dd,m=new Ia,p=n.getAggregator().request("omidAdSessionContext"),
...
return{create:function(b){var e=d;if(g.isDef(c))if(a.environment.supportsAdContainerGeometry())e=c;else if(c.shouldDelegateToDomBasedViewability)e=b,e.method=c.method;else if(0===c.percentInView||75<=c.percentInView)e=c;return e},start:function(){var b;g.isDef(a)&&g.isDef(a.measurementStrategy)&&(b=a.measurementStrategy,b.addMeasurementChangedListener(f),b.start())},requiresDelayedViewabilityEvent:function(){b=!0}}},Va=function(a,b,c){var d=!1,e=!1,f=!1,q,m,p,u,l=function(){if(!g.isUndef(m)){var a=
[],b,l;d?(e?(l=!1,b=100):(l=u,b=p),50>b&&a.push(k.OUT_OF_VIEW_REASONS.GEOM)):(l=!1,b=0,a.push(k.OUT_OF_VIEW_REASONS.VIDEO));f=!0;m.shouldDelegateToDomBasedViewability=l;m.percentageInView=b;m.viewState=50>b?k.OUT_OF_VIEW:k.IN_VIEW;m.outOfViewReason=a.join(".");q=m;c.trigger("measurementChanged",q)}},v=function(a){m=a;p=a.percentageInView;u=a.shouldDelegateToDomBasedViewability;l()},r=function(a){a=a.eventType;"AdEnteredFullscreen"===a?e=!0:"AdExitedFullscreen"===a?e=!1:-1!=="AdStarted|AdVideoStart|AdPlaying".indexOf(a)?
...
!s.isAvidNative()}}},Ta=function(a,b,c,d){var e,f,q,m=function(){if(g.isDef(e)&&g.isDef(f)){var a=d.calculateGeometricMeasurement(e,f);q=a.isMeasurable=!0;c.trigger("geometryMeasurementChanged",a)}},p=function(a){e=a;m()},l=function(a){f=a;m()};return{start:function(){n.getAggregator().trigger("addOutputItem",{output:k.MEDIA_TYPE.DISPLAY_CODE},k.MEDIA_TYPE_CODE,{type:k.IMPRESSION_EVENT});a.addAdContainerGeometryMeasurementChangedListener(p);a.start();b.addAdGeometryMeasurementChangedListener(l);b.start()},
addMeasurementChangedListener:function(a){c.on("geometryMeasurementChanged",a)},getStrategyName:function(){return k.MEASUREMENT_STRATEGY.DISPLAY},isMeasurable:function(){return q}}},Sa=function(a){var b=[],c;return{calculateObstructedArea:function(d,e){var f,q,m,p;q=e&&0<e.length;var k;if(q){k=Math.round(d.width);var l=Math.round(d.height);f=Array(k);for(m=0;m<k;m++)f[m]=Array(l);k={matrix:f,obscuredPixelCount:0,x:Math.round(d.x),y:Math.round(d.y),width:k,height:l}}else k={};f=k;l=k=0;if(q){for(;k<
e.length;k++){q=e[k];m=l=f;var n=q;f=Math.max(m.x,n.x);q=Math.max(m.y,n.y);p=Math.min(m.x+m.width,n.x+n.width);n=Math.min(m.y+m.height,n.y+n.height);m=p-f;p=n-q;m=0<m?m:0;p=0<p?p:0;f-=l.x;q-=l.y;m=f+m;p=q+p;for(f=Math.round(f);f<Math.round(m);f++)for(n=Math.round(q);n<Math.round(p);n++)void 0!==l.matrix[f]&&void 0===l.matrix[f][n]&&(l.matrix[f][n]=1,l.obscuredPixelCount+=1);f=l}l=f.obscuredPixelCount;k=f;if(g.isUndef(k.matrix)||0===k.matrix.length)c=[];else{q=0;p=!1;f=k.matrix[0].length;m=k.matrix.length;
p=a.getConfig({height:f}).numberOfSlices;for(var n=r.floor(f/p)||1,s=[],y=0;y<f;y++){p=!1;for(var A=0;A<m;A++)if(1===k.matrix[A][y]){p=!0;break}q++;p&&(y+=n-q,q=n);if(q==n||y===f-1)s.push(p),q=0}c=s}}else c=b;return l},getObstructionStatusBySlice:function(){return c}}},Ed=function(a,b){var c=n.getAggregator().request("omidAdSessionContext");c.geometryChangeEvents=[];var d=null,e=!1,f=r.getWindow(),q=(f=f&&f.omid3p)&&g.isFunction(f.registerSessionObserver)&&g.isFunction(f.addEventListener)?f:a,m=new ga,
p=!1,u=!1,w=function(){var a=r.getDoc().getElementById("iasbi"+l.asid);a&&a.hasAttribute("CreativeLoaded")?(e=c.delayingViewabilityEvents=!1,d&&(v(d),d=null)):r.setTimeout(w,50)},v=function(a){if(a&&"geometryChange"===a.type&&a.data&&a.data.adView){p&&(c.cachedGeometryEventsReceived=!0,c.cachedEvents.push(a));var f=a.data.adView,q=!!(f.measuringElement&&f.containerGeometry&&f.onScreenContainerGeometry);10>c.geometryChangeEvents.length&&(c.geometryChangeEvents.push(s.getTagTime()+"."+f.percentageInView),
...
if(("limited"===c.accessMode||d&&b)&&f&&e&&0<c.cachedEvents.length){for(var g=d="o",b=f=e=0,a=!a,m=(new Date).getTime(),p=0;p<c.cachedEvents.length;p++){for(var g=m,q=-1,k=0;k<c.cachedEvents.length;k++)!c.cachedEvents[k].alreadyOrdered&&c.cachedEvents[k].timestamp<g&&(g=c.cachedEvents[k].timestamp,q=k);-1!==q&&(q=c.cachedEvents[q],q.alreadyOrdered=!0,"geometryChange"===q.type&&q.data&&q.data.adView?e=q.data.adView.percentageInView:a=-1<"start|firstQuartile|midpoint|thirdQuartile|resume|bufferFinish".indexOf(q.type),
g=e&&50<=e&&a?"i":"o","o"===d&&"i"===g?f=q.timestamp:"i"===d&&"o"===g?b+=q.timestamp-f:"i"===d&&"i"===g&&(b+=q.timestamp-f,f=q.timestamp),d=g)}u=!0;0<b&&(c.recoveredTime=b,(d=n.getAggregator().request("mScreenEvents"))&&d.setRecoveredTimeInSlTimes&&d.setRecoveredTimeInSlTimes(b))}}};return{start:function(){p=!0;void 0!==c.impressionViewabilityMeasurement&&v(c.impressionViewabilityMeasurement);q.addEventListener("geometryChange",v);p=!1;c.cachedGeometryEventsChecked=!0;c.cachedGeometryEventsReceived&&
c.processCachedEvents()},addAdContainerGeometryMeasurementChangedListener:function(a){b.on(k.CONTAINER_GEOMETRY_MEASUREMENT_CHANGED,a)},translateOmidOutOfViewReasons:K}},ea=function(){var a=n.getAggregator().request("omidAdSessionContext");return{accepts:function(){return a&&(a.isNative||a.isLimitedSandbox)}}},Fd=function(a,b){var c=n.getAggregator().request("omidAdSessionContext"),d=null,e=!1,f=r.getWindow(),q=(f=f&&f.omid3p)&&g.isFunction(f.registerSessionObserver)&&g.isFunction(f.addEventListener)?
f:a,m=new ga,p=function(){var a=r.getDoc().getElementById("iasbi"+l.asid);a&&a.hasAttribute("CreativeLoaded")?(e=c.delayingViewabilityEvents=!1,d&&(u(d),d=null)):r.setTimeout(p,50)},u=function(a){if(a&&"geometryChange"===a.type&&a.data&&a.data.adView)if(c.delayingViewabilityEvents)d=a,e||(e=!0,p());else{var f=a.data.adView.geometry,g=a.data.adView.containerGeometry,q=!!f,l=a.data.adView.measuringElement&&!!g,f=(new D({x:q&&l?f.x-g.x:0,y:q&&l?f.y-g.y:0,width:q?f.width:0,height:q?f.height:0})).getRoundedGeometry();
...
addMeasurementChangedListener:function(a){d.on("videoGeometryMeasurementChanged",a)},isMeasurable:function(){return r}}},Qa=function(a,b,c){var d,e=function(){var b=a.find(),e,m,p=!1;g.isDef(b)?(m=!0,e=b.getBoundingClientRect(),e={x:e.left,y:e.top,width:e.width,height:e.height},b.hasOwnProperty("adWasClipped")&&(e.adWasClipped=!0)):(d&&(p=!0,e={x:0,y:0,width:0,height:0}),m=!1);if(b=m)b=e,b=!g.isDef(d)||!1!==g(b).compareTo(d);if(b||p)d=e,c.trigger(k.OMID_GEOMETRY_MEASUREMENT_CHANGED,{adGeometry:e,
...
f())},m=function(){c||q()};return{start:function(){var b=!0;if(g.isDef(a.mraid)||t.containsScriptTagWithSrc("mraid.js"))b=!1;n.getAggregator().trigger("addOutputItem",{output:g.stringifyTriState(b)},"mi",{type:"impression"});b?n.getAggregator().trigger("exec","mraid.js",m):q()},addScreenLocationChangedListener:function(a){b.on("mraidScreenLocationChanged",a)}}},gc=function(a,b,c){var d={},e=function(c){var d=g.noop;b.bootstrapOn("useViewabilityNotification")&&(d=function(){a.skipAsFraudulent()||n.getAggregator().trigger("notify",
...
d?new Q({tiv:m}):new Q({tiv:g});n.getAggregator().provide("isFullyInViewProvider",{isFullyInView:p});return{timeInViewThresholds:c,type:k.DT_CODES.FULLY_INVIEW,isInView:p,applies:function(){return e},minUnit:1E3,shouldIncludeSound:!1}},xb=function(a,b){return{timeInViewThresholds:new Q({tiv:[0]}),type:k.DT_CODES.FULLY_INVIEW,rts:{0:l._onInViewFull},isInView:function(a){var b=r.max(a.fullPercentInView||0,a.percentInView);return-1!==(k.IN_VIEW+"|"+k.PARTIAL_VIEW_PLUS).indexOf(a.viewState)&&100===b},
...
0;m=b.ub||f;if(n>=e&&n<=m)return!0});l=!l&&u>=d.piv;b.method==k.DETECTION_METHODS.AD_PLACEHOLDER&&0===a.tiv&&(l=!1);q&&(l=l&&b.isVideoPlaying,p&&(l=l&&b.isSoundOn));return l};c=new Q(a);d=a.qiv;(function(){e={};var a;g.isDef(l.rts)&&g.isDef(l.rts[m])&&(a=c&&g.isFunction(c.getTimeThresholds)&&c.getTimeThresholds()[0],a=g.isDef(a)?g.isFunction(a.getTimeInViewForRts)&&a.getTimeInViewForRts():k.RTS_KEY_FOR_VQ,e[a]=l.rts[m])})();return{timeInViewThresholds:c,qivThreshold:d,type:k.DT_CODES.CUSTOM,rts:e,
isInView:n,isInViewIgnoringRender:function(a){return n(a,!0)},metricId:m,minUnit:a.minunit?1E3*a.minunit:1E3,thresholdType:a.thresholdType,shouldIncludeSound:p,sendOtherwiseInViewSignal:!0}},zb=function(a,b,c){var d=b.isVideo()?"video":"display",e=b.isMobileApp()?"app":"web",f=b.isDeviceTypeGroupMobile()?"mobile":"desktop",k=g(a.customViewability).isArray()&&0<a.customViewability.length,m=c.on("customMetric"),p=c.on("groupmCM"),l=function(a,b){var c,m,k,q,l;c=g(b.mediaTypes).contains(d);m=g(b.distributionChannels).contains(e);
k=g.isDef(b.deviceGroups)?g(b.deviceGroups).contains(f):!0;q=H.contains(b.id,"fiv");l=H.contains(b.id,"groupmCM");q=!q;l&&(q=p);return q&&c&&m&&k};return{resolve:function(){var b=[],c;m&&k&&(c=g(a.customViewability).filter(l),g(c).each(function(a,c){b.push(c)}));return b}}},Q=function(a){var b=[];if(g(a.tiv).isArray())g(a.tiv).each(function(a,c){b.push(new ja(c))});else if("string"===typeof a.tiv){a=a.tiv.split("|");var c=new Pd;b.push(new Qd(c,parseInt(a[1].replace("%"))));b.push(new ja(1E3*parseInt(a[0])))}else g.isDef(a.tiv)&&
...
e);n.getAggregator().on("nodesAdded",f)}}},ae=function(a,b,c,d,e,f){var q,m,p,u,w,v,K,y,A,E=t.getElementsWindow(b);t.getElementsDocument(b);n.getAggregator().provide("iframeCalculatorHelper",Ud(E));var G=Vd(b,d),B=k.AD_IDENTIFIER+"-"+l.asid,C=!1,F=D({}),P=s.isDeviceTypeGroupMobile(),I=s.usesGroupMCustomMetricMobilePassThru(),N,M=function(){if(!q)if(q=G.calcDims(b,d,p),l.autotagSizeSet&&1<l.adWidth&&1<l.adHeight&&(q.set("width",l.adWidth),q.set("height",l.adHeight)),c===k.DETECTION_METHODS.VIDEO&&
s.embedded){var a=q,e=(new D(b)).getRounded();try{a.set("width",e.width),a.set("height",e.height)}catch(f){n.getAggregator().trigger("error",k.ERROR_CODES.VIDEO_IN_IFRAME_DIMS_CALC)}}else c===k.DETECTION_METHODS.AD_PLACEHOLDER&&q.treatAsPlaceholder();return q},H=function(){var b,d=s.xDomainIframe&&C;b=P&&C&&p.isReady();b=d||b;d=G.getClippedDims&&(c===k.DETECTION_METHODS.VIDEO&&s.embedded||s.isCeltra());b?m=p.getPiv():g.isUndef(m)&&(b=!P&&(s.friendly||g.isDef(x.mozInnerScreenX))&&e.on("offscreen"),
y=M(),K=new D(t.calcWinDims()),v=new D(b?t.calcMonDims():{}),A=d?G.getClippedDims():F,m=a.calcPercentInView(y,K,v,A));return m},O=function(){return a.calcInitialViewState(H())},T=function(){return b===x?!1:M().isHidden()};(function(){var d=r.getWindow(),e=r.getDoc(),f=b===d,g=e.body,m=n.getAggregator(),l=new Y,q=m.request("browser"),v=m.request("features"),m=m.request("context"),y=!s.xDomainIframe,e=f&&g?e.body:b;N=s.friendlyIframe?d.frameElement:e;z.addEvent(e,"click",function(){n.getAggregator().trigger("adComponentClicked")});
z.addEvent(e,"mouseover",function(){n.getAggregator().trigger("adComponentMousedOver")});l.applies(q,v,m)?(p=od(b,y),p.start(),C=!0,I&&c!==k.DETECTION_METHODS.AD_PLACEHOLDER&&(d=new Wd(M().getRounded()),l=new Xd,l=new Yd(p.getObservedNode(),l),u=new Zd(d.getSlices(),l))):I&&(w=new $d(a))})();return{mark:function(){t.setAttributeOf(N,B,"")},cleanup:function(){t.removeAttributeOf(N,B)},isNode:function(a){return b===a},isHidden:T,isObstructed:function(){return!1},getDims:M,getPercentInView:H,getLocationState:O,
getOnPageViewability:function(){return T()?k.OUT_OF_VIEW:O()},getDetectionMethod:function(){return c},getContainerDims:function(){return G.allowsOptimization?q:D(d)},refresh:function(){A=y=K=v=m=q=void 0;if(f){var a,c;if(!s.isDomless()&&(c=b.parentNode)){for(;b!==x&&c&&c!==J&&!a;)a=c===d,c=c.parentNode;a||(d=b.parentNode)}}},getAdNode:function(){return b},getSliceStatus:function(){var a;u&&u.isReadyToMeasure()?a=u.getSliceStatus():s.friendly&&w&&g.isDef(y)&&(a=w.getSliceStatus(y,K,v,A));return a}}},
be=function(a,b){var c=[],d,e=g([]),f=function(){return c[0]&&c[0].getDetectionMethod()===k.DETECTION_METHODS.AD_PLACEHOLDER},l=function(m,p,l,q){var u=f()||0===c.length;m=ae(a,m,p,l,b,q);f()&&(l=c.shift(),e=g(c),l.cleanup(),d=void 0);c.push(m);e=g(c);u&&m.mark();u&&p!==k.DETECTION_METHODS.AD_PLACEHOLDER&&n.getAggregator().trigger("primaryadfound",m)},m=function(){if(d)return d;var a,b=!1,c=0,f=0;e.each(function(d,e){var g;g=e.getDims();g.hasValidDims()&&(a=e.getPercentInView(),b=a!==k.NA,g=g.area(),
...
b,c){return s.isDomless()?new re:new se(a,b,c)}}},se=function(a,b,c){var d,e,f=n.getAggregator().request("browser"),q=l&&l.contextNode&&l.contextNode.parentNode?l.contextNode.parentNode:null,m=be(b,c),p=function(){var a,b,e;d=d||je(s,c);a=d.find();s.friendlyIframe&&s.isBlockingSizmekTag()&&x(a);!a&&d.usePlaceholder?(u(),s.isDeviceTypeGroupMobile()&&f.hasMutationObserver()&&r.getMutationObserver(w).observe(q,{childList:!0})):a&&(a=g(a).isArray()?a:[a],b=d.getAdContainer(),e=d.allowForAdContainerChange,
g(a).each(function(a,c){m.addAdComponent(c,g.resolve(d.detectionMethod),b,e)}))},u=function(){var a;m.hasAd()||(a=t.getPlaceholderSpan(),q.insertBefore(a,l.contextNode.nextSibling),m.addAdComponent(a,k.DETECTION_METHODS.AD_PLACEHOLDER,t.getParent(a)))},w=function(a,b){var c=!1;g(a).each(function(a,b){b.addedNodes&&0<b.addedNodes.length&&(c=!0)});c&&(n.getAggregator().trigger("nodesAdded"),b.disconnect())},v=function(a,b){var e=!1;g(a).each(function(a,b){1>=b.target.height*b.target.width&&(e=!0)});
...
var b=r.getWindow().location.href,c=[b];try{c.push(top.location.href)}catch(d){}try{c.push(parent.location.href)}catch(e){}if(s.embedded){try{c.push(parent.document.referrer)}catch(f){}try{c.push(J.referrer)}catch(k){}}try{"jsi"!==l.mode&&c.push(x.location.href)}catch(m){}try{c.push(l.jsref)}catch(p){}c.sort(function(a,b){return a.length>b.length?1:a.length<b.length?-1:0});return!!g(a).findFirst(function(a,d){var e=!1,f,m,k="mobfox"===d?c:[b];for(m=0;m<k.length;m++){f=k[m];var l="string"===typeof d?
...
g(p).each(function(a,b){b&&(g.isUndef(b.sl)&&b.updateScreenLoc(c.getCurrentLoc()),b.trigger(),b.indicatesCompletion()&&n.getAggregator().trigger("adSessionComplete"),b.indicatesQuartile()&&("adVideoComplete"!==b.tp&&n.getAggregator().trigger("sendDt",k.DT_CODES.VIDEO_EVENTS),n.getAggregator().trigger("videoQuartileEvent",b)))});p=[];m=!0};(function(){z.addEvent(r.getWindow(),"message",function(a){F(a)});n.getAggregator().on({volumeChanged:H});n.getAggregator().provide({videoEventsString:A,videoVersion:function(){var a,
b=N();try{a=b.getVersion()}catch(c){a=-1,n.getAggregator().trigger("error",k.ERROR_CODES.NO_VIDEO_AD_INTERFACE)}return a},videoTranslator:function(){return q=q||new Ce},adNode:N});N();G.listenForResult();E.isApplicable(s)&&E.start(c)})();return{findAdNode:N,getViewStateOverride:function(){return u},isHandshakeComplete:function(){return t},triggerInitializationEvents:J,setVideoSpecificScreenEventFields:function(a){var b=a.viewState===k.NA;a.isVideoPlaying=!0;a.isSoundOn=y;a.isVideoPlayingInFullscreen=
