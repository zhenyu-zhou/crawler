...
gapi.config.getInnerText=function(a){if(a){var b=a.nodeType;return 3==b||4==b?a.nodeValue:a.textContent||a.innerText||a.innerHTML||""}};gapi.config.parseConfig=function(a){if(a&&!/^\s+$/.test(a)){for(;0==a.charCodeAt(a.length-1);)a=a.substring(0,a.length-1);try{var b=window.JSON.parse(a)}catch(c){}if("object"===typeof b)return b;try{b=(new Function("return ("+a+"\n)"))()}catch(c){}if("object"===typeof b)return b;try{b=(new Function("return ({"+a+"\n})"))()}catch(c){}return"object"===typeof b?b:{}}};
gapi.config.mergeConfig=function(a){gapi.config.cfg(!0);var b=window[gapi.config.GLOBAL_CFG_KEY],c=gapi.config.jslComponent(gapi.config.USER_CFG_KEY);if(b&&b!==window[gapi.config.GLOBAL_CFG_USED]){var d={};gapi.config.foldConfig(d,b);c.push(d);window[gapi.config.GLOBAL_CFG_USED]=b}gapi.config.appendInlineConfig();a&&(d={},gapi.config.foldConfig(d,a),c.push(d));b=gapi.config.jslComponent(gapi.config.DEFAULT_CFG_KEY);a=0;for(d=b.length;a<d;++a)gapi.config.foldConfig(gapi.config.cfg(),b[a]);b=gapi.config.jslComponent(gapi.config.INJECTED_CFG_KEY);
a=0;for(d=b.length;a<d;++a)gapi.config.foldConfig(gapi.config.cfg(),b[a]);a=0;for(d=c.length;a<d;++a)gapi.config.foldConfig(gapi.config.cfg(),c[a])};gapi.config.get=function(a,b){if(!a)return gapi.config.cfg();a=a.split("/");for(var c=gapi.config.cfg(),d=0,e=a.length;c&&"object"===typeof c&&d<e;++d)c=c[a[d]];return d===a.length&&void 0!==c?c:b};gapi.config.update=function(a,b){var c=a;if("string"===typeof a){var d=c={};a=a.split("/");for(var e=0,f=a.length;e<f-1;++e)var g={},d=d[a[e]]=g;d[a[e]]=b}gapi.config.mergeConfig(c)};
