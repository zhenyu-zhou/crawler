...
gapi.config.update=function(a,b){var d;if("string"===typeof a){var c=d={};a=a.split("/");for(var e=0,f=a.length;e<f-1;++e){var g={};c=c[a[e]]=g}c[a[e]]=b}else d=a;gapi.config.mergeConfig_(d)};gapi.config.init_=gapi.config.mergeConfig_;gapi.config.legacyInit&&gapi.config.legacyInit();gapi.config.init_();
;
