...
var $jscomp=$jscomp||{};$jscomp.scope={};$jscomp.createTemplateTagFirstArg=function(a){return a.raw=a};$jscomp.createTemplateTagFirstArgWithRaw=function(a,b){a.raw=b;return a};$jscomp.checkStringArgs=function(a,b,d){if(a==null)throw new TypeError("The 'this' value for String.prototype."+d+" must not be null or undefined");if(b instanceof RegExp)throw new TypeError("First argument to String.prototype."+d+" must not be a regular expression");return a+""};$jscomp.ASSUME_ES5=!1;
$jscomp.ASSUME_NO_NATIVE_MAP=!1;$jscomp.ASSUME_NO_NATIVE_SET=!1;$jscomp.SIMPLE_FROUND_POLYFILL=!1;$jscomp.ISOLATE_POLYFILLS=!1;$jscomp.FORCE_POLYFILL_PROMISE=!1;$jscomp.FORCE_POLYFILL_PROMISE_WHEN_NO_UNHANDLED_REJECTION=!1;$jscomp.defineProperty=$jscomp.ASSUME_ES5||typeof Object.defineProperties=="function"?Object.defineProperty:function(a,b,d){if(a==Array.prototype||a==Object.prototype)return a;a[b]=d.value;return a};
...
gapi.config.isArray_=function(a){return typeof a==="object"&&/\[native code\]/.test(a.push)};
...
gapi.config.parseConfig_=function(a,b){if(a&&!/^\s+$/.test(a)){for(;a.charCodeAt(a.length-1)==0;)a=a.substring(0,a.length-1);var d=""+a;try{var c=window.JSON.parse(a)}catch(k){}if(typeof c==="object")return c;try{c=window.JSON.parse("{"+a+"}")}catch(k){}if(typeof c==="object")return c;var e=RegExp("([^\"',{}\\s]+?)\\s*:\\s*(.*?)[,}\\s]","g"),f=function(k,l,h){h=h.startsWith('"')?"%DOUBLE_QUOTE%"+h.substring(1):h;h=h.endsWith('"')?h.slice(0,-1)+"%DOUBLE_QUOTE%":h;return"%DOUBLE_QUOTE%"+l+"%DOUBLE_QUOTE%:"+
h};a=a.replace(e,f);a=a.replace(/\\'/g,"%SINGLE_QUOTE%");a=a.replace(/"/g,'\\"');a=a.replace(/'/g,'"');a=a.replace(/%SINGLE_QUOTE%/g,"'");a=a.replace(/%DOUBLE_QUOTE%/g,'"');try{c=window.JSON.parse(a)}catch(k){}if(typeof c==="object")return c;try{c=window.JSON.parse("{"+a+"}")}catch(k){}if(typeof c==="object")return c;a=document.getElementsByTagName("script")||[];var g;a.length>0&&(g=a[0].nonce||a[0].getAttribute("nonce"));if(g&&g===b||!g&&gapi.config.isGoogleDomain_(window.location.hostname))if(c=
gapi.config.evalConfigText_(d),typeof c==="object")return c;return{}}};
